...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 199,344 | 🐛 3,136 | 🌐 C++ | 📅 2026-09-09 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,879 | 🐛 17,639 | 🌐 Python | 📅 2026-09-09 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,322 | 🐛 206 | 🌐 Python | 📅 2026-09-08 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,078 | 🐛 1,499 | 🌐 C++ | 📅 2026-09-09 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [kserve](https://github.com/kserve/kserve) ⭐ 5,866 | 🐛 219 | 🌐 Go | 📅 2026-09-09 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 58,374 | 🐛 5,016 | 🌐 Python | 📅 2026-09-09 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,110 | 🐛 194 | 🌐 Lua | 📅 2026-09-07 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,102 | 🐛 238 | 🌐 Lua | 📅 2026-09-09 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,820 | 🐛 505 | 🌐 Go | 📅 2026-09-09 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,335 | 🐛 1,099 | 🌐 Go | 📅 2026-09-08 - Next-generation Cloud Native Gateway.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 3,024 | 🐛 773 | 🌐 Go | 📅 2026-09-09 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,161 | 🐛 115 | 🌐 Go | 📅 2026-09-09 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [gloo](https://github.com/solo-io/gloo) ⭐ 170 | 🐛 1,877 | 🌐 Go | 📅 2026-09-09 - The Feature-rich, Kubernetes-native, Next-Generation API Gateway Built on Envoy.
...
* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,630 | 🐛 1,920 | 🌐 Go | 📅 2026-09-09 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,300 | 🐛 106 | 🌐 Go | 📅 2026-09-09 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,228 | 🐛 461 | 🌐 Go | 📅 2026-09-09 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 30,139 | 🐛 314 | 🌐 Go | 📅 2026-09-08 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,530 | 🐛 3,603 | 🌐 Java | 📅 2026-09-09 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,658 | 🐛 2,426 | 🌐 Go | 📅 2026-09-09 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 24,115 | 🐛 4,366 | 🌐 Go | 📅 2026-09-09 - Declarative continuous deployment for Kubernetes.
* [argo](https://github.com/argoproj/argo) ⭐ 16,966 | 🐛 1,278 | 🌐 Go | 📅 2026-09-09 - Get stuff done with container-native workflows for Kubernetes.
* [dagger](https://github.com/dagger/dagger) ⭐ 16,238 | 🐛 157 | 🌐 Go | 📅 2026-09-09 - A programmable CI/CD engine that runs your pipelines in containers.
...
* [kustomize](https://github.com/kubernetes-sigs/kustomize) ⭐ 12,158 | 🐛 192 | 🌐 Go | 📅 2026-09-09 - Customization of kubernetes YAML configurations.
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 12,047 | 🐛 200 | 🌐 Go | 📅 2026-09-09 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,736 | 🐛 1,955 | 🌐 TypeScript | 📅 2026-09-09 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,621 | 🐛 20 | 🌐 Go | 📅 2026-09-07 - Go from Docker Compose to Kubernetes.
* [tilt](https://github.com/tilt-dev/tilt) ⭐ 10,045 | 🐛 511 | 🌐 Go | 📅 2026-09-09 - A multi-service dev environment for teams on Kubernetes.
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,783 | 🐛 103 | 🌐 Java | 📅 2026-09-09 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,062 | 🐛 581 | 🌐 Go | 📅 2026-09-08 - A cloud-native Pipeline resource.
...
* [kubevela](https://github.com/oam-dev/kubevela) ⭐ 7,894 | 🐛 275 | 🌐 Go | 📅 2026-09-09 - Make shipping applications more enjoyable.
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,844 | 🐛 370 | 🌐 Go | 📅 2026-09-09 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
* [jsonnet](https://github.com/google/jsonnet) ⭐ 7,566 | 🐛 212 | 🌐 Jsonnet | 📅 2026-03-30 - Jsonnet - The data templating language.
* [flux](https://github.com/fluxcd/flux) ⚠️ Archived - A tool for turning container images into running Kubernetes services.
* [helm-dashboard](https://github.com/komodorio/helm-dashboard) ⭐ 5,751 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-09 - The missing UI for Helm - visualize your releases.
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,593 | 🐛 771 | 🌐 Go | 📅 2026-09-09 - Software Delivery Workflow For Kubernetes
...
* [cds](https://github.com/ovh/cds) ⭐ 4,839 | 🐛 164 | 🌐 Go | 📅 2026-09-09 - Enterprise-Grade Continuous Delivery & DevOps Automation Open Source Platform.
...
* [werf](https://github.com/werf/werf) ⭐ 4,719 | 🐛 27 | 🌐 Go | 📅 2026-09-09 - The CLI tool gluing Git, Docker, Helm, and Kubernetes with any CI system to implement CI/CD and Giterminism.
...
* [ballerina-lang](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,850 | 🐛 1,613 | 🌐 Ballerina | 📅 2026-09-03 - Ballerina is a new programming language for integration built on a sequence diagram metaphor.
...
* [kargo](https://github.com/akuity/kargo) ⭐ 3,641 | 🐛 190 | 🌐 Go | 📅 2026-09-09 - Application lifecycle orchestration.
...
* [argo-rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,574 | 🐛 659 | 🌐 Go | 📅 2026-09-09 - Progressive delivery controller for blue-green, canary, and experiments on Kubernetes.
* [zadig](https://github.com/koderover/zadig) ⭐ 3,240 | 🐛 26 | 🌐 Go | 📅 2026-09-09 - Zadig is a cloud native, distributed, developer-oriented continuous delivery product.
...
* [source-to-image](https://github.com/openshift/source-to-image) ⭐ 2,544 | 🐛 28 | 🌐 Go | 📅 2026-09-09 - A tool for building/building artifacts from source and injecting into docker images.
...
* [hub](https://github.com/artifacthub/hub) ⭐ 2,082 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-03 - Find, install and publish Cloud Native packages
...
* [kpt](https://github.com/GoogleContainerTools/kpt) ⭐ 1,892 | 🐛 336 | 🌐 Go | 📅 2026-09-09 - Kpt is a toolkit to help you manage, manipulate, customize, and apply Kubernetes Resource configuration data files.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,670 | 🐛 327 | 🌐 Go | 📅 2026-09-09 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,434 | 🐛 45 | 🌐 Go | 📅 2026-09-01 - OpenTofu / Terraform / Terragrunt and Atmos version manager.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,352 | 🐛 250 | 🌐 Go | 📅 2026-09-09 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,777 | 🐛 319 | 🌐 Go | 📅 2026-09-09 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,225 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,224 | 🐛 88 | 🌐 Go | 📅 2026-09-08 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,496 | 🐛 358 | 🌐 Go | 📅 2026-09-09 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [kuberlr](https://github.com/flavio/kuberlr) ⭐ 143 | 🐛 16 | 🌐 Go | 📅 2026-09-07 - A tool that simplifies the management of multiple versions of kubectl.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,623 | 🐛 836 | 🌐 Python | 📅 2026-09-08 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,797 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-09 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,394 | 🐛 160 | 🌐 Go | 📅 2026-09-09 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,274 | 🐛 200 | 🌐 Go | 📅 2026-09-08 - Enforce Kubernetes admission policies using Open Policy Agent constraints.
...
* [pluto](https://github.com/FairwindsOps/pluto) ⭐ 2,579 | 🐛 13 | 🌐 Go | 📅 2026-09-09 - A cli tool to help discover deprecated apiVersions in Kubernetes.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,253 | 🐛 40 | 🌐 Python | 📅 2026-09-08 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 235 | 🐛 133 | 🌐 Rust | 📅 2026-09-08 - Policy as code for Kubernetes powered by WebAssembly modules.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 32,111 | 🐛 562 | 🌐 Go | 📅 2026-09-09 - Run Kubernetes locally.
...
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,722 | 🐛 214 | 🌐 Jinja | 📅 2026-09-09 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,343 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-09 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,671 | 🐛 133 | 🌐 Go | 📅 2026-09-09 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
...
* [talos](https://github.com/talos-systems/talos) ⭐ 11,128 | 🐛 240 | 🌐 Go | 📅 2026-09-09 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,367 | 🐛 161 | 🌐 Python | 📅 2026-09-09 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,211 | 🐛 93 | 🌐 Go | 📅 2026-09-09 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,302 | 🐛 209 | 🌐 Go | 📅 2026-09-09 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 4,000 | 🐛 38 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,442 | 🐛 205 | 🌐 Go | 📅 2026-09-09 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
* [cloudpods](https://github.com/yunionio/cloudpods) ⭐ 2,941 | 🐛 213 | 🌐 Go | 📅 2026-09-09 - A cloud-native open-source unified multi-cloud and hybrid-cloud platform.
...
* [fleet](https://github.com/rancher/fleet) ⭐ 1,727 | 🐛 180 | 🌐 Go | 📅 2026-09-09 - Manage large fleets of Kubernetes clusters.
...
* [claudie](https://github.com/berops/claudie) ⭐ 793 | 🐛 55 | 🌐 Go | 📅 2026-09-09 - Cloud-agnostic managed Kubernetes.
...
* [spinifex](https://github.com/mulgadc/spinifex) ⭐ 160 | 🐛 4 | 🌐 Go | 📅 2026-09-09 - Open source AWS-compatible platform for bare-metal, on-prem, and edge deployments. Run EC2, S3, EBS, and VPC-compatible services on your own hardware — no managed cloud required.
...
* [client-go](https://github.com/kubernetes/client-go) ⭐ 9,877 | 🐛 0 | 🌐 Go | 📅 2026-09-09 - Go client for Kubernetes.
* [telepresence](https://github.com/telepresenceio/telepresence) ⭐ 7,295 | 🐛 27 | 🌐 Go | 📅 2026-09-09 - Local development against a remote Kubernetes or OpenShift cluster.
...
* [devspace](https://github.com/devspace-cloud/devspace) ⭐ 5,179 | 🐛 92 | 🌐 Go | 📅 2026-09-06 - Cloud Native Software Development with Kubernetes and Docker - simply run "devspace up" in any of your projects and start coding directly on top of Kubernetes (works with minikube, self-hosted and cloud-based clusters).
...
* [okteto](https://github.com/okteto/okteto) ⭐ 3,542 | 🐛 36 | 🌐 Go | 📅 2026-09-09 - Local development experience for Kubernetes apps.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,559 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - Manage and run multiple kubectl port-forward configurations directly in the menu bar, syncing configurations with git repositories.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,159 | 🐛 98 | 🌐 Go | 📅 2026-09-09 - Giving Kubernetes Superpowers to everyone.
...
* [robusta](https://github.com/robusta-dev/robusta) ⭐ 3,090 | 🐛 203 | 🌐 Python | 📅 2026-09-08 - Open source Kubernetes troubleshooting and automation platform.
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,083 | 🐛 14 | 🌐 Go | 📅 2026-09-09 - Tools for observing Kubernetes resources in real time, powered by Pulumi.
...
* [cri-tools](https://github.com/kubernetes-sigs/cri-tools) ⭐ 2,012 | 🐛 11 | 🌐 Go | 📅 2026-09-09 - CLI and validation tools for Kubelet Container Runtime Interface (CRI).
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,019 | 🐛 133 | 🌐 Go | 📅 2026-09-09 - Test infrastructure for the Kubernetes project.
* [kwok](https://github.com/kubernetes-sigs/kwok) ⭐ 3,184 | 🐛 33 | 🌐 Go | 📅 2026-09-09 - Kubernetes WithOut Kubelet - Simulates thousands of Nodes and Clusters.
...
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 217 | 🐛 183 | 🌐 Python | 📅 2026-09-09 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
* [seaworthy](https://github.com/cakehappens/seaworthy) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2020-08-10 - A CLI to verify Kubernetes resource health.

## Data Protection & Backup

* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,285 | 🐛 831 | 🌐 Go | 📅 2026-09-09 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,736 | 🐛 303 | 🌐 Go | 📅 2026-09-09 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,736 | 🐛 303 | 🌐 Go | 📅 2026-09-09 - Kubernetes cost monitoring powered by open allocation models.
...
* [attune](https://github.com/attune-io/attune) ⭐ 37 | 🐛 10 | 🌐 Go | 📅 2026-09-09 - Kubernetes operator for in-place pod resource right-sizing from Prometheus metrics.
...
* [dragonfly2](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,325 | 🐛 26 | 🌐 Go | 📅 2026-09-09 - Dragonfly is an intelligent P2P based file distribution system.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 29,002 | 🐛 1,130 | 🌐 JavaScript | 📅 2026-09-07 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,288 | 🐛 2,940 | 🌐 C | 📅 2026-09-09 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,906 | 🐛 709 | 🌐 TypeScript | 📅 2026-09-09 - The Open Source Airtable alternative.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 52,246 | 🐛 355 | 🌐 Go | 📅 2026-09-09 - Distributed reliable key-value store for the most critical data of a distributed system.
* [milvus](https://github.com/milvus-io/milvus) ⭐ 46,035 | 🐛 1,384 | 🌐 Go | 📅 2026-09-09 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,504 | 🐛 6,949 | 🌐 Go | 📅 2026-09-09 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
...
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,448 | 🐛 8,467 | 🌐 Go | 📅 2026-09-08 - CockroachDB - the open source, cloud-native SQL database.
* [influxdb](https://github.com/influxdata/influxdb) ⭐ 31,729 | 🐛 2,165 | 🌐 Rust | 📅 2026-09-08 - Scalable datastore for metrics, events, and real-time analytics.
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,542 | 🐛 32 | 🌐 C++ | 📅 2026-09-09 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,994 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,494 | 🐛 391 | 🌐 C | 📅 2026-09-09 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,798 | 🐛 207 | 🌐 Java | 📅 2026-09-09 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,837 | 🐛 1,808 | 🌐 Rust | 📅 2026-09-08 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,267 | 🐛 846 | 🌐 C++ | 📅 2026-09-09 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
...
* [oceanbase](https://github.com/oceanbase/oceanbase) ⭐ 10,265 | 🐛 599 | 🌐 C++ | 📅 2026-09-09 - A distributed, banking suitable, open-source related database featuring high scalability and high compatibility.
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,434 | 🐛 574 | 🌐 Rust | 📅 2026-09-09 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 7,035 | 🐛 150 | 🌐 Go | 📅 2026-09-07 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
* [couchdb](https://github.com/apache/couchdb) ⭐ 6,949 | 🐛 374 | 🌐 Erlang | 📅 2026-09-08 - Apache CouchDB is one of a new breed of database management systems.
...
* [kvrocks](https://github.com/KvrocksLabs/kvrocks) ⭐ 4,422 | 🐛 244 | 🌐 C++ | 📅 2026-09-09 - Kvrocks is a distributed key value NoSQL database based on RocksDB and compatible with Redis protocol.
* [polardb-for-postgresql](https://github.com/alibaba/PolarDB-for-PostgreSQL) ⭐ 3,200 | 🐛 65 | 🌐 C | 📅 2026-09-09 - PolarDB for PostgreSQL (PolarDB for short) is an open source database system based on PostgreSQL.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,122 | 🐛 250 | 🌐 Go | 📅 2026-09-09 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,340 | 🐛 878 | 🌐 Go | 📅 2026-09-09 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,303 | 🐛 1,103 | 🌐 Go | 📅 2026-09-09 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 17,020 | 🐛 1,341 | 🌐 C++ | 📅 2026-09-09 - Ceph is a distributed object, block, and file storage platform.
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,410 | 🐛 206 | 🌐 Go | 📅 2026-09-09 - A distributed POSIX file system built on top of Redis and S3.
* [rook](https://github.com/rook/rook) ⭐ 13,647 | 🐛 143 | 🌐 Go | 📅 2026-09-08 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,809 | 🐛 36 | 📅 2026-09-09 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
* [fastdfs](https://github.com/happyfish100/fastdfs) ⭐ 9,253 | 🐛 466 | 🌐 C | 📅 2026-09-07 - FastDFS is an open source high performance distributed file system (DFS). It's major functions include: file storing, file syncing and file accessing, and design for high capacity and load balance.
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,967 | 🐛 1,890 | 🌐 Shell | 📅 2026-09-09 - We put storage on cows and move them around from rancher.
* [chubaofs](https://github.com/chubaofs/chubaofs) ⭐ 5,654 | 🐛 259 | 🌐 Go | 📅 2026-09-08 - A distributed storage system for cloud native applications.
* [glusterfs](https://github.com/gluster/glusterfs) ⭐ 5,232 | 🐛 283 | 🌐 C | 📅 2026-09-09 - Gluster is a software defined distributed storage that can scale to several petabytes. It provides interfaces for object, block and file storage.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,737 | 🐛 88 | 🌐 Go | 📅 2026-09-09 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,422 | 🐛 75 | 🌐 Go | 📅 2026-09-09 - OCI registry client, managing content like artifacts, images, packages.
...
* [zenko](https://github.com/scality/Zenko) ⭐ 673 | 🐛 21 | 🌐 Gherkin | 📅 2026-09-09 - Because everyone should be in control of their data.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,694 | 🐛 559 | 🌐 Java | 📅 2026-09-09 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,777 | 🐛 78 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,586 | 🐛 659 | 🌐 Java | 📅 2026-09-09 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,687 | 🐛 532 | 🌐 Go | 📅 2026-09-09 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,701 | 🐛 188 | 🌐 Erlang | 📅 2026-09-09 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,326 | 🐛 1,755 | 🌐 Java | 📅 2026-09-09 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,679 | 🐛 60 | 🌐 Java | 📅 2026-09-09 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [istio](https://github.com/istio/istio) ⭐ 38,378 | 🐛 515 | 🌐 Go | 📅 2026-09-09 - Connect, secure, control, and observe services.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,059 | 🐛 1,412 | 🌐 Go | 📅 2026-09-09 - Consul is a distributed, highly available, and data center aware solution to connect and configure applications across dynamic, distributed infrastructure.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,999 | 🐛 160 | 🌐 Go | 📅 2026-09-09 - Universal Control Plane for your Service Mesh.
...
* [apollo](https://github.com/ctripcorp/apollo) ⭐ 29,804 | 🐛 158 | 🌐 Java | 📅 2026-09-06 - Apollo（阿波罗）是携程框架部门研发的分布式配置中心，能够集中化管理应用不同环境、不同集群的配置，配置修改后能够实时推送到应用端，并且具备规范的权限、流程治理等特性，适用于微服务配置管理场景。
* [coredns](https://github.com/coredns/coredns) ⭐ 14,304 | 🐛 296 | 🌐 Go | 📅 2026-09-09 - CoreDNS is a DNS server that chains middleware.
* [zookeeper](https://github.com/apache/zookeeper) ⭐ 12,800 | 🐛 240 | 🌐 Java | 📅 2026-09-03 - Apache ZooKeeper is an effort to develop and maintain an open-source server which enables highly reliable distributed coordination.
...
* [pingora](https://github.com/cloudflare/pingora) ⭐ 27,344 | 🐛 300 | 🌐 Rust | 📅 2026-08-25 - A library for building fast, reliable and evolvable network services.
* [cilium](https://github.com/cilium/cilium) ⭐ 25,102 | 🐛 1,093 | 🌐 Go | 📅 2026-09-09 - API-aware Networking and Security using eBPF and XDP.
* [flannel](https://github.com/coreos/flannel) ⭐ 9,533 | 🐛 28 | 🌐 Go | 📅 2026-09-07 - Flannel is a network fabric for containers, designed for Kubernetes.
* [weave](https://github.com/weaveworks/weave) ⚠️ Archived - Simple, resilient multi-host Docker networking and more.
* [cni](https://github.com/containernetworking/cni) ⭐ 6,112 | 🐛 156 | 🌐 Go | 📅 2026-09-03 - Container Network Interface - networking for Linux containers.
* [ziti](https://github.com/openziti/ziti) ⭐ 4,381 | 🐛 305 | 🌐 Go | 📅 2026-09-09 - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network.
...
* [multus](https://github.com/k8snetworkplumbingwg/multus-cni) ⭐ 2,944 | 🐛 18 | 🌐 Go | 📅 2026-09-08 - A CNI meta-plugin for multi-homed pods in Kubernetes.
* [submariner](https://github.com/submariner-io/submariner) ⭐ 2,687 | 🐛 22 | 🌐 Go | 📅 2026-09-09 - Connect all your Kubernetes clusters, no matter where they are in the world.
...
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,393 | 🐛 63 | 🌐 Go | 📅 2026-09-09 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,807 | 🐛 207 | 🌐 Go | 📅 2026-09-09 - Antrea is a Kubernetes networking based on Open vSwitch.
...
* [spiderpool](https://github.com/spidernet-io/spiderpool) ⭐ 677 | 🐛 97 | 🌐 Go | 📅 2026-09-09 - Underlay and RDMA network solution of the Kubernetes, for bare metal, VM and any public cloud.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,591 | 🐛 274 | 🌐 Go | 📅 2026-09-09 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,794 | 🐛 919 | 🌐 Go | 📅 2026-09-09 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,607 | 🐛 483 | 🌐 C | 📅 2026-09-09 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,891 | 🐛 1,844 | 🌐 C++ | 📅 2026-09-09 - C++ front/service proxy.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15,557 | 🐛 538 | 🌐 Go | 📅 2026-09-09 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [bunkerweb](https://github.com/bunkerity/bunkerweb) ⭐ 10,924 | 🐛 165 | 🌐 Python | 📅 2026-09-09 - Open-source Web Application Firewall and reverse proxy with Kubernetes integration.
...
* [metallb](https://github.com/metallb/metallb) ⭐ 8,345 | 🐛 97 | 🌐 Go | 📅 2026-09-09 - A network load-balancer implementation for Kubernetes using standard routing protocols.
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,844 | 🐛 391 | 🌐 C | 📅 2026-09-08 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,313 | 🐛 0 | 🌐 C | 📅 2026-09-09 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,075 | 🐛 254 | 🌐 Go | 📅 2026-09-09 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [skipper](https://github.com/zalando/skipper) ⭐ 3,323 | 🐛 304 | 🌐 Go | 📅 2026-09-09 - An HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress.
* [kong/kubernetes-ingress-controller](https://github.com/Kong/kubernetes-ingress-controller) ⭐ 2,410 | 🐛 284 | 🌐 Go | 📅 2026-09-09 - Deploy Kong in a native Kubernetes Ingress Controller.
* [gobetween](https://github.com/yyyar/gobetween) ⭐ 1,986 | 🐛 102 | 🌐 Go | 📅 2025-08-16 - Modern & minimalistic load balancer for the Сloud era.
* [loxilb](https://github.com/loxilb-io/loxilb) ⭐ 1,875 | 🐛 31 | 🌐 Go | 📅 2026-09-09 - eBPF powered cloud-native load-balancer providing efficient externalLB, clusterIP and nodePort services for Kubernetes.
...
* [apisix-ingress-controller](https://github.com/apache/apisix-ingress-controller) ⭐ 1,143 | 🐛 44 | 🌐 Go | 📅 2026-09-09 - Ingress controller for K8s.
* [dev-proxy](https://github.com/microsoft/dev-proxy) ⭐ 827 | 🐛 35 | 🌐 C# | 📅 2026-09-09 - Dev Proxy is a command line tool that simulates real world behaviors of HTTP APIs, including Microsoft Graph, locally.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,600 | 🐛 461 | 🌐 C++ | 📅 2026-09-09 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,957 | 🐛 30 | 🌐 C++ | 📅 2026-09-09 - Apache thrift.
...
* [proxygen](https://github.com/facebook/proxygen) ⭐ 8,378 | 🐛 39 | 🌐 C++ | 📅 2026-09-09 - A collection of C++ HTTP libraries including an easy to use HTTP server.
* [kitex](https://github.com/cloudwego/kitex) ⭐ 8,034 | 🐛 70 | 🌐 Go | 📅 2026-08-31 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices.
...
* [moby](https://github.com/moby/moby) ⭐ 72,082 | 🐛 3,883 | 🌐 Go | 📅 2026-09-09 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,826 | 🐛 1,122 | 🌐 Go | 📅 2026-09-09 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,854 | 🐛 537 | 🌐 Go | 📅 2026-09-09 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,272 | 🐛 457 | 🌐 Go | 📅 2026-09-09 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,259 | 🐛 874 | 🌐 Go | 📅 2026-09-09 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 7,012 | 🐛 64 | 🌐 Go | 📅 2026-09-09 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
* [spin](https://github.com/fermyon/spin) ⭐ 6,506 | 🐛 266 | 🌐 Rust | 📅 2026-09-08 - Spin is an open source framework for building and running fast, secure, and composable cloud microservices with WebAssembly.
* [wazero](https://github.com/tetratelabs/wazero) ⭐ 6,365 | 🐛 39 | 🌐 Go | 📅 2026-09-08 - The zero dependency WebAssembly runtime for Go developers.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,086 | 🐛 605 | 🌐 C | 📅 2026-09-07 - WebAssembly Micro Runtime (WAMR).
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,656 | 🐛 122 | 🌐 Go | 📅 2026-09-09 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface.
...
* [crun](https://github.com/containers/crun) ⭐ 4,112 | 🐛 51 | 🌐 C | 📅 2026-09-09 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,435 | 🐛 62 | 🌐 Rust | 📅 2026-09-09 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
* [hyperd](https://github.com/hyperhq/hyperd) ⚠️ Archived - HyperContainer Daemon.
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,525 | 🐛 269 | 🌐 Go | 📅 2026-09-09 - OpenChoreo is a developer platform for Kubernetes.
...
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,335 | 🐛 68 | 🌐 Rust | 📅 2026-09-09 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 126,921 | 🐛 3,053 | 🌐 Go | 📅 2026-09-09 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,127 | 🐛 109 | 🌐 Go | 📅 2026-09-09 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,963 | 🐛 337 | 🌐 Go | 📅 2026-09-09 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
...
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,931 | 🐛 822 | 🌐 Go | 📅 2026-09-08 - A Kubernetes Native Batch System (Project under CNCF).
* [swarm](https://github.com/docker/classicswarm) ⚠️ Archived - Swarm: a Docker-native clustering system.
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,603 | 🐛 848 | 🌐 Go | 📅 2026-09-09 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
...
* [kruise](https://github.com/openkruise/kruise) ⭐ 5,336 | 🐛 79 | 🌐 Go | 📅 2026-08-31 - Automate application workloads management on Kubernetes.
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,560 | 🐛 50 | 🌐 Go | 📅 2026-09-09 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,958 | 🐛 753 | 🌐 Go | 📅 2026-09-09 - Kubernetes-native Job Queueing.
* [kcp](https://github.com/kcp-dev/kcp) ⭐ 2,819 | 🐛 152 | 🌐 Go | 📅 2026-09-09 - Multi-tenant control plane for running many virtual Kubernetes clusters.
* [fleet](https://github.com/coreos/fleet) ⚠️ Archived - Fleet ties together systemd and etcd into a distributed init system.
* [koordinator](https://github.com/koordinator-sh/koordinator) ⭐ 1,753 | 🐛 224 | 🌐 Go | 📅 2026-09-07 - QoS based scheduling system for hybrid orchestration workloads on Kubernetes, bringing workloads the best layout and status.
* [eks-distro](https://github.com/aws/eks-distro) ⭐ 1,459 | 🐛 118 | 🌐 Shell | 📅 2026-09-09 - Amazon EKS Distro (EKS-D) is a Kubernetes distribution based on and used by Amazon Elastic Kubernetes Service (EKS) to create reliable and secure Kubernetes clusters.
* [ocm](https://github.com/open-cluster-management-io/OCM) ⭐ 1,087 | 🐛 49 | 🌐 Go | 📅 2026-09-08 - The open-cluster-management.io project is focused on enabling end-to-end visibility and control across your Kubernetes clusters.
...
* [serverless](https://github.com/serverless/serverless) ⭐ 46,914 | 🐛 1,222 | 🌐 JavaScript | 📅 2026-09-09 - Serverless Framework – Build web, mobile and IoT applications with serverless architectures using AWS Lambda, Azure Functions, Google CloudFunctions & more!
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,641 | 🐛 96 | 🌐 Rust | 📅 2026-09-09 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,087 | 🐛 442 | 🌐 Go | 📅 2026-09-09 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
* [thanos](https://github.com/thanos-io/thanos) ⭐ 14,202 | 🐛 897 | 🌐 Go | 📅 2026-09-09 - Highly available Prometheus setup with long term storage capabilities.
* [keda](https://github.com/kedacore/keda) ⭐ 10,509 | 🐛 248 | 🌐 Go | 📅 2026-09-09 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
* [nuclio](https://github.com/nuclio/nuclio) ⭐ 5,755 | 🐛 118 | 🌐 Go | 📅 2026-09-08 - High-Performance Serverless event and data processing platform.
...
* [eventing](https://github.com/knative/eventing) ⭐ 1,552 | 🐛 100 | 🌐 Go | 📅 2026-09-09 - Open source specification and implementation of Knative event binding and delivery.
* [layotto](https://github.com/mosn/layotto) ⭐ 853 | 🐛 52 | 🌐 Go | 📅 2026-09-09 - A fast and efficient cloud native application runtime.
...
* [prometheus-operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 298 | 🌐 Go | 📅 2026-09-09 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes.
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,309 | 🐛 64 | 🌐 Go | 📅 2026-09-09 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
...
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,058 | 🐛 572 | 🌐 Go | 📅 2026-09-09 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,928 | 🐛 158 | 🌐 Java | 📅 2026-09-09 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,152 | 🐛 132 | 🌐 Python | 📅 2026-09-09 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
...
* [tidb-operator](https://github.com/pingcap/tidb-operator) ⭐ 1,336 | 🐛 395 | 🌐 Go | 📅 2026-09-09 - TiDB operator creates and manages TiDB clusters running in Kubernetes.
* [kudo](https://github.com/kudobuilder/kudo) ⭐ 1,214 | 🐛 191 | 🌐 Go | 📅 2023-08-22 - Kubernetes Universal Declarative Operator (KUDO).
* [kaito](https://github.com/Azure/kaito) ⭐ 1,010 | 🐛 77 | 🌐 Go | 📅 2026-09-08 - Kubernetes AI Toolchain Operator.
* [k0smotron](https://github.com/k0sproject/k0smotron) ⭐ 743 | 🐛 53 | 🌐 Go | 📅 2026-09-09 - k0smotron is a powerful open-source tool for the efficient management of k0s Kubernetes clusters.
...
* [gateway-operator](https://github.com/kong/gateway-operator) ⭐ 109 | 🐛 222 | 🌐 Go | 📅 2026-09-09 - Kong Gateway Operator is a Kubernetes Operator that can manage your Kong Ingress Controller, Kong Gateway Data Planes, or both together when running on Kubernetes.
* [kubevirtbmc](https://github.com/kubevirtbmc/kubevirtbmc) ⭐ 103 | 🐛 32 | 🌐 Go | 📅 2026-09-09 - A Kubernetes operator of virtual BMCs that provide Redfish and IPMI services for KubeVirt virtual machines.
* [agenttier](https://github.com/agenttier/agenttier) ⭐ 61 | 🐛 20 | 🌐 Go | 📅 2026-09-09 - Kubernetes-native operator that manages isolated, persistent sandboxes for human developers and AI agents through Sandbox CRDs, with built-in governance, warm-pod pool, and a streaming agent-mode REST API.
...
* [k3s](https://github.com/k3s-io/k3s) ⭐ 33,917 | 🐛 79 | 🌐 Go | 📅 2026-09-09 - Lightweight Kubernetes.
* [kubeedge](https://github.com/kubeedge/kubeedge) ⭐ 7,566 | 🐛 1,289 | 🌐 Go | 📅 2026-09-03 - Kubernetes Native Edge Computing Framework (project under CNCF).
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,467 | 🐛 228 | 🌐 Go | 📅 2026-09-09 - Zero Friction Kubernetes.
* [openyurt](https://github.com/openyurtio/openyurt) ⭐ 1,999 | 🐛 148 | 🌐 Go | 📅 2026-09-07 - Extending your native Kubernetes to edge(project under CNCF).
...
* [kairos](https://github.com/kairos-io/kairos) ⭐ 1,819 | 🐛 289 | 🌐 Go | 📅 2026-09-09 - The immutable Linux meta-distribution for edge Kubernetes.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,660 | 🐛 3,311 | 🌐 TypeScript | 📅 2026-09-09 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,019 | 🐛 885 | 🌐 Go | 📅 2026-09-09 - The Prometheus monitoring system and time series database.
* [kibana](https://github.com/elastic/kibana) ⭐ 21,282 | 🐛 14,836 | 🌐 TypeScript | 📅 2026-09-09 - Kibana analytics and search dashboard for Elasticsearch.
* [cadvisor](https://github.com/google/cadvisor) ⭐ 19,408 | 🐛 65 | 🌐 Go | 📅 2026-09-09 - Analyzes resource usage and performance characteristics of running containers.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,689 | 🐛 793 | 🌐 Go | 📅 2026-09-09 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,075 | 🐛 149 | 🌐 Go | 📅 2026-09-08 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
...
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,517 | 🐛 696 | 🌐 Go | 📅 2026-09-09 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,195 | 🐛 111 | 🌐 Go | 📅 2026-09-08 - Add-on agent to generate and expose cluster-level metrics.
...
* [cortex](https://github.com/cortexproject/cortex) ⭐ 5,861 | 🐛 348 | 🌐 Go | 📅 2026-09-08 - A multitenant, horizontally scalable Prometheus as a Service.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,994 | 🐛 275 | 🌐 C | 📅 2026-09-09 - eBPF-based Security Observability and Runtime Enforcement.
* [parca](https://github.com/parca-dev/parca) ⭐ 4,966 | 🐛 205 | 🌐 TypeScript | 📅 2026-09-03 - Continuous profiling for analysis of CPU and memory usage, down to the line number and throughout time. Saving infrastructure cost, improving performance, and increasing reliability.
* [deepflow](https://github.com/deepflowys/deepflow) ⭐ 4,259 | 🐛 270 | 🌐 Go | 📅 2026-09-09 - A highly automated observability platform.
* [metaflow](https://github.com/metaflowys/metaflow) ⭐ 4,259 | 🐛 270 | 🌐 Go | 📅 2026-09-09 - MetaFlow is an automated observability platform for cloud-native developers.
* [vizceral](https://github.com/Netflix/vizceral) ⭐ 4,096 | 🐛 54 | 🌐 JavaScript | 📅 2023-11-28 - WebGL visualization for displaying animated traffic graphs.
* [kiali](https://github.com/kiali/kiali) ⭐ 3,635 | 🐛 74 | 🌐 Go | 📅 2026-09-09 - Kiali project to help istio service mesh observability.
* [open-falcon](https://github.com/XiaoMi/open-falcon) ⭐ 3,020 | 🐛 32 | 📅 2018-07-05 - Enterprise Internet monitoring system from Xiaomi.
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,923 | 🐛 425 | 🌐 C | 📅 2026-09-09 - The eBPF tool and systems inspection framework for Kubernetes, containers and Linux hosts.
...
* [ebpftop](https://github.com/Netflix/bpftop) ⭐ 2,704 | 🐛 5 | 🌐 C | 📅 2026-09-01 - bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
* [perses](https://github.com/perses/perses) ⭐ 2,407 | 🐛 268 | 🌐 Go | 📅 2026-09-09 - The CNCF candidate for observability visualisation.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,900 | 🐛 6,056 | 🌐 Java | 📅 2026-09-09 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,857 | 🐛 1,623 | 🌐 Go | 📅 2026-09-09 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,528 | 🐛 2,511 | 🌐 Rust | 📅 2026-09-09 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,798 | 🐛 410 | 🌐 Go | 📅 2026-09-09 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,582 | 🐛 135 | 🌐 Ruby | 📅 2026-09-09 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,647 | 🐛 1,059 | 🌐 Go | 📅 2026-09-09 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,597 | 🐛 812 | 🌐 Rust | 📅 2026-09-09 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,086 | 🐛 761 | 🌐 C | 📅 2026-09-09 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,755 | 🐛 2,242 | 🌐 Python | 📅 2026-09-09 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,946 | 🐛 41 | 🌐 Java | 📅 2026-09-09 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,195 | 🐛 555 | 🌐 Go | 📅 2026-09-08 - Jaeger, a Distributed Tracing System.
* [zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,456 | 🐛 176 | 🌐 Java | 📅 2026-08-06 - Zipkin is a distributed tracing system.
* [pinpoint](https://github.com/naver/pinpoint) ⭐ 13,866 | 🐛 540 | 🌐 Java | 📅 2026-09-09 - Pinpoint is an open source APM (Application Performance Management) tool for large-scale distributed systems written in Java.
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,337 | 🐛 374 | 🌐 Makefile | 📅 2026-09-08 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,845 | 🐛 269 | 🌐 Go | 📅 2026-09-09 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
...
* [vault](https://github.com/hashicorp/vault) ⭐ 36,219 | 🐛 1,432 | 🌐 Go | 📅 2026-09-09 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,898 | 🐛 3,323 | 🌐 Go | 📅 2026-09-09 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
* [supertokens-core](https://github.com/supertokens/supertokens-core) ⭐ 15,294 | 🐛 140 | 🌐 Java | 📅 2026-09-09 - Open source alternative to Auth0 / Firebase Auth / AWS Cognito.
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,071 | 🐛 257 | 🌐 Go | 📅 2026-09-09 - Automatically provision and manage TLS certificates in Kubernetes.
...
* [grype](https://github.com/anchore/grype) ⭐ 12,863 | 🐛 403 | 🌐 Go | 📅 2026-09-09 - A vulnerability scanner for container images and filesystems.
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,221 | 🐛 323 | 🌐 Go | 📅 2026-09-09 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,724 | 🐛 41 | 🌐 Go | 📅 2026-09-09 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
* [dex](https://github.com/dexidp/dex) ⭐ 11,082 | 🐛 534 | 🌐 Go | 📅 2026-09-09 - OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors.
* [clair](https://github.com/quay/clair) ⭐ 11,057 | 🐛 55 | 🌐 Go | 📅 2026-09-09 - Vulnerability Static Analysis for Containers.
...
* [syft](https://github.com/anchore/syft) ⭐ 9,544 | 🐛 640 | 🌐 Go | 📅 2026-09-09 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,355 | 🐛 48 | 🌐 C++ | 📅 2026-09-09 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,080 | 🐛 420 | 🌐 Elixir | 📅 2026-09-09 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,990 | 🐛 168 | 🌐 Python | 📅 2026-09-05 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,175 | 🐛 102 | 🌐 Go | 📅 2026-09-07 - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices.
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,125 | 🐛 685 | 🌐 Go | 📅 2026-09-09 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,844 | 🐛 277 | 🌐 Go | 📅 2026-09-09 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,290 | 🐛 162 | 🌐 Go | 📅 2026-09-08 - Container signing, verification, and provenance powered by Sigstore.
...
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,999 | 🐛 154 | 🌐 Go | 📅 2026-09-09 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,798 | 🐛 122 | 🌐 Go | 📅 2026-09-08 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [cedar](https://github.com/cedar-policy/cedar) ⭐ 1,720 | 🐛 173 | 🌐 Rust | 📅 2026-09-09 - Core implementation of the Cedar language.
...
* [topaz](https://github.com/aserto-dev/topaz) ⭐ 1,362 | 🐛 11 | 🌐 Go | 📅 2026-09-09 - Cloud-native authorization for modern applications and APIs.
* [neuvector](https://github.com/neuvector/neuvector) ⭐ 1,335 | 🐛 316 | 🌐 Go | 📅 2026-09-09 - Kubernetes-native container security platform.
...
* [darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 909 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks, with a proof trail per finding.
...
* [trust-manager](https://github.com/cert-manager/trust-manager) ⭐ 397 | 🐛 44 | 🌐 Go | 📅 2026-09-08 - trust-manager is an operator for distributing trust bundles across a Kubernetes cluster.
...
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,513 | 🐛 2 | 🌐 Java | 📅 2026-09-01 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
...
* [chaos-mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,883 | 🐛 544 | 🌐 Go | 📅 2026-09-06 - A Chaos Engineering Platform for Kubernetes.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,510 | 🐛 367 | 🌐 Python | 📅 2026-09-09 - An easy to use and powerful chaos engineering experiment toolkit（阿里巴巴开源的一款简单易用、功能强大的混沌实验注入工具）.
* [litmus](https://github.com/litmuschaos/litmus) ⭐ 5,608 | 🐛 398 | 🌐 Go | 📅 2026-08-25 - Litmus helps SREs and developers practice chaos engineering in a Cloud-native way.
* [concurrency-limits](https://github.com/Netflix/concurrency-limits) ⭐ 3,606 | 🐛 53 | 🌐 Java | 📅 2026-01-16 - Java Library that implements and integrates concepts from TCP congestion control to auto-detect concurrency limits to achieve optimal throughput with optimal latency.
* [ratelimit](https://github.com/envoyproxy/ratelimit) ⭐ 2,689 | 🐛 38 | 🌐 Go | 📅 2026-09-07 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,656 | 🐛 49 | 🌐 Go | 📅 2026-09-09 - Kubernetes-native framework for test definition and execution.
* [krkn](https://github.com/krkn-chaos/krkn) ⭐ 495 | 🐛 137 | 🌐 Python | 📅 2026-09-09 - Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,472 | 🐛 751 | 🌐 TypeScript | 📅 2026-09-07 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,380 | 🐛 486 | 🌐 TypeScript | 📅 2026-09-09 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,892 | 🐛 3,355 | 🌐 Go | 📅 2026-09-09 - Complete container management platform.
...
* [openshift](https://github.com/openshift/origin) ⭐ 8,685 | 🐛 312 | 🌐 Go | 📅 2026-09-09 - Enterprise Kubernetes for Developers.
* [rainbond](https://github.com/goodrain/rainbond) ⭐ 6,264 | 🐛 55 | 🌐 Go | 📅 2026-09-08 - Serverless PaaS , A new generation of easy-to-use cloud management platforms based on kubernetes.
* [wayne](https://github.com/Qihoo360/wayne) ⭐ 3,698 | 🐛 61 | 🌐 TypeScript | 📅 2022-05-31 - Web UI for Kubernetes multi-clusters.
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,298 | 🐛 104 | 🌐 Go | 📅 2026-09-09 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
...
* [kubermatic](https://github.com/kubermatic/kubermatic) ⭐ 1,302 | 🐛 459 | 🌐 Go | 📅 2026-09-09 - The Central Kubernetes Management Platform For Any Infrastructure.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 133 | 🐛 167 | 🌐 TypeScript | 📅 2026-09-09 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,718 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-09 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
...
* [kubernetes-on-aws](https://github.com/zalando-incubator/kubernetes-on-aws) ⭐ 635 | 🐛 44 | 🌐 Go | 📅 2026-09-09 - Deploying Kubernetes on AWS with CloudFormation and Ubuntu.
...
This website is hosted on GitHub Pages within [rootsongjc/awesome-cloud-native](https://github.com/rootsongjc/awesome-cloud-native) ⭐ 2,441 | 🐛 7 | 🌐 HTML | 📅 2026-09-09 repository.

Please take a quick gander at the **[contribution guidelines](https://github.com/rootsongjc/awesome-cloud-native/blob/main/CONTRIBUTING.md) ⭐ 2,441 | 🐛 7 | 🌐 HTML | 📅 2026-09-09** first. Thanks to all **[contributors](https://github.com/rootsongjc/awesome-cloud-native/graphs/contributors) ⭐ 2,441 | 🐛 7 | 🌐 HTML | 📅 2026-09-09**, you rock 🤟!
