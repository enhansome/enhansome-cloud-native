...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 199,334 | 🐛 3,143 | 🌐 C++ | 📅 2026-09-07 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,844 | 🐛 17,587 | 🌐 Python | 📅 2026-09-07 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,320 | 🐛 214 | 🌐 Python | 📅 2026-09-05 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,075 | 🐛 1,501 | 🌐 C++ | 📅 2026-09-07 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [h2o-3](https://github.com/h2oai/h2o-3) ⭐ 7,501 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-09-02 - Open Source Fast Scalable Machine Learning API For Smarter Applications (Deep Learning, Gradient Boosting, Random Forest, Generalized Linear Modeling (Logistic Regression, Elastic Net), K-Means, PCA, Stacked Ensembles.)
* [kserve](https://github.com/kserve/kserve) ⭐ 5,863 | 🐛 210 | 🌐 Go | 📅 2026-09-07 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 58,223 | 🐛 4,962 | 🌐 Python | 📅 2026-09-07 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,096 | 🐛 194 | 🌐 Lua | 📅 2026-09-07 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,093 | 🐛 242 | 🌐 Lua | 📅 2026-09-07 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,818 | 🐛 504 | 🌐 Go | 📅 2026-09-07 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,315 | 🐛 1,084 | 🌐 Go | 📅 2026-09-07 - Next-generation Cloud Native Gateway.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 3,018 | 🐛 763 | 🌐 Go | 📅 2026-09-07 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [haproxy-ingress](https://github.com/jcmoraisjr/haproxy-ingress) ⭐ 1,166 | 🐛 80 | 🌐 Go | 📅 2026-09-07 - HaProxy Ingress.
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,160 | 🐛 116 | 🌐 Go | 📅 2026-09-07 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [sbproxy](https://github.com/soapbucket/sbproxy) ⭐ 51 | 🐛 0 | 🌐 Rust | 📅 2026-09-07 - Single-binary AI gateway and reverse proxy with 103+ LLM providers, cost-based routing, rate limiting, and declarative YAML configuration.

## Continuous Delivery & GitOps

* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,634 | 🐛 1,924 | 🌐 Go | 📅 2026-09-07 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,266 | 🐛 106 | 🌐 Go | 📅 2026-09-04 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,223 | 🐛 456 | 🌐 Go | 📅 2026-09-02 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 30,116 | 🐛 314 | 🌐 Go | 📅 2026-09-07 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,538 | 🐛 3,605 | 🌐 Java | 📅 2026-09-07 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,655 | 🐛 2,438 | 🌐 Go | 📅 2026-09-05 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 24,096 | 🐛 4,366 | 🌐 Go | 📅 2026-09-07 - Declarative continuous deployment for Kubernetes.
...
* [dagger](https://github.com/dagger/dagger) ⭐ 16,230 | 🐛 157 | 🌐 Go | 📅 2026-09-07 - A programmable CI/CD engine that runs your pipelines in containers.
...
* [kustomize](https://github.com/kubernetes-sigs/kustomize) ⭐ 12,156 | 🐛 187 | 🌐 Go | 📅 2026-09-06 - Customization of kubernetes YAML configurations.
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 12,039 | 🐛 194 | 🌐 Go | 📅 2026-09-07 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,723 | 🐛 1,935 | 🌐 TypeScript | 📅 2026-09-07 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,782 | 🐛 101 | 🌐 Java | 📅 2026-09-07 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,060 | 🐛 577 | 🌐 Go | 📅 2026-09-04 - A cloud-native Pipeline resource.
...
* [kubevela](https://github.com/oam-dev/kubevela) ⭐ 7,894 | 🐛 280 | 🌐 Go | 📅 2026-09-02 - Make shipping applications more enjoyable.
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,827 | 🐛 370 | 🌐 Go | 📅 2026-09-07 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
* [jsonnet](https://github.com/google/jsonnet) ⭐ 7,565 | 🐛 210 | 🌐 Jsonnet | 📅 2026-03-30 - Jsonnet - The data templating language.
...
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,591 | 🐛 769 | 🌐 Go | 📅 2026-09-07 - Software Delivery Workflow For Kubernetes
* [flagger](https://github.com/weaveworks/flagger) ⭐ 5,399 | 🐛 387 | 🌐 Go | 📅 2026-09-07 - Progressive delivery Kubernetes operator (Canary, A/B Testing and Blue/Green deployments) .
...
* [cdk8s](https://github.com/awslabs/cdk8s) ⭐ 4,854 | 🐛 74 | 🌐 JavaScript | 📅 2026-09-07 - Define Kubernetes native apps and abstractions using object-oriented programming.
* [cds](https://github.com/ovh/cds) ⭐ 4,838 | 🐛 161 | 🌐 Go | 📅 2026-09-07 - Enterprise-Grade Continuous Delivery & DevOps Automation Open Source Platform.
...
* [werf](https://github.com/werf/werf) ⭐ 4,719 | 🐛 35 | 🌐 Go | 📅 2026-09-07 - The CLI tool gluing Git, Docker, Helm, and Kubernetes with any CI system to implement CI/CD and Giterminism.
* [jx](https://github.com/jenkins-x/jx) ⭐ 4,689 | 🐛 147 | 🌐 Go | 📅 2026-09-02 - A command line tool for installing and working with Jenkins X.
* [arkade](https://github.com/alexellis/arkade) ⭐ 4,614 | 🐛 17 | 🌐 Go | 📅 2026-09-07 - Kubernetes apps for developers.
...
* [spegel](https://github.com/spegel-org/spegel) ⭐ 3,773 | 🐛 16 | 🌐 Go | 📅 2026-09-07 - Stateless cluster local OCI registry mirror.
* [kargo](https://github.com/akuity/kargo) ⭐ 3,636 | 🐛 184 | 🌐 Go | 📅 2026-09-07 - Application lifecycle orchestration.
...
* [argo-rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,572 | 🐛 660 | 🌐 Go | 📅 2026-09-07 - Progressive delivery controller for blue-green, canary, and experiments on Kubernetes.
* [zadig](https://github.com/koderover/zadig) ⭐ 3,238 | 🐛 25 | 🌐 Go | 📅 2026-09-07 - Zadig is a cloud native, distributed, developer-oriented continuous delivery product.
...
* [erda](https://github.com/erda-project/erda) ⭐ 2,753 | 🐛 7 | 🌐 Go | 📅 2026-09-07 - An enterprise-grade application building, deploying, monitoring platform (An iPaaS).
...
* [source-to-image](https://github.com/openshift/source-to-image) ⭐ 2,543 | 🐛 28 | 🌐 Go | 📅 2026-09-07 - A tool for building/building artifacts from source and injecting into docker images.
...
* [timoni](https://github.com/stefanprodan/timoni) ⭐ 2,010 | 🐛 33 | 🌐 Go | 📅 2026-09-07 - Timoni is a package manager for Kubernetes, powered by CUE and inspired by Helm.
...
* [kpt](https://github.com/GoogleContainerTools/kpt) ⭐ 1,892 | 🐛 341 | 🌐 Go | 📅 2026-09-04 - Kpt is a toolkit to help you manage, manipulate, customize, and apply Kubernetes Resource configuration data files.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,669 | 🐛 320 | 🌐 Go | 📅 2026-09-07 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [carvel](https://github.com/carvel-dev/carvel) ⭐ 408 | 🐛 87 | 🌐 HTML | 📅 2026-08-28 - Carvel provides a set of reliable, single-purpose, composable tools that aid in your application building, configuration, and deployment to Kubernetes. This repo contains information regarding the Carvel open-source community.
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,775 | 🐛 320 | 🌐 Go | 📅 2026-09-07 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,222 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,217 | 🐛 89 | 🌐 Go | 📅 2026-09-07 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,496 | 🐛 356 | 🌐 Go | 📅 2026-09-03 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,615 | 🐛 845 | 🌐 Python | 📅 2026-09-04 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,789 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-07 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,390 | 🐛 162 | 🌐 Go | 📅 2026-09-07 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,273 | 🐛 199 | 🌐 Go | 📅 2026-09-07 - Enforce Kubernetes admission policies using Open Policy Agent constraints.
...
* [pluto](https://github.com/FairwindsOps/pluto) ⭐ 2,578 | 🐛 13 | 🌐 Go | 📅 2026-09-07 - A cli tool to help discover deprecated apiVersions in Kubernetes.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,251 | 🐛 39 | 🌐 Python | 📅 2026-09-06 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 234 | 🐛 132 | 🌐 Rust | 📅 2026-09-07 - Policy as code for Kubernetes powered by WebAssembly modules.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 32,105 | 🐛 567 | 🌐 Go | 📅 2026-09-07 - Run Kubernetes locally.
* [vagrant](https://github.com/hashicorp/vagrant) ⭐ 27,205 | 🐛 752 | 🌐 Ruby | 📅 2026-09-07 - Vagrant is a tool for building and distributing development environments.
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,716 | 🐛 229 | 🌐 Jinja | 📅 2026-09-07 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,340 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-07 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,669 | 🐛 135 | 🌐 Go | 📅 2026-09-05 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
...
* [talos](https://github.com/talos-systems/talos) ⭐ 11,113 | 🐛 215 | 🌐 Go | 📅 2026-09-07 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,367 | 🐛 160 | 🌐 Python | 📅 2026-09-07 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,211 | 🐛 93 | 🌐 Go | 📅 2026-09-04 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,301 | 🐛 214 | 🌐 Go | 📅 2026-09-07 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 4,000 | 🐛 38 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,442 | 🐛 202 | 🌐 Go | 📅 2026-09-07 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
* [cloudpods](https://github.com/yunionio/cloudpods) ⭐ 2,940 | 🐛 212 | 🌐 Go | 📅 2026-09-07 - A cloud-native open-source unified multi-cloud and hybrid-cloud platform.
...
* [fleet](https://github.com/rancher/fleet) ⭐ 1,726 | 🐛 179 | 🌐 Go | 📅 2026-09-07 - Manage large fleets of Kubernetes clusters.
...
* [claudie](https://github.com/berops/claudie) ⭐ 793 | 🐛 61 | 🌐 Go | 📅 2026-09-07 - Cloud-agnostic managed Kubernetes.
...
* [spinifex](https://github.com/mulgadc/spinifex) ⭐ 158 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - Open source AWS-compatible platform for bare-metal, on-prem, and edge deployments. Run EC2, S3, EBS, and VPC-compatible services on your own hardware — no managed cloud required.
...
* [client-go](https://github.com/kubernetes/client-go) ⭐ 9,878 | 🐛 0 | 🌐 Go | 📅 2026-09-04 - Go client for Kubernetes.
* [telepresence](https://github.com/telepresenceio/telepresence) ⭐ 7,293 | 🐛 26 | 🌐 Go | 📅 2026-08-25 - Local development against a remote Kubernetes or OpenShift cluster.
* [che](https://github.com/eclipse/che) ⭐ 7,167 | 🐛 175 | 🌐 TypeScript | 📅 2026-09-07 - Eclipse Che: Next-generation Eclipse IDE. Open source workspace server and cloud IDE.
* [devspace](https://github.com/devspace-cloud/devspace) ⭐ 5,174 | 🐛 90 | 🌐 Go | 📅 2026-09-06 - Cloud Native Software Development with Kubernetes and Docker - simply run "devspace up" in any of your projects and start coding directly on top of Kubernetes (works with minikube, self-hosted and cloud-based clusters).
...
* [kubernetes-client](https://github.com/fabric8io/kubernetes-client) ⭐ 3,673 | 🐛 112 | 🌐 Java | 📅 2026-09-04 - Java client for Kubernetes & OpenShift 3.
* [okteto](https://github.com/okteto/okteto) ⭐ 3,541 | 🐛 35 | 🌐 Go | 📅 2026-09-07 - Local development experience for Kubernetes apps.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,557 | 🐛 20 | 🌐 Rust | 📅 2026-09-07 - Manage and run multiple kubectl port-forward configurations directly in the menu bar, syncing configurations with git repositories.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,152 | 🐛 97 | 🌐 Go | 📅 2026-09-07 - Giving Kubernetes Superpowers to everyone.
...
* [robusta](https://github.com/robusta-dev/robusta) ⭐ 3,087 | 🐛 204 | 🌐 Python | 📅 2026-09-07 - Open source Kubernetes troubleshooting and automation platform.
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,082 | 🐛 14 | 🌐 Go | 📅 2026-09-07 - Tools for observing Kubernetes resources in real time, powered by Pulumi.
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,017 | 🐛 134 | 🌐 Go | 📅 2026-09-07 - Test infrastructure for the Kubernetes project.
...
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 216 | 🐛 182 | 🌐 Python | 📅 2026-09-07 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
* [seaworthy](https://github.com/cakehappens/seaworthy) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2020-08-10 - A CLI to verify Kubernetes resource health.

## Data Protection & Backup

* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,284 | 🐛 837 | 🌐 Go | 📅 2026-09-07 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [karpenter](https://github.com/aws/karpenter) ⭐ 7,714 | 🐛 511 | 🌐 Go | 📅 2026-09-07 - Kubernetes Node Autoscaling: built for flexibility, performance, and scalability.
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,732 | 🐛 302 | 🌐 Go | 📅 2026-09-02 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,732 | 🐛 302 | 🌐 Go | 📅 2026-09-02 - Kubernetes cost monitoring powered by open allocation models.
...
* [burn](https://github.com/tanrikuluozlem/burn) ⭐ 87 | 🐛 7 | 🌐 Go | 📅 2026-09-07 - CLI tool for Kubernetes cost analysis with per-namespace breakdown, real cloud pricing, and AI-powered recommendations.
...
* [dragonfly2](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,319 | 🐛 37 | 🌐 Go | 📅 2026-09-07 - Dragonfly is an intelligent P2P based file distribution system.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 29,003 | 🐛 1,127 | 🌐 JavaScript | 📅 2026-09-07 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,265 | 🐛 2,931 | 🌐 C | 📅 2026-09-07 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,880 | 🐛 708 | 🌐 TypeScript | 📅 2026-09-07 - The Open Source Airtable alternative.
...
* [milvus](https://github.com/milvus-io/milvus) ⭐ 46,015 | 🐛 1,350 | 🌐 Go | 📅 2026-09-07 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,496 | 🐛 6,931 | 🌐 Go | 📅 2026-09-07 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,392 | 🐛 407 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,444 | 🐛 8,465 | 🌐 Go | 📅 2026-09-02 - CockroachDB - the open source, cloud-native SQL database.
...
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,536 | 🐛 32 | 🌐 C++ | 📅 2026-09-07 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,995 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,474 | 🐛 393 | 🌐 C | 📅 2026-09-07 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,796 | 🐛 216 | 🌐 Java | 📅 2026-09-07 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,834 | 🐛 1,806 | 🌐 Rust | 📅 2026-09-07 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,269 | 🐛 846 | 🌐 C++ | 📅 2026-09-07 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
* [nebula](https://github.com/vesoft-inc/nebula) ⭐ 12,379 | 🐛 678 | 🌐 C++ | 📅 2026-09-07 - A distributed, fast open-source graph database featuring horizontal scalability and high availability.
...
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,434 | 🐛 572 | 🌐 Rust | 📅 2026-09-07 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 7,029 | 🐛 145 | 🌐 Go | 📅 2026-09-04 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
* [couchdb](https://github.com/apache/couchdb) ⭐ 6,949 | 🐛 371 | 🌐 Erlang | 📅 2026-09-07 - Apache CouchDB is one of a new breed of database management systems.
...
* [kvrocks](https://github.com/KvrocksLabs/kvrocks) ⭐ 4,419 | 🐛 242 | 🌐 C++ | 📅 2026-09-03 - Kvrocks is a distributed key value NoSQL database based on RocksDB and compatible with Redis protocol.
* [polardb-for-postgresql](https://github.com/alibaba/PolarDB-for-PostgreSQL) ⭐ 3,200 | 🐛 65 | 🌐 C | 📅 2026-09-07 - PolarDB for PostgreSQL (PolarDB for short) is an open source database system based on PostgreSQL.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,119 | 🐛 247 | 🌐 Go | 📅 2026-09-07 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,328 | 🐛 872 | 🌐 Go | 📅 2026-09-07 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,299 | 🐛 1,099 | 🌐 Go | 📅 2026-09-07 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 17,008 | 🐛 1,325 | 🌐 C++ | 📅 2026-09-07 - Ceph is a distributed object, block, and file storage platform.
...
* [rook](https://github.com/rook/rook) ⭐ 13,644 | 🐛 140 | 🌐 Go | 📅 2026-09-07 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,808 | 🐛 37 | 📅 2026-09-07 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
...
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,964 | 🐛 1,887 | 🌐 Shell | 📅 2026-09-07 - We put storage on cows and move them around from rancher.
...
* [glusterfs](https://github.com/gluster/glusterfs) ⭐ 5,230 | 🐛 293 | 🌐 C | 📅 2026-08-31 - Gluster is a software defined distributed storage that can scale to several petabytes. It provides interfaces for object, block and file storage.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,719 | 🐛 84 | 🌐 Go | 📅 2026-09-07 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,418 | 🐛 76 | 🌐 Go | 📅 2026-09-07 - OCI registry client, managing content like artifacts, images, packages.
...
* [zenko](https://github.com/scality/Zenko) ⭐ 673 | 🐛 20 | 🌐 Gherkin | 📅 2026-09-07 - Because everyone should be in control of their data.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,685 | 🐛 561 | 🌐 Java | 📅 2026-09-07 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,777 | 🐛 78 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,584 | 🐛 625 | 🌐 Java | 📅 2026-09-07 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,678 | 🐛 538 | 🌐 Go | 📅 2026-09-07 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,699 | 🐛 189 | 🌐 Erlang | 📅 2026-09-07 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,326 | 🐛 1,752 | 🌐 Java | 📅 2026-09-07 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,643 | 🐛 62 | 🌐 Java | 📅 2026-09-07 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [istio](https://github.com/istio/istio) ⭐ 38,374 | 🐛 508 | 🌐 Go | 📅 2026-09-07 - Connect, secure, control, and observe services.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,059 | 🐛 1,426 | 🌐 Go | 📅 2026-09-07 - Consul is a distributed, highly available, and data center aware solution to connect and configure applications across dynamic, distributed infrastructure.
* [linkerd2](https://github.com/linkerd/linkerd2) ⭐ 11,486 | 🐛 217 | 🌐 Go | 📅 2026-09-07 - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,998 | 🐛 154 | 🌐 Go | 📅 2026-09-07 - Universal Control Plane for your Service Mesh.
...
* [kmesh](https://github.com/kmesh-net/kmesh) ⭐ 753 | 🐛 488 | 🌐 Go | 📅 2026-08-20 - High Performance Service Mesh Data Plane Based on Programmable Kernel.
...
* [coredns](https://github.com/coredns/coredns) ⭐ 14,299 | 🐛 295 | 🌐 Go | 📅 2026-09-07 - CoreDNS is a DNS server that chains middleware.
...
* [cilium](https://github.com/cilium/cilium) ⭐ 25,095 | 🐛 1,087 | 🌐 Go | 📅 2026-09-07 - API-aware Networking and Security using eBPF and XDP.
...
* [ziti](https://github.com/openziti/ziti) ⭐ 4,381 | 🐛 303 | 🌐 Go | 📅 2026-09-07 - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network.
...
* [kube-router](https://github.com/cloudnativelabs/kube-router) ⭐ 2,499 | 🐛 19 | 🌐 Go | 📅 2026-09-07 - Kube-router, a turnkey solution for Kubernetes networking.
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,394 | 🐛 58 | 🌐 Go | 📅 2026-09-07 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,807 | 🐛 205 | 🌐 Go | 📅 2026-09-07 - Antrea is a Kubernetes networking based on Open vSwitch.
...
* [spiderpool](https://github.com/spidernet-io/spiderpool) ⭐ 673 | 🐛 97 | 🌐 Go | 📅 2026-09-07 - Underlay and RDMA network solution of the Kubernetes, for bare metal, VM and any public cloud.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,553 | 🐛 272 | 🌐 Go | 📅 2026-09-07 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,776 | 🐛 917 | 🌐 Go | 📅 2026-09-07 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,595 | 🐛 474 | 🌐 C | 📅 2026-09-07 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,876 | 🐛 1,877 | 🌐 C++ | 📅 2026-09-07 - C++ front/service proxy.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15,539 | 🐛 538 | 🌐 Go | 📅 2026-09-03 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [bunkerweb](https://github.com/bunkerity/bunkerweb) ⭐ 10,914 | 🐛 169 | 🌐 Python | 📅 2026-09-07 - Open-source Web Application Firewall and reverse proxy with Kubernetes integration.
* [reverse-proxy](https://github.com/microsoft/reverse-proxy) ⭐ 9,611 | 🐛 191 | 🌐 C# | 📅 2026-09-07 - A toolkit for developing high-performance HTTP reverse proxy applications.
* [metallb](https://github.com/metallb/metallb) ⭐ 8,343 | 🐛 102 | 🌐 Go | 📅 2026-09-02 - A network load-balancer implementation for Kubernetes using standard routing protocols.
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,837 | 🐛 392 | 🌐 C | 📅 2026-09-07 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,309 | 🐛 0 | 🌐 C | 📅 2026-09-06 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,076 | 🐛 263 | 🌐 Go | 📅 2026-09-07 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [contour](https://github.com/projectcontour/contour) ⭐ 3,946 | 🐛 121 | 🌐 HTML | 📅 2026-09-07 - Contour is a Kubernetes ingress controller for Lyft's Envoy proxy.
* [skipper](https://github.com/zalando/skipper) ⭐ 3,321 | 🐛 306 | 🌐 Go | 📅 2026-09-07 - An HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress.
...
* [loxilb](https://github.com/loxilb-io/loxilb) ⭐ 1,874 | 🐛 31 | 🌐 Go | 📅 2026-09-07 - eBPF powered cloud-native load-balancer providing efficient externalLB, clusterIP and nodePort services for Kubernetes.
...
* [apisix-ingress-controller](https://github.com/apache/apisix-ingress-controller) ⭐ 1,142 | 🐛 41 | 🌐 Go | 📅 2026-09-04 - Ingress controller for K8s.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,596 | 🐛 463 | 🌐 C++ | 📅 2026-09-07 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,957 | 🐛 21 | 🌐 C++ | 📅 2026-09-07 - Apache thrift.
...
* [proxygen](https://github.com/facebook/proxygen) ⭐ 8,378 | 🐛 39 | 🌐 C++ | 📅 2026-09-07 - A collection of C++ HTTP libraries including an easy to use HTTP server.
...
* [moby](https://github.com/moby/moby) ⭐ 72,088 | 🐛 3,883 | 🌐 Go | 📅 2026-09-07 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,801 | 🐛 1,123 | 🌐 Go | 📅 2026-09-07 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,831 | 🐛 540 | 🌐 Go | 📅 2026-09-07 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,267 | 🐛 460 | 🌐 Go | 📅 2026-09-07 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,240 | 🐛 868 | 🌐 Go | 📅 2026-09-07 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 7,009 | 🐛 69 | 🌐 Go | 📅 2026-09-07 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
* [spin](https://github.com/fermyon/spin) ⭐ 6,506 | 🐛 266 | 🌐 Rust | 📅 2026-09-06 - Spin is an open source framework for building and running fast, secure, and composable cloud microservices with WebAssembly.
* [wazero](https://github.com/tetratelabs/wazero) ⭐ 6,364 | 🐛 40 | 🌐 Go | 📅 2026-09-04 - The zero dependency WebAssembly runtime for Go developers.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,084 | 🐛 605 | 🌐 C | 📅 2026-09-07 - WebAssembly Micro Runtime (WAMR).
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,656 | 🐛 139 | 🌐 Go | 📅 2026-09-07 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface.
...
* [crun](https://github.com/containers/crun) ⭐ 4,108 | 🐛 49 | 🌐 C | 📅 2026-09-04 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,434 | 🐛 64 | 🌐 Rust | 📅 2026-09-07 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
* [hyperd](https://github.com/hyperhq/hyperd) ⚠️ Archived - HyperContainer Daemon.
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,509 | 🐛 271 | 🌐 Go | 📅 2026-09-07 - OpenChoreo is a developer platform for Kubernetes.
...
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,334 | 🐛 68 | 🌐 Rust | 📅 2026-09-07 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 126,886 | 🐛 3,057 | 🌐 Go | 📅 2026-09-07 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,126 | 🐛 110 | 🌐 Go | 📅 2026-09-07 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,959 | 🐛 335 | 🌐 Go | 📅 2026-09-07 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
...
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,926 | 🐛 818 | 🌐 Go | 📅 2026-09-04 - A Kubernetes Native Batch System (Project under CNCF).
* [swarm](https://github.com/docker/classicswarm) ⚠️ Archived - Swarm: a Docker-native clustering system.
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,579 | 🐛 846 | 🌐 Go | 📅 2026-09-07 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
* [descheduler](https://github.com/kubernetes-sigs/descheduler) ⭐ 5,508 | 🐛 63 | 🌐 Go | 📅 2026-08-29 - Descheduler for Kubernetes.
...
* [kruise](https://github.com/openkruise/kruise) ⭐ 5,332 | 🐛 80 | 🌐 Go | 📅 2026-08-31 - Automate application workloads management on Kubernetes.
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,516 | 🐛 59 | 🌐 Go | 📅 2026-09-07 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,951 | 🐛 754 | 🌐 Go | 📅 2026-09-07 - Kubernetes-native Job Queueing.
* [kcp](https://github.com/kcp-dev/kcp) ⭐ 2,819 | 🐛 154 | 🌐 Go | 📅 2026-09-01 - Multi-tenant control plane for running many virtual Kubernetes clusters.
* [fleet](https://github.com/coreos/fleet) ⚠️ Archived - Fleet ties together systemd and etcd into a distributed init system.
* [koordinator](https://github.com/koordinator-sh/koordinator) ⭐ 1,752 | 🐛 220 | 🌐 Go | 📅 2026-09-06 - QoS based scheduling system for hybrid orchestration workloads on Kubernetes, bringing workloads the best layout and status.
...
* [ocm](https://github.com/open-cluster-management-io/OCM) ⭐ 1,083 | 🐛 53 | 🌐 Go | 📅 2026-09-07 - The open-cluster-management.io project is focused on enabling end-to-end visibility and control across your Kubernetes clusters.
...
* [serverless](https://github.com/serverless/serverless) ⭐ 46,917 | 🐛 1,219 | 🌐 JavaScript | 📅 2026-09-07 - Serverless Framework – Build web, mobile and IoT applications with serverless architectures using AWS Lambda, Azure Functions, Google CloudFunctions & more!
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,590 | 🐛 104 | 🌐 Rust | 📅 2026-09-07 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,082 | 🐛 451 | 🌐 Go | 📅 2026-09-07 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
* [thanos](https://github.com/thanos-io/thanos) ⭐ 14,200 | 🐛 894 | 🌐 Go | 📅 2026-09-03 - Highly available Prometheus setup with long term storage capabilities.
* [keda](https://github.com/kedacore/keda) ⭐ 10,501 | 🐛 262 | 🌐 Go | 📅 2026-09-07 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
* [serving](https://github.com/knative/serving) ⭐ 6,088 | 🐛 166 | 🌐 Go | 📅 2026-08-25 - Kubernetes-based, scale-to-zero, request-driven compute.
...
* [nuclio](https://github.com/nuclio/nuclio) ⭐ 5,755 | 🐛 121 | 🌐 Go | 📅 2026-09-07 - High-Performance Serverless event and data processing platform.
...
* [eventing](https://github.com/knative/eventing) ⭐ 1,552 | 🐛 96 | 🌐 Go | 📅 2026-09-07 - Open source specification and implementation of Knative event binding and delivery.
...
* [prometheus-operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 300 | 🌐 Go | 📅 2026-09-07 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes.
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,307 | 🐛 68 | 🌐 Go | 📅 2026-09-07 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
...
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,051 | 🐛 563 | 🌐 Go | 📅 2026-09-07 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,928 | 🐛 163 | 🌐 Java | 📅 2026-09-07 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,152 | 🐛 125 | 🌐 Python | 📅 2026-09-04 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
* [keel](https://github.com/keel-hq/keel) ⭐ 2,726 | 🐛 214 | 🌐 Go | 📅 2026-09-06 - Kubernetes Operator to automate Helm, DaemonSet, StatefulSet & Deployment updates.
...
* [tidb-operator](https://github.com/pingcap/tidb-operator) ⭐ 1,336 | 🐛 394 | 🌐 Go | 📅 2026-09-07 - TiDB operator creates and manages TiDB clusters running in Kubernetes.
* [kudo](https://github.com/kudobuilder/kudo) ⭐ 1,214 | 🐛 191 | 🌐 Go | 📅 2023-08-22 - Kubernetes Universal Declarative Operator (KUDO).
* [kaito](https://github.com/Azure/kaito) ⭐ 1,010 | 🐛 72 | 🌐 Go | 📅 2026-09-07 - Kubernetes AI Toolchain Operator.
* [k0smotron](https://github.com/k0sproject/k0smotron) ⭐ 742 | 🐛 56 | 🌐 Go | 📅 2026-09-07 - k0smotron is a powerful open-source tool for the efficient management of k0s Kubernetes clusters.
...
* [gateway-operator](https://github.com/kong/gateway-operator) ⭐ 109 | 🐛 217 | 🌐 Go | 📅 2026-09-07 - Kong Gateway Operator is a Kubernetes Operator that can manage your Kong Ingress Controller, Kong Gateway Data Planes, or both together when running on Kubernetes.
* [kubevirtbmc](https://github.com/kubevirtbmc/kubevirtbmc) ⭐ 103 | 🐛 28 | 🌐 Go | 📅 2026-09-04 - A Kubernetes operator of virtual BMCs that provide Redfish and IPMI services for KubeVirt virtual machines.
...
* [k3s](https://github.com/k3s-io/k3s) ⭐ 33,905 | 🐛 77 | 🌐 Go | 📅 2026-09-04 - Lightweight Kubernetes.
...
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,465 | 🐛 231 | 🌐 Go | 📅 2026-09-07 - Zero Friction Kubernetes.
...
* [kairos](https://github.com/kairos-io/kairos) ⭐ 1,813 | 🐛 298 | 🌐 Go | 📅 2026-09-07 - The immutable Linux meta-distribution for edge Kubernetes.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,656 | 🐛 3,347 | 🌐 TypeScript | 📅 2026-09-07 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,998 | 🐛 896 | 🌐 Go | 📅 2026-09-07 - The Prometheus monitoring system and time series database.
* [kibana](https://github.com/elastic/kibana) ⭐ 21,284 | 🐛 14,826 | 🌐 TypeScript | 📅 2026-09-07 - Kibana analytics and search dashboard for Elasticsearch.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,673 | 🐛 785 | 🌐 Go | 📅 2026-09-07 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,072 | 🐛 150 | 🌐 Go | 📅 2026-09-01 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
...
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,507 | 🐛 691 | 🌐 Go | 📅 2026-09-07 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,195 | 🐛 112 | 🌐 Go | 📅 2026-09-07 - Add-on agent to generate and expose cluster-level metrics.
...
* [cortex](https://github.com/cortexproject/cortex) ⭐ 5,860 | 🐛 348 | 🌐 Go | 📅 2026-09-07 - A multitenant, horizontally scalable Prometheus as a Service.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,988 | 🐛 272 | 🌐 C | 📅 2026-09-07 - eBPF-based Security Observability and Runtime Enforcement.
...
* [deepflow](https://github.com/deepflowys/deepflow) ⭐ 4,257 | 🐛 270 | 🌐 Go | 📅 2026-09-07 - A highly automated observability platform.
* [metaflow](https://github.com/metaflowys/metaflow) ⭐ 4,257 | 🐛 270 | 🌐 Go | 📅 2026-09-07 - MetaFlow is an automated observability platform for cloud-native developers.
...
* [kiali](https://github.com/kiali/kiali) ⭐ 3,634 | 🐛 80 | 🌐 Go | 📅 2026-09-04 - Kiali project to help istio service mesh observability.
* [open-falcon](https://github.com/XiaoMi/open-falcon) ⭐ 3,020 | 🐛 32 | 📅 2018-07-05 - Enterprise Internet monitoring system from Xiaomi.
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,923 | 🐛 429 | 🌐 C | 📅 2026-09-07 - The eBPF tool and systems inspection framework for Kubernetes, containers and Linux hosts.
...
* [perses](https://github.com/perses/perses) ⭐ 2,397 | 🐛 261 | 🌐 Go | 📅 2026-09-07 - The CNCF candidate for observability visualisation.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,904 | 🐛 6,066 | 🌐 Java | 📅 2026-09-07 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,847 | 🐛 1,703 | 🌐 Go | 📅 2026-09-07 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,519 | 🐛 2,515 | 🌐 Rust | 📅 2026-09-05 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,795 | 🐛 405 | 🌐 Go | 📅 2026-09-07 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,581 | 🐛 134 | 🌐 Ruby | 📅 2026-09-07 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,645 | 🐛 1,053 | 🌐 Go | 📅 2026-09-07 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,575 | 🐛 806 | 🌐 Rust | 📅 2026-09-07 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,082 | 🐛 753 | 🌐 C | 📅 2026-09-07 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [loggie](https://github.com/loggie-io/loggie/) ⭐ 1,332 | 🐛 160 | 🌐 Go | 📅 2024-07-25 - A lightweight, cloud-native data transfer agent and aggregator.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,741 | 🐛 2,237 | 🌐 Python | 📅 2026-09-07 - Sentry is a cross-platform crash reporting and aggregation platform.
...
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,195 | 🐛 562 | 🌐 Go | 📅 2026-09-07 - Jaeger, a Distributed Tracing System.
* [zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,458 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - Zipkin is a distributed tracing system.
* [pinpoint](https://github.com/naver/pinpoint) ⭐ 13,866 | 🐛 541 | 🌐 Java | 📅 2026-09-07 - Pinpoint is an open source APM (Application Performance Management) tool for large-scale distributed systems written in Java.
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,336 | 🐛 376 | 🌐 Makefile | 📅 2026-09-07 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,826 | 🐛 264 | 🌐 Go | 📅 2026-09-07 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
* [keycloak](https://github.com/keycloak/keycloak) ⭐ 36,643 | 🐛 3,228 | 🌐 Java | 📅 2026-09-07 - Open Source Identity and Access Management For Modern Applications and Services.
* [vault](https://github.com/hashicorp/vault) ⭐ 36,216 | 🐛 1,433 | 🌐 Go | 📅 2026-09-07 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,893 | 🐛 3,321 | 🌐 Go | 📅 2026-09-07 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
...
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,068 | 🐛 258 | 🌐 Go | 📅 2026-09-07 - Automatically provision and manage TLS certificates in Kubernetes.
* [kratos](https://github.com/ory/kratos) ⭐ 13,869 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication, MFA, FIDO2, profile management, identity schemas, social sign in, registration, account recovery, service-to-service and IoT auth. Can work as an OAuth2 / OpenID Connect Provider. Golang, headless, API-only - without templating or theming headaches.
* [grype](https://github.com/anchore/grype) ⭐ 12,851 | 🐛 406 | 🌐 Go | 📅 2026-09-04 - A vulnerability scanner for container images and filesystems.
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,208 | 🐛 335 | 🌐 Go | 📅 2026-09-07 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,722 | 🐛 46 | 🌐 Go | 📅 2026-09-07 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
* [dex](https://github.com/dexidp/dex) ⭐ 11,083 | 🐛 542 | 🌐 Go | 📅 2026-09-07 - OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors.
...
* [syft](https://github.com/anchore/syft) ⭐ 9,533 | 🐛 635 | 🌐 Go | 📅 2026-09-04 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,350 | 🐛 60 | 🌐 C++ | 📅 2026-09-07 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,054 | 🐛 429 | 🌐 Elixir | 📅 2026-09-07 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,987 | 🐛 162 | 🌐 Python | 📅 2026-09-05 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,176 | 🐛 102 | 🌐 Go | 📅 2026-08-24 - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices.
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,118 | 🐛 686 | 🌐 Go | 📅 2026-09-07 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,840 | 🐛 279 | 🌐 Go | 📅 2026-09-07 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,284 | 🐛 168 | 🌐 Go | 📅 2026-09-07 - Container signing, verification, and provenance powered by Sigstore.
...
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,997 | 🐛 153 | 🌐 Go | 📅 2026-09-06 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,792 | 🐛 122 | 🌐 Go | 📅 2026-09-06 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [cedar](https://github.com/cedar-policy/cedar) ⭐ 1,712 | 🐛 176 | 🌐 Rust | 📅 2026-09-04 - Core implementation of the Cedar language.
...
* [neuvector](https://github.com/neuvector/neuvector) ⭐ 1,333 | 🐛 309 | 🌐 Go | 📅 2026-09-07 - Kubernetes-native container security platform.
...
* [darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 893 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks, with a proof trail per finding.
...
* [trust-manager](https://github.com/cert-manager/trust-manager) ⭐ 395 | 🐛 42 | 🌐 Go | 📅 2026-09-07 - trust-manager is an operator for distributing trust bundles across a Kubernetes cluster.
...
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,510 | 🐛 2 | 🌐 Java | 📅 2026-09-01 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,313 | 🐛 109 | 🌐 Go | 📅 2026-09-01 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,655 | 🐛 41 | 🌐 Go | 📅 2026-09-07 - Kubernetes-native framework for test definition and execution.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,456 | 🐛 747 | 🌐 TypeScript | 📅 2026-09-07 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,359 | 🐛 478 | 🌐 TypeScript | 📅 2026-09-07 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,889 | 🐛 3,346 | 🌐 Go | 📅 2026-09-07 - Complete container management platform.
...
* [openshift](https://github.com/openshift/origin) ⭐ 8,684 | 🐛 317 | 🌐 Go | 📅 2026-09-07 - Enterprise Kubernetes for Developers.
* [rainbond](https://github.com/goodrain/rainbond) ⭐ 6,264 | 🐛 55 | 🌐 Go | 📅 2026-09-07 - Serverless PaaS , A new generation of easy-to-use cloud management platforms based on kubernetes.
* [wayne](https://github.com/Qihoo360/wayne) ⭐ 3,700 | 🐛 61 | 🌐 TypeScript | 📅 2022-05-31 - Web UI for Kubernetes multi-clusters.
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,277 | 🐛 94 | 🌐 Go | 📅 2026-09-07 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
...
* [kubermatic](https://github.com/kubermatic/kubermatic) ⭐ 1,301 | 🐛 462 | 🌐 Go | 📅 2026-09-07 - The Central Kubernetes Management Platform For Any Infrastructure.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 132 | 🐛 166 | 🌐 TypeScript | 📅 2026-09-07 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,502 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-07 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,677 | 🐛 54 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
...
* [kubernetes-on-aws](https://github.com/zalando-incubator/kubernetes-on-aws) ⭐ 635 | 🐛 40 | 🌐 Go | 📅 2026-09-07 - Deploying Kubernetes on AWS with CloudFormation and Ubuntu.
...
This website is hosted on GitHub Pages within [rootsongjc/awesome-cloud-native](https://github.com/rootsongjc/awesome-cloud-native) ⭐ 2,441 | 🐛 8 | 🌐 HTML | 📅 2026-09-07 repository.

Please take a quick gander at the **[contribution guidelines](https://github.com/rootsongjc/awesome-cloud-native/blob/main/CONTRIBUTING.md) ⭐ 2,441 | 🐛 8 | 🌐 HTML | 📅 2026-09-07** first. Thanks to all **[contributors](https://github.com/rootsongjc/awesome-cloud-native/graphs/contributors) ⭐ 2,441 | 🐛 8 | 🌐 HTML | 📅 2026-09-07**, you rock 🤟!
