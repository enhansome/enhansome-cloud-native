...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 197,213 | 🐛 2,947 | 🌐 C++ | 📅 2026-08-21 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,509 | 🐛 17,229 | 🌐 Python | 📅 2026-08-21 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,240 | 🐛 227 | 🌐 Python | 📅 2026-08-21 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,058 | 🐛 1,506 | 🌐 C++ | 📅 2026-08-20 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [h2o-3](https://github.com/h2oai/h2o-3) ⭐ 7,495 | 🐛 2,881 | 🌐 Jupyter Notebook | 📅 2026-08-20 - Open Source Fast Scalable Machine Learning API For Smarter Applications (Deep Learning, Gradient Boosting, Random Forest, Generalized Linear Modeling (Logistic Regression, Elastic Net), K-Means, PCA, Stacked Ensembles.)
* [kserve](https://github.com/kserve/kserve) ⭐ 5,815 | 🐛 197 | 🌐 Go | 📅 2026-08-21 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [pachyderm](https://github.com/pachyderm/pachyderm) ⭐ 6,307 | 🐛 939 | 🌐 Go | 📅 2025-02-03 - Reproducible Data Science at Scale!
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 56,919 | 🐛 5,042 | 🌐 Python | 📅 2026-08-21 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,016 | 🐛 189 | 🌐 Lua | 📅 2026-08-16 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,015 | 🐛 251 | 🌐 Lua | 📅 2026-08-20 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,795 | 🐛 501 | 🌐 Go | 📅 2026-08-21 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,157 | 🐛 1,071 | 🌐 Go | 📅 2026-08-20 - Next-generation Cloud Native Gateway.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 2,971 | 🐛 759 | 🌐 Go | 📅 2026-08-21 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,145 | 🐛 107 | 🌐 Go | 📅 2026-08-21 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [sbproxy](https://github.com/soapbucket/sbproxy) ⭐ 49 | 🐛 1 | 🌐 Rust | 📅 2026-08-21 - Single-binary AI gateway and reverse proxy with 103+ LLM providers, cost-based routing, rate limiting, and declarative YAML configuration.

## Continuous Delivery & GitOps

* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,504 | 🐛 1,912 | 🌐 Go | 📅 2026-08-21 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,061 | 🐛 106 | 🌐 Go | 📅 2026-08-21 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,159 | 🐛 452 | 🌐 Go | 📅 2026-08-20 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 29,853 | 🐛 327 | 🌐 Go | 📅 2026-08-21 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,478 | 🐛 3,619 | 🌐 Java | 📅 2026-08-21 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,595 | 🐛 2,449 | 🌐 Go | 📅 2026-08-21 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 23,965 | 🐛 4,393 | 🌐 Go | 📅 2026-08-21 - Declarative continuous deployment for Kubernetes.
* [argo](https://github.com/argoproj/argo) ⭐ 16,923 | 🐛 1,261 | 🌐 Go | 📅 2026-08-21 - Get stuff done with container-native workflows for Kubernetes.
* [dagger](https://github.com/dagger/dagger) ⭐ 16,189 | 🐛 139 | 🌐 Go | 📅 2026-08-21 - A programmable CI/CD engine that runs your pipelines in containers.
* [skaffold](https://github.com/GoogleContainerTools/skaffold) ⭐ 15,888 | 🐛 907 | 🌐 Go | 📅 2026-08-20 - Easy and Repeatable Kubernetes Development.
...
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 11,962 | 🐛 187 | 🌐 Go | 📅 2026-08-20 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,542 | 🐛 1,826 | 🌐 TypeScript | 📅 2026-08-21 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,771 | 🐛 109 | 🌐 Java | 📅 2026-08-21 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,038 | 🐛 555 | 🌐 Go | 📅 2026-08-21 - A cloud-native Pipeline resource.
* [ko](https://github.com/ko-build/ko) ⭐ 8,498 | 🐛 58 | 🌐 Go | 📅 2026-08-20 - Build and deploy Go applications on Kubernetes.
* [spec](https://github.com/score-spec/spec) ⭐ 8,084 | 🐛 12 | 🌐 Makefile | 📅 2026-07-27 - The score specification file.
* [kubevela](https://github.com/oam-dev/kubevela) ⭐ 7,883 | 🐛 270 | 🌐 Go | 📅 2026-08-19 - Make shipping applications more enjoyable.
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,726 | 🐛 358 | 🌐 Go | 📅 2026-08-21 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
* [jsonnet](https://github.com/google/jsonnet) ⭐ 7,556 | 🐛 210 | 🌐 Jsonnet | 📅 2026-03-30 - Jsonnet - The data templating language.
...
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,584 | 🐛 763 | 🌐 Go | 📅 2026-08-21 - Software Delivery Workflow For Kubernetes
...
* [cds](https://github.com/ovh/cds) ⭐ 4,835 | 🐛 159 | 🌐 Go | 📅 2026-08-21 - Enterprise-Grade Continuous Delivery & DevOps Automation Open Source Platform.
...
* [arkade](https://github.com/alexellis/arkade) ⭐ 4,607 | 🐛 15 | 🌐 Go | 📅 2026-08-21 - Kubernetes apps for developers.
...
* [spegel](https://github.com/spegel-org/spegel) ⭐ 3,745 | 🐛 20 | 🌐 Go | 📅 2026-08-21 - Stateless cluster local OCI registry mirror.
...
* [kargo](https://github.com/akuity/kargo) ⭐ 3,587 | 🐛 181 | 🌐 Go | 📅 2026-08-21 - Application lifecycle orchestration.
* [argo-rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,559 | 🐛 659 | 🌐 Go | 📅 2026-08-21 - Progressive delivery controller for blue-green, canary, and experiments on Kubernetes.
...
* [spec](https://github.com/oam-dev/spec) ⭐ 3,173 | 🐛 114 | 📅 2026-08-20 - The Open Application Model specification.
...
* [hub](https://github.com/artifacthub/hub) ⭐ 2,076 | 🐛 27 | 🌐 TypeScript | 📅 2026-07-07 - Find, install and publish Cloud Native packages
* [timoni](https://github.com/stefanprodan/timoni) ⭐ 2,002 | 🐛 34 | 🌐 Go | 📅 2026-08-20 - Timoni is a package manager for Kubernetes, powered by CUE and inspired by Helm.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,661 | 🐛 375 | 🌐 Go | 📅 2026-08-21 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,344 | 🐛 259 | 🌐 Go | 📅 2026-08-21 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,762 | 🐛 316 | 🌐 Go | 📅 2026-08-21 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,218 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,179 | 🐛 87 | 🌐 Go | 📅 2026-08-20 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,483 | 🐛 388 | 🌐 Go | 📅 2026-08-20 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,419 | 🐛 835 | 🌐 Python | 📅 2026-08-19 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,747 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-21 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,351 | 🐛 164 | 🌐 Go | 📅 2026-08-17 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,240 | 🐛 38 | 🌐 Python | 📅 2026-08-20 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 233 | 🐛 135 | 🌐 Rust | 📅 2026-08-18 - Policy as code for Kubernetes powered by WebAssembly modules.
...
* [vagrant](https://github.com/hashicorp/vagrant) ⭐ 27,198 | 🐛 753 | 🌐 Ruby | 📅 2026-08-03 - Vagrant is a tool for building and distributing development environments.
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,695 | 🐛 201 | 🌐 Jinja | 📅 2026-08-21 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,312 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-21 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,666 | 🐛 129 | 🌐 Go | 📅 2026-08-21 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
...
* [talos](https://github.com/talos-systems/talos) ⭐ 10,991 | 🐛 219 | 🌐 Go | 📅 2026-08-21 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,354 | 🐛 166 | 🌐 Python | 📅 2026-08-21 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,212 | 🐛 91 | 🌐 Go | 📅 2026-08-20 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,286 | 🐛 227 | 🌐 Go | 📅 2026-08-21 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 3,997 | 🐛 39 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,430 | 🐛 194 | 🌐 Go | 📅 2026-08-21 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
* [cloudpods](https://github.com/yunionio/cloudpods) ⭐ 2,932 | 🐛 217 | 🌐 Go | 📅 2026-08-21 - A cloud-native open-source unified multi-cloud and hybrid-cloud platform.
...
* [fleet](https://github.com/rancher/fleet) ⭐ 1,724 | 🐛 185 | 🌐 Go | 📅 2026-08-21 - Manage large fleets of Kubernetes clusters.
...
* [client-go](https://github.com/kubernetes/client-go) ⭐ 9,864 | 🐛 0 | 🌐 Go | 📅 2026-08-21 - Go client for Kubernetes.
* [telepresence](https://github.com/telepresenceio/telepresence) ⭐ 7,285 | 🐛 27 | 🌐 Go | 📅 2026-08-20 - Local development against a remote Kubernetes or OpenShift cluster.
* [che](https://github.com/eclipse/che) ⭐ 7,157 | 🐛 218 | 🌐 TypeScript | 📅 2026-08-21 - Eclipse Che: Next-generation Eclipse IDE. Open source workspace server and cloud IDE.
...
* [okteto](https://github.com/okteto/okteto) ⭐ 3,533 | 🐛 37 | 🌐 Go | 📅 2026-08-21 - Local development experience for Kubernetes apps.
* [kubectl-tree](https://github.com/ahmetb/kubectl-tree) ⭐ 3,417 | 🐛 16 | 🌐 Go | 📅 2026-07-27 - kubectl plugin to browse Kubernetes object hierarchies as a tree 🎄 (using? star the repo!)
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,550 | 🐛 16 | 🌐 Rust | 📅 2026-08-21 - Manage and run multiple kubectl port-forward configurations directly in the menu bar, syncing configurations with git repositories.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,097 | 🐛 79 | 🌐 Go | 📅 2026-08-20 - Giving Kubernetes Superpowers to everyone.
...
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,078 | 🐛 18 | 🌐 Go | 📅 2026-08-20 - Tools for observing Kubernetes resources in real time, powered by Pulumi.
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,014 | 🐛 125 | 🌐 Go | 📅 2026-08-21 - Test infrastructure for the Kubernetes project.
* [kwok](https://github.com/kubernetes-sigs/kwok) ⭐ 3,173 | 🐛 25 | 🌐 Go | 📅 2026-08-21 - Kubernetes WithOut Kubelet - Simulates thousands of Nodes and Clusters.
* [sonobuoy](https://github.com/vmware-tanzu/sonobuoy) ⭐ 3,050 | 🐛 34 | 🌐 Go | 📅 2026-07-27 - Heptio Sonobuoy is a diagnostic tool that makes it easier to understand the state of a Kubernetes cluster by running a set of Kubernetes conformance tests in an accessible and non-destructive manner.
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 211 | 🐛 171 | 🌐 Python | 📅 2026-08-21 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
* [seaworthy](https://github.com/cakehappens/seaworthy) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2020-08-10 - A CLI to verify Kubernetes resource health.

## Data Protection & Backup

* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,249 | 🐛 825 | 🌐 Go | 📅 2026-08-21 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [karpenter](https://github.com/aws/karpenter) ⭐ 7,705 | 🐛 505 | 🌐 Go | 📅 2026-08-21 - Kubernetes Node Autoscaling: built for flexibility, performance, and scalability.
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,687 | 🐛 297 | 🌐 Go | 📅 2026-08-20 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,687 | 🐛 297 | 🌐 Go | 📅 2026-08-20 - Kubernetes cost monitoring powered by open allocation models.
...
* [dragonfly2](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,306 | 🐛 31 | 🌐 Go | 📅 2026-08-20 - Dragonfly is an intelligent P2P based file distribution system.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 28,980 | 🐛 1,138 | 🌐 JavaScript | 📅 2026-08-21 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,079 | 🐛 2,903 | 🌐 C | 📅 2026-08-20 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,613 | 🐛 704 | 🌐 TypeScript | 📅 2026-08-21 - The Open Source Airtable alternative.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 52,144 | 🐛 322 | 🌐 Go | 📅 2026-08-20 - Distributed reliable key-value store for the most critical data of a distributed system.
* [milvus](https://github.com/milvus-io/milvus) ⭐ 45,727 | 🐛 1,322 | 🌐 Go | 📅 2026-08-21 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,455 | 🐛 6,828 | 🌐 Go | 📅 2026-08-21 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,347 | 🐛 402 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,407 | 🐛 8,291 | 🌐 Go | 📅 2026-08-07 - CockroachDB - the open source, cloud-native SQL database.
...
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,502 | 🐛 31 | 🌐 C++ | 📅 2026-08-21 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,994 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,391 | 🐛 394 | 🌐 C | 📅 2026-08-20 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,781 | 🐛 269 | 🌐 Java | 📅 2026-08-21 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,806 | 🐛 1,806 | 🌐 Rust | 📅 2026-08-21 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,260 | 🐛 835 | 🌐 C++ | 📅 2026-08-21 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
* [nebula](https://github.com/vesoft-inc/nebula) ⭐ 12,355 | 🐛 679 | 🌐 C++ | 📅 2026-05-18 - A distributed, fast open-source graph database featuring horizontal scalability and high availability.
* [oceanbase](https://github.com/oceanbase/oceanbase) ⭐ 10,252 | 🐛 584 | 🌐 C++ | 📅 2026-08-21 - A distributed, banking suitable, open-source related database featuring high scalability and high compatibility.
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,420 | 🐛 563 | 🌐 Rust | 📅 2026-08-21 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 6,978 | 🐛 149 | 🌐 Go | 📅 2026-08-21 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
* [couchdb](https://github.com/apache/couchdb) ⭐ 6,938 | 🐛 370 | 🌐 Erlang | 📅 2026-08-20 - Apache CouchDB is one of a new breed of database management systems.
* [opentsdb](https://github.com/OpenTSDB/opentsdb) ⭐ 5,068 | 🐛 538 | 🌐 Java | 📅 2024-12-12 - A scalable, distributed Time Series Database.
* [m3](https://github.com/m3db/m3) ⭐ 4,895 | 🐛 220 | 🌐 Go | 📅 2026-08-17 - M3 monorepo - Distributed TSDB, Aggregator and Query Engine, Prometheus Sidecar, Graphite Compatible, Metrics Platform.
* [stolon](https://github.com/sorintlab/stolon) ⭐ 4,826 | 🐛 153 | 🌐 Go | 📅 2024-07-08 - PostgreSQL cloud native High Availability and more.
* [kvrocks](https://github.com/KvrocksLabs/kvrocks) ⭐ 4,401 | 🐛 242 | 🌐 C++ | 📅 2026-08-20 - Kvrocks is a distributed key value NoSQL database based on RocksDB and compatible with Redis protocol.
* [polardb-for-postgresql](https://github.com/alibaba/PolarDB-for-PostgreSQL) ⭐ 3,193 | 🐛 64 | 🌐 C | 📅 2026-08-21 - PolarDB for PostgreSQL (PolarDB for short) is an open source database system based on PostgreSQL.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,106 | 🐛 254 | 🌐 Go | 📅 2026-08-21 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,198 | 🐛 845 | 🌐 Go | 📅 2026-08-21 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,236 | 🐛 1,090 | 🌐 Go | 📅 2026-08-21 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 16,953 | 🐛 1,300 | 🌐 C++ | 📅 2026-08-21 - Ceph is a distributed object, block, and file storage platform.
...
* [rook](https://github.com/rook/rook) ⭐ 13,607 | 🐛 139 | 🌐 Go | 📅 2026-08-20 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,801 | 🐛 37 | 📅 2026-08-21 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
...
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,921 | 🐛 1,854 | 🌐 Shell | 📅 2026-08-21 - We put storage on cows and move them around from rancher.
* [chubaofs](https://github.com/chubaofs/chubaofs) ⭐ 5,630 | 🐛 268 | 🌐 Go | 📅 2026-08-19 - A distributed storage system for cloud native applications.
* [glusterfs](https://github.com/gluster/glusterfs) ⭐ 5,219 | 🐛 291 | 🌐 C | 📅 2026-08-21 - Gluster is a software defined distributed storage that can scale to several petabytes. It provides interfaces for object, block and file storage.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,638 | 🐛 75 | 🌐 Go | 📅 2026-08-21 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,393 | 🐛 77 | 🌐 Go | 📅 2026-08-20 - OCI registry client, managing content like artifacts, images, packages.
...
* [zenko](https://github.com/scality/Zenko) ⭐ 671 | 🐛 22 | 🌐 Gherkin | 📅 2026-08-21 - Because everyone should be in control of their data.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,581 | 🐛 503 | 🌐 Java | 📅 2026-08-21 - A distributed streaming platform.
...
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,557 | 🐛 539 | 🌐 Go | 📅 2026-08-21 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,647 | 🐛 257 | 🌐 Erlang | 📅 2026-08-21 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,310 | 🐛 1,739 | 🌐 Java | 📅 2026-08-20 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,541 | 🐛 61 | 🌐 Java | 📅 2026-08-21 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [flume](https://github.com/apache/flume) ⭐ 2,566 | 🐛 80 | 🌐 Java | 📅 2026-08-21 - Apache Flume is a distributed, reliable, and available service for efficiently collecting, aggregating, and moving large amounts of log data.
...
* [istio](https://github.com/istio/istio) ⭐ 38,355 | 🐛 510 | 🌐 Go | 📅 2026-08-21 - Connect, secure, control, and observe services.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,034 | 🐛 1,413 | 🌐 Go | 📅 2026-08-21 - Consul is a distributed, highly available, and data center aware solution to connect and configure applications across dynamic, distributed infrastructure.
* [linkerd2](https://github.com/linkerd/linkerd2) ⭐ 11,478 | 🐛 209 | 🌐 Go | 📅 2026-08-21 - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,994 | 🐛 151 | 🌐 Go | 📅 2026-08-21 - Universal Control Plane for your Service Mesh.
...
* [coredns](https://github.com/coredns/coredns) ⭐ 14,264 | 🐛 295 | 🌐 Go | 📅 2026-08-20 - CoreDNS is a DNS server that chains middleware.
* [zookeeper](https://github.com/apache/zookeeper) ⭐ 12,791 | 🐛 240 | 🌐 Java | 📅 2026-08-17 - Apache ZooKeeper is an effort to develop and maintain an open-source server which enables highly reliable distributed coordination.
...
* [service-broker](https://github.com/openservicebrokerapi/servicebroker) ⭐ 1,481 | 🐛 28 | 🌐 Shell | 📅 2026-04-15 - Open Service Broker API Specification.
...
* [pingora](https://github.com/cloudflare/pingora) ⭐ 27,248 | 🐛 313 | 🌐 Rust | 📅 2026-08-07 - A library for building fast, reliable and evolvable network services.
* [cilium](https://github.com/cilium/cilium) ⭐ 24,988 | 🐛 1,114 | 🌐 Go | 📅 2026-08-21 - API-aware Networking and Security using eBPF and XDP.
...
* [cni](https://github.com/containernetworking/cni) ⭐ 6,102 | 🐛 156 | 🌐 Go | 📅 2026-08-13 - Container Network Interface - networking for Linux containers.
* [ziti](https://github.com/openziti/ziti) ⭐ 4,354 | 🐛 283 | 🌐 Go | 📅 2026-08-21 - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network.
* [hubble](https://github.com/cilium/hubble) ⭐ 4,307 | 🐛 44 | 🌐 Makefile | 📅 2026-08-18 - Hubble - Network, Service & Security Observability for Kubernetes.
...
* [submariner](https://github.com/submariner-io/submariner) ⭐ 2,676 | 🐛 27 | 🌐 Go | 📅 2026-08-21 - Connect all your Kubernetes clusters, no matter where they are in the world.
...
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,391 | 🐛 83 | 🌐 Go | 📅 2026-08-21 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,806 | 🐛 201 | 🌐 Go | 📅 2026-08-21 - Antrea is a Kubernetes networking based on Open vSwitch.
* [matchbox](https://github.com/poseidon/matchbox) ⭐ 1,424 | 🐛 5 | 🌐 Go | 📅 2026-08-19 - Network boot and provision Container Linux clusters (e.g. etcd3, Kubernetes, more).
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,070 | 🐛 272 | 🌐 Go | 📅 2026-08-19 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,528 | 🐛 913 | 🌐 Go | 📅 2026-08-20 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,463 | 🐛 467 | 🌐 C | 📅 2026-08-21 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,808 | 🐛 1,875 | 🌐 C++ | 📅 2026-08-21 - C++ front/service proxy.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15,326 | 🐛 531 | 🌐 Go | 📅 2026-08-21 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [metallb](https://github.com/metallb/metallb) ⭐ 8,328 | 🐛 102 | 🌐 Go | 📅 2026-08-17 - A network load-balancer implementation for Kubernetes using standard routing protocols.
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,796 | 🐛 379 | 🌐 C | 📅 2026-08-21 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,297 | 🐛 0 | 🌐 C | 📅 2026-08-20 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,068 | 🐛 269 | 🌐 Go | 📅 2026-08-21 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [contour](https://github.com/projectcontour/contour) ⭐ 3,945 | 🐛 123 | 🌐 HTML | 📅 2026-08-18 - Contour is a Kubernetes ingress controller for Lyft's Envoy proxy.
* [skipper](https://github.com/zalando/skipper) ⭐ 3,318 | 🐛 313 | 🌐 Go | 📅 2026-08-20 - An HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,589 | 🐛 464 | 🌐 C++ | 📅 2026-08-19 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,954 | 🐛 15 | 🌐 C++ | 📅 2026-08-20 - Apache thrift.
...
* [kitex](https://github.com/cloudwego/kitex) ⭐ 8,023 | 🐛 67 | 🌐 Go | 📅 2026-08-21 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices.
* [sofa-rpc](https://github.com/sofastack/sofa-rpc) ⭐ 3,922 | 🐛 28 | 🌐 Java | 📅 2026-08-08 - SOFARPC is a high-performance, high-extensibility, production-level Java RPC framework.
...
* [moby](https://github.com/moby/moby) ⭐ 71,991 | 🐛 3,893 | 🌐 Go | 📅 2026-08-21 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,657 | 🐛 1,129 | 🌐 Go | 📅 2026-08-20 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,726 | 🐛 536 | 🌐 Go | 📅 2026-08-21 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,142 | 🐛 444 | 🌐 Go | 📅 2026-08-21 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,134 | 🐛 783 | 🌐 Go | 📅 2026-08-21 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 6,980 | 🐛 60 | 🌐 Go | 📅 2026-08-19 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
* [spin](https://github.com/fermyon/spin) ⭐ 6,501 | 🐛 266 | 🌐 Rust | 📅 2026-08-20 - Spin is an open source framework for building and running fast, secure, and composable cloud microservices with WebAssembly.
...
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,071 | 🐛 597 | 🌐 C | 📅 2026-08-21 - WebAssembly Micro Runtime (WAMR).
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,651 | 🐛 143 | 🌐 Go | 📅 2026-08-21 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface.
...
* [crun](https://github.com/containers/crun) ⭐ 4,060 | 🐛 54 | 🌐 C | 📅 2026-08-19 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [krustlet](https://github.com/deislabs/krustlet) ⭐ 3,602 | 🐛 137 | 🌐 Rust | 📅 2023-10-02 - Kubernetes Rust Kubelet.
...
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,417 | 🐛 58 | 🌐 Rust | 📅 2026-08-20 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
* [hyperd](https://github.com/hyperhq/hyperd) ⚠️ Archived - HyperContainer Daemon.
* [kuasar](https://github.com/kuasar-io/kuasar) ⭐ 1,441 | 🐛 29 | 🌐 Rust | 📅 2026-06-05 - An efficient container runtime that provides cloud-native, all-scenario multiple sandbox container solutions.
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,393 | 🐛 252 | 🌐 Go | 📅 2026-08-21 - OpenChoreo is a developer platform for Kubernetes.
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,329 | 🐛 66 | 🌐 Rust | 📅 2026-08-21 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 124,755 | 🐛 2,989 | 🌐 Go | 📅 2026-08-21 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,050 | 🐛 93 | 🌐 Go | 📅 2026-08-21 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,942 | 🐛 310 | 🌐 Go | 📅 2026-08-20 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
...
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,877 | 🐛 805 | 🌐 Go | 📅 2026-08-20 - A Kubernetes Native Batch System (Project under CNCF).
* [swarm](https://github.com/docker/classicswarm) ⚠️ Archived - Swarm: a Docker-native clustering system.
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,571 | 🐛 839 | 🌐 Go | 📅 2026-08-21 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
...
* [kruise](https://github.com/openkruise/kruise) ⭐ 5,322 | 🐛 85 | 🌐 Go | 📅 2026-08-18 - Automate application workloads management on Kubernetes.
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,406 | 🐛 45 | 🌐 Go | 📅 2026-08-21 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,891 | 🐛 714 | 🌐 Go | 📅 2026-08-21 - Kubernetes-native Job Queueing.
* [kcp](https://github.com/kcp-dev/kcp) ⭐ 2,813 | 🐛 143 | 🌐 Go | 📅 2026-08-21 - Multi-tenant control plane for running many virtual Kubernetes clusters.
...
* [serverless](https://github.com/serverless/serverless) ⭐ 46,917 | 🐛 1,222 | 🌐 JavaScript | 📅 2026-08-20 - Serverless Framework – Build web, mobile and IoT applications with serverless architectures using AWS Lambda, Azure Functions, Google CloudFunctions & more!
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,190 | 🐛 109 | 🌐 Rust | 📅 2026-08-21 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,025 | 🐛 432 | 🌐 Go | 📅 2026-08-20 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
...
* [keda](https://github.com/kedacore/keda) ⭐ 10,452 | 🐛 234 | 🌐 Go | 📅 2026-08-20 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
* [fission](https://github.com/fission/fission) ⭐ 8,908 | 🐛 51 | 🌐 Go | 📅 2026-08-21 - Fast Serverless Functions for Kubernetes.
...
* [serving](https://github.com/knative/serving) ⭐ 6,083 | 🐛 163 | 🌐 Go | 📅 2026-08-21 - Kubernetes-based, scale-to-zero, request-driven compute.
...
* [eventing](https://github.com/knative/eventing) ⭐ 1,552 | 🐛 115 | 🌐 Go | 📅 2026-08-20 - Open source specification and implementation of Knative event binding and delivery.
...
* [prometheus-operator](https://github.com/coreos/prometheus-operator) ⭐ 9,973 | 🐛 304 | 🌐 Go | 📅 2026-08-21 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes.
...
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,015 | 🐛 567 | 🌐 Go | 📅 2026-08-21 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,910 | 🐛 157 | 🌐 Java | 📅 2026-08-21 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,148 | 🐛 115 | 🌐 Python | 📅 2026-08-20 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
* [keel](https://github.com/keel-hq/keel) ⭐ 2,720 | 🐛 212 | 🌐 Go | 📅 2026-08-20 - Kubernetes Operator to automate Helm, DaemonSet, StatefulSet & Deployment updates.
...
* [kaito](https://github.com/Azure/kaito) ⭐ 1,001 | 🐛 67 | 🌐 Go | 📅 2026-08-21 - Kubernetes AI Toolchain Operator.
* [k0smotron](https://github.com/k0sproject/k0smotron) ⭐ 731 | 🐛 51 | 🌐 Go | 📅 2026-08-18 - k0smotron is a powerful open-source tool for the efficient management of k0s Kubernetes clusters.
...
* [gateway-operator](https://github.com/kong/gateway-operator) ⭐ 108 | 🐛 193 | 🌐 Go | 📅 2026-08-21 - Kong Gateway Operator is a Kubernetes Operator that can manage your Kong Ingress Controller, Kong Gateway Data Planes, or both together when running on Kubernetes.
* [kubevirtbmc](https://github.com/kubevirtbmc/kubevirtbmc) ⭐ 88 | 🐛 35 | 🌐 Go | 📅 2026-08-13 - A Kubernetes operator of virtual BMCs that provide Redfish and IPMI services for KubeVirt virtual machines.
...
* [k3s](https://github.com/k3s-io/k3s) ⭐ 33,779 | 🐛 78 | 🌐 Go | 📅 2026-08-20 - Lightweight Kubernetes.
* [kubeedge](https://github.com/kubeedge/kubeedge) ⭐ 7,554 | 🐛 1,269 | 🌐 Go | 📅 2026-08-18 - Kubernetes Native Edge Computing Framework (project under CNCF).
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,441 | 🐛 203 | 🌐 Go | 📅 2026-08-21 - Zero Friction Kubernetes.
...
* [kairos](https://github.com/kairos-io/kairos) ⭐ 1,807 | 🐛 285 | 🌐 Go | 📅 2026-08-21 - The immutable Linux meta-distribution for edge Kubernetes.
* [iotedge](https://github.com/Azure/iotedge) ⭐ 1,508 | 🐛 96 | 🌐 C# | 📅 2026-08-17 - The IoT Edge OSS project.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,339 | 🐛 3,319 | 🌐 TypeScript | 📅 2026-08-21 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,770 | 🐛 902 | 🌐 Go | 📅 2026-08-21 - The Prometheus monitoring system and time series database.
* [kibana](https://github.com/elastic/kibana) ⭐ 21,251 | 🐛 14,202 | 🌐 TypeScript | 📅 2026-08-21 - Kibana analytics and search dashboard for Elasticsearch.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,574 | 🐛 775 | 🌐 Go | 📅 2026-08-21 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,056 | 🐛 143 | 🌐 Go | 📅 2026-08-18 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
...
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,431 | 🐛 710 | 🌐 Go | 📅 2026-08-21 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,180 | 🐛 104 | 🌐 Go | 📅 2026-08-20 - Add-on agent to generate and expose cluster-level metrics.
...
* [cortex](https://github.com/cortexproject/cortex) ⭐ 5,851 | 🐛 363 | 🌐 Go | 📅 2026-08-21 - A multitenant, horizontally scalable Prometheus as a Service.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,941 | 🐛 262 | 🌐 C | 📅 2026-08-21 - eBPF-based Security Observability and Runtime Enforcement.
* [deepflow](https://github.com/deepflowys/deepflow) ⭐ 4,238 | 🐛 266 | 🌐 Go | 📅 2026-08-21 - A highly automated observability platform.
* [metaflow](https://github.com/metaflowys/metaflow) ⭐ 4,238 | 🐛 266 | 🌐 Go | 📅 2026-08-21 - MetaFlow is an automated observability platform for cloud-native developers.
...
* [kiali](https://github.com/kiali/kiali) ⭐ 3,630 | 🐛 82 | 🌐 Go | 📅 2026-08-20 - Kiali project to help istio service mesh observability.
* [open-falcon](https://github.com/XiaoMi/open-falcon) ⭐ 3,020 | 🐛 32 | 📅 2018-07-05 - Enterprise Internet monitoring system from Xiaomi.
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,913 | 🐛 429 | 🌐 C | 📅 2026-08-21 - The eBPF tool and systems inspection framework for Kubernetes, containers and Linux hosts.
...
* [perses](https://github.com/perses/perses) ⭐ 2,372 | 🐛 263 | 🌐 Go | 📅 2026-08-21 - The CNCF candidate for observability visualisation.
...
* [kepler](https://github.com/sustainable-computing-io/kepler) ⭐ 1,558 | 🐛 49 | 🌐 Go | 📅 2026-08-21 - Kepler (Kubernetes-based Efficient Power Level Exporter) uses eBPF to probe performance counters and other system stats, use ML models to estimate workload energy consumption based on these stats, and exports them as Prometheus metrics.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,853 | 🐛 5,909 | 🌐 Java | 📅 2026-08-21 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,772 | 🐛 1,717 | 🌐 Go | 📅 2026-08-21 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,425 | 🐛 2,525 | 🌐 Rust | 📅 2026-08-21 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,763 | 🐛 395 | 🌐 Go | 📅 2026-08-19 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,578 | 🐛 137 | 🌐 Ruby | 📅 2026-08-21 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,640 | 🐛 1,054 | 🌐 Go | 📅 2026-08-21 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,533 | 🐛 805 | 🌐 Rust | 📅 2026-08-21 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,050 | 🐛 775 | 🌐 C | 📅 2026-08-21 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,587 | 🐛 2,291 | 🌐 Python | 📅 2026-08-21 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,926 | 🐛 21 | 🌐 Java | 📅 2026-08-20 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,124 | 🐛 565 | 🌐 Go | 📅 2026-08-20 - Jaeger, a Distributed Tracing System.
* [zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,454 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - Zipkin is a distributed tracing system.
* [pinpoint](https://github.com/naver/pinpoint) ⭐ 13,863 | 🐛 532 | 🌐 Java | 📅 2026-08-21 - Pinpoint is an open source APM (Application Performance Management) tool for large-scale distributed systems written in Java.
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,316 | 🐛 531 | 🌐 Makefile | 📅 2026-08-19 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,539 | 🐛 254 | 🌐 Go | 📅 2026-08-21 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
...
* [vault](https://github.com/hashicorp/vault) ⭐ 36,150 | 🐛 1,426 | 🌐 Go | 📅 2026-08-21 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,834 | 🐛 3,400 | 🌐 Go | 📅 2026-08-21 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
* [supertokens-core](https://github.com/supertokens/supertokens-core) ⭐ 15,271 | 🐛 168 | 🌐 Java | 📅 2026-08-19 - Open source alternative to Auth0 / Firebase Auth / AWS Cognito.
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,040 | 🐛 249 | 🌐 Go | 📅 2026-08-21 - Automatically provision and manage TLS certificates in Kubernetes.
* [kratos](https://github.com/ory/kratos) ⭐ 13,835 | 🐛 223 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication, MFA, FIDO2, profile management, identity schemas, social sign in, registration, account recovery, service-to-service and IoT auth. Can work as an OAuth2 / OpenID Connect Provider. Golang, headless, API-only - without templating or theming headaches.
* [grype](https://github.com/anchore/grype) ⭐ 12,771 | 🐛 406 | 🌐 Go | 📅 2026-08-20 - A vulnerability scanner for container images and filesystems.
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,130 | 🐛 336 | 🌐 Go | 📅 2026-08-21 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,677 | 🐛 78 | 🌐 Go | 📅 2026-08-21 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
* [dex](https://github.com/dexidp/dex) ⭐ 11,054 | 🐛 524 | 🌐 Go | 📅 2026-08-20 - OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors.
* [clair](https://github.com/quay/clair) ⭐ 11,049 | 🐛 60 | 🌐 Go | 📅 2026-08-11 - Vulnerability Static Analysis for Containers.
* [docker-bench-security](https://github.com/docker/docker-bench-security) ⭐ 9,694 | 🐛 29 | 🌐 Shell | 📅 2026-06-04 - The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
* [syft](https://github.com/anchore/syft) ⭐ 9,440 | 🐛 629 | 🌐 Go | 📅 2026-08-21 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,288 | 🐛 64 | 🌐 C++ | 📅 2026-08-03 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,040 | 🐛 392 | 🌐 Elixir | 📅 2026-08-21 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,966 | 🐛 166 | 🌐 Python | 📅 2026-08-20 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
...
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,058 | 🐛 614 | 🌐 Go | 📅 2026-08-21 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,803 | 🐛 265 | 🌐 Go | 📅 2026-08-19 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,226 | 🐛 162 | 🌐 Go | 📅 2026-08-19 - Container signing, verification, and provenance powered by Sigstore.
...
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,969 | 🐛 148 | 🌐 Go | 📅 2026-08-21 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,747 | 🐛 119 | 🌐 Go | 📅 2026-08-21 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [spiffe](https://github.com/spiffe/spiffe) ⭐ 1,829 | 🐛 49 | 🌐 Shell | 📅 2026-08-03 - The SPIFFE Project.
* [cedar](https://github.com/cedar-policy/cedar) ⭐ 1,679 | 🐛 174 | 🌐 Rust | 📅 2026-08-20 - Core implementation of the Cedar language.
...
* [trivy-action](https://github.com/aquasecurity/trivy-action) ⭐ 1,401 | 🐛 178 | 🌐 Shell | 📅 2026-08-19 - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities.
...
* [neuvector](https://github.com/neuvector/neuvector) ⭐ 1,329 | 🐛 306 | 🌐 Go | 📅 2026-08-21 - Kubernetes-native container security platform.
* [in-toto](https://github.com/in-toto/in-toto) ⭐ 1,028 | 🐛 59 | 🌐 Python | 📅 2026-08-05 - in-toto is a framework to protect supply chain integrity.
...
* [darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 854 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks, with a proof trail per finding.
...
* [trust-manager](https://github.com/cert-manager/trust-manager) ⭐ 394 | 🐛 43 | 🌐 Go | 📅 2026-08-21 - trust-manager is an operator for distributing trust bundles across a Kubernetes cluster.
...
* [brood-box](https://github.com/stacklok/brood-box) ⭐ 60 | 🐛 13 | 🌐 Go | 📅 2026-08-19 - CLI tool for running coding agents inside hardware-isolated microVMs with workspace snapshot isolation and egress control.
...
* [go-microvm](https://github.com/stacklok/go-microvm) ⭐ 19 | 🐛 10 | 🌐 Go | 📅 2026-08-19 - Go framework for running OCI images as microVMs via libkrun with embedded runtime, rootfs management, and guest networking.
...
* [chaosmonkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,085 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,462 | 🐛 1 | 🌐 Java | 📅 2026-08-10 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
...
* [litmus](https://github.com/litmuschaos/litmus) ⭐ 5,599 | 🐛 416 | 🌐 Go | 📅 2026-07-31 - Litmus helps SREs and developers practice chaos engineering in a Cloud-native way.
...
* [ratelimit](https://github.com/envoyproxy/ratelimit) ⭐ 2,684 | 🐛 34 | 🌐 Go | 📅 2026-08-20 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,644 | 🐛 49 | 🌐 Go | 📅 2026-08-21 - Kubernetes-native framework for test definition and execution.
* [krkn](https://github.com/krkn-chaos/krkn) ⭐ 486 | 🐛 141 | 🌐 Python | 📅 2026-08-20 - Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,300 | 🐛 746 | 🌐 TypeScript | 📅 2026-08-21 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,199 | 🐛 423 | 🌐 TypeScript | 📅 2026-08-21 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,867 | 🐛 3,352 | 🌐 Go | 📅 2026-08-21 - Complete container management platform.
...
* [openshift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 299 | 🌐 Go | 📅 2026-08-21 - Enterprise Kubernetes for Developers.
...
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,035 | 🐛 57 | 🌐 Go | 📅 2026-08-20 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 127 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-21 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,052 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-20 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,521 | 🐛 51 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
