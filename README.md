...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 197,613 | 🐛 2,927 | 🌐 C++ | 📅 2026-08-25 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,581 | 🐛 17,326 | 🌐 Python | 📅 2026-08-25 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,249 | 🐛 246 | 🌐 Python | 📅 2026-08-24 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,062 | 🐛 1,504 | 🌐 C++ | 📅 2026-08-24 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [kserve](https://github.com/kserve/kserve) ⭐ 5,827 | 🐛 202 | 🌐 Go | 📅 2026-08-25 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 57,193 | 🐛 4,903 | 🌐 Python | 📅 2026-08-25 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,033 | 🐛 190 | 🌐 Lua | 📅 2026-08-16 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,028 | 🐛 255 | 🌐 Lua | 📅 2026-08-24 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,798 | 🐛 497 | 🌐 Go | 📅 2026-08-24 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,180 | 🐛 1,070 | 🌐 Go | 📅 2026-08-25 - Next-generation Cloud Native Gateway.
* [ocelot](https://github.com/ThreeMammals/Ocelot) ⭐ 8,717 | 🐛 61 | 🌐 C# | 📅 2026-08-21 - .NET core API Gateway.
* [lura](https://github.com/luraproject/lura) ⭐ 6,788 | 🐛 12 | 🌐 Go | 📅 2026-08-18 - Ultra performant API Gateway with middlewares. A project hosted at The Linux Foundation.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 2,980 | 🐛 763 | 🌐 Go | 📅 2026-08-25 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,147 | 🐛 106 | 🌐 Go | 📅 2026-08-24 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,528 | 🐛 1,913 | 🌐 Go | 📅 2026-08-24 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,113 | 🐛 106 | 🌐 Go | 📅 2026-08-21 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,173 | 🐛 456 | 🌐 Go | 📅 2026-08-24 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 29,903 | 🐛 324 | 🌐 Go | 📅 2026-08-24 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,491 | 🐛 3,606 | 🌐 Java | 📅 2026-08-25 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,605 | 🐛 2,454 | 🌐 Go | 📅 2026-08-25 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 23,988 | 🐛 4,396 | 🌐 Go | 📅 2026-08-25 - Declarative continuous deployment for Kubernetes.
...
* [dagger](https://github.com/dagger/dagger) ⭐ 16,197 | 🐛 148 | 🌐 Go | 📅 2026-08-25 - A programmable CI/CD engine that runs your pipelines in containers.
...
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 11,976 | 🐛 188 | 🌐 Go | 📅 2026-08-24 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,568 | 🐛 1,828 | 🌐 TypeScript | 📅 2026-08-25 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,611 | 🐛 19 | 🌐 Go | 📅 2026-08-24 - Go from Docker Compose to Kubernetes.
* [tilt](https://github.com/tilt-dev/tilt) ⭐ 10,016 | 🐛 510 | 🌐 Go | 📅 2026-08-15 - A multi-service dev environment for teams on Kubernetes.
...
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,043 | 🐛 566 | 🌐 Go | 📅 2026-08-24 - A cloud-native Pipeline resource.
* [ko](https://github.com/ko-build/ko) ⭐ 8,505 | 🐛 56 | 🌐 Go | 📅 2026-08-24 - Build and deploy Go applications on Kubernetes.
...
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,742 | 🐛 360 | 🌐 Go | 📅 2026-08-25 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
...
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,590 | 🐛 764 | 🌐 Go | 📅 2026-08-24 - Software Delivery Workflow For Kubernetes
...
* [cds](https://github.com/ovh/cds) ⭐ 4,836 | 🐛 158 | 🌐 Go | 📅 2026-08-24 - Enterprise-Grade Continuous Delivery & DevOps Automation Open Source Platform.
...
* [ballerina-lang](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,846 | 🐛 1,604 | 🌐 Ballerina | 📅 2026-08-14 - Ballerina is a new programming language for integration built on a sequence diagram metaphor.
...
* [spegel](https://github.com/spegel-org/spegel) ⭐ 3,751 | 🐛 24 | 🌐 Go | 📅 2026-08-24 - Stateless cluster local OCI registry mirror.
...
* [kargo](https://github.com/akuity/kargo) ⭐ 3,595 | 🐛 176 | 🌐 Go | 📅 2026-08-25 - Application lifecycle orchestration.
* [argo-rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,560 | 🐛 660 | 🌐 Go | 📅 2026-08-25 - Progressive delivery controller for blue-green, canary, and experiments on Kubernetes.
* [zadig](https://github.com/koderover/zadig) ⭐ 3,232 | 🐛 36 | 🌐 Go | 📅 2026-08-25 - Zadig is a cloud native, distributed, developer-oriented continuous delivery product.
...
* [erda](https://github.com/erda-project/erda) ⭐ 2,750 | 🐛 10 | 🌐 Go | 📅 2026-08-23 - An enterprise-grade application building, deploying, monitoring platform (An iPaaS).
...
* [hub](https://github.com/artifacthub/hub) ⭐ 2,079 | 🐛 26 | 🌐 TypeScript | 📅 2026-07-07 - Find, install and publish Cloud Native packages
* [timoni](https://github.com/stefanprodan/timoni) ⭐ 2,006 | 🐛 34 | 🌐 Go | 📅 2026-08-24 - Timoni is a package manager for Kubernetes, powered by CUE and inspired by Helm.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,664 | 🐛 323 | 🌐 Go | 📅 2026-08-25 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,345 | 🐛 214 | 🌐 Go | 📅 2026-08-24 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
* [kusion](https://github.com/KusionStack/kusion) ⭐ 1,316 | 🐛 55 | 🌐 Go | 📅 2026-08-24 - A compile-to-cloud technology stack with tool chains and engine.
...
* [kapp](https://github.com/carvel-dev/kapp) ⭐ 1,075 | 🐛 129 | 🌐 Go | 📅 2026-08-17 - kapp is a simple deployment tool focused on the concept of "Kubernetes application" — a set of resources with the same label.
...
* [screwdriver](https://github.com/screwdriver-cd/screwdriver) ⭐ 1,045 | 🐛 55 | 🌐 JavaScript | 📅 2026-08-21 - An open source build platform designed for continuous delivery.
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,764 | 🐛 317 | 🌐 Go | 📅 2026-08-25 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,219 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,191 | 🐛 87 | 🌐 Go | 📅 2026-08-20 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,486 | 🐛 390 | 🌐 Go | 📅 2026-08-25 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,450 | 🐛 842 | 🌐 Python | 📅 2026-08-19 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,752 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-24 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,358 | 🐛 164 | 🌐 Go | 📅 2026-08-23 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,268 | 🐛 189 | 🌐 Go | 📅 2026-08-24 - Enforce Kubernetes admission policies using Open Policy Agent constraints.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,242 | 🐛 39 | 🌐 Python | 📅 2026-08-24 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,702 | 🐛 202 | 🌐 Jinja | 📅 2026-08-21 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,319 | 🐛 95 | 🌐 TypeScript | 📅 2026-08-24 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,668 | 🐛 132 | 🌐 Go | 📅 2026-08-25 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
...
* [talos](https://github.com/talos-systems/talos) ⭐ 11,009 | 🐛 214 | 🌐 Go | 📅 2026-08-24 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,355 | 🐛 164 | 🌐 Python | 📅 2026-08-22 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,213 | 🐛 89 | 🌐 Go | 📅 2026-08-21 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,289 | 🐛 222 | 🌐 Go | 📅 2026-08-24 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 3,997 | 🐛 39 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,432 | 🐛 189 | 🌐 Go | 📅 2026-08-24 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
* [cloudpods](https://github.com/yunionio/cloudpods) ⭐ 2,934 | 🐛 219 | 🌐 Go | 📅 2026-08-25 - A cloud-native open-source unified multi-cloud and hybrid-cloud platform.
...
* [fleet](https://github.com/rancher/fleet) ⭐ 1,724 | 🐛 187 | 🌐 Go | 📅 2026-08-25 - Manage large fleets of Kubernetes clusters.
...
* [claudie](https://github.com/berops/claudie) ⭐ 790 | 🐛 69 | 🌐 Go | 📅 2026-08-24 - Cloud-agnostic managed Kubernetes.
...
* [telepresence](https://github.com/telepresenceio/telepresence) ⭐ 7,287 | 🐛 27 | 🌐 Go | 📅 2026-08-25 - Local development against a remote Kubernetes or OpenShift cluster.
...
* [devspace](https://github.com/devspace-cloud/devspace) ⭐ 5,150 | 🐛 77 | 🌐 Go | 📅 2026-08-17 - Cloud Native Software Development with Kubernetes and Docker - simply run "devspace up" in any of your projects and start coding directly on top of Kubernetes (works with minikube, self-hosted and cloud-based clusters).
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,111 | 🐛 85 | 🌐 Go | 📅 2026-08-24 - Giving Kubernetes Superpowers to everyone.
...
* [robusta](https://github.com/robusta-dev/robusta) ⭐ 3,077 | 🐛 203 | 🌐 Python | 📅 2026-08-24 - Open source Kubernetes troubleshooting and automation platform.
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,017 | 🐛 124 | 🌐 Go | 📅 2026-08-24 - Test infrastructure for the Kubernetes project.
...
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 211 | 🐛 163 | 🌐 Python | 📅 2026-08-25 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
* [seaworthy](https://github.com/cakehappens/seaworthy) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2020-08-10 - A CLI to verify Kubernetes resource health.

## Data Protection & Backup

* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,253 | 🐛 835 | 🌐 Go | 📅 2026-08-25 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [karpenter](https://github.com/aws/karpenter) ⭐ 7,705 | 🐛 505 | 🌐 Go | 📅 2026-08-24 - Kubernetes Node Autoscaling: built for flexibility, performance, and scalability.
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,694 | 🐛 298 | 🌐 Go | 📅 2026-08-21 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,694 | 🐛 298 | 🌐 Go | 📅 2026-08-21 - Kubernetes cost monitoring powered by open allocation models.
...
* [dragonfly2](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,309 | 🐛 34 | 🌐 Go | 📅 2026-08-25 - Dragonfly is an intelligent P2P based file distribution system.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 28,986 | 🐛 1,140 | 🌐 JavaScript | 📅 2026-08-24 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,103 | 🐛 2,913 | 🌐 C | 📅 2026-08-25 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,716 | 🐛 710 | 🌐 TypeScript | 📅 2026-08-24 - The Open Source Airtable alternative.
...
* [milvus](https://github.com/milvus-io/milvus) ⭐ 45,776 | 🐛 1,321 | 🌐 Go | 📅 2026-08-25 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,464 | 🐛 6,824 | 🌐 Go | 📅 2026-08-25 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,359 | 🐛 402 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,414 | 🐛 8,269 | 🌐 Go | 📅 2026-08-07 - CockroachDB - the open source, cloud-native SQL database.
...
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,501 | 🐛 31 | 🌐 C++ | 📅 2026-08-25 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,995 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,406 | 🐛 393 | 🌐 C | 📅 2026-08-24 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,787 | 🐛 209 | 🌐 Java | 📅 2026-08-25 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,809 | 🐛 1,803 | 🌐 Rust | 📅 2026-08-25 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,262 | 🐛 838 | 🌐 C++ | 📅 2026-08-25 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
...
* [oceanbase](https://github.com/oceanbase/oceanbase) ⭐ 10,256 | 🐛 584 | 🌐 C++ | 📅 2026-08-25 - A distributed, banking suitable, open-source related database featuring high scalability and high compatibility.
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,422 | 🐛 569 | 🌐 Rust | 📅 2026-08-25 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 6,987 | 🐛 150 | 🌐 Go | 📅 2026-08-24 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
* [couchdb](https://github.com/apache/couchdb) ⭐ 6,941 | 🐛 368 | 🌐 Erlang | 📅 2026-08-25 - Apache CouchDB is one of a new breed of database management systems.
...
* [kvrocks](https://github.com/KvrocksLabs/kvrocks) ⭐ 4,403 | 🐛 242 | 🌐 C++ | 📅 2026-08-21 - Kvrocks is a distributed key value NoSQL database based on RocksDB and compatible with Redis protocol.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,110 | 🐛 262 | 🌐 Go | 📅 2026-08-25 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,223 | 🐛 854 | 🌐 Go | 📅 2026-08-25 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,244 | 🐛 1,085 | 🌐 Go | 📅 2026-08-25 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 16,961 | 🐛 1,279 | 🌐 C++ | 📅 2026-08-25 - Ceph is a distributed object, block, and file storage platform.
...
* [rook](https://github.com/rook/rook) ⭐ 13,612 | 🐛 142 | 🌐 Go | 📅 2026-08-24 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,799 | 🐛 40 | 📅 2026-08-25 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,650 | 🐛 83 | 🌐 Go | 📅 2026-08-24 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,398 | 🐛 77 | 🌐 Go | 📅 2026-08-25 - OCI registry client, managing content like artifacts, images, packages.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,610 | 🐛 517 | 🌐 Java | 📅 2026-08-25 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,772 | 🐛 77 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,568 | 🐛 564 | 🌐 Java | 📅 2026-08-20 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,585 | 🐛 543 | 🌐 Go | 📅 2026-08-24 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,651 | 🐛 227 | 🌐 Erlang | 📅 2026-08-25 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,311 | 🐛 1,748 | 🌐 Java | 📅 2026-08-24 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,556 | 🐛 54 | 🌐 Java | 📅 2026-08-21 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [istio](https://github.com/istio/istio) ⭐ 38,357 | 🐛 504 | 🌐 Go | 📅 2026-08-25 - Connect, secure, control, and observe services.
...
* [linkerd2](https://github.com/linkerd/linkerd2) ⭐ 11,479 | 🐛 206 | 🌐 Go | 📅 2026-08-25 - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,994 | 🐛 172 | 🌐 Go | 📅 2026-08-24 - Universal Control Plane for your Service Mesh.
...
* [coredns](https://github.com/coredns/coredns) ⭐ 14,273 | 🐛 293 | 🌐 Go | 📅 2026-08-24 - CoreDNS is a DNS server that chains middleware.
...
* [eureka](https://github.com/Netflix/eureka) ⭐ 12,737 | 🐛 137 | 🌐 Java | 📅 2026-08-24 - AWS Service registry for resilient mid-tier load balancing and failover.
...
* [cilium](https://github.com/cilium/cilium) ⭐ 25,004 | 🐛 1,108 | 🌐 Go | 📅 2026-08-24 - API-aware Networking and Security using eBPF and XDP.
...
* [multus](https://github.com/k8snetworkplumbingwg/multus-cni) ⭐ 2,937 | 🐛 23 | 🌐 Go | 📅 2026-08-24 - A CNI meta-plugin for multi-homed pods in Kubernetes.
...
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,393 | 🐛 79 | 🌐 Go | 📅 2026-08-25 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,807 | 🐛 198 | 🌐 Go | 📅 2026-08-25 - Antrea is a Kubernetes networking based on Open vSwitch.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,188 | 🐛 276 | 🌐 Go | 📅 2026-08-25 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,573 | 🐛 916 | 🌐 Go | 📅 2026-08-24 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,488 | 🐛 474 | 🌐 C | 📅 2026-08-24 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,816 | 🐛 1,873 | 🌐 C++ | 📅 2026-08-25 - C++ front/service proxy.
...
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,800 | 🐛 381 | 🌐 C | 📅 2026-08-24 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,299 | 🐛 0 | 🌐 C | 📅 2026-08-24 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,067 | 🐛 246 | 🌐 Go | 📅 2026-08-24 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [skipper](https://github.com/zalando/skipper) ⭐ 3,319 | 🐛 313 | 🌐 Go | 📅 2026-08-24 - An HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress.
...
* [dev-proxy](https://github.com/microsoft/dev-proxy) ⭐ 823 | 🐛 42 | 🌐 C# | 📅 2026-08-25 - Dev Proxy is a command line tool that simulates real world behaviors of HTTP APIs, including Microsoft Graph, locally.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,593 | 🐛 466 | 🌐 C++ | 📅 2026-08-24 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
...
* [kitex](https://github.com/cloudwego/kitex) ⭐ 8,025 | 🐛 71 | 🌐 Go | 📅 2026-08-21 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices.
...
* [moby](https://github.com/moby/moby) ⭐ 71,999 | 🐛 3,912 | 🌐 Go | 📅 2026-08-25 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,682 | 🐛 1,130 | 🌐 Go | 📅 2026-08-24 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,748 | 🐛 534 | 🌐 Go | 📅 2026-08-25 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,157 | 🐛 453 | 🌐 Go | 📅 2026-08-25 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,152 | 🐛 804 | 🌐 Go | 📅 2026-08-25 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 6,988 | 🐛 63 | 🌐 Go | 📅 2026-08-24 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
...
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,072 | 🐛 604 | 🌐 C | 📅 2026-08-25 - WebAssembly Micro Runtime (WAMR).
...
* [crun](https://github.com/containers/crun) ⭐ 4,070 | 🐛 57 | 🌐 C | 📅 2026-08-24 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,420 | 🐛 61 | 🌐 Rust | 📅 2026-08-25 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
...
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,398 | 🐛 255 | 🌐 Go | 📅 2026-08-25 - OpenChoreo is a developer platform for Kubernetes.
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,329 | 🐛 66 | 🌐 Rust | 📅 2026-08-25 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,165 | 🐛 3,036 | 🌐 Go | 📅 2026-08-21 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,056 | 🐛 98 | 🌐 Go | 📅 2026-08-24 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,948 | 🐛 320 | 🌐 Go | 📅 2026-08-24 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
...
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,892 | 🐛 806 | 🌐 Go | 📅 2026-08-25 - A Kubernetes Native Batch System (Project under CNCF).
* [swarm](https://github.com/docker/classicswarm) ⚠️ Archived - Swarm: a Docker-native clustering system.
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,573 | 🐛 839 | 🌐 Go | 📅 2026-08-24 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
* [descheduler](https://github.com/kubernetes-sigs/descheduler) ⭐ 5,493 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Descheduler for Kubernetes.
...
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,426 | 🐛 44 | 🌐 Go | 📅 2026-08-25 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,903 | 🐛 716 | 🌐 Go | 📅 2026-08-24 - Kubernetes-native Job Queueing.
* [kcp](https://github.com/kcp-dev/kcp) ⭐ 2,815 | 🐛 144 | 🌐 Go | 📅 2026-08-21 - Multi-tenant control plane for running many virtual Kubernetes clusters.
* [fleet](https://github.com/coreos/fleet) ⚠️ Archived - Fleet ties together systemd and etcd into a distributed init system.
* [koordinator](https://github.com/koordinator-sh/koordinator) ⭐ 1,740 | 🐛 311 | 🌐 Go | 📅 2026-08-23 - QoS based scheduling system for hybrid orchestration workloads on Kubernetes, bringing workloads the best layout and status.
* [eks-distro](https://github.com/aws/eks-distro) ⭐ 1,456 | 🐛 92 | 🌐 Shell | 📅 2026-08-24 - Amazon EKS Distro (EKS-D) is a Kubernetes distribution based on and used by Amazon Elastic Kubernetes Service (EKS) to create reliable and secure Kubernetes clusters.
* [ocm](https://github.com/open-cluster-management-io/OCM) ⭐ 1,076 | 🐛 50 | 🌐 Go | 📅 2026-08-24 - The open-cluster-management.io project is focused on enabling end-to-end visibility and control across your Kubernetes clusters.
...
* [serverless](https://github.com/serverless/serverless) ⭐ 46,918 | 🐛 1,224 | 🌐 JavaScript | 📅 2026-08-20 - Serverless Framework – Build web, mobile and IoT applications with serverless architectures using AWS Lambda, Azure Functions, Google CloudFunctions & more!
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,252 | 🐛 114 | 🌐 Rust | 📅 2026-08-24 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,032 | 🐛 428 | 🌐 Go | 📅 2026-08-24 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
...
* [fission](https://github.com/fission/fission) ⭐ 8,913 | 🐛 44 | 🌐 Go | 📅 2026-08-25 - Fast Serverless Functions for Kubernetes.
...
* [nuclio](https://github.com/nuclio/nuclio) ⭐ 5,749 | 🐛 116 | 🌐 Go | 📅 2026-08-24 - High-Performance Serverless event and data processing platform.
...
* [layotto](https://github.com/mosn/layotto) ⭐ 852 | 🐛 50 | 🌐 Go | 📅 2026-08-24 - A fast and efficient cloud native application runtime.
...
* [prometheus-operator](https://github.com/coreos/prometheus-operator) ⭐ 9,974 | 🐛 308 | 🌐 Go | 📅 2026-08-24 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes.
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,295 | 🐛 72 | 🌐 Go | 📅 2026-08-24 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
...
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,022 | 🐛 571 | 🌐 Go | 📅 2026-08-24 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,915 | 🐛 154 | 🌐 Java | 📅 2026-08-24 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,148 | 🐛 118 | 🌐 Python | 📅 2026-08-23 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
* [keel](https://github.com/keel-hq/keel) ⭐ 2,724 | 🐛 210 | 🌐 Go | 📅 2026-08-21 - Kubernetes Operator to automate Helm, DaemonSet, StatefulSet & Deployment updates.
...
* [operator-lifecycle-manager](https://github.com/operator-framework/operator-lifecycle-manager) ⭐ 1,863 | 🐛 11 | 🌐 Go | 📅 2026-08-24 - A management framework for extending Kubernetes with Operators.
...
* [k0smotron](https://github.com/k0sproject/k0smotron) ⭐ 735 | 🐛 54 | 🌐 Go | 📅 2026-08-18 - k0smotron is a powerful open-source tool for the efficient management of k0s Kubernetes clusters.
...
* [gateway-operator](https://github.com/kong/gateway-operator) ⭐ 108 | 🐛 203 | 🌐 Go | 📅 2026-08-25 - Kong Gateway Operator is a Kubernetes Operator that can manage your Kong Ingress Controller, Kong Gateway Data Planes, or both together when running on Kubernetes.
* [kubevirtbmc](https://github.com/kubevirtbmc/kubevirtbmc) ⭐ 88 | 🐛 31 | 🌐 Go | 📅 2026-08-25 - A Kubernetes operator of virtual BMCs that provide Redfish and IPMI services for KubeVirt virtual machines.
* [agenttier](https://github.com/agenttier/agenttier) ⭐ 71 | 🐛 18 | 🌐 Go | 📅 2026-08-24 - Kubernetes-native operator that manages isolated, persistent sandboxes for human developers and AI agents through Sandbox CRDs, with built-in governance, warm-pod pool, and a streaming agent-mode REST API.
...
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,445 | 🐛 210 | 🌐 Go | 📅 2026-08-24 - Zero Friction Kubernetes.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,397 | 🐛 3,302 | 🌐 TypeScript | 📅 2026-08-25 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
...
* [kibana](https://github.com/elastic/kibana) ⭐ 21,255 | 🐛 14,242 | 🌐 TypeScript | 📅 2026-08-25 - Kibana analytics and search dashboard for Elasticsearch.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,591 | 🐛 779 | 🌐 Go | 📅 2026-08-25 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,056 | 🐛 145 | 🌐 Go | 📅 2026-08-18 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,183 | 🐛 106 | 🌐 Go | 📅 2026-08-23 - Add-on agent to generate and expose cluster-level metrics.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,949 | 🐛 271 | 🌐 C | 📅 2026-08-25 - eBPF-based Security Observability and Runtime Enforcement.
...
* [kiali](https://github.com/kiali/kiali) ⭐ 3,631 | 🐛 82 | 🌐 Go | 📅 2026-08-25 - Kiali project to help istio service mesh observability.
* [open-falcon](https://github.com/XiaoMi/open-falcon) ⭐ 3,020 | 🐛 32 | 📅 2018-07-05 - Enterprise Internet monitoring system from Xiaomi.
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,913 | 🐛 431 | 🌐 C | 📅 2026-08-25 - The eBPF tool and systems inspection framework for Kubernetes, containers and Linux hosts.
...
* [perses](https://github.com/perses/perses) ⭐ 2,376 | 🐛 266 | 🌐 Go | 📅 2026-08-24 - The CNCF candidate for observability visualisation.
...
* [kepler](https://github.com/sustainable-computing-io/kepler) ⭐ 1,559 | 🐛 51 | 🌐 Go | 📅 2026-08-24 - Kepler (Kubernetes-based Efficient Power Level Exporter) uses eBPF to probe performance counters and other system stats, use ML models to estimate workload energy consumption based on these stats, and exports them as Prometheus metrics.
...
* [kubenurse](https://github.com/postfinance/kubenurse) ⭐ 494 | 🐛 8 | 🌐 Go | 📅 2026-08-24 - Kubernetes network monitoring.
...
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,448 | 🐛 2,519 | 🌐 Rust | 📅 2026-08-24 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,764 | 🐛 424 | 🌐 Go | 📅 2026-08-24 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,578 | 🐛 137 | 🌐 Ruby | 📅 2026-08-24 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,640 | 🐛 1,041 | 🌐 Go | 📅 2026-08-25 - Beats - Lightweight shippers for Elasticsearch & Logstash.
...
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,061 | 🐛 781 | 🌐 C | 📅 2026-08-24 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,612 | 🐛 2,256 | 🌐 Python | 📅 2026-08-25 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,929 | 🐛 29 | 🌐 Java | 📅 2026-08-25 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,137 | 🐛 568 | 🌐 Go | 📅 2026-08-24 - Jaeger, a Distributed Tracing System.
* [zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,453 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - Zipkin is a distributed tracing system.
* [pinpoint](https://github.com/naver/pinpoint) ⭐ 13,861 | 🐛 531 | 🌐 Java | 📅 2026-08-24 - Pinpoint is an open source APM (Application Performance Management) tool for large-scale distributed systems written in Java.
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,322 | 🐛 478 | 🌐 Makefile | 📅 2026-08-24 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,596 | 🐛 255 | 🌐 Go | 📅 2026-08-21 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
...
* [vault](https://github.com/hashicorp/vault) ⭐ 36,164 | 🐛 1,428 | 🌐 Go | 📅 2026-08-24 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,844 | 🐛 3,389 | 🌐 Go | 📅 2026-08-24 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
* [supertokens-core](https://github.com/supertokens/supertokens-core) ⭐ 15,276 | 🐛 164 | 🌐 Java | 📅 2026-08-24 - Open source alternative to Auth0 / Firebase Auth / AWS Cognito.
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,048 | 🐛 249 | 🌐 Go | 📅 2026-08-25 - Automatically provision and manage TLS certificates in Kubernetes.
...
* [grype](https://github.com/anchore/grype) ⭐ 12,784 | 🐛 412 | 🌐 Go | 📅 2026-08-21 - A vulnerability scanner for container images and filesystems.
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,154 | 🐛 344 | 🌐 Go | 📅 2026-08-24 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,686 | 🐛 90 | 🌐 Go | 📅 2026-08-25 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
...
* [clair](https://github.com/quay/clair) ⭐ 11,051 | 🐛 59 | 🌐 Go | 📅 2026-08-24 - Vulnerability Static Analysis for Containers.
...
* [syft](https://github.com/anchore/syft) ⭐ 9,453 | 🐛 638 | 🌐 Go | 📅 2026-08-21 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,300 | 🐛 64 | 🌐 C++ | 📅 2026-08-03 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,041 | 🐛 406 | 🌐 Elixir | 📅 2026-08-25 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,973 | 🐛 166 | 🌐 Python | 📅 2026-08-23 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,151 | 🐛 95 | 🌐 Go | 📅 2026-08-24 - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices.
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,068 | 🐛 642 | 🌐 Go | 📅 2026-08-25 - Kubernetes Native Policy Management.
...
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,232 | 🐛 163 | 🌐 Go | 📅 2026-08-24 - Container signing, verification, and provenance powered by Sigstore.
...
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,973 | 🐛 150 | 🌐 Go | 📅 2026-08-25 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,755 | 🐛 124 | 🌐 Go | 📅 2026-08-24 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [topaz](https://github.com/aserto-dev/topaz) ⭐ 1,360 | 🐛 10 | 🌐 Go | 📅 2026-08-24 - Cloud-native authorization for modern applications and APIs.
...
* [darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 869 | 🐛 2 | 🌐 Python | 📅 2026-08-23 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks, with a proof trail per finding.
...
* [brood-box](https://github.com/stacklok/brood-box) ⭐ 61 | 🐛 13 | 🌐 Go | 📅 2026-08-24 - CLI tool for running coding agents inside hardware-isolated microVMs with workspace snapshot isolation and egress control.
...
* [go-microvm](https://github.com/stacklok/go-microvm) ⭐ 21 | 🐛 10 | 🌐 Go | 📅 2026-08-23 - Go framework for running OCI images as microVMs via libkrun with embedded runtime, rootfs management, and guest networking.
...
* [chaosmonkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,087 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,465 | 🐛 1 | 🌐 Java | 📅 2026-08-10 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
...
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,499 | 🐛 365 | 🌐 Python | 📅 2026-08-17 - An easy to use and powerful chaos engineering experiment toolkit（阿里巴巴开源的一款简单易用、功能强大的混沌实验注入工具）.
* [litmus](https://github.com/litmuschaos/litmus) ⭐ 5,601 | 🐛 414 | 🌐 Go | 📅 2026-07-31 - Litmus helps SREs and developers practice chaos engineering in a Cloud-native way.
...
* [chaostoolkit](https://github.com/chaostoolkit/chaostoolkit/) ⭐ 2,019 | 🐛 3 | 🌐 Python | 📅 2026-08-09 - An Open API to Chaos Engineering.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,647 | 🐛 50 | 🌐 Go | 📅 2026-08-25 - Kubernetes-native framework for test definition and execution.
* [krkn](https://github.com/krkn-chaos/krkn) ⭐ 490 | 🐛 139 | 🌐 Python | 📅 2026-08-24 - Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,330 | 🐛 746 | 🌐 TypeScript | 📅 2026-08-21 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,234 | 🐛 404 | 🌐 TypeScript | 📅 2026-08-24 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,872 | 🐛 3,344 | 🌐 Go | 📅 2026-08-25 - Complete container management platform.
...
* [openshift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 307 | 🌐 Go | 📅 2026-08-22 - Enterprise Kubernetes for Developers.
* [rainbond](https://github.com/goodrain/rainbond) ⭐ 6,254 | 🐛 57 | 🌐 Go | 📅 2026-08-24 - Serverless PaaS , A new generation of easy-to-use cloud management platforms based on kubernetes.
* [wayne](https://github.com/Qihoo360/wayne) ⭐ 3,700 | 🐛 61 | 🌐 TypeScript | 📅 2022-05-31 - Web UI for Kubernetes multi-clusters.
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,104 | 🐛 56 | 🌐 Go | 📅 2026-08-24 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,341 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-21 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,548 | 🐛 52 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
...
* [kubernetes-on-aws](https://github.com/zalando-incubator/kubernetes-on-aws) ⭐ 635 | 🐛 36 | 🌐 Go | 📅 2026-08-25 - Deploying Kubernetes on AWS with CloudFormation and Ubuntu.
