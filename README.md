...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 198,881 | 🐛 3,089 | 🌐 C++ | 📅 2026-09-06 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,809 | 🐛 17,575 | 🌐 Python | 📅 2026-09-06 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,306 | 🐛 211 | 🌐 Python | 📅 2026-09-05 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,073 | 🐛 1,501 | 🌐 C++ | 📅 2026-09-05 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [h2o-3](https://github.com/h2oai/h2o-3) ⭐ 7,500 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-09-02 - Open Source Fast Scalable Machine Learning API For Smarter Applications (Deep Learning, Gradient Boosting, Random Forest, Generalized Linear Modeling (Logistic Regression, Elastic Net), K-Means, PCA, Stacked Ensembles.)
* [kserve](https://github.com/kserve/kserve) ⭐ 5,860 | 🐛 203 | 🌐 Go | 📅 2026-09-04 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 58,149 | 🐛 4,921 | 🌐 Python | 📅 2026-09-06 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,093 | 🐛 194 | 🌐 Lua | 📅 2026-09-03 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,090 | 🐛 243 | 🌐 Lua | 📅 2026-09-04 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,817 | 🐛 498 | 🌐 Go | 📅 2026-09-04 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,304 | 🐛 1,086 | 🌐 Go | 📅 2026-09-06 - Next-generation Cloud Native Gateway.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 3,014 | 🐛 758 | 🌐 Go | 📅 2026-09-06 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,158 | 🐛 114 | 🌐 Go | 📅 2026-09-06 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [sbproxy](https://github.com/soapbucket/sbproxy) ⭐ 51 | 🐛 1 | 🌐 Rust | 📅 2026-09-06 - Single-binary AI gateway and reverse proxy with 103+ LLM providers, cost-based routing, rate limiting, and declarative YAML configuration.

## Continuous Delivery & GitOps

* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,621 | 🐛 1,919 | 🌐 Go | 📅 2026-09-04 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,248 | 🐛 106 | 🌐 Go | 📅 2026-09-04 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,219 | 🐛 458 | 🌐 Go | 📅 2026-09-02 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 30,100 | 🐛 315 | 🌐 Go | 📅 2026-09-04 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,533 | 🐛 3,613 | 🌐 Java | 📅 2026-09-06 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,651 | 🐛 2,438 | 🌐 Go | 📅 2026-09-05 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 24,087 | 🐛 4,358 | 🌐 Go | 📅 2026-09-06 - Declarative continuous deployment for Kubernetes.
...
* [dagger](https://github.com/dagger/dagger) ⭐ 16,227 | 🐛 155 | 🌐 Go | 📅 2026-09-05 - A programmable CI/CD engine that runs your pipelines in containers.
* [skaffold](https://github.com/GoogleContainerTools/skaffold) ⭐ 15,887 | 🐛 909 | 🌐 Go | 📅 2026-09-02 - Easy and Repeatable Kubernetes Development.
...
* [kustomize](https://github.com/kubernetes-sigs/kustomize) ⭐ 12,152 | 🐛 187 | 🌐 Go | 📅 2026-09-06 - Customization of kubernetes YAML configurations.
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 12,034 | 🐛 195 | 🌐 Go | 📅 2026-09-04 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,708 | 🐛 1,931 | 🌐 TypeScript | 📅 2026-09-06 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,620 | 🐛 20 | 🌐 Go | 📅 2026-08-31 - Go from Docker Compose to Kubernetes.
* [tilt](https://github.com/tilt-dev/tilt) ⭐ 10,040 | 🐛 509 | 🌐 Go | 📅 2026-09-04 - A multi-service dev environment for teams on Kubernetes.
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,782 | 🐛 101 | 🌐 Java | 📅 2026-09-05 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,059 | 🐛 575 | 🌐 Go | 📅 2026-09-04 - A cloud-native Pipeline resource.
* [ko](https://github.com/ko-build/ko) ⭐ 8,515 | 🐛 56 | 🌐 Go | 📅 2026-09-03 - Build and deploy Go applications on Kubernetes.
* [spec](https://github.com/score-spec/spec) ⭐ 8,093 | 🐛 13 | 🌐 Makefile | 📅 2026-07-27 - The score specification file.
* [kubevela](https://github.com/oam-dev/kubevela) ⭐ 7,893 | 🐛 279 | 🌐 Go | 📅 2026-09-02 - Make shipping applications more enjoyable.
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,819 | 🐛 371 | 🌐 Go | 📅 2026-09-06 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
...
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,591 | 🐛 771 | 🌐 Go | 📅 2026-09-04 - Software Delivery Workflow For Kubernetes
* [wing](https://github.com/winglang/wing) ⭐ 5,400 | 🐛 880 | 🌐 TypeScript | 📅 2026-09-06 - A cloud-oriented programming language that allows developers to build distributed systems, leveraging cloud services as first-class citizens.
...
* [jx](https://github.com/jenkins-x/jx) ⭐ 4,689 | 🐛 147 | 🌐 Go | 📅 2026-09-02 - A command line tool for installing and working with Jenkins X.
* [arkade](https://github.com/alexellis/arkade) ⭐ 4,613 | 🐛 16 | 🌐 Go | 📅 2026-09-04 - Kubernetes apps for developers.
* [helmfile](https://github.com/roboll/helmfile) ⭐ 4,033 | 🐛 527 | 🌐 Go | 📅 2023-04-27 - Deploy Kubernetes Helm Charts.
* [ballerina-lang](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,848 | 🐛 1,610 | 🌐 Ballerina | 📅 2026-09-03 - Ballerina is a new programming language for integration built on a sequence diagram metaphor.
...
* [kargo](https://github.com/akuity/kargo) ⭐ 3,633 | 🐛 188 | 🌐 Go | 📅 2026-09-06 - Application lifecycle orchestration.
...
* [argo-rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,571 | 🐛 658 | 🌐 Go | 📅 2026-09-04 - Progressive delivery controller for blue-green, canary, and experiments on Kubernetes.
...
* [source-to-image](https://github.com/openshift/source-to-image) ⭐ 2,543 | 🐛 25 | 🌐 Go | 📅 2026-09-06 - A tool for building/building artifacts from source and injecting into docker images.
...
* [hub](https://github.com/artifacthub/hub) ⭐ 2,081 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-03 - Find, install and publish Cloud Native packages
...
* [kpt](https://github.com/GoogleContainerTools/kpt) ⭐ 1,892 | 🐛 339 | 🌐 Go | 📅 2026-09-04 - Kpt is a toolkit to help you manage, manipulate, customize, and apply Kubernetes Resource configuration data files.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,670 | 🐛 318 | 🌐 Go | 📅 2026-09-04 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [helmsman](https://github.com/Praqma/helmsman) ⭐ 1,494 | 🐛 2 | 🌐 Go | 📅 2026-09-06 - Helm Charts as Code.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,352 | 🐛 226 | 🌐 Go | 📅 2026-09-06 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
...
* [draft](https://github.com/azure/draft) ⭐ 643 | 🐛 25 | 🌐 Go | 📅 2026-09-02 - A tool for developers to create cloud-native applications on Kubernetes.
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,773 | 🐛 318 | 🌐 Go | 📅 2026-09-06 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,221 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,212 | 🐛 90 | 🌐 Go | 📅 2026-09-03 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,494 | 🐛 355 | 🌐 Go | 📅 2026-09-03 - Docker CLI plugin for extended build capabilities with BuildKit.
* [container-structure-test](https://github.com/GoogleContainerTools/container-structure-test) ⭐ 2,494 | 🐛 117 | 🌐 Go | 📅 2026-07-20 - Validate the structure of your container images.
* [docker-wine](https://github.com/scottyhardy/docker-wine) ⭐ 1,527 | 🐛 55 | 🌐 Shell | 📅 2025-05-29 - Docker image that includes Wine and Winetricks for running Windows applications on Linux and macOS.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,597 | 🐛 840 | 🌐 Python | 📅 2026-09-04 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,787 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-05 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,386 | 🐛 162 | 🌐 Go | 📅 2026-09-02 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,273 | 🐛 193 | 🌐 Go | 📅 2026-09-02 - Enforce Kubernetes admission policies using Open Policy Agent constraints.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,251 | 🐛 39 | 🌐 Python | 📅 2026-09-05 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 32,101 | 🐛 560 | 🌐 Go | 📅 2026-09-06 - Run Kubernetes locally.
...
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,715 | 🐛 223 | 🌐 Jinja | 📅 2026-09-05 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,341 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-04 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,669 | 🐛 133 | 🌐 Go | 📅 2026-09-05 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
...
* [talos](https://github.com/talos-systems/talos) ⭐ 11,102 | 🐛 224 | 🌐 Go | 📅 2026-09-06 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,366 | 🐛 161 | 🌐 Python | 📅 2026-09-06 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,211 | 🐛 93 | 🌐 Go | 📅 2026-09-04 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,299 | 🐛 215 | 🌐 Go | 📅 2026-09-04 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 3,999 | 🐛 38 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,440 | 🐛 202 | 🌐 Go | 📅 2026-09-05 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
...
* [claudie](https://github.com/berops/claudie) ⭐ 793 | 🐛 64 | 🌐 Go | 📅 2026-09-03 - Cloud-agnostic managed Kubernetes.
...
* [spinifex](https://github.com/mulgadc/spinifex) ⭐ 157 | 🐛 5 | 🌐 Go | 📅 2026-09-06 - Open source AWS-compatible platform for bare-metal, on-prem, and edge deployments. Run EC2, S3, EBS, and VPC-compatible services on your own hardware — no managed cloud required.
...
* [client-go](https://github.com/kubernetes/client-go) ⭐ 9,876 | 🐛 0 | 🌐 Go | 📅 2026-09-04 - Go client for Kubernetes.
* [telepresence](https://github.com/telepresenceio/telepresence) ⭐ 7,292 | 🐛 26 | 🌐 Go | 📅 2026-08-25 - Local development against a remote Kubernetes or OpenShift cluster.
...
* [devspace](https://github.com/devspace-cloud/devspace) ⭐ 5,171 | 🐛 90 | 🌐 Go | 📅 2026-09-06 - Cloud Native Software Development with Kubernetes and Docker - simply run "devspace up" in any of your projects and start coding directly on top of Kubernetes (works with minikube, self-hosted and cloud-based clusters).
...
* [kube-ps1](https://github.com/jonmosco/kube-ps1) ⭐ 3,811 | 🐛 5 | 🌐 Shell | 📅 2026-05-24 - Kubernetes prompt info for bash and zsh.
* [kubernetes-client](https://github.com/fabric8io/kubernetes-client) ⭐ 3,673 | 🐛 111 | 🌐 Java | 📅 2026-09-04 - Java client for Kubernetes & OpenShift 3.
* [okteto](https://github.com/okteto/okteto) ⭐ 3,540 | 🐛 37 | 🌐 Go | 📅 2026-09-05 - Local development experience for Kubernetes apps.
...
* [kubie](https://github.com/sbstp/kubie) ⭐ 2,629 | 🐛 60 | 🌐 Rust | 📅 2026-09-05 - A more powerful alternative to kubectx and kubens.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,149 | 🐛 96 | 🌐 Go | 📅 2026-09-05 - Giving Kubernetes Superpowers to everyone.
* [kube-no-trouble](https://github.com/doitintl/kube-no-trouble) ⭐ 3,680 | 🐛 25 | 🌐 Go | 📅 2026-09-06 - Easily check your clusters for use of deprecated APIs.
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,017 | 🐛 135 | 🌐 Go | 📅 2026-09-06 - Test infrastructure for the Kubernetes project.
* [kwok](https://github.com/kubernetes-sigs/kwok) ⭐ 3,183 | 🐛 32 | 🌐 Go | 📅 2026-09-04 - Kubernetes WithOut Kubelet - Simulates thousands of Nodes and Clusters.
...
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 216 | 🐛 180 | 🌐 Python | 📅 2026-09-06 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
* [seaworthy](https://github.com/cakehappens/seaworthy) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2020-08-10 - A CLI to verify Kubernetes resource health.

## Data Protection & Backup

* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,276 | 🐛 832 | 🌐 Go | 📅 2026-09-05 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [karpenter](https://github.com/aws/karpenter) ⭐ 7,714 | 🐛 510 | 🌐 Go | 📅 2026-09-06 - Kubernetes Node Autoscaling: built for flexibility, performance, and scalability.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 29,001 | 🐛 1,127 | 🌐 JavaScript | 📅 2026-09-05 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,241 | 🐛 2,931 | 🌐 C | 📅 2026-09-04 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,859 | 🐛 706 | 🌐 TypeScript | 📅 2026-09-05 - The Open Source Airtable alternative.
...
* [milvus](https://github.com/milvus-io/milvus) ⭐ 45,998 | 🐛 1,322 | 🌐 Go | 📅 2026-09-06 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,492 | 🐛 6,934 | 🌐 Go | 📅 2026-09-06 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,387 | 🐛 407 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,442 | 🐛 8,438 | 🌐 Go | 📅 2026-09-02 - CockroachDB - the open source, cloud-native SQL database.
...
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,531 | 🐛 32 | 🌐 C++ | 📅 2026-09-05 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,994 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,471 | 🐛 392 | 🌐 C | 📅 2026-09-06 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,796 | 🐛 215 | 🌐 Java | 📅 2026-09-06 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,832 | 🐛 1,805 | 🌐 Rust | 📅 2026-09-03 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,267 | 🐛 853 | 🌐 C++ | 📅 2026-09-06 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
* [nebula](https://github.com/vesoft-inc/nebula) ⭐ 12,378 | 🐛 678 | 🌐 C++ | 📅 2026-05-18 - A distributed, fast open-source graph database featuring horizontal scalability and high availability.
* [oceanbase](https://github.com/oceanbase/oceanbase) ⭐ 10,263 | 🐛 596 | 🌐 C++ | 📅 2026-09-05 - A distributed, banking suitable, open-source related database featuring high scalability and high compatibility.
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,433 | 🐛 569 | 🌐 Rust | 📅 2026-09-06 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
* [tinydb](https://github.com/msiemens/tinydb) ⭐ 7,561 | 🐛 12 | 🌐 Python | 📅 2026-08-10 - TinyDB is a lightweight document oriented database optimized for your happiness.
* [spicedb](https://github.com/authzed/spicedb) ⭐ 7,027 | 🐛 144 | 🌐 Go | 📅 2026-09-04 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
* [couchdb](https://github.com/apache/couchdb) ⭐ 6,946 | 🐛 369 | 🌐 Erlang | 📅 2026-09-05 - Apache CouchDB is one of a new breed of database management systems.
...
* [kvrocks](https://github.com/KvrocksLabs/kvrocks) ⭐ 4,419 | 🐛 241 | 🌐 C++ | 📅 2026-09-03 - Kvrocks is a distributed key value NoSQL database based on RocksDB and compatible with Redis protocol.
* [polardb-for-postgresql](https://github.com/alibaba/PolarDB-for-PostgreSQL) ⭐ 3,199 | 🐛 65 | 🌐 C | 📅 2026-09-06 - PolarDB for PostgreSQL (PolarDB for short) is an open source database system based on PostgreSQL.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,119 | 🐛 247 | 🌐 Go | 📅 2026-09-06 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,320 | 🐛 874 | 🌐 Go | 📅 2026-09-06 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,296 | 🐛 1,097 | 🌐 Go | 📅 2026-09-06 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 17,008 | 🐛 1,316 | 🌐 C++ | 📅 2026-09-06 - Ceph is a distributed object, block, and file storage platform.
...
* [rook](https://github.com/rook/rook) ⭐ 13,644 | 🐛 132 | 🌐 Go | 📅 2026-09-03 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,808 | 🐛 37 | 📅 2026-09-06 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
...
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,951 | 🐛 1,886 | 🌐 Shell | 📅 2026-09-06 - We put storage on cows and move them around from rancher.
...
* [glusterfs](https://github.com/gluster/glusterfs) ⭐ 5,230 | 🐛 292 | 🌐 C | 📅 2026-08-31 - Gluster is a software defined distributed storage that can scale to several petabytes. It provides interfaces for object, block and file storage.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,713 | 🐛 82 | 🌐 Go | 📅 2026-09-05 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,418 | 🐛 79 | 🌐 Go | 📅 2026-09-06 - OCI registry client, managing content like artifacts, images, packages.
...
* [zenko](https://github.com/scality/Zenko) ⭐ 673 | 🐛 19 | 🌐 Gherkin | 📅 2026-09-06 - Because everyone should be in control of their data.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,677 | 🐛 552 | 🌐 Java | 📅 2026-09-06 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,777 | 🐛 78 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,582 | 🐛 624 | 🌐 Java | 📅 2026-09-04 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,671 | 🐛 537 | 🌐 Go | 📅 2026-09-04 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,695 | 🐛 187 | 🌐 Erlang | 📅 2026-09-06 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,326 | 🐛 1,742 | 🌐 Java | 📅 2026-09-05 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,629 | 🐛 60 | 🌐 Java | 📅 2026-09-06 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [istio](https://github.com/istio/istio) ⭐ 38,371 | 🐛 508 | 🌐 Go | 📅 2026-09-06 - Connect, secure, control, and observe services.
...
* [linkerd2](https://github.com/linkerd/linkerd2) ⭐ 11,486 | 🐛 201 | 🌐 Go | 📅 2026-09-04 - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,998 | 🐛 142 | 🌐 Go | 📅 2026-09-06 - Universal Control Plane for your Service Mesh.
...
* [apollo](https://github.com/ctripcorp/apollo) ⭐ 29,803 | 🐛 157 | 🌐 Java | 📅 2026-09-06 - Apollo（阿波罗）是携程框架部门研发的分布式配置中心，能够集中化管理应用不同环境、不同集群的配置，配置修改后能够实时推送到应用端，并且具备规范的权限、流程治理等特性，适用于微服务配置管理场景。
* [coredns](https://github.com/coredns/coredns) ⭐ 14,296 | 🐛 299 | 🌐 Go | 📅 2026-09-06 - CoreDNS is a DNS server that chains middleware.
* [zookeeper](https://github.com/apache/zookeeper) ⭐ 12,799 | 🐛 240 | 🌐 Java | 📅 2026-09-03 - Apache ZooKeeper is an effort to develop and maintain an open-source server which enables highly reliable distributed coordination.
...
* [pingora](https://github.com/cloudflare/pingora) ⭐ 27,329 | 🐛 297 | 🌐 Rust | 📅 2026-08-25 - A library for building fast, reliable and evolvable network services.
* [cilium](https://github.com/cilium/cilium) ⭐ 25,082 | 🐛 1,101 | 🌐 Go | 📅 2026-09-06 - API-aware Networking and Security using eBPF and XDP.
* [flannel](https://github.com/coreos/flannel) ⭐ 9,532 | 🐛 27 | 🌐 Go | 📅 2026-09-02 - Flannel is a network fabric for containers, designed for Kubernetes.
...
* [hubble](https://github.com/cilium/hubble) ⭐ 4,324 | 🐛 44 | 🌐 Makefile | 📅 2026-09-03 - Hubble - Network, Service & Security Observability for Kubernetes.
...
* [submariner](https://github.com/submariner-io/submariner) ⭐ 2,687 | 🐛 19 | 🌐 Go | 📅 2026-09-06 - Connect all your Kubernetes clusters, no matter where they are in the world.
* [kube-router](https://github.com/cloudnativelabs/kube-router) ⭐ 2,498 | 🐛 19 | 🌐 Go | 📅 2026-09-05 - Kube-router, a turnkey solution for Kubernetes networking.
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,394 | 🐛 61 | 🌐 Go | 📅 2026-09-06 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
...
* [spiderpool](https://github.com/spidernet-io/spiderpool) ⭐ 673 | 🐛 100 | 🌐 Go | 📅 2026-09-04 - Underlay and RDMA network solution of the Kubernetes, for bare metal, VM and any public cloud.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,522 | 🐛 272 | 🌐 Go | 📅 2026-09-06 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,758 | 🐛 906 | 🌐 Go | 📅 2026-09-04 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,582 | 🐛 464 | 🌐 C | 📅 2026-09-02 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,865 | 🐛 1,872 | 🌐 C++ | 📅 2026-09-06 - C++ front/service proxy.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15,527 | 🐛 537 | 🌐 Go | 📅 2026-09-03 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [bunkerweb](https://github.com/bunkerity/bunkerweb) ⭐ 10,910 | 🐛 166 | 🌐 Python | 📅 2026-09-06 - Open-source Web Application Firewall and reverse proxy with Kubernetes integration.
* [reverse-proxy](https://github.com/microsoft/reverse-proxy) ⭐ 9,609 | 🐛 191 | 🌐 C# | 📅 2026-08-31 - A toolkit for developing high-performance HTTP reverse proxy applications.
...
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,835 | 🐛 389 | 🌐 C | 📅 2026-09-04 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,308 | 🐛 0 | 🌐 C | 📅 2026-09-05 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,074 | 🐛 262 | 🌐 Go | 📅 2026-09-06 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [loxilb](https://github.com/loxilb-io/loxilb) ⭐ 1,874 | 🐛 32 | 🌐 Go | 📅 2026-09-04 - eBPF powered cloud-native load-balancer providing efficient externalLB, clusterIP and nodePort services for Kubernetes.
...
* [dev-proxy](https://github.com/microsoft/dev-proxy) ⭐ 827 | 🐛 35 | 🌐 C# | 📅 2026-09-02 - Dev Proxy is a command line tool that simulates real world behaviors of HTTP APIs, including Microsoft Graph, locally.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,595 | 🐛 463 | 🌐 C++ | 📅 2026-09-06 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,956 | 🐛 24 | 🌐 C++ | 📅 2026-09-05 - Apache thrift.
...
* [proxygen](https://github.com/facebook/proxygen) ⭐ 8,377 | 🐛 39 | 🌐 C++ | 📅 2026-09-05 - A collection of C++ HTTP libraries including an easy to use HTTP server.
...
* [moby](https://github.com/moby/moby) ⭐ 72,066 | 🐛 3,882 | 🌐 Go | 📅 2026-09-04 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,789 | 🐛 1,127 | 🌐 Go | 📅 2026-09-05 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,820 | 🐛 534 | 🌐 Go | 📅 2026-09-04 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,261 | 🐛 459 | 🌐 Go | 📅 2026-09-05 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,238 | 🐛 869 | 🌐 Go | 📅 2026-09-06 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 7,007 | 🐛 65 | 🌐 Go | 📅 2026-09-05 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
...
* [wazero](https://github.com/tetratelabs/wazero) ⭐ 6,363 | 🐛 39 | 🌐 Go | 📅 2026-09-04 - The zero dependency WebAssembly runtime for Go developers.
...
* [crun](https://github.com/containers/crun) ⭐ 4,107 | 🐛 49 | 🌐 C | 📅 2026-09-04 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [krustlet](https://github.com/deislabs/krustlet) ⭐ 3,599 | 🐛 138 | 🌐 Rust | 📅 2023-10-02 - Kubernetes Rust Kubelet.
...
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,433 | 🐛 63 | 🌐 Rust | 📅 2026-09-04 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
* [hyperd](https://github.com/hyperhq/hyperd) ⚠️ Archived - HyperContainer Daemon.
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,477 | 🐛 281 | 🌐 Go | 📅 2026-09-04 - OpenChoreo is a developer platform for Kubernetes.
...
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,334 | 🐛 68 | 🌐 Rust | 📅 2026-09-06 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 126,422 | 🐛 3,060 | 🌐 Go | 📅 2026-09-04 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,120 | 🐛 117 | 🌐 Go | 📅 2026-09-04 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,958 | 🐛 335 | 🌐 Go | 📅 2026-09-05 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
* [serf](https://github.com/hashicorp/serf) ⭐ 6,070 | 🐛 107 | 🌐 Go | 📅 2026-09-01 - Service orchestration and management tool by hashicorp.
* [deis](https://github.com/deis/deis) ⚠️ Archived - Deis v1, the CoreOS and Docker PaaS: Your PaaS. Your Rules.
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,924 | 🐛 814 | 🌐 Go | 📅 2026-09-04 - A Kubernetes Native Batch System (Project under CNCF).
...
* [mesos](https://github.com/apache/mesos) ⭐ 5,369 | 🐛 11 | 🌐 C++ | 📅 2026-05-15 - Apache Mesos abstracts CPU, memory, storage, and other compute resources away from machines (physical or virtual), enabling fault-tolerant and elastic distributed systems to easily be built and run effectively.
* [kruise](https://github.com/openkruise/kruise) ⭐ 5,331 | 🐛 79 | 🌐 Go | 📅 2026-08-31 - Automate application workloads management on Kubernetes.
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,502 | 🐛 54 | 🌐 Go | 📅 2026-09-05 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,947 | 🐛 751 | 🌐 Go | 📅 2026-09-05 - Kubernetes-native Job Queueing.
* [kcp](https://github.com/kcp-dev/kcp) ⭐ 2,819 | 🐛 153 | 🌐 Go | 📅 2026-09-01 - Multi-tenant control plane for running many virtual Kubernetes clusters.
* [fleet](https://github.com/coreos/fleet) ⚠️ Archived - Fleet ties together systemd and etcd into a distributed init system.
* [koordinator](https://github.com/koordinator-sh/koordinator) ⭐ 1,750 | 🐛 215 | 🌐 Go | 📅 2026-09-06 - QoS based scheduling system for hybrid orchestration workloads on Kubernetes, bringing workloads the best layout and status.
...
* [serverless](https://github.com/serverless/serverless) ⭐ 46,918 | 🐛 1,219 | 🌐 JavaScript | 📅 2026-09-04 - Serverless Framework – Build web, mobile and IoT applications with serverless architectures using AWS Lambda, Azure Functions, Google CloudFunctions & more!
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,570 | 🐛 103 | 🌐 Rust | 📅 2026-09-04 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,080 | 🐛 452 | 🌐 Go | 📅 2026-09-04 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
...
* [keda](https://github.com/kedacore/keda) ⭐ 10,500 | 🐛 261 | 🌐 Go | 📅 2026-09-05 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
* [fission](https://github.com/fission/fission) ⭐ 8,914 | 🐛 47 | 🌐 Go | 📅 2026-09-02 - Fast Serverless Functions for Kubernetes.
...
* [nuclio](https://github.com/nuclio/nuclio) ⭐ 5,755 | 🐛 124 | 🌐 Go | 📅 2026-09-06 - High-Performance Serverless event and data processing platform.
...
* [eventing](https://github.com/knative/eventing) ⭐ 1,553 | 🐛 98 | 🌐 Go | 📅 2026-09-02 - Open source specification and implementation of Knative event binding and delivery.
...
* [prometheus-operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 297 | 🌐 Go | 📅 2026-09-04 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes.
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,306 | 🐛 69 | 🌐 Go | 📅 2026-09-05 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
* [operator-sdk](https://github.com/operator-framework/operator-sdk) ⭐ 7,677 | 🐛 68 | 🌐 Go | 📅 2026-09-02 - SDK for building Kubernetes applications. Provides high level APIs, useful abstractions, and project scaffolding.
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,048 | 🐛 559 | 🌐 Go | 📅 2026-09-05 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,927 | 🐛 159 | 🌐 Java | 📅 2026-09-05 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,151 | 🐛 124 | 🌐 Python | 📅 2026-09-04 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
* [keel](https://github.com/keel-hq/keel) ⭐ 2,726 | 🐛 214 | 🌐 Go | 📅 2026-09-03 - Kubernetes Operator to automate Helm, DaemonSet, StatefulSet & Deployment updates.
...
* [operator-lifecycle-manager](https://github.com/operator-framework/operator-lifecycle-manager) ⭐ 1,862 | 🐛 8 | 🌐 Go | 📅 2026-09-01 - A management framework for extending Kubernetes with Operators.
...
* [k3s](https://github.com/k3s-io/k3s) ⭐ 33,893 | 🐛 76 | 🌐 Go | 📅 2026-09-04 - Lightweight Kubernetes.
...
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,465 | 🐛 230 | 🌐 Go | 📅 2026-09-06 - Zero Friction Kubernetes.
...
* [akri](https://github.com/project-akri/akri) ⭐ 1,262 | 🐛 89 | 🌐 Rust | 📅 2026-09-01 - A Kubernetes Resource Interface for the Edge.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,633 | 🐛 3,355 | 🌐 TypeScript | 📅 2026-09-06 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,968 | 🐛 896 | 🌐 Go | 📅 2026-09-04 - The Prometheus monitoring system and time series database.
* [kibana](https://github.com/elastic/kibana) ⭐ 21,283 | 🐛 14,792 | 🌐 TypeScript | 📅 2026-09-06 - Kibana analytics and search dashboard for Elasticsearch.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,664 | 🐛 785 | 🌐 Go | 📅 2026-09-06 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,069 | 🐛 150 | 🌐 Go | 📅 2026-09-01 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
...
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,499 | 🐛 693 | 🌐 Go | 📅 2026-09-06 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,986 | 🐛 280 | 🌐 C | 📅 2026-09-05 - eBPF-based Security Observability and Runtime Enforcement.
* [parca](https://github.com/parca-dev/parca) ⭐ 4,963 | 🐛 205 | 🌐 TypeScript | 📅 2026-09-03 - Continuous profiling for analysis of CPU and memory usage, down to the line number and throughout time. Saving infrastructure cost, improving performance, and increasing reliability.
...
* [kiali](https://github.com/kiali/kiali) ⭐ 3,634 | 🐛 81 | 🌐 Go | 📅 2026-09-04 - Kiali project to help istio service mesh observability.
* [open-falcon](https://github.com/XiaoMi/open-falcon) ⭐ 3,020 | 🐛 32 | 📅 2018-07-05 - Enterprise Internet monitoring system from Xiaomi.
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,920 | 🐛 436 | 🌐 C | 📅 2026-09-04 - The eBPF tool and systems inspection framework for Kubernetes, containers and Linux hosts.
...
* [perses](https://github.com/perses/perses) ⭐ 2,396 | 🐛 262 | 🌐 Go | 📅 2026-09-06 - The CNCF candidate for observability visualisation.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,901 | 🐛 6,043 | 🌐 Java | 📅 2026-09-06 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,839 | 🐛 1,739 | 🌐 Go | 📅 2026-09-06 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,514 | 🐛 2,511 | 🌐 Rust | 📅 2026-09-05 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,794 | 🐛 418 | 🌐 Go | 📅 2026-09-04 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,581 | 🐛 138 | 🌐 Ruby | 📅 2026-09-06 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,643 | 🐛 1,044 | 🌐 Go | 📅 2026-09-06 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,572 | 🐛 806 | 🌐 Rust | 📅 2026-09-04 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,078 | 🐛 748 | 🌐 C | 📅 2026-09-05 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,736 | 🐛 2,232 | 🌐 Python | 📅 2026-09-06 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,942 | 🐛 40 | 🌐 Java | 📅 2026-09-06 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,193 | 🐛 562 | 🌐 Go | 📅 2026-09-05 - Jaeger, a Distributed Tracing System.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,800 | 🐛 264 | 🌐 Go | 📅 2026-09-04 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
* [keycloak](https://github.com/keycloak/keycloak) ⭐ 36,623 | 🐛 3,241 | 🌐 Java | 📅 2026-09-06 - Open Source Identity and Access Management For Modern Applications and Services.
* [vault](https://github.com/hashicorp/vault) ⭐ 36,210 | 🐛 1,432 | 🌐 Go | 📅 2026-09-04 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,887 | 🐛 3,322 | 🌐 Go | 📅 2026-09-03 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
...
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,067 | 🐛 256 | 🌐 Go | 📅 2026-09-05 - Automatically provision and manage TLS certificates in Kubernetes.
...
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,202 | 🐛 334 | 🌐 Go | 📅 2026-09-06 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,720 | 🐛 47 | 🌐 Go | 📅 2026-09-04 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
* [dex](https://github.com/dexidp/dex) ⭐ 11,081 | 🐛 541 | 🌐 Go | 📅 2026-09-04 - OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors.
* [clair](https://github.com/quay/clair) ⭐ 11,056 | 🐛 60 | 🌐 Go | 📅 2026-09-02 - Vulnerability Static Analysis for Containers.
* [docker-bench-security](https://github.com/docker/docker-bench-security) ⭐ 9,698 | 🐛 29 | 🌐 Shell | 📅 2026-06-04 - The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
* [syft](https://github.com/anchore/syft) ⭐ 9,526 | 🐛 633 | 🌐 Go | 📅 2026-09-04 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,342 | 🐛 61 | 🌐 C++ | 📅 2026-09-04 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,052 | 🐛 440 | 🌐 Elixir | 📅 2026-09-06 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,984 | 🐛 162 | 🌐 Python | 📅 2026-09-05 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,174 | 🐛 100 | 🌐 Go | 📅 2026-08-24 - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices.
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,114 | 🐛 674 | 🌐 Go | 📅 2026-09-06 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,835 | 🐛 272 | 🌐 Go | 📅 2026-09-06 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,281 | 🐛 164 | 🌐 Go | 📅 2026-09-06 - Container signing, verification, and provenance powered by Sigstore.
...
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,995 | 🐛 153 | 🌐 Go | 📅 2026-09-06 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
...
* [authenticator](https://github.com/kubernetes-sigs/aws-iam-authenticator) ⭐ 2,332 | 🐛 18 | 🌐 Go | 📅 2026-08-31 - A tool for using AWS IAM credentials to authenticate to a Kubernetes cluster.
...
* [neuvector](https://github.com/neuvector/neuvector) ⭐ 1,333 | 🐛 309 | 🌐 Go | 📅 2026-09-06 - Kubernetes-native container security platform.
...
* [darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 890 | 🐛 3 | 🌐 Python | 📅 2026-08-29 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks, with a proof trail per finding.
...
* [trust-manager](https://github.com/cert-manager/trust-manager) ⭐ 395 | 🐛 42 | 🌐 Go | 📅 2026-09-05 - trust-manager is an operator for distributing trust bundles across a Kubernetes cluster.
...
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,503 | 🐛 2 | 🌐 Java | 📅 2026-09-01 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
...
* [chaos-mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,878 | 🐛 550 | 🌐 Go | 📅 2026-09-02 - A Chaos Engineering Platform for Kubernetes.
...
* [litmus](https://github.com/litmuschaos/litmus) ⭐ 5,607 | 🐛 401 | 🌐 Go | 📅 2026-08-25 - Litmus helps SREs and developers practice chaos engineering in a Cloud-native way.
...
* [ratelimit](https://github.com/envoyproxy/ratelimit) ⭐ 2,690 | 🐛 37 | 🌐 Go | 📅 2026-09-02 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,654 | 🐛 46 | 🌐 Go | 📅 2026-09-05 - Kubernetes-native framework for test definition and execution.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,443 | 🐛 747 | 🌐 TypeScript | 📅 2026-09-02 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,347 | 🐛 569 | 🌐 TypeScript | 📅 2026-09-06 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,888 | 🐛 3,347 | 🌐 Go | 📅 2026-09-06 - Complete container management platform.
...
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,263 | 🐛 78 | 🌐 Go | 📅 2026-09-06 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
...
* [karpor](https://github.com/KusionStack/karpor) ⭐ 1,733 | 🐛 90 | 🌐 Go | 📅 2026-07-12 - Intelligence for Kubernetes. World's most promising Kubernetes Visualization Tool for Developer and Platform Engineering teams.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 132 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-06 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,409 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-04 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,661 | 🐛 54 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
* [kubernetes-handbook](https://github.com/rootsongjc/kubernetes-handbook) ⭐ 11,617 | 🐛 1 | 🌐 Mermaid | 📅 2025-12-26 - Kubernetes 中文指南/云原生应用架构实践手册。
