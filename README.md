...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 197,742 | 🐛 2,928 | 🌐 C++ | 📅 2026-08-27 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,629 | 🐛 17,370 | 🌐 Python | 📅 2026-08-27 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,260 | 🐛 253 | 🌐 Python | 📅 2026-08-26 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,063 | 🐛 1,506 | 🌐 C++ | 📅 2026-08-27 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [kserve](https://github.com/kserve/kserve) ⭐ 5,837 | 🐛 203 | 🌐 Go | 📅 2026-08-27 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 57,419 | 🐛 4,875 | 🌐 Python | 📅 2026-08-27 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,049 | 🐛 189 | 🌐 Lua | 📅 2026-08-16 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,043 | 🐛 250 | 🌐 Lua | 📅 2026-08-27 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,807 | 🐛 498 | 🌐 Go | 📅 2026-08-27 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,218 | 🐛 1,082 | 🌐 Go | 📅 2026-08-27 - Next-generation Cloud Native Gateway.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 2,993 | 🐛 761 | 🌐 Go | 📅 2026-08-27 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,151 | 🐛 109 | 🌐 Go | 📅 2026-08-27 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [sbproxy](https://github.com/soapbucket/sbproxy) ⭐ 51 | 🐛 1 | 🌐 Rust | 📅 2026-08-27 - Single-binary AI gateway and reverse proxy with 103+ LLM providers, cost-based routing, rate limiting, and declarative YAML configuration.

## Continuous Delivery & GitOps

* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,554 | 🐛 1,912 | 🌐 Go | 📅 2026-08-27 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,146 | 🐛 102 | 🌐 Go | 📅 2026-08-27 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,178 | 🐛 456 | 🌐 Go | 📅 2026-08-25 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 29,952 | 🐛 321 | 🌐 Go | 📅 2026-08-27 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,506 | 🐛 3,611 | 🌐 Java | 📅 2026-08-27 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,618 | 🐛 2,450 | 🌐 Go | 📅 2026-08-27 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 24,013 | 🐛 4,407 | 🌐 Go | 📅 2026-08-27 - Declarative continuous deployment for Kubernetes.
...
* [dagger](https://github.com/dagger/dagger) ⭐ 16,205 | 🐛 140 | 🌐 Go | 📅 2026-08-27 - A programmable CI/CD engine that runs your pipelines in containers.
* [skaffold](https://github.com/GoogleContainerTools/skaffold) ⭐ 15,889 | 🐛 903 | 🌐 Go | 📅 2026-08-27 - Easy and Repeatable Kubernetes Development.
...
* [kustomize](https://github.com/kubernetes-sigs/kustomize) ⭐ 12,146 | 🐛 188 | 🌐 Go | 📅 2026-08-27 - Customization of kubernetes YAML configurations.
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 11,981 | 🐛 187 | 🌐 Go | 📅 2026-08-27 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,591 | 🐛 1,834 | 🌐 TypeScript | 📅 2026-08-27 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,618 | 🐛 21 | 🌐 Go | 📅 2026-08-27 - Go from Docker Compose to Kubernetes.
* [tilt](https://github.com/tilt-dev/tilt) ⭐ 10,022 | 🐛 509 | 🌐 Go | 📅 2026-08-27 - A multi-service dev environment for teams on Kubernetes.
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,778 | 🐛 108 | 🌐 Java | 📅 2026-08-27 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,050 | 🐛 566 | 🌐 Go | 📅 2026-08-27 - A cloud-native Pipeline resource.
* [ko](https://github.com/ko-build/ko) ⭐ 8,512 | 🐛 56 | 🌐 Go | 📅 2026-08-26 - Build and deploy Go applications on Kubernetes.
* [spec](https://github.com/score-spec/spec) ⭐ 8,088 | 🐛 12 | 🌐 Makefile | 📅 2026-07-27 - The score specification file.
* [kubevela](https://github.com/oam-dev/kubevela) ⭐ 7,889 | 🐛 276 | 🌐 Go | 📅 2026-08-27 - Make shipping applications more enjoyable.
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,762 | 🐛 365 | 🌐 Go | 📅 2026-08-27 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
...
* [helm-dashboard](https://github.com/komodorio/helm-dashboard) ⭐ 5,747 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-10 - The missing UI for Helm - visualize your releases.
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,590 | 🐛 766 | 🌐 Go | 📅 2026-08-24 - Software Delivery Workflow For Kubernetes
...
* [cds](https://github.com/ovh/cds) ⭐ 4,837 | 🐛 159 | 🌐 Go | 📅 2026-08-27 - Enterprise-Grade Continuous Delivery & DevOps Automation Open Source Platform.
...
* [werf](https://github.com/werf/werf) ⭐ 4,717 | 🐛 29 | 🌐 Go | 📅 2026-08-27 - The CLI tool gluing Git, Docker, Helm, and Kubernetes with any CI system to implement CI/CD and Giterminism.
* [jx](https://github.com/jenkins-x/jx) ⭐ 4,690 | 🐛 147 | 🌐 Go | 📅 2026-08-10 - A command line tool for installing and working with Jenkins X.
...
* [spegel](https://github.com/spegel-org/spegel) ⭐ 3,753 | 🐛 24 | 🌐 Go | 📅 2026-08-25 - Stateless cluster local OCI registry mirror.
...
* [kargo](https://github.com/akuity/kargo) ⭐ 3,605 | 🐛 174 | 🌐 Go | 📅 2026-08-27 - Application lifecycle orchestration.
* [argo-rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,561 | 🐛 658 | 🌐 Go | 📅 2026-08-27 - Progressive delivery controller for blue-green, canary, and experiments on Kubernetes.
* [zadig](https://github.com/koderover/zadig) ⭐ 3,235 | 🐛 25 | 🌐 Go | 📅 2026-08-27 - Zadig is a cloud native, distributed, developer-oriented continuous delivery product.
* [spec](https://github.com/oam-dev/spec) ⭐ 3,174 | 🐛 114 | 📅 2026-08-21 - The Open Application Model specification.
...
* [source-to-image](https://github.com/openshift/source-to-image) ⭐ 2,543 | 🐛 27 | 🌐 Go | 📅 2026-08-27 - A tool for building/building artifacts from source and injecting into docker images.
* [kcl](https://github.com/kcl-lang/kcl) ⭐ 2,404 | 🐛 75 | 🌐 Rust | 📅 2026-08-27 - KCL is a constraint-based record & functional language mainly used in configuration and policy scenarios. (CNCF Sandbox Project).
...
* [timoni](https://github.com/stefanprodan/timoni) ⭐ 2,007 | 🐛 35 | 🌐 Go | 📅 2026-08-26 - Timoni is a package manager for Kubernetes, powered by CUE and inspired by Helm.
...
* [kpt](https://github.com/GoogleContainerTools/kpt) ⭐ 1,890 | 🐛 343 | 🌐 Go | 📅 2026-08-26 - Kpt is a toolkit to help you manage, manipulate, customize, and apply Kubernetes Resource configuration data files.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,665 | 🐛 331 | 🌐 Go | 📅 2026-08-27 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [helmsman](https://github.com/Praqma/helmsman) ⭐ 1,495 | 🐛 1 | 🌐 Go | 📅 2026-08-26 - Helm Charts as Code.
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,429 | 🐛 45 | 🌐 Go | 📅 2026-08-20 - OpenTofu / Terraform / Terragrunt and Atmos version manager.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,345 | 🐛 222 | 🌐 Go | 📅 2026-08-27 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
...
* [kapp](https://github.com/carvel-dev/kapp) ⭐ 1,077 | 🐛 128 | 🌐 Go | 📅 2026-08-25 - kapp is a simple deployment tool focused on the concept of "Kubernetes application" — a set of resources with the same label.
...
* [screwdriver](https://github.com/screwdriver-cd/screwdriver) ⭐ 1,045 | 🐛 58 | 🌐 JavaScript | 📅 2026-08-26 - An open source build platform designed for continuous delivery.
...
* [beetle](https://github.com/Clivern/Beetle) ⭐ 167 | 🐛 16 | 🌐 Go | 📅 2026-08-26 - Kubernetes multi-cluster deployment automation service.
...
* [qovery](https://github.com/Qovery/qovery-skills) ⭐ 9 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 - Enterprise Kubernetes management platform for deploying applications, databases, Helm charts, and Terraform modules on AWS, GCP, Azure, and Scaleway. Includes Terraform provider, CLI, API, and AI Agent Skill.
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,769 | 🐛 316 | 🌐 Go | 📅 2026-08-27 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,219 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,195 | 🐛 89 | 🌐 Go | 📅 2026-08-26 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,491 | 🐛 388 | 🌐 Go | 📅 2026-08-27 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [kuberlr](https://github.com/flavio/kuberlr) ⭐ 142 | 🐛 12 | 🌐 Go | 📅 2026-08-26 - A tool that simplifies the management of multiple versions of kubectl.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,482 | 🐛 831 | 🌐 Python | 📅 2026-08-27 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,767 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-27 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,371 | 🐛 164 | 🌐 Go | 📅 2026-08-23 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,268 | 🐛 188 | 🌐 Go | 📅 2026-08-27 - Enforce Kubernetes admission policies using Open Policy Agent constraints.
...
* [pluto](https://github.com/FairwindsOps/pluto) ⭐ 2,570 | 🐛 13 | 🌐 Go | 📅 2026-08-27 - A cli tool to help discover deprecated apiVersions in Kubernetes.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,247 | 🐛 39 | 🌐 Python | 📅 2026-08-27 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 233 | 🐛 134 | 🌐 Rust | 📅 2026-08-27 - Policy as code for Kubernetes powered by WebAssembly modules.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 32,071 | 🐛 544 | 🌐 Go | 📅 2026-08-26 - Run Kubernetes locally.
...
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,704 | 🐛 202 | 🌐 Jinja | 📅 2026-08-21 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,326 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-27 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,669 | 🐛 137 | 🌐 Go | 📅 2026-08-27 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
...
* [talos](https://github.com/talos-systems/talos) ⭐ 11,033 | 🐛 225 | 🌐 Go | 📅 2026-08-27 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,359 | 🐛 166 | 🌐 Python | 📅 2026-08-27 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,213 | 🐛 91 | 🌐 Go | 📅 2026-08-27 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,289 | 🐛 220 | 🌐 Go | 📅 2026-08-27 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 3,998 | 🐛 38 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,432 | 🐛 202 | 🌐 Go | 📅 2026-08-27 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
* [cloudpods](https://github.com/yunionio/cloudpods) ⭐ 2,936 | 🐛 211 | 🌐 Go | 📅 2026-08-27 - A cloud-native open-source unified multi-cloud and hybrid-cloud platform.
...
* [fleet](https://github.com/rancher/fleet) ⭐ 1,725 | 🐛 193 | 🌐 Go | 📅 2026-08-27 - Manage large fleets of Kubernetes clusters.
...
* [cluster-lifecycle-manager](https://github.com/zalando-incubator/cluster-lifecycle-manager) ⭐ 248 | 🐛 20 | 🌐 Go | 📅 2026-08-27 - Cluster Lifecycle Manager (CLM) to provision and update multiple Kubernetes clusters.
...
* [client-go](https://github.com/kubernetes/client-go) ⭐ 9,869 | 🐛 0 | 🌐 Go | 📅 2026-08-27 - Go client for Kubernetes.
...
* [devspace](https://github.com/devspace-cloud/devspace) ⭐ 5,155 | 🐛 77 | 🌐 Go | 📅 2026-08-17 - Cloud Native Software Development with Kubernetes and Docker - simply run "devspace up" in any of your projects and start coding directly on top of Kubernetes (works with minikube, self-hosted and cloud-based clusters).
...
* [kubernetes-client](https://github.com/fabric8io/kubernetes-client) ⭐ 3,670 | 🐛 104 | 🌐 Java | 📅 2026-08-27 - Java client for Kubernetes & OpenShift 3.
* [okteto](https://github.com/okteto/okteto) ⭐ 3,534 | 🐛 36 | 🌐 Go | 📅 2026-08-27 - Local development experience for Kubernetes apps.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,555 | 🐛 19 | 🌐 Rust | 📅 2026-08-27 - Manage and run multiple kubectl port-forward configurations directly in the menu bar, syncing configurations with git repositories.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,123 | 🐛 89 | 🌐 Go | 📅 2026-08-27 - Giving Kubernetes Superpowers to everyone.
...
* [robusta](https://github.com/robusta-dev/robusta) ⭐ 3,082 | 🐛 203 | 🌐 Python | 📅 2026-08-27 - Open source Kubernetes troubleshooting and automation platform.
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,078 | 🐛 19 | 🌐 Go | 📅 2026-08-27 - Tools for observing Kubernetes resources in real time, powered by Pulumi.
...
* [cri-tools](https://github.com/kubernetes-sigs/cri-tools) ⭐ 2,009 | 🐛 17 | 🌐 Go | 📅 2026-08-27 - CLI and validation tools for Kubelet Container Runtime Interface (CRI).
...
* [kubeletctl](https://github.com/cyberark/kubeletctl) ⭐ 904 | 🐛 6 | 🌐 Go | 📅 2025-08-06 - A client for kubelet.
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,017 | 🐛 125 | 🌐 Go | 📅 2026-08-27 - Test infrastructure for the Kubernetes project.
* [kwok](https://github.com/kubernetes-sigs/kwok) ⭐ 3,178 | 🐛 31 | 🌐 Go | 📅 2026-08-25 - Kubernetes WithOut Kubelet - Simulates thousands of Nodes and Clusters.
...
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 213 | 🐛 163 | 🌐 Python | 📅 2026-08-27 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
* [seaworthy](https://github.com/cakehappens/seaworthy) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2020-08-10 - A CLI to verify Kubernetes resource health.

## Data Protection & Backup

* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,256 | 🐛 830 | 🌐 Go | 📅 2026-08-27 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [karpenter](https://github.com/aws/karpenter) ⭐ 7,708 | 🐛 497 | 🌐 Go | 📅 2026-08-27 - Kubernetes Node Autoscaling: built for flexibility, performance, and scalability.
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,706 | 🐛 296 | 🌐 Go | 📅 2026-08-26 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,706 | 🐛 296 | 🌐 Go | 📅 2026-08-26 - Kubernetes cost monitoring powered by open allocation models.
...
* [dragonfly2](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,311 | 🐛 29 | 🌐 Go | 📅 2026-08-27 - Dragonfly is an intelligent P2P based file distribution system.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 28,994 | 🐛 1,139 | 🌐 JavaScript | 📅 2026-08-27 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,124 | 🐛 2,916 | 🌐 C | 📅 2026-08-27 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,765 | 🐛 716 | 🌐 TypeScript | 📅 2026-08-27 - The Open Source Airtable alternative.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 52,191 | 🐛 329 | 🌐 Go | 📅 2026-08-27 - Distributed reliable key-value store for the most critical data of a distributed system.
* [milvus](https://github.com/milvus-io/milvus) ⭐ 45,832 | 🐛 1,327 | 🌐 Go | 📅 2026-08-27 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,476 | 🐛 6,841 | 🌐 Go | 📅 2026-08-27 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,366 | 🐛 402 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,428 | 🐛 8,344 | 🌐 Go | 📅 2026-08-26 - CockroachDB - the open source, cloud-native SQL database.
...
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,510 | 🐛 32 | 🌐 C++ | 📅 2026-08-27 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,994 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,431 | 🐛 398 | 🌐 C | 📅 2026-08-27 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,790 | 🐛 215 | 🌐 Java | 📅 2026-08-27 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,815 | 🐛 1,797 | 🌐 Rust | 📅 2026-08-27 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,266 | 🐛 832 | 🌐 C++ | 📅 2026-08-27 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
* [nebula](https://github.com/vesoft-inc/nebula) ⭐ 12,366 | 🐛 678 | 🌐 C++ | 📅 2026-05-18 - A distributed, fast open-source graph database featuring horizontal scalability and high availability.
* [oceanbase](https://github.com/oceanbase/oceanbase) ⭐ 10,256 | 🐛 585 | 🌐 C++ | 📅 2026-08-27 - A distributed, banking suitable, open-source related database featuring high scalability and high compatibility.
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,424 | 🐛 567 | 🌐 Rust | 📅 2026-08-27 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 6,991 | 🐛 146 | 🌐 Go | 📅 2026-08-27 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
* [couchdb](https://github.com/apache/couchdb) ⭐ 6,943 | 🐛 368 | 🌐 Erlang | 📅 2026-08-27 - Apache CouchDB is one of a new breed of database management systems.
...
* [polardb-for-postgresql](https://github.com/alibaba/PolarDB-for-PostgreSQL) ⭐ 3,195 | 🐛 65 | 🌐 C | 📅 2026-08-27 - PolarDB for PostgreSQL (PolarDB for short) is an open source database system based on PostgreSQL.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,114 | 🐛 255 | 🌐 Go | 📅 2026-08-27 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,245 | 🐛 862 | 🌐 Go | 📅 2026-08-27 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,266 | 🐛 1,097 | 🌐 Go | 📅 2026-08-27 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 16,971 | 🐛 1,298 | 🌐 C++ | 📅 2026-08-27 - Ceph is a distributed object, block, and file storage platform.
...
* [rook](https://github.com/rook/rook) ⭐ 13,616 | 🐛 128 | 🌐 Go | 📅 2026-08-27 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,805 | 🐛 38 | 📅 2026-08-27 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
* [fastdfs](https://github.com/happyfish100/fastdfs) ⭐ 9,251 | 🐛 466 | 🌐 C | 📅 2026-08-23 - FastDFS is an open source high performance distributed file system (DFS). It's major functions include: file storing, file syncing and file accessing, and design for high capacity and load balance.
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,941 | 🐛 1,879 | 🌐 Shell | 📅 2026-08-26 - We put storage on cows and move them around from rancher.
* [chubaofs](https://github.com/chubaofs/chubaofs) ⭐ 5,637 | 🐛 268 | 🌐 Go | 📅 2026-08-24 - A distributed storage system for cloud native applications.
* [glusterfs](https://github.com/gluster/glusterfs) ⭐ 5,220 | 🐛 283 | 🌐 C | 📅 2026-08-25 - Gluster is a software defined distributed storage that can scale to several petabytes. It provides interfaces for object, block and file storage.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,664 | 🐛 87 | 🌐 Go | 📅 2026-08-27 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,404 | 🐛 75 | 🌐 Go | 📅 2026-08-27 - OCI registry client, managing content like artifacts, images, packages.
...
* [zenko](https://github.com/scality/Zenko) ⭐ 672 | 🐛 22 | 🌐 Gherkin | 📅 2026-08-26 - Because everyone should be in control of their data.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,637 | 🐛 525 | 🌐 Java | 📅 2026-08-27 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,774 | 🐛 77 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,572 | 🐛 580 | 🌐 Java | 📅 2026-08-26 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,614 | 🐛 542 | 🌐 Go | 📅 2026-08-27 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,664 | 🐛 166 | 🌐 Erlang | 📅 2026-08-27 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,316 | 🐛 1,738 | 🌐 Java | 📅 2026-08-27 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,581 | 🐛 56 | 🌐 Java | 📅 2026-08-27 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [flume](https://github.com/apache/flume) ⭐ 2,568 | 🐛 79 | 🌐 Java | 📅 2026-08-25 - Apache Flume is a distributed, reliable, and available service for efficiently collecting, aggregating, and moving large amounts of log data.
* [eventmesh](https://github.com/WeBankFinTech/EventMesh) ⭐ 1,747 | 🐛 270 | 🌐 Java | 📅 2026-08-27 - EventMesh is a dynamic cloud-native eventing infrastructure used to decouple the application and backend middleware layer, which supports a wide range of use cases that encompass complex multi-cloud, widely distributed topologies using diverse technology stacks.
...
* [istio](https://github.com/istio/istio) ⭐ 38,362 | 🐛 512 | 🌐 Go | 📅 2026-08-27 - Connect, secure, control, and observe services.
...
* [linkerd2](https://github.com/linkerd/linkerd2) ⭐ 11,482 | 🐛 207 | 🌐 Go | 📅 2026-08-27 - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,995 | 🐛 154 | 🌐 Go | 📅 2026-08-27 - Universal Control Plane for your Service Mesh.
...
* [apollo](https://github.com/ctripcorp/apollo) ⭐ 29,804 | 🐛 158 | 🌐 Java | 📅 2026-08-22 - Apollo（阿波罗）是携程框架部门研发的分布式配置中心，能够集中化管理应用不同环境、不同集群的配置，配置修改后能够实时推送到应用端，并且具备规范的权限、流程治理等特性，适用于微服务配置管理场景。
* [coredns](https://github.com/coredns/coredns) ⭐ 14,280 | 🐛 293 | 🌐 Go | 📅 2026-08-27 - CoreDNS is a DNS server that chains middleware.
...
* [clusterpedia](https://github.com/clusterpedia-io/clusterpedia) ⭐ 883 | 🐛 61 | 🌐 Go | 📅 2026-08-26 - Clusterpedia is used for complex resource searches across multiple clusters, support simultaneous search of a single kind of resource or multiple kinds of resources existing in multiple clusters.
...
* [pingora](https://github.com/cloudflare/pingora) ⭐ 27,283 | 🐛 281 | 🌐 Rust | 📅 2026-08-25 - A library for building fast, reliable and evolvable network services.
* [cilium](https://github.com/cilium/cilium) ⭐ 25,017 | 🐛 1,092 | 🌐 Go | 📅 2026-08-27 - API-aware Networking and Security using eBPF and XDP.
* [flannel](https://github.com/coreos/flannel) ⭐ 9,522 | 🐛 27 | 🌐 Go | 📅 2026-08-27 - Flannel is a network fabric for containers, designed for Kubernetes.
...
* [ziti](https://github.com/openziti/ziti) ⭐ 4,360 | 🐛 279 | 🌐 Go | 📅 2026-08-27 - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network.
...
* [submariner](https://github.com/submariner-io/submariner) ⭐ 2,686 | 🐛 25 | 🌐 Go | 📅 2026-08-27 - Connect all your Kubernetes clusters, no matter where they are in the world.
...
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,394 | 🐛 66 | 🌐 Go | 📅 2026-08-27 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,808 | 🐛 195 | 🌐 Go | 📅 2026-08-27 - Antrea is a Kubernetes networking based on Open vSwitch.
...
* [spiderpool](https://github.com/spidernet-io/spiderpool) ⭐ 673 | 🐛 107 | 🌐 Go | 📅 2026-08-25 - Underlay and RDMA network solution of the Kubernetes, for bare metal, VM and any public cloud.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,255 | 🐛 267 | 🌐 Go | 📅 2026-08-25 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,622 | 🐛 913 | 🌐 Go | 📅 2026-08-27 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,506 | 🐛 469 | 🌐 C | 📅 2026-08-26 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,828 | 🐛 1,869 | 🌐 C++ | 📅 2026-08-27 - C++ front/service proxy.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15,405 | 🐛 537 | 🌐 Go | 📅 2026-08-27 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,812 | 🐛 383 | 🌐 C | 📅 2026-08-26 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,304 | 🐛 0 | 🌐 C | 📅 2026-08-27 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,070 | 🐛 241 | 🌐 Go | 📅 2026-08-27 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [contour](https://github.com/projectcontour/contour) ⭐ 3,945 | 🐛 127 | 🌐 HTML | 📅 2026-08-27 - Contour is a Kubernetes ingress controller for Lyft's Envoy proxy.
* [skipper](https://github.com/zalando/skipper) ⭐ 3,319 | 🐛 306 | 🌐 Go | 📅 2026-08-27 - An HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress.
* [kong/kubernetes-ingress-controller](https://github.com/Kong/kubernetes-ingress-controller) ⭐ 2,408 | 🐛 277 | 🌐 Go | 📅 2026-08-27 - Deploy Kong in a native Kubernetes Ingress Controller.
...
* [apisix-ingress-controller](https://github.com/apache/apisix-ingress-controller) ⭐ 1,143 | 🐛 46 | 🌐 Go | 📅 2026-08-27 - Ingress controller for K8s.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,596 | 🐛 463 | 🌐 C++ | 📅 2026-08-27 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,954 | 🐛 17 | 🌐 C++ | 📅 2026-08-27 - Apache thrift.
...
* [proxygen](https://github.com/facebook/proxygen) ⭐ 8,376 | 🐛 39 | 🌐 C++ | 📅 2026-08-27 - A collection of C++ HTTP libraries including an easy to use HTTP server.
* [kitex](https://github.com/cloudwego/kitex) ⭐ 8,027 | 🐛 71 | 🌐 Go | 📅 2026-08-27 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices.
...
* [moby](https://github.com/moby/moby) ⭐ 72,004 | 🐛 3,903 | 🌐 Go | 📅 2026-08-27 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,709 | 🐛 1,141 | 🌐 Go | 📅 2026-08-27 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,770 | 🐛 536 | 🌐 Go | 📅 2026-08-27 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,205 | 🐛 454 | 🌐 Go | 📅 2026-08-27 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,170 | 🐛 832 | 🌐 Go | 📅 2026-08-27 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 6,995 | 🐛 62 | 🌐 Go | 📅 2026-08-27 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
...
* [wazero](https://github.com/tetratelabs/wazero) ⭐ 6,347 | 🐛 40 | 🌐 Go | 📅 2026-08-24 - The zero dependency WebAssembly runtime for Go developers.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,076 | 🐛 604 | 🌐 C | 📅 2026-08-26 - WebAssembly Micro Runtime (WAMR).
...
* [crun](https://github.com/containers/crun) ⭐ 4,085 | 🐛 56 | 🌐 C | 📅 2026-08-25 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,422 | 🐛 61 | 🌐 Rust | 📅 2026-08-27 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
* [hyperd](https://github.com/hyperhq/hyperd) ⚠️ Archived - HyperContainer Daemon.
* [kuasar](https://github.com/kuasar-io/kuasar) ⭐ 1,445 | 🐛 29 | 🌐 Rust | 📅 2026-06-05 - An efficient container runtime that provides cloud-native, all-scenario multiple sandbox container solutions.
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,415 | 🐛 262 | 🌐 Go | 📅 2026-08-25 - OpenChoreo is a developer platform for Kubernetes.
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,331 | 🐛 66 | 🌐 Rust | 📅 2026-08-27 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,305 | 🐛 2,975 | 🌐 Go | 📅 2026-08-27 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,067 | 🐛 104 | 🌐 Go | 📅 2026-08-27 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,951 | 🐛 324 | 🌐 Go | 📅 2026-08-27 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
* [serf](https://github.com/hashicorp/serf) ⭐ 6,069 | 🐛 108 | 🌐 Go | 📅 2026-08-27 - Service orchestration and management tool by hashicorp.
* [deis](https://github.com/deis/deis) ⚠️ Archived - Deis v1, the CoreOS and Docker PaaS: Your PaaS. Your Rules.
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,902 | 🐛 803 | 🌐 Go | 📅 2026-08-27 - A Kubernetes Native Batch System (Project under CNCF).
* [swarm](https://github.com/docker/classicswarm) ⚠️ Archived - Swarm: a Docker-native clustering system.
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,577 | 🐛 845 | 🌐 Go | 📅 2026-08-27 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
* [descheduler](https://github.com/kubernetes-sigs/descheduler) ⭐ 5,498 | 🐛 61 | 🌐 Go | 📅 2026-08-25 - Descheduler for Kubernetes.
...
* [kruise](https://github.com/openkruise/kruise) ⭐ 5,326 | 🐛 81 | 🌐 Go | 📅 2026-08-27 - Automate application workloads management on Kubernetes.
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,449 | 🐛 48 | 🌐 Go | 📅 2026-08-27 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,910 | 🐛 727 | 🌐 Go | 📅 2026-08-27 - Kubernetes-native Job Queueing.
* [kcp](https://github.com/kcp-dev/kcp) ⭐ 2,815 | 🐛 150 | 🌐 Go | 📅 2026-08-27 - Multi-tenant control plane for running many virtual Kubernetes clusters.
* [fleet](https://github.com/coreos/fleet) ⚠️ Archived - Fleet ties together systemd and etcd into a distributed init system.
* [koordinator](https://github.com/koordinator-sh/koordinator) ⭐ 1,746 | 🐛 309 | 🌐 Go | 📅 2026-08-27 - QoS based scheduling system for hybrid orchestration workloads on Kubernetes, bringing workloads the best layout and status.
...
* [ocm](https://github.com/open-cluster-management-io/OCM) ⭐ 1,081 | 🐛 52 | 🌐 Go | 📅 2026-08-27 - The open-cluster-management.io project is focused on enabling end-to-end visibility and control across your Kubernetes clusters.
...
* [serverless](https://github.com/serverless/serverless) ⭐ 46,919 | 🐛 1,216 | 🌐 JavaScript | 📅 2026-08-27 - Serverless Framework – Build web, mobile and IoT applications with serverless architectures using AWS Lambda, Azure Functions, Google CloudFunctions & more!
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,326 | 🐛 105 | 🌐 Rust | 📅 2026-08-27 - Secure and fast microVMs for serverless computing.
* [openfaas](https://github.com/openfaas/faas) ⭐ 26,230 | 🐛 31 | 🌐 Go | 📅 2026-07-02 - OpenFaaS - Serverless Functions Made Simple for Docker & Kubernetes.
* [dapr](https://github.com/dapr/dapr) ⭐ 26,038 | 🐛 432 | 🌐 Go | 📅 2026-08-27 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
...
* [keda](https://github.com/kedacore/keda) ⭐ 10,472 | 🐛 244 | 🌐 Go | 📅 2026-08-27 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
* [fission](https://github.com/fission/fission) ⭐ 8,913 | 🐛 52 | 🌐 Go | 📅 2026-08-27 - Fast Serverless Functions for Kubernetes.
...
* [serving](https://github.com/knative/serving) ⭐ 6,086 | 🐛 163 | 🌐 Go | 📅 2026-08-25 - Kubernetes-based, scale-to-zero, request-driven compute.
...
* [eventing](https://github.com/knative/eventing) ⭐ 1,551 | 🐛 95 | 🌐 Go | 📅 2026-08-26 - Open source specification and implementation of Knative event binding and delivery.
* [layotto](https://github.com/mosn/layotto) ⭐ 853 | 🐛 49 | 🌐 Go | 📅 2026-08-27 - A fast and efficient cloud native application runtime.
...
* [prometheus-operator](https://github.com/coreos/prometheus-operator) ⭐ 9,975 | 🐛 310 | 🌐 Go | 📅 2026-08-27 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes.
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,295 | 🐛 74 | 🌐 Go | 📅 2026-08-27 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
* [operator-sdk](https://github.com/operator-framework/operator-sdk) ⭐ 7,674 | 🐛 70 | 🌐 Go | 📅 2026-08-24 - SDK for building Kubernetes applications. Provides high level APIs, useful abstractions, and project scaffolding.
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,031 | 🐛 577 | 🌐 Go | 📅 2026-08-27 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,917 | 🐛 154 | 🌐 Java | 📅 2026-08-27 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,150 | 🐛 113 | 🌐 Python | 📅 2026-08-27 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
...
* [kaito](https://github.com/Azure/kaito) ⭐ 1,004 | 🐛 63 | 🌐 Go | 📅 2026-08-27 - Kubernetes AI Toolchain Operator.
* [k0smotron](https://github.com/k0sproject/k0smotron) ⭐ 739 | 🐛 54 | 🌐 Go | 📅 2026-08-26 - k0smotron is a powerful open-source tool for the efficient management of k0s Kubernetes clusters.
...
* [gateway-operator](https://github.com/kong/gateway-operator) ⭐ 108 | 🐛 202 | 🌐 Go | 📅 2026-08-27 - Kong Gateway Operator is a Kubernetes Operator that can manage your Kong Ingress Controller, Kong Gateway Data Planes, or both together when running on Kubernetes.
...
* [kubeedge](https://github.com/kubeedge/kubeedge) ⭐ 7,559 | 🐛 1,281 | 🌐 Go | 📅 2026-08-26 - Kubernetes Native Edge Computing Framework (project under CNCF).
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,454 | 🐛 206 | 🌐 Go | 📅 2026-08-27 - Zero Friction Kubernetes.
* [openyurt](https://github.com/openyurtio/openyurt) ⭐ 2,000 | 🐛 126 | 🌐 Go | 📅 2026-08-24 - Extending your native Kubernetes to edge(project under CNCF).
...
* [kairos](https://github.com/kairos-io/kairos) ⭐ 1,810 | 🐛 287 | 🌐 Go | 📅 2026-08-27 - The immutable Linux meta-distribution for edge Kubernetes.
* [iotedge](https://github.com/Azure/iotedge) ⭐ 1,509 | 🐛 95 | 🌐 C# | 📅 2026-08-26 - The IoT Edge OSS project.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,456 | 🐛 3,316 | 🌐 TypeScript | 📅 2026-08-27 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,860 | 🐛 888 | 🌐 Go | 📅 2026-08-27 - The Prometheus monitoring system and time series database.
* [kibana](https://github.com/elastic/kibana) ⭐ 21,265 | 🐛 14,292 | 🌐 TypeScript | 📅 2026-08-27 - Kibana analytics and search dashboard for Elasticsearch.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,603 | 🐛 780 | 🌐 Go | 📅 2026-08-27 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,060 | 🐛 149 | 🌐 Go | 📅 2026-08-27 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
...
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,461 | 🐛 697 | 🌐 Go | 📅 2026-08-27 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
...
* [cortex](https://github.com/cortexproject/cortex) ⭐ 5,856 | 🐛 356 | 🌐 Go | 📅 2026-08-27 - A multitenant, horizontally scalable Prometheus as a Service.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,957 | 🐛 266 | 🌐 C | 📅 2026-08-27 - eBPF-based Security Observability and Runtime Enforcement.
* [parca](https://github.com/parca-dev/parca) ⭐ 4,953 | 🐛 204 | 🌐 TypeScript | 📅 2026-08-27 - Continuous profiling for analysis of CPU and memory usage, down to the line number and throughout time. Saving infrastructure cost, improving performance, and increasing reliability.
* [deepflow](https://github.com/deepflowys/deepflow) ⭐ 4,245 | 🐛 268 | 🌐 Go | 📅 2026-08-27 - A highly automated observability platform.
* [metaflow](https://github.com/metaflowys/metaflow) ⭐ 4,245 | 🐛 268 | 🌐 Go | 📅 2026-08-27 - MetaFlow is an automated observability platform for cloud-native developers.
...
* [kiali](https://github.com/kiali/kiali) ⭐ 3,633 | 🐛 74 | 🌐 Go | 📅 2026-08-27 - Kiali project to help istio service mesh observability.
* [open-falcon](https://github.com/XiaoMi/open-falcon) ⭐ 3,020 | 🐛 32 | 📅 2018-07-05 - Enterprise Internet monitoring system from Xiaomi.
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,913 | 🐛 429 | 🌐 C | 📅 2026-08-27 - The eBPF tool and systems inspection framework for Kubernetes, containers and Linux hosts.
* [goldpinger](https://github.com/bloomberg/goldpinger) ⭐ 2,735 | 🐛 36 | 🌐 JavaScript | 📅 2026-04-23 - Debugging tool for Kubernetes which tests and displays connectivity between nodes in the cluster.
...
* [perses](https://github.com/perses/perses) ⭐ 2,379 | 🐛 263 | 🌐 Go | 📅 2026-08-27 - The CNCF candidate for observability visualisation.
...
* [kepler](https://github.com/sustainable-computing-io/kepler) ⭐ 1,560 | 🐛 47 | 🌐 Go | 📅 2026-08-27 - Kepler (Kubernetes-based Efficient Power Level Exporter) uses eBPF to probe performance counters and other system stats, use ML models to estimate workload energy consumption based on these stats, and exports them as Prometheus metrics.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,874 | 🐛 5,928 | 🌐 Java | 📅 2026-08-27 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,794 | 🐛 1,727 | 🌐 Go | 📅 2026-08-27 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,469 | 🐛 2,518 | 🌐 Rust | 📅 2026-08-27 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,773 | 🐛 424 | 🌐 Go | 📅 2026-08-26 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,580 | 🐛 136 | 🌐 Ruby | 📅 2026-08-24 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,640 | 🐛 1,041 | 🌐 Go | 📅 2026-08-27 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,551 | 🐛 804 | 🌐 Rust | 📅 2026-08-27 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,064 | 🐛 785 | 🌐 C | 📅 2026-08-27 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,629 | 🐛 2,223 | 🌐 Python | 📅 2026-08-27 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,931 | 🐛 42 | 🌐 Java | 📅 2026-08-26 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,146 | 🐛 553 | 🌐 Go | 📅 2026-08-27 - Jaeger, a Distributed Tracing System.
* [zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,455 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - Zipkin is a distributed tracing system.
* [pinpoint](https://github.com/naver/pinpoint) ⭐ 13,861 | 🐛 535 | 🌐 Java | 📅 2026-08-27 - Pinpoint is an open source APM (Application Performance Management) tool for large-scale distributed systems written in Java.
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,326 | 🐛 479 | 🌐 Makefile | 📅 2026-08-27 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,659 | 🐛 261 | 🌐 Go | 📅 2026-08-27 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
...
* [vault](https://github.com/hashicorp/vault) ⭐ 36,182 | 🐛 1,431 | 🌐 Go | 📅 2026-08-27 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,856 | 🐛 3,342 | 🌐 Go | 📅 2026-08-26 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
* [supertokens-core](https://github.com/supertokens/supertokens-core) ⭐ 15,287 | 🐛 173 | 🌐 Java | 📅 2026-08-27 - Open source alternative to Auth0 / Firebase Auth / AWS Cognito.
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,053 | 🐛 245 | 🌐 Go | 📅 2026-08-27 - Automatically provision and manage TLS certificates in Kubernetes.
* [kratos](https://github.com/ory/kratos) ⭐ 13,851 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication, MFA, FIDO2, profile management, identity schemas, social sign in, registration, account recovery, service-to-service and IoT auth. Can work as an OAuth2 / OpenID Connect Provider. Golang, headless, API-only - without templating or theming headaches.
* [grype](https://github.com/anchore/grype) ⭐ 12,792 | 🐛 402 | 🌐 Go | 📅 2026-08-27 - A vulnerability scanner for container images and filesystems.
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,171 | 🐛 334 | 🌐 Go | 📅 2026-08-27 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,695 | 🐛 63 | 🌐 Go | 📅 2026-08-27 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
* [dex](https://github.com/dexidp/dex) ⭐ 11,067 | 🐛 532 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors.
...
* [syft](https://github.com/anchore/syft) ⭐ 9,465 | 🐛 627 | 🌐 Go | 📅 2026-08-27 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,310 | 🐛 64 | 🌐 C++ | 📅 2026-08-03 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,043 | 🐛 395 | 🌐 Elixir | 📅 2026-08-27 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,973 | 🐛 167 | 🌐 Python | 📅 2026-08-27 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,157 | 🐛 95 | 🌐 Go | 📅 2026-08-24 - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices.
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,077 | 🐛 644 | 🌐 Go | 📅 2026-08-27 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,811 | 🐛 264 | 🌐 Go | 📅 2026-08-27 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,260 | 🐛 172 | 🌐 Go | 📅 2026-08-24 - Container signing, verification, and provenance powered by Sigstore.
...
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,979 | 🐛 152 | 🌐 Go | 📅 2026-08-27 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,767 | 🐛 123 | 🌐 Go | 📅 2026-08-27 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [authenticator](https://github.com/kubernetes-sigs/aws-iam-authenticator) ⭐ 2,333 | 🐛 19 | 🌐 Go | 📅 2026-08-26 - A tool for using AWS IAM credentials to authenticate to a Kubernetes cluster.
...
* [spiffe](https://github.com/spiffe/spiffe) ⭐ 1,836 | 🐛 52 | 🌐 Shell | 📅 2026-08-27 - The SPIFFE Project.
* [cedar](https://github.com/cedar-policy/cedar) ⭐ 1,696 | 🐛 175 | 🌐 Rust | 📅 2026-08-27 - Core implementation of the Cedar language.
...
* [neuvector](https://github.com/neuvector/neuvector) ⭐ 1,330 | 🐛 308 | 🌐 Go | 📅 2026-08-27 - Kubernetes-native container security platform.
* [in-toto](https://github.com/in-toto/in-toto) ⭐ 1,032 | 🐛 61 | 🌐 Python | 📅 2026-08-27 - in-toto is a framework to protect supply chain integrity.
...
* [darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 875 | 🐛 2 | 🌐 Python | 📅 2026-08-25 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks, with a proof trail per finding.
...
* [trust-manager](https://github.com/cert-manager/trust-manager) ⭐ 394 | 🐛 42 | 🌐 Go | 📅 2026-08-27 - trust-manager is an operator for distributing trust bundles across a Kubernetes cluster.
...
* [brood-box](https://github.com/stacklok/brood-box) ⭐ 63 | 🐛 13 | 🌐 Go | 📅 2026-08-27 - CLI tool for running coding agents inside hardware-isolated microVMs with workspace snapshot isolation and egress control.
...
* [go-microvm](https://github.com/stacklok/go-microvm) ⭐ 22 | 🐛 12 | 🌐 Go | 📅 2026-08-27 - Go framework for running OCI images as microVMs via libkrun with embedded runtime, rootfs management, and guest networking.
...
* [chaosmonkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,091 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,475 | 🐛 1 | 🌐 Java | 📅 2026-08-10 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
...
* [chaos-mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,858 | 🐛 551 | 🌐 Go | 📅 2026-08-27 - A Chaos Engineering Platform for Kubernetes.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,508 | 🐛 365 | 🌐 Python | 📅 2026-08-25 - An easy to use and powerful chaos engineering experiment toolkit（阿里巴巴开源的一款简单易用、功能强大的混沌实验注入工具）.
...
* [concurrency-limits](https://github.com/Netflix/concurrency-limits) ⭐ 3,599 | 🐛 52 | 🌐 Java | 📅 2026-01-16 - Java Library that implements and integrates concepts from TCP congestion control to auto-detect concurrency limits to achieve optimal throughput with optimal latency.
* [ratelimit](https://github.com/envoyproxy/ratelimit) ⭐ 2,687 | 🐛 35 | 🌐 Go | 📅 2026-08-26 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,650 | 🐛 51 | 🌐 Go | 📅 2026-08-27 - Kubernetes-native framework for test definition and execution.
* [krkn](https://github.com/krkn-chaos/krkn) ⭐ 493 | 🐛 139 | 🌐 Python | 📅 2026-08-25 - Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,360 | 🐛 746 | 🌐 TypeScript | 📅 2026-08-27 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,274 | 🐛 410 | 🌐 TypeScript | 📅 2026-08-27 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,876 | 🐛 3,352 | 🌐 Go | 📅 2026-08-27 - Complete container management platform.
...
* [openshift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 314 | 🌐 Go | 📅 2026-08-27 - Enterprise Kubernetes for Developers.
* [rainbond](https://github.com/goodrain/rainbond) ⭐ 6,255 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - Serverless PaaS , A new generation of easy-to-use cloud management platforms based on kubernetes.
* [wayne](https://github.com/Qihoo360/wayne) ⭐ 3,700 | 🐛 61 | 🌐 TypeScript | 📅 2022-05-31 - Web UI for Kubernetes multi-clusters.
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,145 | 🐛 50 | 🌐 Go | 📅 2026-08-27 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
* [kubediagrams](https://github.com/philippemerle/KubeDiagrams) ⭐ 2,683 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-19 - A CLI tool to generate Kubernetes architecture diagrams automatically from Kubernetes manifest files, kustomization files, Helm charts, helmfile descriptors, and actual cluster state.
...
* [kubermatic](https://github.com/kubermatic/kubermatic) ⭐ 1,298 | 🐛 461 | 🌐 Go | 📅 2026-08-27 - The Central Kubernetes Management Platform For Any Infrastructure.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 129 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-27 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,696 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-21 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,562 | 🐛 54 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
* [kubernetes-handbook](https://github.com/rootsongjc/kubernetes-handbook) ⭐ 11,611 | 🐛 1 | 🌐 Mermaid | 📅 2025-12-26 - Kubernetes 中文指南/云原生应用架构实践手册。
...
* [kubernetes-on-aws](https://github.com/zalando-incubator/kubernetes-on-aws) ⭐ 635 | 🐛 38 | 🌐 Go | 📅 2026-08-27 - Deploying Kubernetes on AWS with CloudFormation and Ubuntu.
...
This website is hosted on GitHub Pages within [rootsongjc/awesome-cloud-native](https://github.com/rootsongjc/awesome-cloud-native) ⭐ 2,439 | 🐛 6 | 🌐 HTML | 📅 2026-08-24 repository.

Please take a quick gander at the **[contribution guidelines](https://github.com/rootsongjc/awesome-cloud-native/blob/main/CONTRIBUTING.md) ⭐ 2,439 | 🐛 6 | 🌐 HTML | 📅 2026-08-24** first. Thanks to all **[contributors](https://github.com/rootsongjc/awesome-cloud-native/graphs/contributors) ⭐ 2,439 | 🐛 6 | 🌐 HTML | 📅 2026-08-24**, you rock 🤟!
