...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 198,097 | 🐛 2,982 | 🌐 C++ | 📅 2026-08-31 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,694 | 🐛 17,497 | 🌐 Python | 📅 2026-08-31 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,270 | 🐛 235 | 🌐 Python | 📅 2026-08-30 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,064 | 🐛 1,501 | 🌐 C++ | 📅 2026-08-31 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [h2o-3](https://github.com/h2oai/h2o-3) ⭐ 7,497 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-08-31 - Open Source Fast Scalable Machine Learning API For Smarter Applications (Deep Learning, Gradient Boosting, Random Forest, Generalized Linear Modeling (Logistic Regression, Elastic Net), K-Means, PCA, Stacked Ensembles.)
* [kserve](https://github.com/kserve/kserve) ⭐ 5,844 | 🐛 199 | 🌐 Go | 📅 2026-08-31 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 57,687 | 🐛 4,909 | 🌐 Python | 📅 2026-08-31 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,063 | 🐛 193 | 🌐 Lua | 📅 2026-08-16 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,066 | 🐛 243 | 🌐 Lua | 📅 2026-08-31 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,810 | 🐛 499 | 🌐 Go | 📅 2026-08-31 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,254 | 🐛 1,076 | 🌐 Go | 📅 2026-08-31 - Next-generation Cloud Native Gateway.
* [ocelot](https://github.com/ThreeMammals/Ocelot) ⭐ 8,716 | 🐛 59 | 🌐 C# | 📅 2026-08-31 - .NET core API Gateway.
* [lura](https://github.com/luraproject/lura) ⭐ 6,793 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - Ultra performant API Gateway with middlewares. A project hosted at The Linux Foundation.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 3,000 | 🐛 757 | 🌐 Go | 📅 2026-08-30 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,155 | 🐛 114 | 🌐 Go | 📅 2026-08-31 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [gloo](https://github.com/solo-io/gloo) ⭐ 170 | 🐛 1,873 | 🌐 Go | 📅 2026-08-27 - The Feature-rich, Kubernetes-native, Next-Generation API Gateway Built on Envoy.
...
* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,592 | 🐛 1,921 | 🌐 Go | 📅 2026-08-31 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,190 | 🐛 103 | 🌐 Go | 📅 2026-08-31 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,204 | 🐛 457 | 🌐 Go | 📅 2026-08-28 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 29,990 | 🐛 317 | 🌐 Go | 📅 2026-08-31 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,522 | 🐛 3,616 | 🌐 Java | 📅 2026-08-31 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,633 | 🐛 2,452 | 🌐 Go | 📅 2026-08-31 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 24,045 | 🐛 4,428 | 🌐 Go | 📅 2026-08-31 - Declarative continuous deployment for Kubernetes.
* [argo](https://github.com/argoproj/argo) ⭐ 16,945 | 🐛 1,256 | 🌐 Go | 📅 2026-08-29 - Get stuff done with container-native workflows for Kubernetes.
* [dagger](https://github.com/dagger/dagger) ⭐ 16,219 | 🐛 146 | 🌐 Go | 📅 2026-08-31 - A programmable CI/CD engine that runs your pipelines in containers.
* [skaffold](https://github.com/GoogleContainerTools/skaffold) ⭐ 15,891 | 🐛 904 | 🌐 Go | 📅 2026-08-31 - Easy and Repeatable Kubernetes Development.
...
* [kustomize](https://github.com/kubernetes-sigs/kustomize) ⭐ 12,149 | 🐛 189 | 🌐 Go | 📅 2026-08-31 - Customization of kubernetes YAML configurations.
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 11,999 | 🐛 191 | 🌐 Go | 📅 2026-08-27 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,622 | 🐛 1,852 | 🌐 TypeScript | 📅 2026-08-31 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,619 | 🐛 21 | 🌐 Go | 📅 2026-08-31 - Go from Docker Compose to Kubernetes.
* [tilt](https://github.com/tilt-dev/tilt) ⭐ 10,026 | 🐛 509 | 🌐 Go | 📅 2026-08-27 - A multi-service dev environment for teams on Kubernetes.
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,781 | 🐛 106 | 🌐 Java | 📅 2026-08-31 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,056 | 🐛 555 | 🌐 Go | 📅 2026-08-31 - A cloud-native Pipeline resource.
* [ko](https://github.com/ko-build/ko) ⭐ 8,516 | 🐛 56 | 🌐 Go | 📅 2026-08-31 - Build and deploy Go applications on Kubernetes.
...
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,790 | 🐛 364 | 🌐 Go | 📅 2026-08-31 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
...
* [helm-dashboard](https://github.com/komodorio/helm-dashboard) ⭐ 5,751 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-10 - The missing UI for Helm - visualize your releases.
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,591 | 🐛 766 | 🌐 Go | 📅 2026-08-31 - Software Delivery Workflow For Kubernetes
* [wing](https://github.com/winglang/wing) ⭐ 5,398 | 🐛 894 | 🌐 TypeScript | 📅 2026-08-31 - A cloud-oriented programming language that allows developers to build distributed systems, leveraging cloud services as first-class citizens.
...
* [cds](https://github.com/ovh/cds) ⭐ 4,837 | 🐛 159 | 🌐 Go | 📅 2026-08-31 - Enterprise-Grade Continuous Delivery & DevOps Automation Open Source Platform.
...
* [werf](https://github.com/werf/werf) ⭐ 4,720 | 🐛 31 | 🌐 Go | 📅 2026-08-31 - The CLI tool gluing Git, Docker, Helm, and Kubernetes with any CI system to implement CI/CD and Giterminism.
...
* [ballerina-lang](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,848 | 🐛 1,606 | 🌐 Ballerina | 📅 2026-08-28 - Ballerina is a new programming language for integration built on a sequence diagram metaphor.
...
* [spegel](https://github.com/spegel-org/spegel) ⭐ 3,762 | 🐛 26 | 🌐 Go | 📅 2026-08-31 - Stateless cluster local OCI registry mirror.
* [kargo](https://github.com/akuity/kargo) ⭐ 3,619 | 🐛 179 | 🌐 Go | 📅 2026-08-31 - Application lifecycle orchestration.
...
* [argo-rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,565 | 🐛 661 | 🌐 Go | 📅 2026-08-31 - Progressive delivery controller for blue-green, canary, and experiments on Kubernetes.
* [zadig](https://github.com/koderover/zadig) ⭐ 3,236 | 🐛 28 | 🌐 Go | 📅 2026-08-31 - Zadig is a cloud native, distributed, developer-oriented continuous delivery product.
...
* [binderhub](https://github.com/jupyterhub/binderhub) ⭐ 2,669 | 🐛 271 | 🌐 Python | 📅 2026-08-05 - Run your code in the cloud, with technology so advanced, it feels like magic!
* [source-to-image](https://github.com/openshift/source-to-image) ⭐ 2,543 | 🐛 27 | 🌐 Go | 📅 2026-08-30 - A tool for building/building artifacts from source and injecting into docker images.
* [kcl](https://github.com/kcl-lang/kcl) ⭐ 2,407 | 🐛 28 | 🌐 Rust | 📅 2026-08-31 - KCL is a constraint-based record & functional language mainly used in configuration and policy scenarios. (CNCF Sandbox Project).
...
* [hub](https://github.com/artifacthub/hub) ⭐ 2,079 | 🐛 27 | 🌐 TypeScript | 📅 2026-07-07 - Find, install and publish Cloud Native packages
...
* [kpt](https://github.com/GoogleContainerTools/kpt) ⭐ 1,891 | 🐛 339 | 🌐 Go | 📅 2026-08-31 - Kpt is a toolkit to help you manage, manipulate, customize, and apply Kubernetes Resource configuration data files.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,666 | 🐛 331 | 🌐 Go | 📅 2026-08-31 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,430 | 🐛 46 | 🌐 Go | 📅 2026-08-31 - OpenTofu / Terraform / Terragrunt and Atmos version manager.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,350 | 🐛 228 | 🌐 Go | 📅 2026-08-29 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
...
* [kapp](https://github.com/carvel-dev/kapp) ⭐ 1,079 | 🐛 128 | 🌐 Go | 📅 2026-08-25 - kapp is a simple deployment tool focused on the concept of "Kubernetes application" — a set of resources with the same label.
...
* [screwdriver](https://github.com/screwdriver-cd/screwdriver) ⭐ 1,045 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-31 - An open source build platform designed for continuous delivery.
...
* [qovery](https://github.com/Qovery/qovery-skills) ⭐ 10 | 🐛 3 | 🌐 Shell | 📅 2026-08-31 - Enterprise Kubernetes management platform for deploying applications, databases, Helm charts, and Terraform modules on AWS, GCP, Azure, and Scaleway. Includes Terraform provider, CLI, API, and AI Agent Skill.
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,772 | 🐛 317 | 🌐 Go | 📅 2026-08-31 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,217 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,199 | 🐛 90 | 🌐 Go | 📅 2026-08-31 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,491 | 🐛 392 | 🌐 Go | 📅 2026-08-31 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,519 | 🐛 837 | 🌐 Python | 📅 2026-08-31 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,772 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-31 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,378 | 🐛 163 | 🌐 Go | 📅 2026-08-30 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,270 | 🐛 195 | 🌐 Go | 📅 2026-08-31 - Enforce Kubernetes admission policies using Open Policy Agent constraints.
...
* [pluto](https://github.com/FairwindsOps/pluto) ⭐ 2,574 | 🐛 15 | 🌐 Go | 📅 2026-08-31 - A cli tool to help discover deprecated apiVersions in Kubernetes.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,250 | 🐛 39 | 🌐 Python | 📅 2026-08-30 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 233 | 🐛 136 | 🌐 Rust | 📅 2026-08-31 - Policy as code for Kubernetes powered by WebAssembly modules.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 32,079 | 🐛 552 | 🌐 Go | 📅 2026-08-31 - Run Kubernetes locally.
* [vagrant](https://github.com/hashicorp/vagrant) ⭐ 27,204 | 🐛 753 | 🌐 Ruby | 📅 2026-08-31 - Vagrant is a tool for building and distributing development environments.
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,711 | 🐛 217 | 🌐 Jinja | 📅 2026-08-31 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,335 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-31 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,673 | 🐛 132 | 🌐 Go | 📅 2026-08-29 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
* [kind](https://github.com/kubernetes-sigs/kind) ⭐ 15,461 | 🐛 245 | 🌐 Go | 📅 2026-08-26 - Kubernetes IN Docker - local clusters for testing Kubernetes.
* [kubeasz](https://github.com/easzlab/kubeasz) ⭐ 11,417 | 🐛 4 | 🌐 Jinja | 📅 2026-08-24 - 使用 Ansible 脚本安装 K8S 集群，介绍组件交互原理，方便直接，不受国内网络环境影响。
* [talos](https://github.com/talos-systems/talos) ⭐ 11,060 | 🐛 230 | 🌐 Go | 📅 2026-08-31 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,361 | 🐛 165 | 🌐 Python | 📅 2026-08-31 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,213 | 🐛 92 | 🌐 Go | 📅 2026-08-27 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,293 | 🐛 219 | 🌐 Go | 📅 2026-08-31 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 3,999 | 🐛 38 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,433 | 🐛 194 | 🌐 Go | 📅 2026-08-31 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
* [cloudpods](https://github.com/yunionio/cloudpods) ⭐ 2,935 | 🐛 217 | 🌐 Go | 📅 2026-08-31 - A cloud-native open-source unified multi-cloud and hybrid-cloud platform.
...
* [fleet](https://github.com/rancher/fleet) ⭐ 1,725 | 🐛 187 | 🌐 Go | 📅 2026-08-31 - Manage large fleets of Kubernetes clusters.
...
* [usernetes](https://github.com/rootless-containers/usernetes) ⭐ 988 | 🐛 27 | 🌐 Shell | 📅 2026-08-31 - Kubernetes installable under $HOME, without the root privileges.
* [claudie](https://github.com/berops/claudie) ⭐ 791 | 🐛 62 | 🌐 Go | 📅 2026-08-30 - Cloud-agnostic managed Kubernetes.
...
* [spinifex](https://github.com/mulgadc/spinifex) ⭐ 104 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - Open source AWS-compatible platform for bare-metal, on-prem, and edge deployments. Run EC2, S3, EBS, and VPC-compatible services on your own hardware — no managed cloud required.
...
* [devspace](https://github.com/devspace-cloud/devspace) ⭐ 5,161 | 🐛 88 | 🌐 Go | 📅 2026-08-31 - Cloud Native Software Development with Kubernetes and Docker - simply run "devspace up" in any of your projects and start coding directly on top of Kubernetes (works with minikube, self-hosted and cloud-based clusters).
...
* [okteto](https://github.com/okteto/okteto) ⭐ 3,535 | 🐛 35 | 🌐 Go | 📅 2026-08-31 - Local development experience for Kubernetes apps.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,555 | 🐛 19 | 🌐 Rust | 📅 2026-08-31 - Manage and run multiple kubectl port-forward configurations directly in the menu bar, syncing configurations with git repositories.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,134 | 🐛 96 | 🌐 Go | 📅 2026-08-31 - Giving Kubernetes Superpowers to everyone.
...
* [robusta](https://github.com/robusta-dev/robusta) ⭐ 3,083 | 🐛 201 | 🌐 Python | 📅 2026-08-31 - Open source Kubernetes troubleshooting and automation platform.
...
* [cri-tools](https://github.com/kubernetes-sigs/cri-tools) ⭐ 2,010 | 🐛 16 | 🌐 Go | 📅 2026-08-31 - CLI and validation tools for Kubelet Container Runtime Interface (CRI).
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,017 | 🐛 127 | 🌐 Go | 📅 2026-08-31 - Test infrastructure for the Kubernetes project.
* [kwok](https://github.com/kubernetes-sigs/kwok) ⭐ 3,180 | 🐛 34 | 🌐 Go | 📅 2026-08-25 - Kubernetes WithOut Kubelet - Simulates thousands of Nodes and Clusters.
...
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 214 | 🐛 176 | 🌐 Python | 📅 2026-08-31 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
* [seaworthy](https://github.com/cakehappens/seaworthy) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2020-08-10 - A CLI to verify Kubernetes resource health.

## Data Protection & Backup

* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,260 | 🐛 836 | 🌐 Go | 📅 2026-08-31 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [karpenter](https://github.com/aws/karpenter) ⭐ 7,711 | 🐛 512 | 🌐 Go | 📅 2026-08-31 - Kubernetes Node Autoscaling: built for flexibility, performance, and scalability.
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,716 | 🐛 297 | 🌐 Go | 📅 2026-08-31 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,716 | 🐛 297 | 🌐 Go | 📅 2026-08-31 - Kubernetes cost monitoring powered by open allocation models.
...
* [lotus](https://github.com/uselotus/lotus) ⭐ 1,834 | 🐛 35 | 🌐 Python | 📅 2026-08-30 - Open Source Pricing & Packaging Infrastructure for SaaS.
...
* [burn](https://github.com/tanrikuluozlem/burn) ⭐ 85 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - CLI tool for Kubernetes cost analysis with per-namespace breakdown, real cloud pricing, and AI-powered recommendations.
...
* [dragonfly2](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,313 | 🐛 38 | 🌐 Go | 📅 2026-08-31 - Dragonfly is an intelligent P2P based file distribution system.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 28,993 | 🐛 1,140 | 🌐 JavaScript | 📅 2026-08-31 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,162 | 🐛 2,925 | 🌐 C | 📅 2026-08-31 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,794 | 🐛 712 | 🌐 TypeScript | 📅 2026-08-31 - The Open Source Airtable alternative.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 52,210 | 🐛 334 | 🌐 Go | 📅 2026-08-31 - Distributed reliable key-value store for the most critical data of a distributed system.
* [milvus](https://github.com/milvus-io/milvus) ⭐ 45,908 | 🐛 1,295 | 🌐 Go | 📅 2026-08-31 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,479 | 🐛 6,851 | 🌐 Go | 📅 2026-08-31 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,373 | 🐛 404 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,436 | 🐛 8,372 | 🌐 Go | 📅 2026-08-26 - CockroachDB - the open source, cloud-native SQL database.
...
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,520 | 🐛 32 | 🌐 C++ | 📅 2026-08-31 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,995 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,452 | 🐛 393 | 🌐 C | 📅 2026-08-31 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,787 | 🐛 212 | 🌐 Java | 📅 2026-08-31 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,822 | 🐛 1,801 | 🌐 Rust | 📅 2026-08-31 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,267 | 🐛 839 | 🌐 C++ | 📅 2026-08-31 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
...
* [oceanbase](https://github.com/oceanbase/oceanbase) ⭐ 10,258 | 🐛 586 | 🌐 C++ | 📅 2026-08-30 - A distributed, banking suitable, open-source related database featuring high scalability and high compatibility.
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,428 | 🐛 566 | 🌐 Rust | 📅 2026-08-31 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 7,004 | 🐛 146 | 🌐 Go | 📅 2026-08-31 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
...
* [kvrocks](https://github.com/KvrocksLabs/kvrocks) ⭐ 4,410 | 🐛 243 | 🌐 C++ | 📅 2026-08-28 - Kvrocks is a distributed key value NoSQL database based on RocksDB and compatible with Redis protocol.
* [polardb-for-postgresql](https://github.com/alibaba/PolarDB-for-PostgreSQL) ⭐ 3,196 | 🐛 65 | 🌐 C | 📅 2026-08-31 - PolarDB for PostgreSQL (PolarDB for short) is an open source database system based on PostgreSQL.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,118 | 🐛 257 | 🌐 Go | 📅 2026-08-31 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [xline](https://github.com/xline-kv/Xline) ⭐ 715 | 🐛 40 | 🌐 Rust | 📅 2026-08-31 - A geo-distributed KV store for metadata management.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,270 | 🐛 874 | 🌐 Go | 📅 2026-08-31 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,280 | 🐛 1,094 | 🌐 Go | 📅 2026-08-31 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 16,983 | 🐛 1,320 | 🌐 C++ | 📅 2026-08-31 - Ceph is a distributed object, block, and file storage platform.
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,377 | 🐛 198 | 🌐 Go | 📅 2026-08-31 - A distributed POSIX file system built on top of Redis and S3.
* [rook](https://github.com/rook/rook) ⭐ 13,623 | 🐛 131 | 🌐 Go | 📅 2026-08-31 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,806 | 🐛 38 | 📅 2026-08-31 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
* [fastdfs](https://github.com/happyfish100/fastdfs) ⭐ 9,252 | 🐛 466 | 🌐 C | 📅 2026-08-31 - FastDFS is an open source high performance distributed file system (DFS). It's major functions include: file storing, file syncing and file accessing, and design for high capacity and load balance.
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,945 | 🐛 1,887 | 🌐 Shell | 📅 2026-08-30 - We put storage on cows and move them around from rancher.
* [chubaofs](https://github.com/chubaofs/chubaofs) ⭐ 5,645 | 🐛 271 | 🌐 Go | 📅 2026-08-24 - A distributed storage system for cloud native applications.
* [glusterfs](https://github.com/gluster/glusterfs) ⭐ 5,222 | 🐛 282 | 🌐 C | 📅 2026-08-31 - Gluster is a software defined distributed storage that can scale to several petabytes. It provides interfaces for object, block and file storage.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,675 | 🐛 86 | 🌐 Go | 📅 2026-08-31 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,408 | 🐛 73 | 🌐 Go | 📅 2026-08-31 - OCI registry client, managing content like artifacts, images, packages.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,648 | 🐛 528 | 🌐 Java | 📅 2026-08-31 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,779 | 🐛 77 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,573 | 🐛 585 | 🌐 Java | 📅 2026-08-26 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,641 | 🐛 546 | 🌐 Go | 📅 2026-08-31 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,677 | 🐛 166 | 🌐 Erlang | 📅 2026-08-31 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,321 | 🐛 1,730 | 🌐 Java | 📅 2026-08-31 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,595 | 🐛 55 | 🌐 Java | 📅 2026-08-31 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [flume](https://github.com/apache/flume) ⭐ 2,569 | 🐛 79 | 🌐 Java | 📅 2026-08-25 - Apache Flume is a distributed, reliable, and available service for efficiently collecting, aggregating, and moving large amounts of log data.
* [eventmesh](https://github.com/WeBankFinTech/EventMesh) ⭐ 1,749 | 🐛 267 | 🌐 Java | 📅 2026-08-31 - EventMesh is a dynamic cloud-native eventing infrastructure used to decouple the application and backend middleware layer, which supports a wide range of use cases that encompass complex multi-cloud, widely distributed topologies using diverse technology stacks.
...
* [istio](https://github.com/istio/istio) ⭐ 38,367 | 🐛 508 | 🌐 Go | 📅 2026-08-31 - Connect, secure, control, and observe services.
...
* [linkerd2](https://github.com/linkerd/linkerd2) ⭐ 11,485 | 🐛 214 | 🌐 Go | 📅 2026-08-31 - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,997 | 🐛 156 | 🌐 Go | 📅 2026-08-31 - Universal Control Plane for your Service Mesh.
* [secretscanner](https://github.com/deepfence/SecretScanner) ⭐ 3,384 | 🐛 25 | 🌐 Go | 📅 2026-03-07 - Find secrets and passwords in container images and file systems.
...
* [coredns](https://github.com/coredns/coredns) ⭐ 14,284 | 🐛 301 | 🌐 Go | 📅 2026-08-30 - CoreDNS is a DNS server that chains middleware.
* [zookeeper](https://github.com/apache/zookeeper) ⭐ 12,793 | 🐛 242 | 🌐 Java | 📅 2026-08-27 - Apache ZooKeeper is an effort to develop and maintain an open-source server which enables highly reliable distributed coordination.
...
* [pingora](https://github.com/cloudflare/pingora) ⭐ 27,304 | 🐛 286 | 🌐 Rust | 📅 2026-08-25 - A library for building fast, reliable and evolvable network services.
* [cilium](https://github.com/cilium/cilium) ⭐ 25,033 | 🐛 1,090 | 🌐 Go | 📅 2026-08-31 - API-aware Networking and Security using eBPF and XDP.
* [flannel](https://github.com/coreos/flannel) ⭐ 9,529 | 🐛 24 | 🌐 Go | 📅 2026-08-31 - Flannel is a network fabric for containers, designed for Kubernetes.
* [weave](https://github.com/weaveworks/weave) ⚠️ Archived - Simple, resilient multi-host Docker networking and more.
* [cni](https://github.com/containernetworking/cni) ⭐ 6,107 | 🐛 156 | 🌐 Go | 📅 2026-08-13 - Container Network Interface - networking for Linux containers.
* [ziti](https://github.com/openziti/ziti) ⭐ 4,365 | 🐛 278 | 🌐 Go | 📅 2026-08-31 - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network.
* [hubble](https://github.com/cilium/hubble) ⭐ 4,318 | 🐛 44 | 🌐 Makefile | 📅 2026-08-24 - Hubble - Network, Service & Security Observability for Kubernetes.
...
* [submariner](https://github.com/submariner-io/submariner) ⭐ 2,687 | 🐛 22 | 🌐 Go | 📅 2026-08-31 - Connect all your Kubernetes clusters, no matter where they are in the world.
* [kube-router](https://github.com/cloudnativelabs/kube-router) ⭐ 2,498 | 🐛 13 | 🌐 Go | 📅 2026-08-30 - Kube-router, a turnkey solution for Kubernetes networking.
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,394 | 🐛 66 | 🌐 Go | 📅 2026-08-31 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,808 | 🐛 203 | 🌐 Go | 📅 2026-08-31 - Antrea is a Kubernetes networking based on Open vSwitch.
...
* [spiderpool](https://github.com/spidernet-io/spiderpool) ⭐ 673 | 🐛 109 | 🌐 Go | 📅 2026-08-31 - Underlay and RDMA network solution of the Kubernetes, for bare metal, VM and any public cloud.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,371 | 🐛 277 | 🌐 Go | 📅 2026-08-31 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,683 | 🐛 908 | 🌐 Go | 📅 2026-08-31 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,542 | 🐛 476 | 🌐 C | 📅 2026-08-26 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,839 | 🐛 1,863 | 🌐 C++ | 📅 2026-08-31 - C++ front/service proxy.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15,459 | 🐛 537 | 🌐 Go | 📅 2026-08-31 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [bunkerweb](https://github.com/bunkerity/bunkerweb) ⭐ 10,887 | 🐛 155 | 🌐 Python | 📅 2026-08-31 - Open-source Web Application Firewall and reverse proxy with Kubernetes integration.
...
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,820 | 🐛 385 | 🌐 C | 📅 2026-08-31 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,307 | 🐛 0 | 🌐 C | 📅 2026-08-31 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,071 | 🐛 262 | 🌐 Go | 📅 2026-08-31 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [skipper](https://github.com/zalando/skipper) ⭐ 3,319 | 🐛 306 | 🌐 Go | 📅 2026-08-31 - An HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress.
...
* [loxilb](https://github.com/loxilb-io/loxilb) ⭐ 1,872 | 🐛 31 | 🌐 Go | 📅 2026-08-28 - eBPF powered cloud-native load-balancer providing efficient externalLB, clusterIP and nodePort services for Kubernetes.
...
* [apisix-ingress-controller](https://github.com/apache/apisix-ingress-controller) ⭐ 1,144 | 🐛 42 | 🌐 Go | 📅 2026-08-31 - Ingress controller for K8s.
* [dev-proxy](https://github.com/microsoft/dev-proxy) ⭐ 824 | 🐛 35 | 🌐 C# | 📅 2026-08-31 - Dev Proxy is a command line tool that simulates real world behaviors of HTTP APIs, including Microsoft Graph, locally.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,595 | 🐛 469 | 🌐 C++ | 📅 2026-08-31 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,953 | 🐛 17 | 🌐 C++ | 📅 2026-08-31 - Apache thrift.
* [tars](https://github.com/TarsCloud/Tars) ⭐ 10,078 | 🐛 48 | 🌐 C++ | 📅 2026-07-18 - Tars is a high-performance RPC framework based on name service and Tars protocol, also integrated administration platform, and implemented hosting-service via flexible schedule.
* [finagle](https://github.com/twitter/finagle) ⭐ 8,865 | 🐛 65 | 🌐 Scala | 📅 2026-08-13 - A fault tolerant, protocol-agnostic RPC system.
* [proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-31 - A collection of C++ HTTP libraries including an easy to use HTTP server.
* [kitex](https://github.com/cloudwego/kitex) ⭐ 8,027 | 🐛 70 | 🌐 Go | 📅 2026-08-31 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices.
...
* [moby](https://github.com/moby/moby) ⭐ 72,027 | 🐛 3,904 | 🌐 Go | 📅 2026-08-31 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,740 | 🐛 1,147 | 🌐 Go | 📅 2026-08-31 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,789 | 🐛 534 | 🌐 Go | 📅 2026-08-31 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,231 | 🐛 442 | 🌐 Go | 📅 2026-08-31 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,205 | 🐛 864 | 🌐 Go | 📅 2026-08-31 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 7,001 | 🐛 60 | 🌐 Go | 📅 2026-08-31 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
* [spin](https://github.com/fermyon/spin) ⭐ 6,506 | 🐛 265 | 🌐 Rust | 📅 2026-08-31 - Spin is an open source framework for building and running fast, secure, and composable cloud microservices with WebAssembly.
* [wazero](https://github.com/tetratelabs/wazero) ⭐ 6,356 | 🐛 41 | 🌐 Go | 📅 2026-08-29 - The zero dependency WebAssembly runtime for Go developers.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,083 | 🐛 606 | 🌐 C | 📅 2026-08-31 - WebAssembly Micro Runtime (WAMR).
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,655 | 🐛 144 | 🌐 Go | 📅 2026-08-31 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface.
...
* [crun](https://github.com/containers/crun) ⭐ 4,094 | 🐛 56 | 🌐 C | 📅 2026-08-30 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [firecracker-containerd](https://github.com/firecracker-microvm/firecracker-containerd) ⭐ 2,916 | 🐛 95 | 🌐 Go | 📅 2026-08-17 - firecracker-containerd enables containerd to manage containers as Firecracker microVMs.
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,426 | 🐛 58 | 🌐 Rust | 📅 2026-08-31 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
* [hyperd](https://github.com/hyperhq/hyperd) ⚠️ Archived - HyperContainer Daemon.
* [kuasar](https://github.com/kuasar-io/kuasar) ⭐ 1,448 | 🐛 29 | 🌐 Rust | 📅 2026-06-05 - An efficient container runtime that provides cloud-native, all-scenario multiple sandbox container solutions.
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,443 | 🐛 253 | 🌐 Go | 📅 2026-08-31 - OpenChoreo is a developer platform for Kubernetes.
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,333 | 🐛 66 | 🌐 Rust | 📅 2026-08-31 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,611 | 🐛 3,012 | 🌐 Go | 📅 2026-08-31 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,095 | 🐛 108 | 🌐 Go | 📅 2026-08-31 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,953 | 🐛 330 | 🌐 Go | 📅 2026-08-31 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
...
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,912 | 🐛 801 | 🌐 Go | 📅 2026-08-31 - A Kubernetes Native Batch System (Project under CNCF).
* [swarm](https://github.com/docker/classicswarm) ⚠️ Archived - Swarm: a Docker-native clustering system.
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,579 | 🐛 844 | 🌐 Go | 📅 2026-08-31 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
* [descheduler](https://github.com/kubernetes-sigs/descheduler) ⭐ 5,502 | 🐛 60 | 🌐 Go | 📅 2026-08-29 - Descheduler for Kubernetes.
...
* [kruise](https://github.com/openkruise/kruise) ⭐ 5,327 | 🐛 80 | 🌐 Go | 📅 2026-08-31 - Automate application workloads management on Kubernetes.
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,464 | 🐛 65 | 🌐 Go | 📅 2026-08-31 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,925 | 🐛 729 | 🌐 Go | 📅 2026-08-31 - Kubernetes-native Job Queueing.
...
* [ocm](https://github.com/open-cluster-management-io/OCM) ⭐ 1,081 | 🐛 51 | 🌐 Go | 📅 2026-08-31 - The open-cluster-management.io project is focused on enabling end-to-end visibility and control across your Kubernetes clusters.
...
* [serverless](https://github.com/serverless/serverless) ⭐ 46,919 | 🐛 1,216 | 🌐 JavaScript | 📅 2026-08-31 - Serverless Framework – Build web, mobile and IoT applications with serverless architectures using AWS Lambda, Azure Functions, Google CloudFunctions & more!
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,401 | 🐛 109 | 🌐 Rust | 📅 2026-08-31 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,056 | 🐛 444 | 🌐 Go | 📅 2026-08-28 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
...
* [keda](https://github.com/kedacore/keda) ⭐ 10,479 | 🐛 250 | 🌐 Go | 📅 2026-08-31 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
* [serving](https://github.com/knative/serving) ⭐ 6,089 | 🐛 162 | 🌐 Go | 📅 2026-08-25 - Kubernetes-based, scale-to-zero, request-driven compute.
* [fn](https://github.com/fnproject/fn) ⭐ 5,943 | 🐛 159 | 🌐 Go | 📅 2026-06-08 - The container native, cloud agnostic serverless platform.
* [spec](https://github.com/cloudevents/spec) ⭐ 5,883 | 🐛 16 | 🌐 Python | 📅 2026-08-27 - CloudEvents Specification.
* [nuclio](https://github.com/nuclio/nuclio) ⭐ 5,753 | 🐛 116 | 🌐 Go | 📅 2026-08-31 - High-Performance Serverless event and data processing platform.
...
* [layotto](https://github.com/mosn/layotto) ⭐ 853 | 🐛 45 | 🌐 Go | 📅 2026-08-31 - A fast and efficient cloud native application runtime.
...
* [prometheus-operator](https://github.com/coreos/prometheus-operator) ⭐ 9,977 | 🐛 314 | 🌐 Go | 📅 2026-08-31 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes.
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,302 | 🐛 74 | 🌐 Go | 📅 2026-08-29 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
...
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,034 | 🐛 576 | 🌐 Go | 📅 2026-08-29 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,923 | 🐛 160 | 🌐 Java | 📅 2026-08-31 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,150 | 🐛 119 | 🌐 Python | 📅 2026-08-28 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
...
* [operator-lifecycle-manager](https://github.com/operator-framework/operator-lifecycle-manager) ⭐ 1,863 | 🐛 7 | 🌐 Go | 📅 2026-08-31 - A management framework for extending Kubernetes with Operators.
...
* [kaito](https://github.com/Azure/kaito) ⭐ 1,005 | 🐛 64 | 🌐 Go | 📅 2026-08-31 - Kubernetes AI Toolchain Operator.
* [k0smotron](https://github.com/k0sproject/k0smotron) ⭐ 739 | 🐛 54 | 🌐 Go | 📅 2026-08-31 - k0smotron is a powerful open-source tool for the efficient management of k0s Kubernetes clusters.
...
* [gateway-operator](https://github.com/kong/gateway-operator) ⭐ 108 | 🐛 204 | 🌐 Go | 📅 2026-08-31 - Kong Gateway Operator is a Kubernetes Operator that can manage your Kong Ingress Controller, Kong Gateway Data Planes, or both together when running on Kubernetes.
...
* [k3s](https://github.com/k3s-io/k3s) ⭐ 33,856 | 🐛 78 | 🌐 Go | 📅 2026-08-28 - Lightweight Kubernetes.
* [kubeedge](https://github.com/kubeedge/kubeedge) ⭐ 7,560 | 🐛 1,280 | 🌐 Go | 📅 2026-08-26 - Kubernetes Native Edge Computing Framework (project under CNCF).
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,455 | 🐛 220 | 🌐 Go | 📅 2026-08-31 - Zero Friction Kubernetes.
* [openyurt](https://github.com/openyurtio/openyurt) ⭐ 2,000 | 🐛 146 | 🌐 Go | 📅 2026-08-31 - Extending your native Kubernetes to edge(project under CNCF).
...
* [kairos](https://github.com/kairos-io/kairos) ⭐ 1,811 | 🐛 288 | 🌐 Go | 📅 2026-08-31 - The immutable Linux meta-distribution for edge Kubernetes.
* [iotedge](https://github.com/Azure/iotedge) ⭐ 1,509 | 🐛 99 | 🌐 C# | 📅 2026-08-31 - The IoT Edge OSS project.
* [akri](https://github.com/project-akri/akri) ⭐ 1,260 | 🐛 90 | 🌐 Rust | 📅 2026-08-24 - A Kubernetes Resource Interface for the Edge.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,535 | 🐛 3,326 | 🌐 TypeScript | 📅 2026-08-31 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,924 | 🐛 882 | 🌐 Go | 📅 2026-08-31 - The Prometheus monitoring system and time series database.
* [kibana](https://github.com/elastic/kibana) ⭐ 21,276 | 🐛 14,322 | 🌐 TypeScript | 📅 2026-08-31 - Kibana analytics and search dashboard for Elasticsearch.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,623 | 🐛 773 | 🌐 Go | 📅 2026-08-31 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,064 | 🐛 150 | 🌐 Go | 📅 2026-08-31 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
* [highlight](https://github.com/highlight/highlight) ⭐ 9,373 | 🐛 553 | 🌐 TypeScript | 📅 2026-08-20 - The open source, full-stack monitoring platform. Error monitoring, session replay, logging and more.
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,473 | 🐛 700 | 🌐 Go | 📅 2026-08-31 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,193 | 🐛 111 | 🌐 Go | 📅 2026-08-31 - Add-on agent to generate and expose cluster-level metrics.
...
* [cortex](https://github.com/cortexproject/cortex) ⭐ 5,857 | 🐛 352 | 🌐 Go | 📅 2026-08-31 - A multitenant, horizontally scalable Prometheus as a Service.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,970 | 🐛 269 | 🌐 C | 📅 2026-08-31 - eBPF-based Security Observability and Runtime Enforcement.
* [parca](https://github.com/parca-dev/parca) ⭐ 4,956 | 🐛 204 | 🌐 TypeScript | 📅 2026-08-31 - Continuous profiling for analysis of CPU and memory usage, down to the line number and throughout time. Saving infrastructure cost, improving performance, and increasing reliability.
* [deepflow](https://github.com/deepflowys/deepflow) ⭐ 4,250 | 🐛 268 | 🌐 Go | 📅 2026-08-31 - A highly automated observability platform.
* [metaflow](https://github.com/metaflowys/metaflow) ⭐ 4,250 | 🐛 268 | 🌐 Go | 📅 2026-08-31 - MetaFlow is an automated observability platform for cloud-native developers.
...
* [kiali](https://github.com/kiali/kiali) ⭐ 3,633 | 🐛 79 | 🌐 Go | 📅 2026-08-27 - Kiali project to help istio service mesh observability.
* [open-falcon](https://github.com/XiaoMi/open-falcon) ⭐ 3,020 | 🐛 32 | 📅 2018-07-05 - Enterprise Internet monitoring system from Xiaomi.
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,914 | 🐛 430 | 🌐 C | 📅 2026-08-31 - The eBPF tool and systems inspection framework for Kubernetes, containers and Linux hosts.
...
* [perses](https://github.com/perses/perses) ⭐ 2,383 | 🐛 257 | 🌐 Go | 📅 2026-08-31 - The CNCF candidate for observability visualisation.
...
* [kepler](https://github.com/sustainable-computing-io/kepler) ⭐ 1,560 | 🐛 47 | 🌐 Go | 📅 2026-08-31 - Kepler (Kubernetes-based Efficient Power Level Exporter) uses eBPF to probe performance counters and other system stats, use ML models to estimate workload energy consumption based on these stats, and exports them as Prometheus metrics.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,883 | 🐛 6,022 | 🌐 Java | 📅 2026-08-31 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,818 | 🐛 1,726 | 🌐 Go | 📅 2026-08-31 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,496 | 🐛 2,513 | 🌐 Rust | 📅 2026-08-31 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,780 | 🐛 422 | 🌐 Go | 📅 2026-08-31 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,582 | 🐛 133 | 🌐 Ruby | 📅 2026-08-31 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,642 | 🐛 1,064 | 🌐 Go | 📅 2026-08-31 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,560 | 🐛 802 | 🌐 Rust | 📅 2026-08-31 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,069 | 🐛 780 | 🌐 C | 📅 2026-08-31 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,694 | 🐛 2,225 | 🌐 Python | 📅 2026-08-31 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,936 | 🐛 38 | 🌐 Java | 📅 2026-08-26 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,169 | 🐛 562 | 🌐 Go | 📅 2026-08-29 - Jaeger, a Distributed Tracing System.
* [zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,456 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - Zipkin is a distributed tracing system.
* [pinpoint](https://github.com/naver/pinpoint) ⭐ 13,860 | 🐛 536 | 🌐 Java | 📅 2026-08-31 - Pinpoint is an open source APM (Application Performance Management) tool for large-scale distributed systems written in Java.
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,332 | 🐛 424 | 🌐 Makefile | 📅 2026-08-31 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,716 | 🐛 264 | 🌐 Go | 📅 2026-08-28 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
* [keycloak](https://github.com/keycloak/keycloak) ⭐ 36,518 | 🐛 3,175 | 🌐 Java | 📅 2026-08-31 - Open Source Identity and Access Management For Modern Applications and Services.
* [vault](https://github.com/hashicorp/vault) ⭐ 36,194 | 🐛 1,434 | 🌐 Go | 📅 2026-08-31 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,868 | 🐛 3,329 | 🌐 Go | 📅 2026-08-31 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
* [supertokens-core](https://github.com/supertokens/supertokens-core) ⭐ 15,296 | 🐛 150 | 🌐 Java | 📅 2026-08-31 - Open source alternative to Auth0 / Firebase Auth / AWS Cognito.
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,059 | 🐛 251 | 🌐 Go | 📅 2026-08-31 - Automatically provision and manage TLS certificates in Kubernetes.
* [kratos](https://github.com/ory/kratos) ⭐ 13,856 | 🐛 223 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication, MFA, FIDO2, profile management, identity schemas, social sign in, registration, account recovery, service-to-service and IoT auth. Can work as an OAuth2 / OpenID Connect Provider. Golang, headless, API-only - without templating or theming headaches.
* [grype](https://github.com/anchore/grype) ⭐ 12,809 | 🐛 404 | 🌐 Go | 📅 2026-08-28 - A vulnerability scanner for container images and filesystems.
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,181 | 🐛 332 | 🌐 Go | 📅 2026-08-31 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,712 | 🐛 80 | 🌐 Go | 📅 2026-08-31 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
* [dex](https://github.com/dexidp/dex) ⭐ 11,073 | 🐛 536 | 🌐 Go | 📅 2026-08-31 - OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors.
* [clair](https://github.com/quay/clair) ⭐ 11,054 | 🐛 59 | 🌐 Go | 📅 2026-08-31 - Vulnerability Static Analysis for Containers.
...
* [syft](https://github.com/anchore/syft) ⭐ 9,487 | 🐛 629 | 🌐 Go | 📅 2026-08-31 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,319 | 🐛 64 | 🌐 C++ | 📅 2026-08-31 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,046 | 🐛 432 | 🌐 Elixir | 📅 2026-08-31 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,975 | 🐛 167 | 🌐 Python | 📅 2026-08-30 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,162 | 🐛 97 | 🌐 Go | 📅 2026-08-24 - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices.
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,089 | 🐛 661 | 🌐 Go | 📅 2026-08-31 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,822 | 🐛 276 | 🌐 Go | 📅 2026-08-31 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,270 | 🐛 172 | 🌐 Go | 📅 2026-08-31 - Container signing, verification, and provenance powered by Sigstore.
* [opal](https://github.com/permitio/opal) ⭐ 5,504 | 🐛 63 | 🌐 Python | 📅 2026-08-27 - An administration layer for Policy Engines, detecting changes to both policy and policy data in real time and pushing live updates to your agents.
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,983 | 🐛 153 | 🌐 Go | 📅 2026-08-31 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,775 | 🐛 122 | 🌐 Go | 📅 2026-08-31 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [spiffe](https://github.com/spiffe/spiffe) ⭐ 1,839 | 🐛 52 | 🌐 Shell | 📅 2026-08-27 - The SPIFFE Project.
* [cedar](https://github.com/cedar-policy/cedar) ⭐ 1,701 | 🐛 172 | 🌐 Rust | 📅 2026-08-31 - Core implementation of the Cedar language.
...
* [trivy-action](https://github.com/aquasecurity/trivy-action) ⭐ 1,406 | 🐛 178 | 🌐 Shell | 📅 2026-08-19 - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities.
...
* [neuvector](https://github.com/neuvector/neuvector) ⭐ 1,330 | 🐛 308 | 🌐 Go | 📅 2026-08-31 - Kubernetes-native container security platform.
...
* [darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 881 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks, with a proof trail per finding.
...
* [trust-manager](https://github.com/cert-manager/trust-manager) ⭐ 394 | 🐛 41 | 🌐 Go | 📅 2026-08-30 - trust-manager is an operator for distributing trust bundles across a Kubernetes cluster.
...
* [chaosmonkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,098 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,485 | 🐛 1 | 🌐 Java | 📅 2026-08-10 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,291 | 🐛 103 | 🌐 Go | 📅 2026-08-25 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
...
* [ratelimit](https://github.com/envoyproxy/ratelimit) ⭐ 2,688 | 🐛 37 | 🌐 Go | 📅 2026-08-31 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,650 | 🐛 49 | 🌐 Go | 📅 2026-08-31 - Kubernetes-native framework for test definition and execution.
* [krkn](https://github.com/krkn-chaos/krkn) ⭐ 494 | 🐛 138 | 🌐 Python | 📅 2026-08-31 - Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,396 | 🐛 745 | 🌐 TypeScript | 📅 2026-08-28 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,284 | 🐛 430 | 🌐 TypeScript | 📅 2026-08-31 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,881 | 🐛 3,339 | 🌐 Go | 📅 2026-08-31 - Complete container management platform.
...
* [openshift](https://github.com/openshift/origin) ⭐ 8,681 | 🐛 312 | 🌐 Go | 📅 2026-08-31 - Enterprise Kubernetes for Developers.
* [rainbond](https://github.com/goodrain/rainbond) ⭐ 6,258 | 🐛 55 | 🌐 Go | 📅 2026-08-29 - Serverless PaaS , A new generation of easy-to-use cloud management platforms based on kubernetes.
* [wayne](https://github.com/Qihoo360/wayne) ⭐ 3,700 | 🐛 61 | 🌐 TypeScript | 📅 2022-05-31 - Web UI for Kubernetes multi-clusters.
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,184 | 🐛 65 | 🌐 Go | 📅 2026-08-31 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
* [kubediagrams](https://github.com/philippemerle/KubeDiagrams) ⭐ 2,686 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-19 - A CLI tool to generate Kubernetes architecture diagrams automatically from Kubernetes manifest files, kustomization files, Helm charts, helmfile descriptors, and actual cluster state.
...
* [kubermatic](https://github.com/kubermatic/kubermatic) ⭐ 1,299 | 🐛 463 | 🌐 Go | 📅 2026-08-27 - The Central Kubernetes Management Platform For Any Infrastructure.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 130 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-31 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,980 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-21 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,601 | 🐛 54 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
...
* [kubernetes-on-aws](https://github.com/zalando-incubator/kubernetes-on-aws) ⭐ 635 | 🐛 30 | 🌐 Go | 📅 2026-08-31 - Deploying Kubernetes on AWS with CloudFormation and Ubuntu.
...
This website is hosted on GitHub Pages within [rootsongjc/awesome-cloud-native](https://github.com/rootsongjc/awesome-cloud-native) ⭐ 2,440 | 🐛 6 | 🌐 HTML | 📅 2026-08-31 repository.

Please take a quick gander at the **[contribution guidelines](https://github.com/rootsongjc/awesome-cloud-native/blob/main/CONTRIBUTING.md) ⭐ 2,440 | 🐛 6 | 🌐 HTML | 📅 2026-08-31** first. Thanks to all **[contributors](https://github.com/rootsongjc/awesome-cloud-native/graphs/contributors) ⭐ 2,440 | 🐛 6 | 🌐 HTML | 📅 2026-08-31**, you rock 🤟!
