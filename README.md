...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 197,719 | 🐛 2,942 | 🌐 C++ | 📅 2026-08-27 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,613 | 🐛 17,373 | 🌐 Python | 📅 2026-08-27 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,255 | 🐛 248 | 🌐 Python | 📅 2026-08-26 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,062 | 🐛 1,504 | 🌐 C++ | 📅 2026-08-27 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [kserve](https://github.com/kserve/kserve) ⭐ 5,836 | 🐛 206 | 🌐 Go | 📅 2026-08-26 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 57,383 | 🐛 4,868 | 🌐 Python | 📅 2026-08-27 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,048 | 🐛 189 | 🌐 Lua | 📅 2026-08-16 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,041 | 🐛 251 | 🌐 Lua | 📅 2026-08-27 - The Cloud-Native API Gateway.
...
* [higress](https://github.com/alibaba/higress) ⭐ 9,209 | 🐛 1,082 | 🌐 Go | 📅 2026-08-27 - Next-generation Cloud Native Gateway.
* [ocelot](https://github.com/ThreeMammals/Ocelot) ⭐ 8,716 | 🐛 61 | 🌐 C# | 📅 2026-08-26 - .NET core API Gateway.
* [lura](https://github.com/luraproject/lura) ⭐ 6,792 | 🐛 13 | 🌐 Go | 📅 2026-08-26 - Ultra performant API Gateway with middlewares. A project hosted at The Linux Foundation.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 2,992 | 🐛 768 | 🌐 Go | 📅 2026-08-27 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
* [orange](https://github.com/orlabs/orange) ⭐ 2,308 | 🐛 77 | 🌐 Lua | 📅 2023-08-25 - OpenResty/Nginx Gateway for API Monitoring and Management.
* [bricksllm](https://github.com/bricks-cloud/BricksLLM) ⭐ 1,227 | 🐛 21 | 🌐 Go | 📅 2025-01-05 - Enterprise-grade API gateway that helps you monitor and impose cost or rate limits per API key. Get fine-grained access control and monitoring per user, application, or environment. Supports OpenAI, Azure OpenAI, Anthropic, vLLM, and open-source LLMs.
* [haproxy-ingress](https://github.com/jcmoraisjr/haproxy-ingress) ⭐ 1,164 | 🐛 85 | 🌐 Go | 📅 2026-08-24 - HaProxy Ingress.
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,150 | 🐛 116 | 🌐 Go | 📅 2026-08-27 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [gloo](https://github.com/solo-io/gloo) ⭐ 170 | 🐛 1,868 | 🌐 Go | 📅 2026-08-26 - The Feature-rich, Kubernetes-native, Next-Generation API Gateway Built on Envoy.
...
* [sbproxy](https://github.com/soapbucket/sbproxy) ⭐ 51 | 🐛 6 | 🌐 Rust | 📅 2026-08-27 - Single-binary AI gateway and reverse proxy with 103+ LLM providers, cost-based routing, rate limiting, and declarative YAML configuration.

## Continuous Delivery & GitOps

* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,546 | 🐛 1,915 | 🌐 Go | 📅 2026-08-27 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
...
* [helm](https://github.com/helm/helm) ⭐ 30,177 | 🐛 450 | 🌐 Go | 📅 2026-08-25 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 29,945 | 🐛 320 | 🌐 Go | 📅 2026-08-27 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,504 | 🐛 3,610 | 🌐 Java | 📅 2026-08-27 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,615 | 🐛 2,447 | 🌐 Go | 📅 2026-08-27 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 24,006 | 🐛 4,401 | 🌐 Go | 📅 2026-08-27 - Declarative continuous deployment for Kubernetes.
...
* [dagger](https://github.com/dagger/dagger) ⭐ 16,204 | 🐛 141 | 🌐 Go | 📅 2026-08-27 - A programmable CI/CD engine that runs your pipelines in containers.
* [skaffold](https://github.com/GoogleContainerTools/skaffold) ⭐ 15,889 | 🐛 902 | 🌐 Go | 📅 2026-08-24 - Easy and Repeatable Kubernetes Development.
...
* [kustomize](https://github.com/kubernetes-sigs/kustomize) ⭐ 12,146 | 🐛 189 | 🌐 Go | 📅 2026-08-24 - Customization of kubernetes YAML configurations.
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 11,979 | 🐛 186 | 🌐 Go | 📅 2026-08-26 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,588 | 🐛 1,835 | 🌐 TypeScript | 📅 2026-08-27 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,777 | 🐛 107 | 🌐 Java | 📅 2026-08-25 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,050 | 🐛 556 | 🌐 Go | 📅 2026-08-27 - A cloud-native Pipeline resource.
...
* [kubevela](https://github.com/oam-dev/kubevela) ⭐ 7,888 | 🐛 277 | 🌐 Go | 📅 2026-08-24 - Make shipping applications more enjoyable.
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,756 | 🐛 365 | 🌐 Go | 📅 2026-08-27 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
...
* [werf](https://github.com/werf/werf) ⭐ 4,717 | 🐛 28 | 🌐 Go | 📅 2026-08-26 - The CLI tool gluing Git, Docker, Helm, and Kubernetes with any CI system to implement CI/CD and Giterminism.
...
* [kargo](https://github.com/akuity/kargo) ⭐ 3,604 | 🐛 171 | 🌐 Go | 📅 2026-08-27 - Application lifecycle orchestration.
...
* [zadig](https://github.com/koderover/zadig) ⭐ 3,235 | 🐛 26 | 🌐 Go | 📅 2026-08-27 - Zadig is a cloud native, distributed, developer-oriented continuous delivery product.
...
* [kcl](https://github.com/kcl-lang/kcl) ⭐ 2,404 | 🐛 81 | 🌐 Rust | 📅 2026-08-27 - KCL is a constraint-based record & functional language mainly used in configuration and policy scenarios. (CNCF Sandbox Project).
...
* [kpt](https://github.com/GoogleContainerTools/kpt) ⭐ 1,890 | 🐛 342 | 🌐 Go | 📅 2026-08-26 - Kpt is a toolkit to help you manage, manipulate, customize, and apply Kubernetes Resource configuration data files.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,665 | 🐛 326 | 🌐 Go | 📅 2026-08-27 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,345 | 🐛 221 | 🌐 Go | 📅 2026-08-27 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,768 | 🐛 316 | 🌐 Go | 📅 2026-08-27 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,220 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,194 | 🐛 89 | 🌐 Go | 📅 2026-08-26 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,491 | 🐛 387 | 🌐 Go | 📅 2026-08-26 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,479 | 🐛 834 | 🌐 Python | 📅 2026-08-26 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,762 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-27 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,368 | 🐛 164 | 🌐 Go | 📅 2026-08-23 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,268 | 🐛 191 | 🌐 Go | 📅 2026-08-27 - Enforce Kubernetes admission policies using Open Policy Agent constraints.
...
* [pluto](https://github.com/FairwindsOps/pluto) ⭐ 2,570 | 🐛 12 | 🌐 Go | 📅 2026-08-26 - A cli tool to help discover deprecated apiVersions in Kubernetes.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,245 | 🐛 39 | 🌐 Python | 📅 2026-08-27 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 233 | 🐛 136 | 🌐 Rust | 📅 2026-08-27 - Policy as code for Kubernetes powered by WebAssembly modules.
...
* [vagrant](https://github.com/hashicorp/vagrant) ⭐ 27,203 | 🐛 753 | 🌐 Ruby | 📅 2026-08-03 - Vagrant is a tool for building and distributing development environments.
...
* [sealos](https://github.com/labring/sealos) ⭐ 18,325 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-27 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,670 | 🐛 136 | 🌐 Go | 📅 2026-08-27 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
...
* [talos](https://github.com/talos-systems/talos) ⭐ 11,027 | 🐛 225 | 🌐 Go | 📅 2026-08-27 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,359 | 🐛 165 | 🌐 Python | 📅 2026-08-22 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,213 | 🐛 90 | 🌐 Go | 📅 2026-08-27 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,288 | 🐛 221 | 🌐 Go | 📅 2026-08-27 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 3,997 | 🐛 38 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,432 | 🐛 201 | 🌐 Go | 📅 2026-08-27 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
...
* [fleet](https://github.com/rancher/fleet) ⭐ 1,724 | 🐛 192 | 🌐 Go | 📅 2026-08-27 - Manage large fleets of Kubernetes clusters.
...
* [usernetes](https://github.com/rootless-containers/usernetes) ⭐ 986 | 🐛 28 | 🌐 Shell | 📅 2026-08-26 - Kubernetes installable under $HOME, without the root privileges.
...
* [client-go](https://github.com/kubernetes/client-go) ⭐ 9,868 | 🐛 0 | 🌐 Go | 📅 2026-08-27 - Go client for Kubernetes.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,121 | 🐛 89 | 🌐 Go | 📅 2026-08-27 - Giving Kubernetes Superpowers to everyone.
...
* [cri-tools](https://github.com/kubernetes-sigs/cri-tools) ⭐ 2,009 | 🐛 16 | 🌐 Go | 📅 2026-08-27 - CLI and validation tools for Kubelet Container Runtime Interface (CRI).
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,017 | 🐛 124 | 🌐 Go | 📅 2026-08-27 - Test infrastructure for the Kubernetes project.
...
* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,255 | 🐛 824 | 🌐 Go | 📅 2026-08-27 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [karpenter](https://github.com/aws/karpenter) ⭐ 7,708 | 🐛 499 | 🌐 Go | 📅 2026-08-26 - Kubernetes Node Autoscaling: built for flexibility, performance, and scalability.
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,700 | 🐛 296 | 🌐 Go | 📅 2026-08-26 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,700 | 🐛 296 | 🌐 Go | 📅 2026-08-26 - Kubernetes cost monitoring powered by open allocation models.
...
* [dragonfly2](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,311 | 🐛 31 | 🌐 Go | 📅 2026-08-27 - Dragonfly is an intelligent P2P based file distribution system.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 28,992 | 🐛 1,138 | 🌐 JavaScript | 📅 2026-08-27 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,122 | 🐛 2,917 | 🌐 C | 📅 2026-08-27 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,752 | 🐛 715 | 🌐 TypeScript | 📅 2026-08-27 - The Open Source Airtable alternative.
...
* [milvus](https://github.com/milvus-io/milvus) ⭐ 45,822 | 🐛 1,330 | 🌐 Go | 📅 2026-08-27 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,475 | 🐛 6,834 | 🌐 Go | 📅 2026-08-27 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,365 | 🐛 402 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,422 | 🐛 8,426 | 🌐 Go | 📅 2026-08-26 - CockroachDB - the open source, cloud-native SQL database.
...
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,509 | 🐛 32 | 🌐 C++ | 📅 2026-08-27 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,994 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,425 | 🐛 399 | 🌐 C | 📅 2026-08-27 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,789 | 🐛 216 | 🌐 Java | 📅 2026-08-27 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,812 | 🐛 1,797 | 🌐 Rust | 📅 2026-08-27 - Distributed transactional key-value database, originally created to complement TiDB.
...
* [oceanbase](https://github.com/oceanbase/oceanbase) ⭐ 10,256 | 🐛 584 | 🌐 C++ | 📅 2026-08-27 - A distributed, banking suitable, open-source related database featuring high scalability and high compatibility.
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,424 | 🐛 564 | 🌐 Rust | 📅 2026-08-27 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 6,990 | 🐛 149 | 🌐 Go | 📅 2026-08-26 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
* [couchdb](https://github.com/apache/couchdb) ⭐ 6,942 | 🐛 368 | 🌐 Erlang | 📅 2026-08-27 - Apache CouchDB is one of a new breed of database management systems.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,241 | 🐛 860 | 🌐 Go | 📅 2026-08-27 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,262 | 🐛 1,092 | 🌐 Go | 📅 2026-08-27 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 16,969 | 🐛 1,287 | 🌐 C++ | 📅 2026-08-27 - Ceph is a distributed object, block, and file storage platform.
...
* [rook](https://github.com/rook/rook) ⭐ 13,616 | 🐛 135 | 🌐 Go | 📅 2026-08-26 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,804 | 🐛 38 | 📅 2026-08-27 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
...
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,941 | 🐛 1,877 | 🌐 Shell | 📅 2026-08-26 - We put storage on cows and move them around from rancher.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,661 | 🐛 86 | 🌐 Go | 📅 2026-08-26 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,403 | 🐛 75 | 🌐 Go | 📅 2026-08-25 - OCI registry client, managing content like artifacts, images, packages.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,633 | 🐛 525 | 🌐 Java | 📅 2026-08-27 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,774 | 🐛 77 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,572 | 🐛 575 | 🌐 Java | 📅 2026-08-26 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,612 | 🐛 542 | 🌐 Go | 📅 2026-08-27 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,662 | 🐛 175 | 🌐 Erlang | 📅 2026-08-27 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,315 | 🐛 1,739 | 🌐 Java | 📅 2026-08-27 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,576 | 🐛 56 | 🌐 Java | 📅 2026-08-27 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [istio](https://github.com/istio/istio) ⭐ 38,361 | 🐛 511 | 🌐 Go | 📅 2026-08-27 - Connect, secure, control, and observe services.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,045 | 🐛 1,420 | 🌐 Go | 📅 2026-08-27 - Consul is a distributed, highly available, and data center aware solution to connect and configure applications across dynamic, distributed infrastructure.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,995 | 🐛 141 | 🌐 Go | 📅 2026-08-27 - Universal Control Plane for your Service Mesh.
...
* [zookeeper](https://github.com/apache/zookeeper) ⭐ 12,795 | 🐛 241 | 🌐 Java | 📅 2026-08-25 - Apache ZooKeeper is an effort to develop and maintain an open-source server which enables highly reliable distributed coordination.
...
* [cilium](https://github.com/cilium/cilium) ⭐ 25,017 | 🐛 1,097 | 🌐 Go | 📅 2026-08-27 - API-aware Networking and Security using eBPF and XDP.
* [flannel](https://github.com/coreos/flannel) ⭐ 9,523 | 🐛 28 | 🌐 Go | 📅 2026-08-24 - Flannel is a network fabric for containers, designed for Kubernetes.
...
* [ziti](https://github.com/openziti/ziti) ⭐ 4,360 | 🐛 279 | 🌐 Go | 📅 2026-08-26 - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network.
...
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,394 | 🐛 65 | 🌐 Go | 📅 2026-08-27 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,807 | 🐛 197 | 🌐 Go | 📅 2026-08-27 - Antrea is a Kubernetes networking based on Open vSwitch.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,244 | 🐛 266 | 🌐 Go | 📅 2026-08-25 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,614 | 🐛 915 | 🌐 Go | 📅 2026-08-26 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,507 | 🐛 468 | 🌐 C | 📅 2026-08-26 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,826 | 🐛 1,872 | 🌐 C++ | 📅 2026-08-27 - C++ front/service proxy.
...
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,812 | 🐛 382 | 🌐 C | 📅 2026-08-26 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,304 | 🐛 0 | 🌐 C | 📅 2026-08-26 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,070 | 🐛 250 | 🌐 Go | 📅 2026-08-27 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [contour](https://github.com/projectcontour/contour) ⭐ 3,945 | 🐛 122 | 🌐 HTML | 📅 2026-08-26 - Contour is a Kubernetes ingress controller for Lyft's Envoy proxy.
...
* [kong/kubernetes-ingress-controller](https://github.com/Kong/kubernetes-ingress-controller) ⭐ 2,408 | 🐛 278 | 🌐 Go | 📅 2026-08-27 - Deploy Kong in a native Kubernetes Ingress Controller.
...
* [func-e](https://github.com/tetratelabs/func-e) ⭐ 384 | 🐛 1 | 🌐 Go | 📅 2026-08-27 - func-e (pronounced funky) makes running Envoy easy.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,594 | 🐛 463 | 🌐 C++ | 📅 2026-08-27 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,954 | 🐛 18 | 🌐 C++ | 📅 2026-08-24 - Apache thrift.
...
* [proxygen](https://github.com/facebook/proxygen) ⭐ 8,376 | 🐛 39 | 🌐 C++ | 📅 2026-08-26 - A collection of C++ HTTP libraries including an easy to use HTTP server.
* [kitex](https://github.com/cloudwego/kitex) ⭐ 8,027 | 🐛 71 | 🌐 Go | 📅 2026-08-26 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices.
...
* [moby](https://github.com/moby/moby) ⭐ 72,002 | 🐛 3,905 | 🌐 Go | 📅 2026-08-27 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,703 | 🐛 1,135 | 🌐 Go | 📅 2026-08-27 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,766 | 🐛 537 | 🌐 Go | 📅 2026-08-27 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,199 | 🐛 453 | 🌐 Go | 📅 2026-08-27 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,168 | 🐛 828 | 🌐 Go | 📅 2026-08-27 - Sandboxed Container Runtime.
...
* [spin](https://github.com/fermyon/spin) ⭐ 6,505 | 🐛 262 | 🌐 Rust | 📅 2026-08-26 - Spin is an open source framework for building and running fast, secure, and composable cloud microservices with WebAssembly.
* [wazero](https://github.com/tetratelabs/wazero) ⭐ 6,345 | 🐛 40 | 🌐 Go | 📅 2026-08-24 - The zero dependency WebAssembly runtime for Go developers.
...
* [crun](https://github.com/containers/crun) ⭐ 4,084 | 🐛 55 | 🌐 C | 📅 2026-08-25 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [firecracker-containerd](https://github.com/firecracker-microvm/firecracker-containerd) ⭐ 2,911 | 🐛 95 | 🌐 Go | 📅 2026-08-17 - firecracker-containerd enables containerd to manage containers as Firecracker microVMs.
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,422 | 🐛 59 | 🌐 Rust | 📅 2026-08-26 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
...
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,406 | 🐛 260 | 🌐 Go | 📅 2026-08-25 - OpenChoreo is a developer platform for Kubernetes.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,287 | 🐛 2,986 | 🌐 Go | 📅 2026-08-27 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,065 | 🐛 99 | 🌐 Go | 📅 2026-08-27 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,951 | 🐛 321 | 🌐 Go | 📅 2026-08-26 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
...
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,901 | 🐛 802 | 🌐 Go | 📅 2026-08-27 - A Kubernetes Native Batch System (Project under CNCF).
* [swarm](https://github.com/docker/classicswarm) ⚠️ Archived - Swarm: a Docker-native clustering system.
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,576 | 🐛 844 | 🌐 Go | 📅 2026-08-27 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
* [descheduler](https://github.com/kubernetes-sigs/descheduler) ⭐ 5,497 | 🐛 61 | 🌐 Go | 📅 2026-08-25 - Descheduler for Kubernetes.
...
* [kruise](https://github.com/openkruise/kruise) ⭐ 5,325 | 🐛 81 | 🌐 Go | 📅 2026-08-27 - Automate application workloads management on Kubernetes.
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,443 | 🐛 48 | 🌐 Go | 📅 2026-08-27 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,907 | 🐛 723 | 🌐 Go | 📅 2026-08-27 - Kubernetes-native Job Queueing.
* [kcp](https://github.com/kcp-dev/kcp) ⭐ 2,816 | 🐛 149 | 🌐 Go | 📅 2026-08-27 - Multi-tenant control plane for running many virtual Kubernetes clusters.
* [fleet](https://github.com/coreos/fleet) ⚠️ Archived - Fleet ties together systemd and etcd into a distributed init system.
* [koordinator](https://github.com/koordinator-sh/koordinator) ⭐ 1,746 | 🐛 307 | 🌐 Go | 📅 2026-08-27 - QoS based scheduling system for hybrid orchestration workloads on Kubernetes, bringing workloads the best layout and status.
* [eks-distro](https://github.com/aws/eks-distro) ⭐ 1,457 | 🐛 102 | 🌐 Shell | 📅 2026-08-26 - Amazon EKS Distro (EKS-D) is a Kubernetes distribution based on and used by Amazon Elastic Kubernetes Service (EKS) to create reliable and secure Kubernetes clusters.
* [ocm](https://github.com/open-cluster-management-io/OCM) ⭐ 1,080 | 🐛 51 | 🌐 Go | 📅 2026-08-27 - The open-cluster-management.io project is focused on enabling end-to-end visibility and control across your Kubernetes clusters.
...
* [serverless](https://github.com/serverless/serverless) ⭐ 46,919 | 🐛 1,225 | 🌐 JavaScript | 📅 2026-08-26 - Serverless Framework – Build web, mobile and IoT applications with serverless architectures using AWS Lambda, Azure Functions, Google CloudFunctions & more!
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,312 | 🐛 104 | 🌐 Rust | 📅 2026-08-26 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,038 | 🐛 433 | 🌐 Go | 📅 2026-08-27 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
...
* [keda](https://github.com/kedacore/keda) ⭐ 10,471 | 🐛 244 | 🌐 Go | 📅 2026-08-27 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
* [serving](https://github.com/knative/serving) ⭐ 6,086 | 🐛 161 | 🌐 Go | 📅 2026-08-25 - Kubernetes-based, scale-to-zero, request-driven compute.
...
* [faas-netes](https://github.com/openfaas/faas-netes) ⭐ 2,170 | 🐛 39 | 🌐 Go | 📅 2026-08-26 - Enable Kubernetes as a backend for Functions as a Service (OpenFaaS).
...
* [eventing](https://github.com/knative/eventing) ⭐ 1,551 | 🐛 97 | 🌐 Go | 📅 2026-08-26 - Open source specification and implementation of Knative event binding and delivery.
...
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,294 | 🐛 72 | 🌐 Go | 📅 2026-08-27 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
...
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,031 | 🐛 573 | 🌐 Go | 📅 2026-08-27 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,916 | 🐛 154 | 🌐 Java | 📅 2026-08-27 - Apache Kafka running on Kubernetes.
...
* [kaito](https://github.com/Azure/kaito) ⭐ 1,003 | 🐛 63 | 🌐 Go | 📅 2026-08-26 - Kubernetes AI Toolchain Operator.
* [k0smotron](https://github.com/k0sproject/k0smotron) ⭐ 737 | 🐛 53 | 🌐 Go | 📅 2026-08-26 - k0smotron is a powerful open-source tool for the efficient management of k0s Kubernetes clusters.
...
* [gateway-operator](https://github.com/kong/gateway-operator) ⭐ 108 | 🐛 205 | 🌐 Go | 📅 2026-08-27 - Kong Gateway Operator is a Kubernetes Operator that can manage your Kong Ingress Controller, Kong Gateway Data Planes, or both together when running on Kubernetes.
* [kubevirtbmc](https://github.com/kubevirtbmc/kubevirtbmc) ⭐ 88 | 🐛 28 | 🌐 Go | 📅 2026-08-27 - A Kubernetes operator of virtual BMCs that provide Redfish and IPMI services for KubeVirt virtual machines.
...
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,454 | 🐛 201 | 🌐 Go | 📅 2026-08-27 - Zero Friction Kubernetes.
* [openyurt](https://github.com/openyurtio/openyurt) ⭐ 2,000 | 🐛 122 | 🌐 Go | 📅 2026-08-24 - Extending your native Kubernetes to edge(project under CNCF).
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,446 | 🐛 3,321 | 🌐 TypeScript | 📅 2026-08-27 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
...
* [kibana](https://github.com/elastic/kibana) ⭐ 21,265 | 🐛 14,256 | 🌐 TypeScript | 📅 2026-08-27 - Kibana analytics and search dashboard for Elasticsearch.
* [cadvisor](https://github.com/google/cadvisor) ⭐ 19,382 | 🐛 61 | 🌐 Go | 📅 2026-07-20 - Analyzes resource usage and performance characteristics of running containers.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,599 | 🐛 789 | 🌐 Go | 📅 2026-08-27 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,060 | 🐛 148 | 🌐 Go | 📅 2026-08-27 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
...
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,459 | 🐛 693 | 🌐 Go | 📅 2026-08-27 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,186 | 🐛 106 | 🌐 Go | 📅 2026-08-23 - Add-on agent to generate and expose cluster-level metrics.
...
* [cortex](https://github.com/cortexproject/cortex) ⭐ 5,856 | 🐛 355 | 🌐 Go | 📅 2026-08-27 - A multitenant, horizontally scalable Prometheus as a Service.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,955 | 🐛 262 | 🌐 C | 📅 2026-08-27 - eBPF-based Security Observability and Runtime Enforcement.
* [parca](https://github.com/parca-dev/parca) ⭐ 4,951 | 🐛 204 | 🌐 TypeScript | 📅 2026-08-27 - Continuous profiling for analysis of CPU and memory usage, down to the line number and throughout time. Saving infrastructure cost, improving performance, and increasing reliability.
* [deepflow](https://github.com/deepflowys/deepflow) ⭐ 4,244 | 🐛 269 | 🌐 Go | 📅 2026-08-27 - A highly automated observability platform.
* [metaflow](https://github.com/metaflowys/metaflow) ⭐ 4,244 | 🐛 269 | 🌐 Go | 📅 2026-08-27 - MetaFlow is an automated observability platform for cloud-native developers.
...
* [kiali](https://github.com/kiali/kiali) ⭐ 3,633 | 🐛 78 | 🌐 Go | 📅 2026-08-26 - Kiali project to help istio service mesh observability.
...
* [perses](https://github.com/perses/perses) ⭐ 2,379 | 🐛 265 | 🌐 Go | 📅 2026-08-26 - The CNCF candidate for observability visualisation.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,869 | 🐛 5,949 | 🌐 Java | 📅 2026-08-27 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,793 | 🐛 1,723 | 🌐 Go | 📅 2026-08-27 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,465 | 🐛 2,527 | 🌐 Rust | 📅 2026-08-27 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,770 | 🐛 422 | 🌐 Go | 📅 2026-08-26 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,579 | 🐛 137 | 🌐 Ruby | 📅 2026-08-24 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,640 | 🐛 1,032 | 🌐 Go | 📅 2026-08-27 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,550 | 🐛 803 | 🌐 Rust | 📅 2026-08-26 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,064 | 🐛 783 | 🌐 C | 📅 2026-08-27 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,628 | 🐛 2,227 | 🌐 Python | 📅 2026-08-27 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,931 | 🐛 41 | 🌐 Java | 📅 2026-08-26 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,145 | 🐛 555 | 🌐 Go | 📅 2026-08-26 - Jaeger, a Distributed Tracing System.
...
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,324 | 🐛 479 | 🌐 Makefile | 📅 2026-08-27 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,651 | 🐛 261 | 🌐 Go | 📅 2026-08-21 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
* [keycloak](https://github.com/keycloak/keycloak) ⭐ 36,445 | 🐛 3,131 | 🌐 Java | 📅 2026-08-27 - Open Source Identity and Access Management For Modern Applications and Services.
* [vault](https://github.com/hashicorp/vault) ⭐ 36,178 | 🐛 1,431 | 🌐 Go | 📅 2026-08-26 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,853 | 🐛 3,352 | 🌐 Go | 📅 2026-08-26 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
* [supertokens-core](https://github.com/supertokens/supertokens-core) ⭐ 15,286 | 🐛 174 | 🌐 Java | 📅 2026-08-26 - Open source alternative to Auth0 / Firebase Auth / AWS Cognito.
...
* [kratos](https://github.com/ory/kratos) ⭐ 13,850 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication, MFA, FIDO2, profile management, identity schemas, social sign in, registration, account recovery, service-to-service and IoT auth. Can work as an OAuth2 / OpenID Connect Provider. Golang, headless, API-only - without templating or theming headaches.
* [grype](https://github.com/anchore/grype) ⭐ 12,791 | 🐛 411 | 🌐 Go | 📅 2026-08-27 - A vulnerability scanner for container images and filesystems.
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,171 | 🐛 342 | 🌐 Go | 📅 2026-08-27 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,693 | 🐛 66 | 🌐 Go | 📅 2026-08-27 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
* [dex](https://github.com/dexidp/dex) ⭐ 11,066 | 🐛 531 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors.
...
* [syft](https://github.com/anchore/syft) ⭐ 9,463 | 🐛 629 | 🌐 Go | 📅 2026-08-27 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,309 | 🐛 65 | 🌐 C++ | 📅 2026-08-03 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,043 | 🐛 396 | 🌐 Elixir | 📅 2026-08-27 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,972 | 🐛 167 | 🌐 Python | 📅 2026-08-27 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
...
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,076 | 🐛 643 | 🌐 Go | 📅 2026-08-27 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,810 | 🐛 261 | 🌐 Go | 📅 2026-08-27 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,258 | 🐛 170 | 🌐 Go | 📅 2026-08-24 - Container signing, verification, and provenance powered by Sigstore.
...
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,979 | 🐛 151 | 🌐 Go | 📅 2026-08-26 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,766 | 🐛 124 | 🌐 Go | 📅 2026-08-27 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [authenticator](https://github.com/kubernetes-sigs/aws-iam-authenticator) ⭐ 2,332 | 🐛 19 | 🌐 Go | 📅 2026-08-26 - A tool for using AWS IAM credentials to authenticate to a Kubernetes cluster.
...
* [spiffe](https://github.com/spiffe/spiffe) ⭐ 1,834 | 🐛 52 | 🌐 Shell | 📅 2026-08-27 - The SPIFFE Project.
* [cedar](https://github.com/cedar-policy/cedar) ⭐ 1,695 | 🐛 170 | 🌐 Rust | 📅 2026-08-26 - Core implementation of the Cedar language.
...
* [neuvector](https://github.com/neuvector/neuvector) ⭐ 1,330 | 🐛 306 | 🌐 Go | 📅 2026-08-27 - Kubernetes-native container security platform.
...
* [brood-box](https://github.com/stacklok/brood-box) ⭐ 62 | 🐛 13 | 🌐 Go | 📅 2026-08-26 - CLI tool for running coding agents inside hardware-isolated microVMs with workspace snapshot isolation and egress control.
...
* [go-microvm](https://github.com/stacklok/go-microvm) ⭐ 22 | 🐛 11 | 🌐 Go | 📅 2026-08-27 - Go framework for running OCI images as microVMs via libkrun with embedded runtime, rootfs management, and guest networking.
...
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,473 | 🐛 1 | 🌐 Java | 📅 2026-08-10 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
...
* [litmus](https://github.com/litmuschaos/litmus) ⭐ 5,603 | 🐛 396 | 🌐 Go | 📅 2026-08-25 - Litmus helps SREs and developers practice chaos engineering in a Cloud-native way.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,649 | 🐛 51 | 🌐 Go | 📅 2026-08-27 - Kubernetes-native framework for test definition and execution.
* [krkn](https://github.com/krkn-chaos/krkn) ⭐ 491 | 🐛 139 | 🌐 Python | 📅 2026-08-25 - Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,356 | 🐛 746 | 🌐 TypeScript | 📅 2026-08-27 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,267 | 🐛 407 | 🌐 TypeScript | 📅 2026-08-26 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,873 | 🐛 3,351 | 🌐 Go | 📅 2026-08-27 - Complete container management platform.
* [kubesphere](https://github.com/kubesphere/kubesphere) ⭐ 17,028 | 🐛 354 | 🌐 Go | 📅 2026-07-15 - Enterprise Container Managent Platform.
* [dashboard](https://github.com/kubernetes/dashboard) ⚠️ Archived - General-purpose web UI for Kubernetes clusters.
* [openshift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 313 | 🌐 Go | 📅 2026-08-27 - Enterprise Kubernetes for Developers.
...
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,142 | 🐛 53 | 🌐 Go | 📅 2026-08-27 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
...
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,528 | 🐛 3 | 🌐 Rust | 📅 2026-08-26 - A simple and fast dashboard for Kubernetes.
...
* [kubermatic](https://github.com/kubermatic/kubermatic) ⭐ 1,298 | 🐛 462 | 🌐 Go | 📅 2026-08-27 - The Central Kubernetes Management Platform For Any Infrastructure.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 128 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-27 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,615 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-21 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,556 | 🐛 54 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
...
* [kubernetes-on-aws](https://github.com/zalando-incubator/kubernetes-on-aws) ⭐ 635 | 🐛 39 | 🌐 Go | 📅 2026-08-27 - Deploying Kubernetes on AWS with CloudFormation and Ubuntu.
