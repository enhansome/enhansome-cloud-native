...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 198,060 | 🐛 2,984 | 🌐 C++ | 📅 2026-08-30 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,675 | 🐛 17,462 | 🌐 Python | 📅 2026-08-30 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,269 | 🐛 234 | 🌐 Python | 📅 2026-08-29 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,063 | 🐛 1,505 | 🌐 C++ | 📅 2026-08-28 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [h2o-3](https://github.com/h2oai/h2o-3) ⭐ 7,497 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-08-26 - Open Source Fast Scalable Machine Learning API For Smarter Applications (Deep Learning, Gradient Boosting, Random Forest, Generalized Linear Modeling (Logistic Regression, Elastic Net), K-Means, PCA, Stacked Ensembles.)
* [kserve](https://github.com/kserve/kserve) ⭐ 5,841 | 🐛 201 | 🌐 Go | 📅 2026-08-30 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 57,590 | 🐛 4,897 | 🌐 Python | 📅 2026-08-30 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,059 | 🐛 193 | 🌐 Lua | 📅 2026-08-16 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,057 | 🐛 248 | 🌐 Lua | 📅 2026-08-28 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,809 | 🐛 498 | 🌐 Go | 📅 2026-08-28 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,243 | 🐛 1,083 | 🌐 Go | 📅 2026-08-30 - Next-generation Cloud Native Gateway.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 2,997 | 🐛 755 | 🌐 Go | 📅 2026-08-30 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,153 | 🐛 111 | 🌐 Go | 📅 2026-08-30 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,576 | 🐛 1,921 | 🌐 Go | 📅 2026-08-28 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,171 | 🐛 103 | 🌐 Go | 📅 2026-08-28 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,194 | 🐛 456 | 🌐 Go | 📅 2026-08-28 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 29,976 | 🐛 322 | 🌐 Go | 📅 2026-08-28 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,515 | 🐛 3,611 | 🌐 Java | 📅 2026-08-29 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,628 | 🐛 2,452 | 🌐 Go | 📅 2026-08-30 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 24,038 | 🐛 4,420 | 🌐 Go | 📅 2026-08-30 - Declarative continuous deployment for Kubernetes.
...
* [dagger](https://github.com/dagger/dagger) ⭐ 16,214 | 🐛 146 | 🌐 Go | 📅 2026-08-30 - A programmable CI/CD engine that runs your pipelines in containers.
* [skaffold](https://github.com/GoogleContainerTools/skaffold) ⭐ 15,891 | 🐛 904 | 🌐 Go | 📅 2026-08-29 - Easy and Repeatable Kubernetes Development.
...
* [kustomize](https://github.com/kubernetes-sigs/kustomize) ⭐ 12,149 | 🐛 189 | 🌐 Go | 📅 2026-08-27 - Customization of kubernetes YAML configurations.
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 11,993 | 🐛 188 | 🌐 Go | 📅 2026-08-27 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,609 | 🐛 1,853 | 🌐 TypeScript | 📅 2026-08-30 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,780 | 🐛 102 | 🌐 Java | 📅 2026-08-28 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,055 | 🐛 569 | 🌐 Go | 📅 2026-08-28 - A cloud-native Pipeline resource.
* [ko](https://github.com/ko-build/ko) ⭐ 8,516 | 🐛 56 | 🌐 Go | 📅 2026-08-26 - Build and deploy Go applications on Kubernetes.
* [spec](https://github.com/score-spec/spec) ⭐ 8,088 | 🐛 12 | 🌐 Makefile | 📅 2026-07-27 - The score specification file.
* [kubevela](https://github.com/oam-dev/kubevela) ⭐ 7,889 | 🐛 272 | 🌐 Go | 📅 2026-08-28 - Make shipping applications more enjoyable.
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,786 | 🐛 368 | 🌐 Go | 📅 2026-08-30 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
...
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,591 | 🐛 766 | 🌐 Go | 📅 2026-08-24 - Software Delivery Workflow For Kubernetes
...
* [werf](https://github.com/werf/werf) ⭐ 4,720 | 🐛 29 | 🌐 Go | 📅 2026-08-29 - The CLI tool gluing Git, Docker, Helm, and Kubernetes with any CI system to implement CI/CD and Giterminism.
* [jx](https://github.com/jenkins-x/jx) ⭐ 4,691 | 🐛 147 | 🌐 Go | 📅 2026-08-10 - A command line tool for installing and working with Jenkins X.
* [arkade](https://github.com/alexellis/arkade) ⭐ 4,610 | 🐛 16 | 🌐 Go | 📅 2026-08-29 - Kubernetes apps for developers.
...
* [spegel](https://github.com/spegel-org/spegel) ⭐ 3,757 | 🐛 25 | 🌐 Go | 📅 2026-08-28 - Stateless cluster local OCI registry mirror.
* [kargo](https://github.com/akuity/kargo) ⭐ 3,617 | 🐛 181 | 🌐 Go | 📅 2026-08-30 - Application lifecycle orchestration.
...
* [argo-rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,562 | 🐛 663 | 🌐 Go | 📅 2026-08-28 - Progressive delivery controller for blue-green, canary, and experiments on Kubernetes.
* [zadig](https://github.com/koderover/zadig) ⭐ 3,236 | 🐛 25 | 🌐 Go | 📅 2026-08-28 - Zadig is a cloud native, distributed, developer-oriented continuous delivery product.
...
* [source-to-image](https://github.com/openshift/source-to-image) ⭐ 2,543 | 🐛 28 | 🌐 Go | 📅 2026-08-30 - A tool for building/building artifacts from source and injecting into docker images.
* [kcl](https://github.com/kcl-lang/kcl) ⭐ 2,407 | 🐛 41 | 🌐 Rust | 📅 2026-08-30 - KCL is a constraint-based record & functional language mainly used in configuration and policy scenarios. (CNCF Sandbox Project).
...
* [hub](https://github.com/artifacthub/hub) ⭐ 2,080 | 🐛 26 | 🌐 TypeScript | 📅 2026-07-07 - Find, install and publish Cloud Native packages
* [timoni](https://github.com/stefanprodan/timoni) ⭐ 2,009 | 🐛 32 | 🌐 Go | 📅 2026-08-30 - Timoni is a package manager for Kubernetes, powered by CUE and inspired by Helm.
...
* [kpt](https://github.com/GoogleContainerTools/kpt) ⭐ 1,891 | 🐛 341 | 🌐 Go | 📅 2026-08-28 - Kpt is a toolkit to help you manage, manipulate, customize, and apply Kubernetes Resource configuration data files.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,666 | 🐛 334 | 🌐 Go | 📅 2026-08-29 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [helmsman](https://github.com/Praqma/helmsman) ⭐ 1,495 | 🐛 2 | 🌐 Go | 📅 2026-08-30 - Helm Charts as Code.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,348 | 🐛 222 | 🌐 Go | 📅 2026-08-29 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
...
* [screwdriver](https://github.com/screwdriver-cd/screwdriver) ⭐ 1,045 | 🐛 57 | 🌐 JavaScript | 📅 2026-08-28 - An open source build platform designed for continuous delivery.
...
* [beetle](https://github.com/Clivern/Beetle) ⭐ 167 | 🐛 16 | 🌐 Go | 📅 2026-08-30 - Kubernetes multi-cluster deployment automation service.
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,772 | 🐛 317 | 🌐 Go | 📅 2026-08-30 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,218 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,198 | 🐛 90 | 🌐 Go | 📅 2026-08-28 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,491 | 🐛 390 | 🌐 Go | 📅 2026-08-28 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,499 | 🐛 836 | 🌐 Python | 📅 2026-08-27 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,771 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-29 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,376 | 🐛 163 | 🌐 Go | 📅 2026-08-30 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,270 | 🐛 188 | 🌐 Go | 📅 2026-08-28 - Enforce Kubernetes admission policies using Open Policy Agent constraints.
...
* [pluto](https://github.com/FairwindsOps/pluto) ⭐ 2,574 | 🐛 15 | 🌐 Go | 📅 2026-08-30 - A cli tool to help discover deprecated apiVersions in Kubernetes.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,250 | 🐛 39 | 🌐 Python | 📅 2026-08-29 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 233 | 🐛 139 | 🌐 Rust | 📅 2026-08-30 - Policy as code for Kubernetes powered by WebAssembly modules.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 32,077 | 🐛 548 | 🌐 Go | 📅 2026-08-30 - Run Kubernetes locally.
* [vagrant](https://github.com/hashicorp/vagrant) ⭐ 27,205 | 🐛 753 | 🌐 Ruby | 📅 2026-08-03 - Vagrant is a tool for building and distributing development environments.
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,710 | 🐛 212 | 🌐 Jinja | 📅 2026-08-21 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,332 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-28 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
...
* [talos](https://github.com/talos-systems/talos) ⭐ 11,052 | 🐛 227 | 🌐 Go | 📅 2026-08-28 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,360 | 🐛 165 | 🌐 Python | 📅 2026-08-28 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,213 | 🐛 91 | 🌐 Go | 📅 2026-08-27 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,292 | 🐛 219 | 🌐 Go | 📅 2026-08-29 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 3,999 | 🐛 38 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,434 | 🐛 193 | 🌐 Go | 📅 2026-08-30 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
* [cloudpods](https://github.com/yunionio/cloudpods) ⭐ 2,935 | 🐛 210 | 🌐 Go | 📅 2026-08-28 - A cloud-native open-source unified multi-cloud and hybrid-cloud platform.
...
* [usernetes](https://github.com/rootless-containers/usernetes) ⭐ 988 | 🐛 27 | 🌐 Shell | 📅 2026-08-27 - Kubernetes installable under $HOME, without the root privileges.
* [claudie](https://github.com/berops/claudie) ⭐ 791 | 🐛 65 | 🌐 Go | 📅 2026-08-26 - Cloud-agnostic managed Kubernetes.
...
* [cluster-lifecycle-manager](https://github.com/zalando-incubator/cluster-lifecycle-manager) ⭐ 248 | 🐛 19 | 🌐 Go | 📅 2026-08-28 - Cluster Lifecycle Manager (CLM) to provision and update multiple Kubernetes clusters.
...
* [spinifex](https://github.com/mulgadc/spinifex) ⭐ 99 | 🐛 3 | 🌐 Go | 📅 2026-08-30 - Open source AWS-compatible platform for bare-metal, on-prem, and edge deployments. Run EC2, S3, EBS, and VPC-compatible services on your own hardware — no managed cloud required.
...
* [devspace](https://github.com/devspace-cloud/devspace) ⭐ 5,158 | 🐛 87 | 🌐 Go | 📅 2026-08-30 - Cloud Native Software Development with Kubernetes and Docker - simply run "devspace up" in any of your projects and start coding directly on top of Kubernetes (works with minikube, self-hosted and cloud-based clusters).
...
* [kubie](https://github.com/sbstp/kubie) ⭐ 2,625 | 🐛 59 | 🌐 Rust | 📅 2026-08-15 - A more powerful alternative to kubectx and kubens.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,556 | 🐛 19 | 🌐 Rust | 📅 2026-08-30 - Manage and run multiple kubectl port-forward configurations directly in the menu bar, syncing configurations with git repositories.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,133 | 🐛 93 | 🌐 Go | 📅 2026-08-30 - Giving Kubernetes Superpowers to everyone.
...
* [robusta](https://github.com/robusta-dev/robusta) ⭐ 3,083 | 🐛 202 | 🌐 Python | 📅 2026-08-30 - Open source Kubernetes troubleshooting and automation platform.
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,079 | 🐛 18 | 🌐 Go | 📅 2026-08-28 - Tools for observing Kubernetes resources in real time, powered by Pulumi.
...
* [cri-tools](https://github.com/kubernetes-sigs/cri-tools) ⭐ 2,010 | 🐛 17 | 🌐 Go | 📅 2026-08-27 - CLI and validation tools for Kubelet Container Runtime Interface (CRI).
...
* [memfree](https://github.com/memfreeme/memfree) ⭐ 1,505 | 🐛 18 | 🌐 TypeScript | 📅 2026-07-06 - Open Source Hybrid AI Search Engine, Instantly Get Accurate Answers from the Internet, Bookmarks, Notes, and Docs. Support One-Click Deployment.
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,017 | 🐛 126 | 🌐 Go | 📅 2026-08-30 - Test infrastructure for the Kubernetes project.
* [kwok](https://github.com/kubernetes-sigs/kwok) ⭐ 3,179 | 🐛 33 | 🌐 Go | 📅 2026-08-25 - Kubernetes WithOut Kubelet - Simulates thousands of Nodes and Clusters.
...
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 214 | 🐛 163 | 🌐 Python | 📅 2026-08-30 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
* [seaworthy](https://github.com/cakehappens/seaworthy) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2020-08-10 - A CLI to verify Kubernetes resource health.

## Data Protection & Backup

* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,259 | 🐛 843 | 🌐 Go | 📅 2026-08-29 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,714 | 🐛 297 | 🌐 Go | 📅 2026-08-26 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,714 | 🐛 297 | 🌐 Go | 📅 2026-08-26 - Kubernetes cost monitoring powered by open allocation models.
...
* [burn](https://github.com/tanrikuluozlem/burn) ⭐ 85 | 🐛 1 | 🌐 Go | 📅 2026-08-30 - CLI tool for Kubernetes cost analysis with per-namespace breakdown, real cloud pricing, and AI-powered recommendations.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 28,993 | 🐛 1,141 | 🌐 JavaScript | 📅 2026-08-28 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,149 | 🐛 2,922 | 🌐 C | 📅 2026-08-28 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
...
* [milvus](https://github.com/milvus-io/milvus) ⭐ 45,882 | 🐛 1,317 | 🌐 Go | 📅 2026-08-30 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,477 | 🐛 6,835 | 🌐 Go | 📅 2026-08-30 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,369 | 🐛 404 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,433 | 🐛 8,470 | 🌐 Go | 📅 2026-08-26 - CockroachDB - the open source, cloud-native SQL database.
...
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,521 | 🐛 32 | 🌐 C++ | 📅 2026-08-29 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,995 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,445 | 🐛 398 | 🌐 C | 📅 2026-08-30 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,789 | 🐛 210 | 🌐 Java | 📅 2026-08-30 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,820 | 🐛 1,802 | 🌐 Rust | 📅 2026-08-28 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,268 | 🐛 834 | 🌐 C++ | 📅 2026-08-29 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
* [nebula](https://github.com/vesoft-inc/nebula) ⭐ 12,367 | 🐛 678 | 🌐 C++ | 📅 2026-05-18 - A distributed, fast open-source graph database featuring horizontal scalability and high availability.
...
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,426 | 🐛 564 | 🌐 Rust | 📅 2026-08-30 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 7,002 | 🐛 146 | 🌐 Go | 📅 2026-08-28 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
...
* [kvrocks](https://github.com/KvrocksLabs/kvrocks) ⭐ 4,409 | 🐛 243 | 🌐 C++ | 📅 2026-08-28 - Kvrocks is a distributed key value NoSQL database based on RocksDB and compatible with Redis protocol.
* [polardb-for-postgresql](https://github.com/alibaba/PolarDB-for-PostgreSQL) ⭐ 3,196 | 🐛 65 | 🌐 C | 📅 2026-08-30 - PolarDB for PostgreSQL (PolarDB for short) is an open source database system based on PostgreSQL.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,116 | 🐛 251 | 🌐 Go | 📅 2026-08-30 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [xline](https://github.com/xline-kv/Xline) ⭐ 715 | 🐛 40 | 🌐 Rust | 📅 2026-08-17 - A geo-distributed KV store for metadata management.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,258 | 🐛 871 | 🌐 Go | 📅 2026-08-29 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,279 | 🐛 1,091 | 🌐 Go | 📅 2026-08-29 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 16,977 | 🐛 1,305 | 🌐 C++ | 📅 2026-08-30 - Ceph is a distributed object, block, and file storage platform.
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,372 | 🐛 199 | 🌐 Go | 📅 2026-08-28 - A distributed POSIX file system built on top of Redis and S3.
* [rook](https://github.com/rook/rook) ⭐ 13,619 | 🐛 127 | 🌐 Go | 📅 2026-08-27 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,806 | 🐛 37 | 📅 2026-08-30 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
...
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,944 | 🐛 1,885 | 🌐 Shell | 📅 2026-08-30 - We put storage on cows and move them around from rancher.
...
* [glusterfs](https://github.com/gluster/glusterfs) ⭐ 5,222 | 🐛 286 | 🌐 C | 📅 2026-08-28 - Gluster is a software defined distributed storage that can scale to several petabytes. It provides interfaces for object, block and file storage.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,671 | 🐛 91 | 🌐 Go | 📅 2026-08-28 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,407 | 🐛 74 | 🌐 Go | 📅 2026-08-28 - OCI registry client, managing content like artifacts, images, packages.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,644 | 🐛 527 | 🌐 Java | 📅 2026-08-29 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,776 | 🐛 77 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,573 | 🐛 586 | 🌐 Java | 📅 2026-08-26 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,633 | 🐛 544 | 🌐 Go | 📅 2026-08-29 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,672 | 🐛 185 | 🌐 Erlang | 📅 2026-08-30 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,319 | 🐛 1,731 | 🌐 Java | 📅 2026-08-28 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,586 | 🐛 54 | 🌐 Java | 📅 2026-08-29 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [istio](https://github.com/istio/istio) ⭐ 38,366 | 🐛 514 | 🌐 Go | 📅 2026-08-29 - Connect, secure, control, and observe services.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,995 | 🐛 161 | 🌐 Go | 📅 2026-08-27 - Universal Control Plane for your Service Mesh.
* [secretscanner](https://github.com/deepfence/SecretScanner) ⭐ 3,383 | 🐛 25 | 🌐 Go | 📅 2026-03-07 - Find secrets and passwords in container images and file systems.
...
* [apollo](https://github.com/ctripcorp/apollo) ⭐ 29,807 | 🐛 161 | 🌐 Java | 📅 2026-08-30 - Apollo（阿波罗）是携程框架部门研发的分布式配置中心，能够集中化管理应用不同环境、不同集群的配置，配置修改后能够实时推送到应用端，并且具备规范的权限、流程治理等特性，适用于微服务配置管理场景。
* [coredns](https://github.com/coredns/coredns) ⭐ 14,284 | 🐛 297 | 🌐 Go | 📅 2026-08-30 - CoreDNS is a DNS server that chains middleware.
...
* [clusterpedia](https://github.com/clusterpedia-io/clusterpedia) ⭐ 883 | 🐛 61 | 🌐 Go | 📅 2026-08-28 - Clusterpedia is used for complex resource searches across multiple clusters, support simultaneous search of a single kind of resource or multiple kinds of resources existing in multiple clusters.
...
* [cilium](https://github.com/cilium/cilium) ⭐ 25,028 | 🐛 1,096 | 🌐 Go | 📅 2026-08-30 - API-aware Networking and Security using eBPF and XDP.
* [flannel](https://github.com/coreos/flannel) ⭐ 9,528 | 🐛 24 | 🌐 Go | 📅 2026-08-28 - Flannel is a network fabric for containers, designed for Kubernetes.
* [weave](https://github.com/weaveworks/weave) ⚠️ Archived - Simple, resilient multi-host Docker networking and more.
* [cni](https://github.com/containernetworking/cni) ⭐ 6,106 | 🐛 156 | 🌐 Go | 📅 2026-08-13 - Container Network Interface - networking for Linux containers.
* [ziti](https://github.com/openziti/ziti) ⭐ 4,361 | 🐛 279 | 🌐 Go | 📅 2026-08-29 - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network.
...
* [submariner](https://github.com/submariner-io/submariner) ⭐ 2,687 | 🐛 23 | 🌐 Go | 📅 2026-08-30 - Connect all your Kubernetes clusters, no matter where they are in the world.
* [kube-router](https://github.com/cloudnativelabs/kube-router) ⭐ 2,497 | 🐛 13 | 🌐 Go | 📅 2026-08-30 - Kube-router, a turnkey solution for Kubernetes networking.
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,394 | 🐛 66 | 🌐 Go | 📅 2026-08-30 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,808 | 🐛 200 | 🌐 Go | 📅 2026-08-30 - Antrea is a Kubernetes networking based on Open vSwitch.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,341 | 🐛 275 | 🌐 Go | 📅 2026-08-30 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,665 | 🐛 915 | 🌐 Go | 📅 2026-08-30 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,531 | 🐛 476 | 🌐 C | 📅 2026-08-26 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,835 | 🐛 1,862 | 🌐 C++ | 📅 2026-08-29 - C++ front/service proxy.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15,440 | 🐛 537 | 🌐 Go | 📅 2026-08-28 - Cloudflare Tunnel client (formerly Argo Tunnel).
...
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,819 | 🐛 383 | 🌐 C | 📅 2026-08-29 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,305 | 🐛 0 | 🌐 C | 📅 2026-08-30 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,071 | 🐛 262 | 🌐 Go | 📅 2026-08-30 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [contour](https://github.com/projectcontour/contour) ⭐ 3,945 | 🐛 121 | 🌐 HTML | 📅 2026-08-28 - Contour is a Kubernetes ingress controller for Lyft's Envoy proxy.
...
* [apisix-ingress-controller](https://github.com/apache/apisix-ingress-controller) ⭐ 1,144 | 🐛 43 | 🌐 Go | 📅 2026-08-28 - Ingress controller for K8s.
* [dev-proxy](https://github.com/microsoft/dev-proxy) ⭐ 824 | 🐛 35 | 🌐 C# | 📅 2026-08-28 - Dev Proxy is a command line tool that simulates real world behaviors of HTTP APIs, including Microsoft Graph, locally.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,595 | 🐛 466 | 🌐 C++ | 📅 2026-08-30 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,953 | 🐛 14 | 🌐 C++ | 📅 2026-08-30 - Apache thrift.
...
* [proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-30 - A collection of C++ HTTP libraries including an easy to use HTTP server.
...
* [moby](https://github.com/moby/moby) ⭐ 72,016 | 🐛 3,903 | 🌐 Go | 📅 2026-08-29 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,730 | 🐛 1,143 | 🌐 Go | 📅 2026-08-30 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,783 | 🐛 536 | 🌐 Go | 📅 2026-08-29 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,221 | 🐛 444 | 🌐 Go | 📅 2026-08-28 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,193 | 🐛 839 | 🌐 Go | 📅 2026-08-30 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 7,000 | 🐛 60 | 🌐 Go | 📅 2026-08-29 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
* [spin](https://github.com/fermyon/spin) ⭐ 6,506 | 🐛 262 | 🌐 Rust | 📅 2026-08-27 - Spin is an open source framework for building and running fast, secure, and composable cloud microservices with WebAssembly.
* [wazero](https://github.com/tetratelabs/wazero) ⭐ 6,352 | 🐛 41 | 🌐 Go | 📅 2026-08-29 - The zero dependency WebAssembly runtime for Go developers.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,083 | 🐛 606 | 🌐 C | 📅 2026-08-28 - WebAssembly Micro Runtime (WAMR).
...
* [crun](https://github.com/containers/crun) ⭐ 4,092 | 🐛 56 | 🌐 C | 📅 2026-08-30 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [firecracker-containerd](https://github.com/firecracker-microvm/firecracker-containerd) ⭐ 2,914 | 🐛 95 | 🌐 Go | 📅 2026-08-17 - firecracker-containerd enables containerd to manage containers as Firecracker microVMs.
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,421 | 🐛 59 | 🌐 Rust | 📅 2026-08-30 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
...
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,437 | 🐛 258 | 🌐 Go | 📅 2026-08-29 - OpenChoreo is a developer platform for Kubernetes.
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,333 | 🐛 66 | 🌐 Rust | 📅 2026-08-30 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,574 | 🐛 2,996 | 🌐 Go | 📅 2026-08-28 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,079 | 🐛 109 | 🌐 Go | 📅 2026-08-28 - Define and run multi-container applications with Docker.
...
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,908 | 🐛 803 | 🌐 Go | 📅 2026-08-29 - A Kubernetes Native Batch System (Project under CNCF).
* [swarm](https://github.com/docker/classicswarm) ⚠️ Archived - Swarm: a Docker-native clustering system.
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,578 | 🐛 844 | 🌐 Go | 📅 2026-08-29 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
...
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,467 | 🐛 61 | 🌐 Go | 📅 2026-08-28 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,918 | 🐛 729 | 🌐 Go | 📅 2026-08-30 - Kubernetes-native Job Queueing.
...
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,376 | 🐛 104 | 🌐 Rust | 📅 2026-08-28 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,055 | 🐛 440 | 🌐 Go | 📅 2026-08-28 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
...
* [keda](https://github.com/kedacore/keda) ⭐ 10,477 | 🐛 247 | 🌐 Go | 📅 2026-08-30 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
...
* [spec](https://github.com/cloudevents/spec) ⭐ 5,881 | 🐛 15 | 🌐 Python | 📅 2026-08-27 - CloudEvents Specification.
* [nuclio](https://github.com/nuclio/nuclio) ⭐ 5,753 | 🐛 119 | 🌐 Go | 📅 2026-08-26 - High-Performance Serverless event and data processing platform.
...
* [eventing](https://github.com/knative/eventing) ⭐ 1,553 | 🐛 140 | 🌐 Go | 📅 2026-08-26 - Open source specification and implementation of Knative event binding and delivery.
* [layotto](https://github.com/mosn/layotto) ⭐ 853 | 🐛 47 | 🌐 Go | 📅 2026-08-30 - A fast and efficient cloud native application runtime.
...
* [prometheus-operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 315 | 🌐 Go | 📅 2026-08-28 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes.
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,300 | 🐛 72 | 🌐 Go | 📅 2026-08-29 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
...
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,033 | 🐛 571 | 🌐 Go | 📅 2026-08-29 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,922 | 🐛 156 | 🌐 Java | 📅 2026-08-30 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,150 | 🐛 118 | 🌐 Python | 📅 2026-08-28 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
* [keel](https://github.com/keel-hq/keel) ⭐ 2,726 | 🐛 210 | 🌐 Go | 📅 2026-08-30 - Kubernetes Operator to automate Helm, DaemonSet, StatefulSet & Deployment updates.
...
* [kaito](https://github.com/Azure/kaito) ⭐ 1,005 | 🐛 65 | 🌐 Go | 📅 2026-08-28 - Kubernetes AI Toolchain Operator.
* [k0smotron](https://github.com/k0sproject/k0smotron) ⭐ 739 | 🐛 50 | 🌐 Go | 📅 2026-08-28 - k0smotron is a powerful open-source tool for the efficient management of k0s Kubernetes clusters.
...
* [gateway-operator](https://github.com/kong/gateway-operator) ⭐ 108 | 🐛 211 | 🌐 Go | 📅 2026-08-30 - Kong Gateway Operator is a Kubernetes Operator that can manage your Kong Ingress Controller, Kong Gateway Data Planes, or both together when running on Kubernetes.
...
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,455 | 🐛 210 | 🌐 Go | 📅 2026-08-30 - Zero Friction Kubernetes.
* [openyurt](https://github.com/openyurtio/openyurt) ⭐ 2,000 | 🐛 146 | 🌐 Go | 📅 2026-08-24 - Extending your native Kubernetes to edge(project under CNCF).
...
* [kairos](https://github.com/kairos-io/kairos) ⭐ 1,811 | 🐛 289 | 🌐 Go | 📅 2026-08-28 - The immutable Linux meta-distribution for edge Kubernetes.
* [iotedge](https://github.com/Azure/iotedge) ⭐ 1,509 | 🐛 98 | 🌐 C# | 📅 2026-08-26 - The IoT Edge OSS project.
* [akri](https://github.com/project-akri/akri) ⭐ 1,260 | 🐛 89 | 🌐 Rust | 📅 2026-08-24 - A Kubernetes Resource Interface for the Edge.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,506 | 🐛 3,319 | 🌐 TypeScript | 📅 2026-08-30 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,908 | 🐛 884 | 🌐 Go | 📅 2026-08-30 - The Prometheus monitoring system and time series database.
* [kibana](https://github.com/elastic/kibana) ⭐ 21,272 | 🐛 14,324 | 🌐 TypeScript | 📅 2026-08-30 - Kibana analytics and search dashboard for Elasticsearch.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,617 | 🐛 783 | 🌐 Go | 📅 2026-08-29 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,062 | 🐛 149 | 🌐 Go | 📅 2026-08-27 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
...
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,471 | 🐛 700 | 🌐 Go | 📅 2026-08-28 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,191 | 🐛 109 | 🌐 Go | 📅 2026-08-23 - Add-on agent to generate and expose cluster-level metrics.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,964 | 🐛 267 | 🌐 C | 📅 2026-08-30 - eBPF-based Security Observability and Runtime Enforcement.
...
* [deepflow](https://github.com/deepflowys/deepflow) ⭐ 4,249 | 🐛 268 | 🌐 Go | 📅 2026-08-30 - A highly automated observability platform.
* [metaflow](https://github.com/metaflowys/metaflow) ⭐ 4,249 | 🐛 268 | 🌐 Go | 📅 2026-08-30 - MetaFlow is an automated observability platform for cloud-native developers.
...
* [perses](https://github.com/perses/perses) ⭐ 2,383 | 🐛 267 | 🌐 Go | 📅 2026-08-30 - The CNCF candidate for observability visualisation.
...
* [kepler](https://github.com/sustainable-computing-io/kepler) ⭐ 1,560 | 🐛 46 | 🌐 Go | 📅 2026-08-27 - Kepler (Kubernetes-based Efficient Power Level Exporter) uses eBPF to probe performance counters and other system stats, use ML models to estimate workload energy consumption based on these stats, and exports them as Prometheus metrics.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,880 | 🐛 6,016 | 🌐 Java | 📅 2026-08-30 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,809 | 🐛 1,740 | 🌐 Go | 📅 2026-08-30 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,488 | 🐛 2,515 | 🌐 Rust | 📅 2026-08-29 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,780 | 🐛 428 | 🌐 Go | 📅 2026-08-26 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,581 | 🐛 137 | 🌐 Ruby | 📅 2026-08-30 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,641 | 🐛 1,051 | 🌐 Go | 📅 2026-08-30 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,557 | 🐛 803 | 🌐 Rust | 📅 2026-08-28 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,068 | 🐛 785 | 🌐 C | 📅 2026-08-29 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,658 | 🐛 2,234 | 🌐 Python | 📅 2026-08-30 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,936 | 🐛 40 | 🌐 Java | 📅 2026-08-26 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,164 | 🐛 561 | 🌐 Go | 📅 2026-08-29 - Jaeger, a Distributed Tracing System.
* [zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,454 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - Zipkin is a distributed tracing system.
* [pinpoint](https://github.com/naver/pinpoint) ⭐ 13,860 | 🐛 538 | 🌐 Java | 📅 2026-08-28 - Pinpoint is an open source APM (Application Performance Management) tool for large-scale distributed systems written in Java.
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,332 | 🐛 446 | 🌐 Makefile | 📅 2026-08-27 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,695 | 🐛 258 | 🌐 Go | 📅 2026-08-28 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
* [keycloak](https://github.com/keycloak/keycloak) ⭐ 36,499 | 🐛 3,162 | 🌐 Java | 📅 2026-08-30 - Open Source Identity and Access Management For Modern Applications and Services.
* [vault](https://github.com/hashicorp/vault) ⭐ 36,188 | 🐛 1,431 | 🌐 Go | 📅 2026-08-28 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,860 | 🐛 3,332 | 🌐 Go | 📅 2026-08-28 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
* [supertokens-core](https://github.com/supertokens/supertokens-core) ⭐ 15,288 | 🐛 148 | 🌐 Java | 📅 2026-08-30 - Open source alternative to Auth0 / Firebase Auth / AWS Cognito.
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,057 | 🐛 251 | 🌐 Go | 📅 2026-08-30 - Automatically provision and manage TLS certificates in Kubernetes.
* [kratos](https://github.com/ory/kratos) ⭐ 13,854 | 🐛 223 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication, MFA, FIDO2, profile management, identity schemas, social sign in, registration, account recovery, service-to-service and IoT auth. Can work as an OAuth2 / OpenID Connect Provider. Golang, headless, API-only - without templating or theming headaches.
* [grype](https://github.com/anchore/grype) ⭐ 12,805 | 🐛 404 | 🌐 Go | 📅 2026-08-28 - A vulnerability scanner for container images and filesystems.
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,178 | 🐛 337 | 🌐 Go | 📅 2026-08-28 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,704 | 🐛 76 | 🌐 Go | 📅 2026-08-28 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
* [dex](https://github.com/dexidp/dex) ⭐ 11,072 | 🐛 535 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors.
* [clair](https://github.com/quay/clair) ⭐ 11,054 | 🐛 59 | 🌐 Go | 📅 2026-08-25 - Vulnerability Static Analysis for Containers.
...
* [syft](https://github.com/anchore/syft) ⭐ 9,479 | 🐛 631 | 🌐 Go | 📅 2026-08-29 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,314 | 🐛 65 | 🌐 C++ | 📅 2026-08-03 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,045 | 🐛 435 | 🌐 Elixir | 📅 2026-08-30 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,976 | 🐛 166 | 🌐 Python | 📅 2026-08-30 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,160 | 🐛 97 | 🌐 Go | 📅 2026-08-24 - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices.
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,086 | 🐛 653 | 🌐 Go | 📅 2026-08-30 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,818 | 🐛 266 | 🌐 Go | 📅 2026-08-28 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,266 | 🐛 172 | 🌐 Go | 📅 2026-08-24 - Container signing, verification, and provenance powered by Sigstore.
...
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,983 | 🐛 154 | 🌐 Go | 📅 2026-08-28 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,774 | 🐛 125 | 🌐 Go | 📅 2026-08-30 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [spiffe](https://github.com/spiffe/spiffe) ⭐ 1,838 | 🐛 51 | 🌐 Shell | 📅 2026-08-27 - The SPIFFE Project.
...
* [brood-box](https://github.com/stacklok/brood-box) ⭐ 63 | 🐛 13 | 🌐 Go | 📅 2026-08-30 - CLI tool for running coding agents inside hardware-isolated microVMs with workspace snapshot isolation and egress control.
...
* [go-microvm](https://github.com/stacklok/go-microvm) ⭐ 22 | 🐛 12 | 🌐 Go | 📅 2026-08-30 - Go framework for running OCI images as microVMs via libkrun with embedded runtime, rootfs management, and guest networking.
...
* [sentinel](https://github.com/alibaba/sentinel) ⭐ 23,144 | 🐛 862 | 🌐 Java | 📅 2026-05-27 - A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
* [chaosmonkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,096 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,480 | 🐛 1 | 🌐 Java | 📅 2026-08-10 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
...
* [litmus](https://github.com/litmuschaos/litmus) ⭐ 5,604 | 🐛 398 | 🌐 Go | 📅 2026-08-25 - Litmus helps SREs and developers practice chaos engineering in a Cloud-native way.
* [concurrency-limits](https://github.com/Netflix/concurrency-limits) ⭐ 3,602 | 🐛 52 | 🌐 Java | 📅 2026-01-16 - Java Library that implements and integrates concepts from TCP congestion control to auto-detect concurrency limits to achieve optimal throughput with optimal latency.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,650 | 🐛 47 | 🌐 Go | 📅 2026-08-28 - Kubernetes-native framework for test definition and execution.
* [krkn](https://github.com/krkn-chaos/krkn) ⭐ 494 | 🐛 138 | 🌐 Python | 📅 2026-08-25 - Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,382 | 🐛 745 | 🌐 TypeScript | 📅 2026-08-28 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,277 | 🐛 435 | 🌐 TypeScript | 📅 2026-08-30 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,883 | 🐛 3,340 | 🌐 Go | 📅 2026-08-29 - Complete container management platform.
...
* [openshift](https://github.com/openshift/origin) ⭐ 8,681 | 🐛 314 | 🌐 Go | 📅 2026-08-28 - Enterprise Kubernetes for Developers.
* [rainbond](https://github.com/goodrain/rainbond) ⭐ 6,256 | 🐛 55 | 🌐 Go | 📅 2026-08-29 - Serverless PaaS , A new generation of easy-to-use cloud management platforms based on kubernetes.
* [wayne](https://github.com/Qihoo360/wayne) ⭐ 3,700 | 🐛 61 | 🌐 TypeScript | 📅 2022-05-31 - Web UI for Kubernetes multi-clusters.
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,168 | 🐛 49 | 🌐 Go | 📅 2026-08-30 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
* [kubediagrams](https://github.com/philippemerle/KubeDiagrams) ⭐ 2,686 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-19 - A CLI tool to generate Kubernetes architecture diagrams automatically from Kubernetes manifest files, kustomization files, Helm charts, helmfile descriptors, and actual cluster state.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 130 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-30 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,884 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-21 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,588 | 🐛 54 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
* [kubernetes-handbook](https://github.com/rootsongjc/kubernetes-handbook) ⭐ 11,614 | 🐛 1 | 🌐 Mermaid | 📅 2025-12-26 - Kubernetes 中文指南/云原生应用架构实践手册。
...
* [kubernetes-on-aws](https://github.com/zalando-incubator/kubernetes-on-aws) ⭐ 635 | 🐛 31 | 🌐 Go | 📅 2026-08-30 - Deploying Kubernetes on AWS with CloudFormation and Ubuntu.
...
This website is hosted on GitHub Pages within [rootsongjc/awesome-cloud-native](https://github.com/rootsongjc/awesome-cloud-native) ⭐ 2,440 | 🐛 6 | 🌐 HTML | 📅 2026-08-28 repository.

Please take a quick gander at the **[contribution guidelines](https://github.com/rootsongjc/awesome-cloud-native/blob/main/CONTRIBUTING.md) ⭐ 2,440 | 🐛 6 | 🌐 HTML | 📅 2026-08-28** first. Thanks to all **[contributors](https://github.com/rootsongjc/awesome-cloud-native/graphs/contributors) ⭐ 2,440 | 🐛 6 | 🌐 HTML | 📅 2026-08-28**, you rock 🤟!
