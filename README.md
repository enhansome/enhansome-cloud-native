...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 197,620 | 🐛 2,929 | 🌐 C++ | 📅 2026-08-25 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,586 | 🐛 17,340 | 🌐 Python | 📅 2026-08-25 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,250 | 🐛 246 | 🌐 Python | 📅 2026-08-24 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,062 | 🐛 1,496 | 🌐 C++ | 📅 2026-08-25 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
* [jina](https://github.com/jina-ai/jina) ⭐ 21,863 | 🐛 26 | 🌐 Python | 📅 2025-03-24 - Cloud-native neural search framework for 𝙖𝙣𝙮 kind of data.
* [kubeflow](https://github.com/kubeflow/kubeflow) ⭐ 15,830 | 🐛 0 | 📅 2026-08-21 - Machine Learning Toolkit for Kubernetes.
...
* [h2o-3](https://github.com/h2oai/h2o-3) ⭐ 7,495 | 🐛 2,882 | 🌐 Jupyter Notebook | 📅 2026-08-25 - Open Source Fast Scalable Machine Learning API For Smarter Applications (Deep Learning, Gradient Boosting, Random Forest, Generalized Linear Modeling (Logistic Regression, Elastic Net), K-Means, PCA, Stacked Ensembles.)
* [kserve](https://github.com/kserve/kserve) ⭐ 5,827 | 🐛 206 | 🌐 Go | 📅 2026-08-25 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 57,239 | 🐛 4,927 | 🌐 Python | 📅 2026-08-25 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,033 | 🐛 190 | 🌐 Lua | 📅 2026-08-16 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,030 | 🐛 257 | 🌐 Lua | 📅 2026-08-24 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,799 | 🐛 497 | 🌐 Go | 📅 2026-08-25 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,183 | 🐛 1,074 | 🌐 Go | 📅 2026-08-25 - Next-generation Cloud Native Gateway.
* [ocelot](https://github.com/ThreeMammals/Ocelot) ⭐ 8,717 | 🐛 61 | 🌐 C# | 📅 2026-08-21 - .NET core API Gateway.
* [lura](https://github.com/luraproject/lura) ⭐ 6,789 | 🐛 12 | 🌐 Go | 📅 2026-08-18 - Ultra performant API Gateway with middlewares. A project hosted at The Linux Foundation.
* [easegress](https://github.com/megaease/easegress) ⭐ 5,868 | 🐛 10 | 🌐 Go | 📅 2026-07-20 - A Cloud Native traffic orchestration system.
* [emissary-gateway](https://github.com/emissary-ingress/emissary) ⭐ 4,519 | 🐛 440 | 🌐 Python | 📅 2026-08-24 - Open source Kubernetes-native API gateway for microservices built on the Envoy Proxy.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 2,983 | 🐛 758 | 🌐 Go | 📅 2026-08-25 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [haproxy-ingress](https://github.com/jcmoraisjr/haproxy-ingress) ⭐ 1,163 | 🐛 85 | 🌐 Go | 📅 2026-08-24 - HaProxy Ingress.
* [nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) ⭐ 1,147 | 🐛 106 | 🌐 Go | 📅 2026-08-25 - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
...
* [sbproxy](https://github.com/soapbucket/sbproxy) ⭐ 51 | 🐛 1 | 🌐 Rust | 📅 2026-08-23 - Single-binary AI gateway and reverse proxy with 103+ LLM providers, cost-based routing, rate limiting, and declarative YAML configuration.

## Continuous Delivery & GitOps

* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,538 | 🐛 1,914 | 🌐 Go | 📅 2026-08-25 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,120 | 🐛 106 | 🌐 Go | 📅 2026-08-21 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,173 | 🐛 453 | 🌐 Go | 📅 2026-08-25 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 29,907 | 🐛 326 | 🌐 Go | 📅 2026-08-25 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,489 | 🐛 3,606 | 🌐 Java | 📅 2026-08-25 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,604 | 🐛 2,456 | 🌐 Go | 📅 2026-08-25 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 23,991 | 🐛 4,399 | 🌐 Go | 📅 2026-08-25 - Declarative continuous deployment for Kubernetes.
* [argo](https://github.com/argoproj/argo) ⭐ 16,936 | 🐛 1,264 | 🌐 Go | 📅 2026-08-25 - Get stuff done with container-native workflows for Kubernetes.
* [dagger](https://github.com/dagger/dagger) ⭐ 16,197 | 🐛 145 | 🌐 Go | 📅 2026-08-25 - A programmable CI/CD engine that runs your pipelines in containers.
* [skaffold](https://github.com/GoogleContainerTools/skaffold) ⭐ 15,887 | 🐛 902 | 🌐 Go | 📅 2026-08-24 - Easy and Repeatable Kubernetes Development.
* [kaniko](https://github.com/GoogleContainerTools/kaniko) ⚠️ Archived - Build Container Images In Kubernetes.
* [jib](https://github.com/GoogleContainerTools/jib) ⭐ 14,441 | 🐛 251 | 🌐 Java | 📅 2026-07-15 - Build container images for your Java applications.
* [kustomize](https://github.com/kubernetes-sigs/kustomize) ⭐ 12,143 | 🐛 195 | 🌐 Go | 📅 2026-08-24 - Customization of kubernetes YAML configurations.
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 11,976 | 🐛 187 | 🌐 Go | 📅 2026-08-25 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,571 | 🐛 1,829 | 🌐 TypeScript | 📅 2026-08-25 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,612 | 🐛 19 | 🌐 Go | 📅 2026-08-24 - Go from Docker Compose to Kubernetes.
* [tilt](https://github.com/tilt-dev/tilt) ⭐ 10,017 | 🐛 510 | 🌐 Go | 📅 2026-08-15 - A multi-service dev environment for teams on Kubernetes.
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,774 | 🐛 103 | 🌐 Java | 📅 2026-08-24 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,043 | 🐛 554 | 🌐 Go | 📅 2026-08-25 - A cloud-native Pipeline resource.
* [ko](https://github.com/ko-build/ko) ⭐ 8,506 | 🐛 56 | 🌐 Go | 📅 2026-08-24 - Build and deploy Go applications on Kubernetes.
* [spec](https://github.com/score-spec/spec) ⭐ 8,086 | 🐛 12 | 🌐 Makefile | 📅 2026-07-27 - The score specification file.
* [kubevela](https://github.com/oam-dev/kubevela) ⭐ 7,886 | 🐛 275 | 🌐 Go | 📅 2026-08-24 - Make shipping applications more enjoyable.
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,748 | 🐛 361 | 🌐 Go | 📅 2026-08-25 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
* [jsonnet](https://github.com/google/jsonnet) ⭐ 7,560 | 🐛 210 | 🌐 Jsonnet | 📅 2026-03-30 - Jsonnet - The data templating language.
...
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,590 | 🐛 765 | 🌐 Go | 📅 2026-08-24 - Software Delivery Workflow For Kubernetes
...
* [cdk8s](https://github.com/awslabs/cdk8s) ⭐ 4,851 | 🐛 77 | 🌐 JavaScript | 📅 2026-08-25 - Define Kubernetes native apps and abstractions using object-oriented programming.
* [cds](https://github.com/ovh/cds) ⭐ 4,836 | 🐛 158 | 🌐 Go | 📅 2026-08-25 - Enterprise-Grade Continuous Delivery & DevOps Automation Open Source Platform.
...
* [arkade](https://github.com/alexellis/arkade) ⭐ 4,608 | 🐛 14 | 🌐 Go | 📅 2026-08-22 - Kubernetes apps for developers.
* [helmfile](https://github.com/roboll/helmfile) ⭐ 4,033 | 🐛 527 | 🌐 Go | 📅 2023-04-27 - Deploy Kubernetes Helm Charts.
* [ballerina-lang](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,847 | 🐛 1,605 | 🌐 Ballerina | 📅 2026-08-14 - Ballerina is a new programming language for integration built on a sequence diagram metaphor.
...
* [garden](https://github.com/garden-io/garden) ⭐ 3,608 | 🐛 247 | 🌐 TypeScript | 📅 2026-08-24 - Development orchestrator for Kubernetes, containers and serverless functions.
* [kargo](https://github.com/akuity/kargo) ⭐ 3,597 | 🐛 173 | 🌐 Go | 📅 2026-08-25 - Application lifecycle orchestration.
* [argo-rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,561 | 🐛 661 | 🌐 Go | 📅 2026-08-25 - Progressive delivery controller for blue-green, canary, and experiments on Kubernetes.
* [zadig](https://github.com/koderover/zadig) ⭐ 3,232 | 🐛 33 | 🌐 Go | 📅 2026-08-25 - Zadig is a cloud native, distributed, developer-oriented continuous delivery product.
...
* [source-to-image](https://github.com/openshift/source-to-image) ⭐ 2,543 | 🐛 27 | 🌐 Go | 📅 2026-08-25 - A tool for building/building artifacts from source and injecting into docker images.
* [kcl](https://github.com/kcl-lang/kcl) ⭐ 2,402 | 🐛 92 | 🌐 Rust | 📅 2026-08-24 - KCL is a constraint-based record & functional language mainly used in configuration and policy scenarios. (CNCF Sandbox Project).
...
* [hub](https://github.com/artifacthub/hub) ⭐ 2,080 | 🐛 25 | 🌐 TypeScript | 📅 2026-07-07 - Find, install and publish Cloud Native packages
* [timoni](https://github.com/stefanprodan/timoni) ⭐ 2,006 | 🐛 35 | 🌐 Go | 📅 2026-08-25 - Timoni is a package manager for Kubernetes, powered by CUE and inspired by Helm.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,664 | 🐛 324 | 🌐 Go | 📅 2026-08-25 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,431 | 🐛 45 | 🌐 Go | 📅 2026-08-20 - OpenTofu / Terraform / Terragrunt and Atmos version manager.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,345 | 🐛 215 | 🌐 Go | 📅 2026-08-25 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
...
* [screwdriver](https://github.com/screwdriver-cd/screwdriver) ⭐ 1,045 | 🐛 56 | 🌐 JavaScript | 📅 2026-08-21 - An open source build platform designed for continuous delivery.
...
* [carvel](https://github.com/carvel-dev/carvel) ⭐ 408 | 🐛 86 | 🌐 HTML | 📅 2026-08-25 - Carvel provides a set of reliable, single-purpose, composable tools that aid in your application building, configuration, and deployment to Kubernetes. This repo contains information regarding the Carvel open-source community.
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,765 | 🐛 317 | 🌐 Go | 📅 2026-08-25 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,219 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,192 | 🐛 87 | 🌐 Go | 📅 2026-08-20 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,486 | 🐛 388 | 🌐 Go | 📅 2026-08-25 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [kuberlr](https://github.com/flavio/kuberlr) ⭐ 142 | 🐛 15 | 🌐 Go | 📅 2026-08-24 - A tool that simplifies the management of multiple versions of kubectl.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,455 | 🐛 843 | 🌐 Python | 📅 2026-08-19 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,756 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-25 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,362 | 🐛 164 | 🌐 Go | 📅 2026-08-23 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,268 | 🐛 193 | 🌐 Go | 📅 2026-08-24 - Enforce Kubernetes admission policies using Open Policy Agent constraints.
...
* [pluto](https://github.com/FairwindsOps/pluto) ⭐ 2,570 | 🐛 12 | 🌐 Go | 📅 2026-08-21 - A cli tool to help discover deprecated apiVersions in Kubernetes.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,243 | 🐛 39 | 🌐 Python | 📅 2026-08-24 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 233 | 🐛 137 | 🌐 Rust | 📅 2026-08-24 - Policy as code for Kubernetes powered by WebAssembly modules.
...
* [vagrant](https://github.com/hashicorp/vagrant) ⭐ 27,200 | 🐛 753 | 🌐 Ruby | 📅 2026-08-03 - Vagrant is a tool for building and distributing development environments.
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,703 | 🐛 203 | 🌐 Jinja | 📅 2026-08-21 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,320 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-24 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,669 | 🐛 132 | 🌐 Go | 📅 2026-08-25 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
...
* [kubeasz](https://github.com/easzlab/kubeasz) ⭐ 11,411 | 🐛 5 | 🌐 Jinja | 📅 2026-08-24 - 使用 Ansible 脚本安装 K8S 集群，介绍组件交互原理，方便直接，不受国内网络环境影响。
* [talos](https://github.com/talos-systems/talos) ⭐ 11,013 | 🐛 216 | 🌐 Go | 📅 2026-08-25 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,356 | 🐛 164 | 🌐 Python | 📅 2026-08-22 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,213 | 🐛 89 | 🌐 Go | 📅 2026-08-21 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,289 | 🐛 218 | 🌐 Go | 📅 2026-08-25 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 3,997 | 🐛 39 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,432 | 🐛 194 | 🌐 Go | 📅 2026-08-25 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
* [cloudpods](https://github.com/yunionio/cloudpods) ⭐ 2,935 | 🐛 220 | 🌐 Go | 📅 2026-08-25 - A cloud-native open-source unified multi-cloud and hybrid-cloud platform.
...
* [fleet](https://github.com/rancher/fleet) ⭐ 1,724 | 🐛 181 | 🌐 Go | 📅 2026-08-25 - Manage large fleets of Kubernetes clusters.
* [clusternet](https://github.com/clusternet/clusternet) ⭐ 1,447 | 🐛 73 | 🌐 Go | 📅 2026-08-24 - Managing your Kubernetes clusters (including public, private, edge, etc) as easily as visiting the Internet.
...
* [claudie](https://github.com/berops/claudie) ⭐ 790 | 🐛 67 | 🌐 Go | 📅 2026-08-25 - Cloud-agnostic managed Kubernetes.
...
* [cluster-lifecycle-manager](https://github.com/zalando-incubator/cluster-lifecycle-manager) ⭐ 248 | 🐛 20 | 🌐 Go | 📅 2026-08-24 - Cluster Lifecycle Manager (CLM) to provision and update multiple Kubernetes clusters.
...
* [telepresence](https://github.com/telepresenceio/telepresence) ⭐ 7,287 | 🐛 26 | 🌐 Go | 📅 2026-08-25 - Local development against a remote Kubernetes or OpenShift cluster.
* [che](https://github.com/eclipse/che) ⭐ 7,160 | 🐛 217 | 🌐 TypeScript | 📅 2026-08-21 - Eclipse Che: Next-generation Eclipse IDE. Open source workspace server and cloud IDE.
...
* [okteto](https://github.com/okteto/okteto) ⭐ 3,534 | 🐛 38 | 🌐 Go | 📅 2026-08-24 - Local development experience for Kubernetes apps.
* [kubectl-tree](https://github.com/ahmetb/kubectl-tree) ⭐ 3,418 | 🐛 16 | 🌐 Go | 📅 2026-08-24 - kubectl plugin to browse Kubernetes object hierarchies as a tree 🎄 (using? star the repo!)
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,554 | 🐛 19 | 🌐 Rust | 📅 2026-08-24 - Manage and run multiple kubectl port-forward configurations directly in the menu bar, syncing configurations with git repositories.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,113 | 🐛 85 | 🌐 Go | 📅 2026-08-24 - Giving Kubernetes Superpowers to everyone.
...
* [kubespy](https://github.com/pulumi/kubespy) ⭐ 3,078 | 🐛 18 | 🌐 Go | 📅 2026-08-24 - Tools for observing Kubernetes resources in real time, powered by Pulumi.
* [robusta](https://github.com/robusta-dev/robusta) ⭐ 3,077 | 🐛 202 | 🌐 Python | 📅 2026-08-25 - Open source Kubernetes troubleshooting and automation platform.
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,018 | 🐛 123 | 🌐 Go | 📅 2026-08-25 - Test infrastructure for the Kubernetes project.
* [kwok](https://github.com/kubernetes-sigs/kwok) ⭐ 3,176 | 🐛 24 | 🌐 Go | 📅 2026-08-25 - Kubernetes WithOut Kubelet - Simulates thousands of Nodes and Clusters.
...
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 211 | 🐛 162 | 🌐 Python | 📅 2026-08-25 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
* [seaworthy](https://github.com/cakehappens/seaworthy) ⭐ 39 | 🐛 0 | 🌐 Go | 📅 2020-08-10 - A CLI to verify Kubernetes resource health.

## Data Protection & Backup

* [ark](https://github.com/vmware-tanzu/velero) ⭐ 10,254 | 🐛 834 | 🌐 Go | 📅 2026-08-25 - Heptio Ark is a utility for managing disaster recovery, specifically for your Kubernetes cluster resources and persistent volumes. Brought to you by Heptio.
...
* [karpenter](https://github.com/aws/karpenter) ⭐ 7,705 | 🐛 505 | 🌐 Go | 📅 2026-08-25 - Kubernetes Node Autoscaling: built for flexibility, performance, and scalability.
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,695 | 🐛 297 | 🌐 Go | 📅 2026-08-21 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,695 | 🐛 297 | 🌐 Go | 📅 2026-08-21 - Kubernetes cost monitoring powered by open allocation models.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,952 | 🐛 42 | 🌐 Shell | 📅 2026-07-01 - A Docker + Kubernetes network trouble-shooting swiss-army container.
* [dragonfly2](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,310 | 🐛 32 | 🌐 Go | 📅 2026-08-25 - Dragonfly is an intelligent P2P based file distribution system.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 28,986 | 🐛 1,142 | 🌐 JavaScript | 📅 2026-08-25 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,106 | 🐛 2,917 | 🌐 C | 📅 2026-08-25 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,723 | 🐛 712 | 🌐 TypeScript | 📅 2026-08-25 - The Open Source Airtable alternative.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 52,170 | 🐛 321 | 🌐 Go | 📅 2026-08-24 - Distributed reliable key-value store for the most critical data of a distributed system.
* [milvus](https://github.com/milvus-io/milvus) ⭐ 45,782 | 🐛 1,329 | 🌐 Go | 📅 2026-08-25 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,468 | 🐛 6,832 | 🌐 Go | 📅 2026-08-25 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,360 | 🐛 402 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,415 | 🐛 8,245 | 🌐 Go | 📅 2026-08-07 - CockroachDB - the open source, cloud-native SQL database.
...
* [mongodb](https://github.com/mongodb/mongo) ⭐ 28,502 | 🐛 31 | 🌐 C++ | 📅 2026-08-25 - MongoDB is an open source database that uses a document-oriented data model.
* [rethinkdb](https://github.com/rethinkdb/rethinkdb) ⭐ 26,994 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The open-source database for the realtime web.
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,411 | 🐛 394 | 🌐 C | 📅 2026-08-25 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,787 | 🐛 210 | 🌐 Java | 📅 2026-08-25 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,812 | 🐛 1,805 | 🌐 Rust | 📅 2026-08-25 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,262 | 🐛 837 | 🌐 C++ | 📅 2026-08-25 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
* [nebula](https://github.com/vesoft-inc/nebula) ⭐ 12,363 | 🐛 678 | 🌐 C++ | 📅 2026-05-18 - A distributed, fast open-source graph database featuring horizontal scalability and high availability.
* [oceanbase](https://github.com/oceanbase/oceanbase) ⭐ 10,255 | 🐛 584 | 🌐 C++ | 📅 2026-08-25 - A distributed, banking suitable, open-source related database featuring high scalability and high compatibility.
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,423 | 🐛 562 | 🌐 Rust | 📅 2026-08-25 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
...
* [spicedb](https://github.com/authzed/spicedb) ⭐ 6,988 | 🐛 150 | 🌐 Go | 📅 2026-08-24 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
...
* [kvrocks](https://github.com/KvrocksLabs/kvrocks) ⭐ 4,404 | 🐛 242 | 🌐 C++ | 📅 2026-08-21 - Kvrocks is a distributed key value NoSQL database based on RocksDB and compatible with Redis protocol.
* [polardb-for-postgresql](https://github.com/alibaba/PolarDB-for-PostgreSQL) ⭐ 3,193 | 🐛 66 | 🌐 C | 📅 2026-08-25 - PolarDB for PostgreSQL (PolarDB for short) is an open source database system based on PostgreSQL.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,111 | 🐛 262 | 🌐 Go | 📅 2026-08-25 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,227 | 🐛 858 | 🌐 Go | 📅 2026-08-25 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,243 | 🐛 1,088 | 🌐 Go | 📅 2026-08-25 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 16,960 | 🐛 1,275 | 🌐 C++ | 📅 2026-08-25 - Ceph is a distributed object, block, and file storage platform.
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,357 | 🐛 198 | 🌐 Go | 📅 2026-08-25 - A distributed POSIX file system built on top of Redis and S3.
* [rook](https://github.com/rook/rook) ⭐ 13,613 | 🐛 140 | 🌐 Go | 📅 2026-08-25 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,799 | 🐛 39 | 📅 2026-08-25 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
...
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,930 | 🐛 1,865 | 🌐 Shell | 📅 2026-08-25 - We put storage on cows and move them around from rancher.
* [chubaofs](https://github.com/chubaofs/chubaofs) ⭐ 5,635 | 🐛 268 | 🌐 Go | 📅 2026-08-24 - A distributed storage system for cloud native applications.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,651 | 🐛 81 | 🌐 Go | 📅 2026-08-25 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,399 | 🐛 75 | 🌐 Go | 📅 2026-08-25 - OCI registry client, managing content like artifacts, images, packages.
...
* [zenko](https://github.com/scality/Zenko) ⭐ 671 | 🐛 22 | 🌐 Gherkin | 📅 2026-08-25 - Because everyone should be in control of their data.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,610 | 🐛 521 | 🌐 Java | 📅 2026-08-25 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,773 | 🐛 77 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,568 | 🐛 563 | 🌐 Java | 📅 2026-08-25 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,586 | 🐛 549 | 🌐 Go | 📅 2026-08-25 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,654 | 🐛 225 | 🌐 Erlang | 📅 2026-08-25 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,311 | 🐛 1,749 | 🌐 Java | 📅 2026-08-25 - A distributed messaging and streaming platform.
* [automq](https://github.com/AutoMQ/automq) ⭐ 10,557 | 🐛 54 | 🌐 Java | 📅 2026-08-21 - A cloud native implementation for Apache Kafka, reducing your cloud infrastructure bill by up to 90%.
...
* [flume](https://github.com/apache/flume) ⭐ 2,566 | 🐛 79 | 🌐 Java | 📅 2026-08-25 - Apache Flume is a distributed, reliable, and available service for efficiently collecting, aggregating, and moving large amounts of log data.
...
* [istio](https://github.com/istio/istio) ⭐ 38,356 | 🐛 504 | 🌐 Go | 📅 2026-08-25 - Connect, secure, control, and observe services.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,043 | 🐛 1,416 | 🌐 Go | 📅 2026-08-25 - Consul is a distributed, highly available, and data center aware solution to connect and configure applications across dynamic, distributed infrastructure.
* [linkerd2](https://github.com/linkerd/linkerd2) ⭐ 11,480 | 🐛 206 | 🌐 Go | 📅 2026-08-25 - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,995 | 🐛 161 | 🌐 Go | 📅 2026-08-25 - Universal Control Plane for your Service Mesh.
...
* [apollo](https://github.com/ctripcorp/apollo) ⭐ 29,800 | 🐛 158 | 🌐 Java | 📅 2026-08-22 - Apollo（阿波罗）是携程框架部门研发的分布式配置中心，能够集中化管理应用不同环境、不同集群的配置，配置修改后能够实时推送到应用端，并且具备规范的权限、流程治理等特性，适用于微服务配置管理场景。
* [coredns](https://github.com/coredns/coredns) ⭐ 14,272 | 🐛 293 | 🌐 Go | 📅 2026-08-24 - CoreDNS is a DNS server that chains middleware.
* [zookeeper](https://github.com/apache/zookeeper) ⭐ 12,794 | 🐛 242 | 🌐 Java | 📅 2026-08-17 - Apache ZooKeeper is an effort to develop and maintain an open-source server which enables highly reliable distributed coordination.
...
* [pingora](https://github.com/cloudflare/pingora) ⭐ 27,268 | 🐛 291 | 🌐 Rust | 📅 2026-08-25 - A library for building fast, reliable and evolvable network services.
* [cilium](https://github.com/cilium/cilium) ⭐ 25,008 | 🐛 1,100 | 🌐 Go | 📅 2026-08-25 - API-aware Networking and Security using eBPF and XDP.
...
* [ziti](https://github.com/openziti/ziti) ⭐ 4,358 | 🐛 286 | 🌐 Go | 📅 2026-08-25 - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network.
* [hubble](https://github.com/cilium/hubble) ⭐ 4,314 | 🐛 44 | 🌐 Makefile | 📅 2026-08-24 - Hubble - Network, Service & Security Observability for Kubernetes.
* [multus](https://github.com/k8snetworkplumbingwg/multus-cni) ⭐ 2,938 | 🐛 22 | 🌐 Go | 📅 2026-08-25 - A CNI meta-plugin for multi-homed pods in Kubernetes.
* [submariner](https://github.com/submariner-io/submariner) ⭐ 2,686 | 🐛 27 | 🌐 Go | 📅 2026-08-25 - Connect all your Kubernetes clusters, no matter where they are in the world.
* [kube-router](https://github.com/cloudnativelabs/kube-router) ⭐ 2,496 | 🐛 14 | 🌐 Go | 📅 2026-08-23 - Kube-router, a turnkey solution for Kubernetes networking.
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,393 | 🐛 81 | 🌐 Go | 📅 2026-08-25 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,807 | 🐛 199 | 🌐 Go | 📅 2026-08-25 - Antrea is a Kubernetes networking based on Open vSwitch.
...
* [spiderpool](https://github.com/spidernet-io/spiderpool) ⭐ 671 | 🐛 106 | 🌐 Go | 📅 2026-08-25 - Underlay and RDMA network solution of the Kubernetes, for bare metal, VM and any public cloud.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,194 | 🐛 275 | 🌐 Go | 📅 2026-08-25 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,578 | 🐛 923 | 🌐 Go | 📅 2026-08-25 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,491 | 🐛 473 | 🌐 C | 📅 2026-08-24 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,817 | 🐛 1,877 | 🌐 C++ | 📅 2026-08-25 - C++ front/service proxy.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15,367 | 🐛 532 | 🌐 Go | 📅 2026-08-21 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [reverse-proxy](https://github.com/microsoft/reverse-proxy) ⭐ 9,600 | 🐛 191 | 🌐 C# | 📅 2026-08-24 - A toolkit for developing high-performance HTTP reverse proxy applications.
* [metallb](https://github.com/metallb/metallb) ⭐ 8,332 | 🐛 102 | 🌐 Go | 📅 2026-08-17 - A network load-balancer implementation for Kubernetes using standard routing protocols.
* [haproxy](https://github.com/haproxy/haproxy) ⭐ 6,802 | 🐛 381 | 🌐 C | 📅 2026-08-25 - HAProxy is a free, very fast and reliable solution offering high availability, load balancing, and proxying for TCP and HTTP-based applications.
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,300 | 🐛 0 | 🌐 C | 📅 2026-08-24 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,067 | 🐛 242 | 🌐 Go | 📅 2026-08-25 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [contour](https://github.com/projectcontour/contour) ⭐ 3,945 | 🐛 124 | 🌐 HTML | 📅 2026-08-24 - Contour is a Kubernetes ingress controller for Lyft's Envoy proxy.
* [skipper](https://github.com/zalando/skipper) ⭐ 3,319 | 🐛 308 | 🌐 Go | 📅 2026-08-25 - An HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress.
...
* [loxilb](https://github.com/loxilb-io/loxilb) ⭐ 1,871 | 🐛 31 | 🌐 Go | 📅 2026-08-19 - eBPF powered cloud-native load-balancer providing efficient externalLB, clusterIP and nodePort services for Kubernetes.
...
* [apisix-ingress-controller](https://github.com/apache/apisix-ingress-controller) ⭐ 1,144 | 🐛 48 | 🌐 Go | 📅 2026-08-18 - Ingress controller for K8s.
* [dev-proxy](https://github.com/microsoft/dev-proxy) ⭐ 823 | 🐛 40 | 🌐 C# | 📅 2026-08-25 - Dev Proxy is a command line tool that simulates real world behaviors of HTTP APIs, including Microsoft Graph, locally.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,593 | 🐛 463 | 🌐 C++ | 📅 2026-08-25 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,952 | 🐛 14 | 🌐 C++ | 📅 2026-08-24 - Apache thrift.
...
* [proxygen](https://github.com/facebook/proxygen) ⭐ 8,375 | 🐛 39 | 🌐 C++ | 📅 2026-08-24 - A collection of C++ HTTP libraries including an easy to use HTTP server.
* [kitex](https://github.com/cloudwego/kitex) ⭐ 8,025 | 🐛 71 | 🌐 Go | 📅 2026-08-25 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices.
...
* [moby](https://github.com/moby/moby) ⭐ 72,001 | 🐛 3,911 | 🌐 Go | 📅 2026-08-25 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,683 | 🐛 1,130 | 🌐 Go | 📅 2026-08-25 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,750 | 🐛 534 | 🌐 Go | 📅 2026-08-25 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,157 | 🐛 453 | 🌐 Go | 📅 2026-08-25 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,153 | 🐛 812 | 🌐 Go | 📅 2026-08-25 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 6,989 | 🐛 63 | 🌐 Go | 📅 2026-08-24 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
* [spin](https://github.com/fermyon/spin) ⭐ 6,503 | 🐛 261 | 🌐 Rust | 📅 2026-08-25 - Spin is an open source framework for building and running fast, secure, and composable cloud microservices with WebAssembly.
* [wazero](https://github.com/tetratelabs/wazero) ⭐ 6,341 | 🐛 40 | 🌐 Go | 📅 2026-08-24 - The zero dependency WebAssembly runtime for Go developers.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,071 | 🐛 605 | 🌐 C | 📅 2026-08-25 - WebAssembly Micro Runtime (WAMR).
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,653 | 🐛 140 | 🌐 Go | 📅 2026-08-25 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface.
...
* [crun](https://github.com/containers/crun) ⭐ 4,072 | 🐛 56 | 🌐 C | 📅 2026-08-25 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,421 | 🐛 61 | 🌐 Rust | 📅 2026-08-25 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
...
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,399 | 🐛 258 | 🌐 Go | 📅 2026-08-25 - OpenChoreo is a developer platform for Kubernetes.
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,330 | 🐛 66 | 🌐 Rust | 📅 2026-08-25 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [mocker](https://github.com/us/mocker) ⭐ 334 | 🐛 4 | 🌐 Swift | 📅 2026-08-25 - Docker-compatible container CLI for macOS, built on Apple's Containerization framework.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,172 | 🐛 3,047 | 🌐 Go | 📅 2026-08-21 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,060 | 🐛 99 | 🌐 Go | 📅 2026-08-25 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,948 | 🐛 321 | 🌐 Go | 📅 2026-08-24 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
...
* [volcano](https://github.com/volcano-sh/volcano) ⭐ 5,896 | 🐛 803 | 🌐 Go | 📅 2026-08-25 - A Kubernetes Native Batch System (Project under CNCF).
* [swarm](https://github.com/docker/classicswarm) ⚠️ Archived - Swarm: a Docker-native clustering system.
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,575 | 🐛 841 | 🌐 Go | 📅 2026-08-24 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
* [descheduler](https://github.com/kubernetes-sigs/descheduler) ⭐ 5,495 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Descheduler for Kubernetes.
...
* [kruise](https://github.com/openkruise/kruise) ⭐ 5,323 | 🐛 86 | 🌐 Go | 📅 2026-08-24 - Automate application workloads management on Kubernetes.
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,430 | 🐛 41 | 🌐 Go | 📅 2026-08-25 - Heterogeneous GPU Sharing on Kubernetes.
...
* [service-fabric](https://github.com/Microsoft/service-fabric) ⭐ 3,064 | 🐛 845 | 🌐 C++ | 📅 2026-08-17 - Service Fabric is a distributed systems platform for packaging, deploying, and managing stateless and stateful distributed applications and containers at large scale.
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,903 | 🐛 715 | 🌐 Go | 📅 2026-08-25 - Kubernetes-native Job Queueing.
* [kcp](https://github.com/kcp-dev/kcp) ⭐ 2,816 | 🐛 144 | 🌐 Go | 📅 2026-08-21 - Multi-tenant control plane for running many virtual Kubernetes clusters.
* [fleet](https://github.com/coreos/fleet) ⚠️ Archived - Fleet ties together systemd and etcd into a distributed init system.
* [koordinator](https://github.com/koordinator-sh/koordinator) ⭐ 1,741 | 🐛 309 | 🌐 Go | 📅 2026-08-25 - QoS based scheduling system for hybrid orchestration workloads on Kubernetes, bringing workloads the best layout and status.
* [eks-distro](https://github.com/aws/eks-distro) ⭐ 1,456 | 🐛 93 | 🌐 Shell | 📅 2026-08-24 - Amazon EKS Distro (EKS-D) is a Kubernetes distribution based on and used by Amazon Elastic Kubernetes Service (EKS) to create reliable and secure Kubernetes clusters.
* [ocm](https://github.com/open-cluster-management-io/OCM) ⭐ 1,076 | 🐛 52 | 🌐 Go | 📅 2026-08-25 - The open-cluster-management.io project is focused on enabling end-to-end visibility and control across your Kubernetes clusters.
...
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,258 | 🐛 113 | 🌐 Rust | 📅 2026-08-25 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,033 | 🐛 429 | 🌐 Go | 📅 2026-08-24 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
* [thanos](https://github.com/thanos-io/thanos) ⭐ 14,185 | 🐛 879 | 🌐 Go | 📅 2026-08-24 - Highly available Prometheus setup with long term storage capabilities.
* [keda](https://github.com/kedacore/keda) ⭐ 10,468 | 🐛 239 | 🌐 Go | 📅 2026-08-24 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
* [fission](https://github.com/fission/fission) ⭐ 8,913 | 🐛 45 | 🌐 Go | 📅 2026-08-25 - Fast Serverless Functions for Kubernetes.
...
* [serving](https://github.com/knative/serving) ⭐ 6,086 | 🐛 163 | 🌐 Go | 📅 2026-08-21 - Kubernetes-based, scale-to-zero, request-driven compute.
* [fn](https://github.com/fnproject/fn) ⭐ 5,944 | 🐛 159 | 🌐 Go | 📅 2026-06-08 - The container native, cloud agnostic serverless platform.
* [spec](https://github.com/cloudevents/spec) ⭐ 5,876 | 🐛 16 | 🌐 Python | 📅 2026-07-23 - CloudEvents Specification.
* [nuclio](https://github.com/nuclio/nuclio) ⭐ 5,749 | 🐛 116 | 🌐 Go | 📅 2026-08-25 - High-Performance Serverless event and data processing platform.
...
* [eventing](https://github.com/knative/eventing) ⭐ 1,552 | 🐛 100 | 🌐 Go | 📅 2026-08-24 - Open source specification and implementation of Knative event binding and delivery.
...
* [prometheus-operator](https://github.com/coreos/prometheus-operator) ⭐ 9,974 | 🐛 309 | 🌐 Go | 📅 2026-08-25 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes.
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,295 | 🐛 73 | 🌐 Go | 📅 2026-08-24 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
...
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,022 | 🐛 573 | 🌐 Go | 📅 2026-08-25 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,915 | 🐛 152 | 🌐 Java | 📅 2026-08-25 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,148 | 🐛 119 | 🌐 Python | 📅 2026-08-23 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
...
* [tidb-operator](https://github.com/pingcap/tidb-operator) ⭐ 1,336 | 🐛 396 | 🌐 Go | 📅 2026-08-25 - TiDB operator creates and manages TiDB clusters running in Kubernetes.
* [kudo](https://github.com/kudobuilder/kudo) ⭐ 1,215 | 🐛 191 | 🌐 Go | 📅 2023-08-22 - Kubernetes Universal Declarative Operator (KUDO).
* [kaito](https://github.com/Azure/kaito) ⭐ 1,003 | 🐛 64 | 🌐 Go | 📅 2026-08-24 - Kubernetes AI Toolchain Operator.
* [k0smotron](https://github.com/k0sproject/k0smotron) ⭐ 735 | 🐛 55 | 🌐 Go | 📅 2026-08-18 - k0smotron is a powerful open-source tool for the efficient management of k0s Kubernetes clusters.
...
* [gateway-operator](https://github.com/kong/gateway-operator) ⭐ 108 | 🐛 211 | 🌐 Go | 📅 2026-08-25 - Kong Gateway Operator is a Kubernetes Operator that can manage your Kong Ingress Controller, Kong Gateway Data Planes, or both together when running on Kubernetes.
* [kubevirtbmc](https://github.com/kubevirtbmc/kubevirtbmc) ⭐ 88 | 🐛 34 | 🌐 Go | 📅 2026-08-25 - A Kubernetes operator of virtual BMCs that provide Redfish and IPMI services for KubeVirt virtual machines.
...
* [k3s](https://github.com/k3s-io/k3s) ⭐ 33,811 | 🐛 71 | 🌐 Go | 📅 2026-08-25 - Lightweight Kubernetes.
* [kubeedge](https://github.com/kubeedge/kubeedge) ⭐ 7,557 | 🐛 1,281 | 🌐 Go | 📅 2026-08-18 - Kubernetes Native Edge Computing Framework (project under CNCF).
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,447 | 🐛 209 | 🌐 Go | 📅 2026-08-25 - Zero Friction Kubernetes.
* [openyurt](https://github.com/openyurtio/openyurt) ⭐ 2,000 | 🐛 118 | 🌐 Go | 📅 2026-08-24 - Extending your native Kubernetes to edge(project under CNCF).
...
* [kairos](https://github.com/kairos-io/kairos) ⭐ 1,809 | 🐛 287 | 🌐 Go | 📅 2026-08-25 - The immutable Linux meta-distribution for edge Kubernetes.
* [iotedge](https://github.com/Azure/iotedge) ⭐ 1,508 | 🐛 95 | 🌐 C# | 📅 2026-08-21 - The IoT Edge OSS project.
* [akri](https://github.com/project-akri/akri) ⭐ 1,259 | 🐛 87 | 🌐 Rust | 📅 2026-08-24 - A Kubernetes Resource Interface for the Edge.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,409 | 🐛 3,306 | 🌐 TypeScript | 📅 2026-08-25 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,812 | 🐛 904 | 🌐 Go | 📅 2026-08-25 - The Prometheus monitoring system and time series database.
* [kibana](https://github.com/elastic/kibana) ⭐ 21,257 | 🐛 14,247 | 🌐 TypeScript | 📅 2026-08-25 - Kibana analytics and search dashboard for Elasticsearch.
...
* [docker-elk](https://github.com/deviantony/docker-elk) ⭐ 18,385 | 🐛 5 | 🌐 Shell | 📅 2026-08-23 - The ELK stack powered by Docker and Compose.
* [statsd](https://github.com/statsd/statsd) ⭐ 18,075 | 🐛 90 | 🌐 JavaScript | 📅 2025-05-20 - Daemon for easy but powerful stats aggregation.
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,592 | 🐛 780 | 🌐 Go | 📅 2026-08-25 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
* [kubeshark](https://github.com/kubeshark/kubeshark) ⭐ 12,056 | 🐛 146 | 🌐 Go | 📅 2026-08-25 - The API traffic viewer for Kubernetes providing deep visibility into all API traffic and payloads going in, out and across containers and pods inside a Kubernetes cluster. Think TCPDump and Wireshark re-invented for Kubernetes.
* [highlight](https://github.com/highlight/highlight) ⭐ 9,369 | 🐛 553 | 🌐 TypeScript | 📅 2026-08-20 - The open source, full-stack monitoring platform. Error monitoring, session replay, logging and more.
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,448 | 🐛 703 | 🌐 Go | 📅 2026-08-25 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,518 | 🐛 395 | 🌐 C++ | 📅 2026-07-30 - Instant Kubernetes-Native Application Observability.
...
* [cortex](https://github.com/cortexproject/cortex) ⭐ 5,856 | 🐛 355 | 🌐 Go | 📅 2026-08-25 - A multitenant, horizontally scalable Prometheus as a Service.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,950 | 🐛 266 | 🌐 C | 📅 2026-08-25 - eBPF-based Security Observability and Runtime Enforcement.
* [parca](https://github.com/parca-dev/parca) ⭐ 4,949 | 🐛 204 | 🌐 TypeScript | 📅 2026-08-24 - Continuous profiling for analysis of CPU and memory usage, down to the line number and throughout time. Saving infrastructure cost, improving performance, and increasing reliability.
* [deepflow](https://github.com/deepflowys/deepflow) ⭐ 4,242 | 🐛 268 | 🌐 Go | 📅 2026-08-25 - A highly automated observability platform.
* [metaflow](https://github.com/metaflowys/metaflow) ⭐ 4,242 | 🐛 268 | 🌐 Go | 📅 2026-08-25 - MetaFlow is an automated observability platform for cloud-native developers.
...
* [kiali](https://github.com/kiali/kiali) ⭐ 3,632 | 🐛 84 | 🌐 Go | 📅 2026-08-25 - Kiali project to help istio service mesh observability.
* [open-falcon](https://github.com/XiaoMi/open-falcon) ⭐ 3,020 | 🐛 32 | 📅 2018-07-05 - Enterprise Internet monitoring system from Xiaomi.
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,913 | 🐛 427 | 🌐 C | 📅 2026-08-25 - The eBPF tool and systems inspection framework for Kubernetes, containers and Linux hosts.
...
* [perses](https://github.com/perses/perses) ⭐ 2,376 | 🐛 265 | 🌐 Go | 📅 2026-08-25 - The CNCF candidate for observability visualisation.
...
* [kepler](https://github.com/sustainable-computing-io/kepler) ⭐ 1,559 | 🐛 50 | 🌐 Go | 📅 2026-08-25 - Kepler (Kubernetes-based Efficient Power Level Exporter) uses eBPF to probe performance counters and other system stats, use ML models to estimate workload energy consumption based on these stats, and exports them as Prometheus metrics.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,861 | 🐛 5,913 | 🌐 Java | 📅 2026-08-25 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,783 | 🐛 1,718 | 🌐 Go | 📅 2026-08-25 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,451 | 🐛 2,519 | 🌐 Rust | 📅 2026-08-24 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,766 | 🐛 407 | 🌐 Go | 📅 2026-08-25 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,577 | 🐛 137 | 🌐 Ruby | 📅 2026-08-24 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,640 | 🐛 1,037 | 🌐 Go | 📅 2026-08-25 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,543 | 🐛 800 | 🌐 Rust | 📅 2026-08-24 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,062 | 🐛 781 | 🌐 C | 📅 2026-08-25 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,613 | 🐛 2,258 | 🌐 Python | 📅 2026-08-25 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,929 | 🐛 40 | 🌐 Java | 📅 2026-08-25 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,141 | 🐛 568 | 🌐 Go | 📅 2026-08-24 - Jaeger, a Distributed Tracing System.
* [zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,453 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - Zipkin is a distributed tracing system.
* [pinpoint](https://github.com/naver/pinpoint) ⭐ 13,861 | 🐛 536 | 🌐 Java | 📅 2026-08-25 - Pinpoint is an open source APM (Application Performance Management) tool for large-scale distributed systems written in Java.
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,323 | 🐛 478 | 🌐 Makefile | 📅 2026-08-24 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,603 | 🐛 258 | 🌐 Go | 📅 2026-08-21 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
* [keycloak](https://github.com/keycloak/keycloak) ⭐ 36,399 | 🐛 3,119 | 🌐 Java | 📅 2026-08-25 - Open Source Identity and Access Management For Modern Applications and Services.
* [vault](https://github.com/hashicorp/vault) ⭐ 36,167 | 🐛 1,428 | 🌐 Go | 📅 2026-08-25 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,845 | 🐛 3,372 | 🌐 Go | 📅 2026-08-24 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
* [supertokens-core](https://github.com/supertokens/supertokens-core) ⭐ 15,277 | 🐛 164 | 🌐 Java | 📅 2026-08-25 - Open source alternative to Auth0 / Firebase Auth / AWS Cognito.
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,049 | 🐛 241 | 🌐 Go | 📅 2026-08-25 - Automatically provision and manage TLS certificates in Kubernetes.
* [kratos](https://github.com/ory/kratos) ⭐ 13,846 | 🐛 224 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication, MFA, FIDO2, profile management, identity schemas, social sign in, registration, account recovery, service-to-service and IoT auth. Can work as an OAuth2 / OpenID Connect Provider. Golang, headless, API-only - without templating or theming headaches.
* [grype](https://github.com/anchore/grype) ⭐ 12,785 | 🐛 412 | 🌐 Go | 📅 2026-08-21 - A vulnerability scanner for container images and filesystems.
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,155 | 🐛 345 | 🌐 Go | 📅 2026-08-25 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,687 | 🐛 70 | 🌐 Go | 📅 2026-08-25 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
* [dex](https://github.com/dexidp/dex) ⭐ 11,057 | 🐛 527 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors.
* [clair](https://github.com/quay/clair) ⭐ 11,052 | 🐛 59 | 🌐 Go | 📅 2026-08-24 - Vulnerability Static Analysis for Containers.
...
* [syft](https://github.com/anchore/syft) ⭐ 9,456 | 🐛 638 | 🌐 Go | 📅 2026-08-21 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,300 | 🐛 64 | 🌐 C++ | 📅 2026-08-03 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,043 | 🐛 402 | 🌐 Elixir | 📅 2026-08-25 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,974 | 🐛 166 | 🌐 Python | 📅 2026-08-23 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
* [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,150 | 🐛 95 | 🌐 Go | 📅 2026-08-24 - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices.
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,069 | 🐛 643 | 🌐 Go | 📅 2026-08-25 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,805 | 🐛 266 | 🌐 Go | 📅 2026-08-24 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,235 | 🐛 163 | 🌐 Go | 📅 2026-08-24 - Container signing, verification, and provenance powered by Sigstore.
* [opal](https://github.com/permitio/opal) ⭐ 5,504 | 🐛 63 | 🌐 Python | 📅 2026-08-24 - An administration layer for Policy Engines, detecting changes to both policy and policy data in real time and pushing live updates to your agents.
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,974 | 🐛 150 | 🌐 Go | 📅 2026-08-25 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,756 | 🐛 124 | 🌐 Go | 📅 2026-08-25 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [spiffe](https://github.com/spiffe/spiffe) ⭐ 1,831 | 🐛 50 | 🌐 Shell | 📅 2026-08-03 - The SPIFFE Project.
* [cedar](https://github.com/cedar-policy/cedar) ⭐ 1,689 | 🐛 171 | 🌐 Rust | 📅 2026-08-24 - Core implementation of the Cedar language.
...
* [neuvector](https://github.com/neuvector/neuvector) ⭐ 1,330 | 🐛 308 | 🌐 Go | 📅 2026-08-25 - Kubernetes-native container security platform.
* [in-toto](https://github.com/in-toto/in-toto) ⭐ 1,030 | 🐛 60 | 🌐 Python | 📅 2026-08-05 - in-toto is a framework to protect supply chain integrity.
...
* [darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 870 | 🐛 2 | 🌐 Python | 📅 2026-08-25 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks, with a proof trail per finding.
...
* [trust-manager](https://github.com/cert-manager/trust-manager) ⭐ 394 | 🐛 43 | 🌐 Go | 📅 2026-08-23 - trust-manager is an operator for distributing trust bundles across a Kubernetes cluster.
...
* [brood-box](https://github.com/stacklok/brood-box) ⭐ 62 | 🐛 13 | 🌐 Go | 📅 2026-08-24 - CLI tool for running coding agents inside hardware-isolated microVMs with workspace snapshot isolation and egress control.
...
* [go-microvm](https://github.com/stacklok/go-microvm) ⭐ 22 | 🐛 10 | 🌐 Go | 📅 2026-08-23 - Go framework for running OCI images as microVMs via libkrun with embedded runtime, rootfs management, and guest networking.
...
* [chaosmonkey](https://github.com/Netflix/chaosmonkey) ⭐ 17,088 | 🐛 34 | 🌐 Go | 📅 2025-01-06 - Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
* [metersphere](https://github.com/metersphere/metersphere) ⭐ 13,469 | 🐛 1 | 🌐 Java | 📅 2026-08-10 - MeterSphere is an End-to-End open source continuous testing platform. MeterSphere 是一站式开源持续测试平台，涵盖测试跟踪、接口测试、性能测试、团队协作等功能，全面兼容 JMeter、Postman、Swagger 等开源、主流标准。
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,283 | 🐛 105 | 🌐 Go | 📅 2026-08-04 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [chaos-mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,855 | 🐛 551 | 🌐 Go | 📅 2026-08-18 - A Chaos Engineering Platform for Kubernetes.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,500 | 🐛 365 | 🌐 Python | 📅 2026-08-25 - An easy to use and powerful chaos engineering experiment toolkit（阿里巴巴开源的一款简单易用、功能强大的混沌实验注入工具）.
...
* [ratelimit](https://github.com/envoyproxy/ratelimit) ⭐ 2,683 | 🐛 36 | 🌐 Go | 📅 2026-08-24 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,647 | 🐛 48 | 🌐 Go | 📅 2026-08-25 - Kubernetes-native framework for test definition and execution.
* [krkn](https://github.com/krkn-chaos/krkn) ⭐ 490 | 🐛 138 | 🌐 Python | 📅 2026-08-25 - Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,335 | 🐛 746 | 🌐 TypeScript | 📅 2026-08-21 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,245 | 🐛 400 | 🌐 TypeScript | 📅 2026-08-25 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,872 | 🐛 3,348 | 🌐 Go | 📅 2026-08-25 - Complete container management platform.
...
* [openshift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 306 | 🌐 Go | 📅 2026-08-22 - Enterprise Kubernetes for Developers.
* [rainbond](https://github.com/goodrain/rainbond) ⭐ 6,255 | 🐛 57 | 🌐 Go | 📅 2026-08-24 - Serverless PaaS , A new generation of easy-to-use cloud management platforms based on kubernetes.
* [wayne](https://github.com/Qihoo360/wayne) ⭐ 3,700 | 🐛 61 | 🌐 TypeScript | 📅 2022-05-31 - Web UI for Kubernetes multi-clusters.
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,110 | 🐛 57 | 🌐 Go | 📅 2026-08-25 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
...
* [kubermatic](https://github.com/kubermatic/kubermatic) ⭐ 1,298 | 🐛 459 | 🌐 Go | 📅 2026-08-21 - The Central Kubernetes Management Platform For Any Infrastructure.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 127 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-25 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,361 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-21 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,551 | 🐛 52 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
...
* [kubernetes-on-aws](https://github.com/zalando-incubator/kubernetes-on-aws) ⭐ 635 | 🐛 42 | 🌐 Go | 📅 2026-08-25 - Deploying Kubernetes on AWS with CloudFormation and Ubuntu.
