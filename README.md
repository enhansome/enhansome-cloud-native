...
* [tensorflow](https://github.com/tensorflow/tensorflow) ⭐ 197,316 | 🐛 2,914 | 🌐 C++ | 📅 2026-08-22 - Computation using data flow graphs for scalable machine learning.
* [pytorch](https://github.com/pytorch/pytorch) ⭐ 102,536 | 🐛 17,247 | 🌐 Python | 📅 2026-08-22 - Tensors and Dynamic neural networks in Python with strong GPU acceleration.
* [keras](https://github.com/keras-team/keras) ⭐ 64,245 | 🐛 232 | 🌐 Python | 📅 2026-08-21 - Keras is a high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK, or Theano.
* [paddlepaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,059 | 🐛 1,505 | 🌐 C++ | 📅 2026-08-20 - PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice（『飞桨』核心框架，深度学习&机器学习高性能单机、分布式训练和跨平台部署）.
...
* [kserve](https://github.com/kserve/kserve) ⭐ 5,815 | 🐛 199 | 🌐 Go | 📅 2026-08-21 - Standardized Serverless ML Inference Platform on Kubernetes.
...
* [litellm](https://github.com/BerriAI/litellm) ⭐ 56,994 | 🐛 4,997 | 🌐 Python | 📅 2026-08-22 - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - \[Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq].
* [kong](https://github.com/Kong/kong) ⭐ 44,020 | 🐛 189 | 🌐 Lua | 📅 2026-08-16 - The Microservice API Gateway.
* [apisix](https://github.com/apache/apisix) ⭐ 17,016 | 🐛 253 | 🌐 Lua | 📅 2026-08-20 - The Cloud-Native API Gateway.
* [tyk](https://github.com/TykTechnologies/tyk) ⭐ 10,796 | 🐛 497 | 🌐 Go | 📅 2026-08-21 - Tyk Open Source API Gateway written in Go, supporting REST, GraphQL, TCP and gRPC protocols.
* [higress](https://github.com/alibaba/higress) ⭐ 9,159 | 🐛 1,071 | 🌐 Go | 📅 2026-08-20 - Next-generation Cloud Native Gateway.
...
* [gateway](https://github.com/envoyproxy/gateway) ⭐ 2,973 | 🐛 763 | 🌐 Go | 📅 2026-08-21 - Manages Envoy Proxy as a standalone or Kubernetes-based application gateway.
...
* [sbproxy](https://github.com/soapbucket/sbproxy) ⭐ 50 | 🐛 3 | 🌐 Rust | 📅 2026-08-22 - Single-binary AI gateway and reverse proxy with 103+ LLM providers, cost-based routing, rate limiting, and declarative YAML configuration.

## Continuous Delivery & GitOps

* [terraform](https://github.com/hashicorp/terraform) ⭐ 49,511 | 🐛 1,915 | 🌐 Go | 📅 2026-08-21 - Terraform is a tool for building, changing, and combining infrastructure safely and efficiently.
* [drone](https://github.com/drone/drone) ⭐ 38,076 | 🐛 107 | 🌐 Go | 📅 2026-08-21 - Drone is a Continuous Delivery platform built on Docker, written in Go.
* [helm](https://github.com/helm/helm) ⭐ 30,164 | 🐛 451 | 🌐 Go | 📅 2026-08-20 - The Kubernetes Package Manager.
* [opentofu](https://github.com/opentofu/opentofu) ⭐ 29,864 | 🐛 325 | 🌐 Go | 📅 2026-08-22 - OpenTofu lets you declaratively manage your cloud infrastructure.
* [jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,481 | 🐛 3,615 | 🌐 Java | 📅 2026-08-22 - Jenkins automation server.
* [pulumi](https://github.com/pulumi/pulumi) ⭐ 25,597 | 🐛 2,449 | 🌐 Go | 📅 2026-08-22 - A multi-language, multi-cloud development platform -- your code, your cloud, your team.
* [argo-cd](https://github.com/argoproj/argo-cd/) ⭐ 23,971 | 🐛 4,394 | 🌐 Go | 📅 2026-08-22 - Declarative continuous deployment for Kubernetes.
* [argo](https://github.com/argoproj/argo) ⭐ 16,928 | 🐛 1,266 | 🌐 Go | 📅 2026-08-21 - Get stuff done with container-native workflows for Kubernetes.
* [dagger](https://github.com/dagger/dagger) ⭐ 16,191 | 🐛 141 | 🌐 Go | 📅 2026-08-22 - A programmable CI/CD engine that runs your pipelines in containers.
...
* [crossplane](https://github.com/crossplane/crossplane) ⭐ 11,968 | 🐛 187 | 🌐 Go | 📅 2026-08-22 - An Open Source Multicloud Control Plane.
* [meshery](https://github.com/meshery/meshery) ⭐ 11,549 | 🐛 1,825 | 🌐 TypeScript | 📅 2026-08-22 - A open source cloud native manager that enables the design and management of all Kubernetes-based infrastructure and applications (multi-cloud).
...
* [spinnaker](https://github.com/spinnaker/spinnaker) ⭐ 9,771 | 🐛 105 | 🌐 Java | 📅 2026-08-22 - Spinnaker is an open source, multi-cloud continuous delivery platform for releasing software changes with high velocity and confidence.
* [pipeline](https://github.com/tektoncd/pipeline) ⭐ 9,039 | 🐛 560 | 🌐 Go | 📅 2026-08-21 - A cloud-native Pipeline resource.
* [ko](https://github.com/ko-build/ko) ⭐ 8,501 | 🐛 58 | 🌐 Go | 📅 2026-08-20 - Build and deploy Go applications on Kubernetes.
...
* [woodpecker](https://github.com/laszlocph/woodpecker) ⭐ 7,729 | 🐛 360 | 🌐 Go | 📅 2026-08-22 - Fork of drone.io v0.8 since drone is not fully opensource anymore.
* [jsonnet](https://github.com/google/jsonnet) ⭐ 7,558 | 🐛 210 | 🌐 Jsonnet | 📅 2026-03-30 - Jsonnet - The data templating language.
...
* [devtron](https://github.com/devtron-labs/devtron) ⭐ 5,586 | 🐛 763 | 🌐 Go | 📅 2026-08-21 - Software Delivery Workflow For Kubernetes
...
* [cdk8s](https://github.com/awslabs/cdk8s) ⭐ 4,851 | 🐛 77 | 🌐 JavaScript | 📅 2026-08-22 - Define Kubernetes native apps and abstractions using object-oriented programming.
* [cds](https://github.com/ovh/cds) ⭐ 4,835 | 🐛 160 | 🌐 Go | 📅 2026-08-21 - Enterprise-Grade Continuous Delivery & DevOps Automation Open Source Platform.
...
* [spegel](https://github.com/spegel-org/spegel) ⭐ 3,746 | 🐛 20 | 🌐 Go | 📅 2026-08-21 - Stateless cluster local OCI registry mirror.
...
* [kargo](https://github.com/akuity/kargo) ⭐ 3,589 | 🐛 179 | 🌐 Go | 📅 2026-08-21 - Application lifecycle orchestration.
...
* [source-to-image](https://github.com/openshift/source-to-image) ⭐ 2,543 | 🐛 27 | 🌐 Go | 📅 2026-08-22 - A tool for building/building artifacts from source and injecting into docker images.
...
* [timoni](https://github.com/stefanprodan/timoni) ⭐ 2,002 | 🐛 34 | 🌐 Go | 📅 2026-08-22 - Timoni is a package manager for Kubernetes, powered by CUE and inspired by Helm.
...
* [radius](https://github.com/radius-project/radius) ⭐ 1,662 | 🐛 317 | 🌐 Go | 📅 2026-08-22 - Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.
...
* [pipecd](https://github.com/pipe-cd/pipecd) ⭐ 1,344 | 🐛 204 | 🌐 Go | 📅 2026-08-22 - The One CD for All {applications, platforms, operations} - Complete and unified CD to deploy any application to any platform
...
* [packer](https://github.com/hashicorp/packer) ⭐ 15,763 | 🐛 317 | 🌐 Go | 📅 2026-08-22 - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
* [tini](https://github.com/krallin/tini) ⭐ 11,218 | 🐛 45 | 🌐 C | 📅 2025-05-08 - A tiny but valid `init` for containers.
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,181 | 🐛 87 | 🌐 Go | 📅 2026-08-20 - Work with remote images registries - retrieving information, images, signing content.
* [buildx](https://github.com/docker/buildx) ⭐ 4,484 | 🐛 388 | 🌐 Go | 📅 2026-08-20 - Docker CLI plugin for extended build capabilities with BuildKit.
...
* [ansible](https://github.com/ansible/ansible) ⭐ 70,433 | 🐛 836 | 🌐 Python | 📅 2026-08-19 - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications — automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
* [unleash](https://github.com/Unleash/unleash) ⭐ 13,747 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-21 - Open-source feature management platform to decouple deploy from release and enable continuous delivery safely.
* [reloader](https://github.com/stakater/Reloader) ⭐ 10,352 | 🐛 164 | 🌐 Go | 📅 2026-08-17 - A Kubernetes controller to watch changes in ConfigMap and Secrets and do rolling upgrades on Pods with their associated Deployment, StatefulSet, DaemonSet and DeploymentConfig.
...
* [openfeature](https://github.com/open-feature/spec) ⭐ 1,240 | 🐛 38 | 🌐 Python | 📅 2026-08-21 - Vendor-neutral feature flag standard and SDKs for cloud native apps.
...
* [kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 233 | 🐛 143 | 🌐 Rust | 📅 2026-08-22 - Policy as code for Kubernetes powered by WebAssembly modules.
...
* [minikube](https://github.com/kubernetes/minikube) ⭐ 32,051 | 🐛 551 | 🌐 Go | 📅 2026-08-22 - Run Kubernetes locally.
...
* [kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,699 | 🐛 201 | 🌐 Jinja | 📅 2026-08-21 - Setup a kubernetes cluster also mentioned as kargo.
* [sealos](https://github.com/labring/sealos) ⭐ 18,315 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-21 - Sealos is a Kubernetes distribution offering comprehensive solutions for both public and private clouds.
* [kops](https://github.com/kubernetes/kops) ⭐ 16,667 | 🐛 132 | 🌐 Go | 📅 2026-08-21 - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management.
...
* [talos](https://github.com/talos-systems/talos) ⭐ 10,995 | 🐛 220 | 🌐 Go | 📅 2026-08-21 - A modern OS for Kubernetes.
* [microk8s](https://github.com/ubuntu/microk8s) ⭐ 9,353 | 🐛 165 | 🌐 Python | 📅 2026-08-22 - A kubernetes cluster in a snap.
* [eksctl](https://github.com/weaveworks/eksctl) ⭐ 5,212 | 🐛 89 | 🌐 Go | 📅 2026-08-21 - A CLI for Amazon EKS.
* [cluster-api](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,287 | 🐛 227 | 🌐 Go | 📅 2026-08-21 - Kubernetes-style APIs for declaratively managing cluster lifecycle across providers.
* [kubeadm](https://github.com/kubernetes/kubeadm) ⭐ 3,997 | 🐛 39 | 🌐 Go | 📅 2026-08-09 - Aggregator for issues filed against kubeadm.
* [gardener](https://github.com/gardener/gardener) ⭐ 3,430 | 🐛 191 | 🌐 Go | 📅 2026-08-21 - Kubernetes API server extension and controller manager providing conformant Kubernetes clusters (a.k.a. (off)shoot clusters) as a service (with day-2 ops) on Alibaba, AWS, Azure, GCP, and OpenStack.
...
* [fleet](https://github.com/rancher/fleet) ⭐ 1,724 | 🐛 189 | 🌐 Go | 📅 2026-08-22 - Manage large fleets of Kubernetes clusters.
...
* [client-go](https://github.com/kubernetes/client-go) ⭐ 9,865 | 🐛 0 | 🌐 Go | 📅 2026-08-21 - Go client for Kubernetes.
...
* [okteto](https://github.com/okteto/okteto) ⭐ 3,533 | 🐛 37 | 🌐 Go | 📅 2026-08-22 - Local development experience for Kubernetes apps.
...
* [kftray](https://github.com/hcavarsan/kftray) ⭐ 1,550 | 🐛 18 | 🌐 Rust | 📅 2026-08-22 - Manage and run multiple kubectl port-forward configurations directly in the menu bar, syncing configurations with git repositories.
...
* [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,101 | 🐛 80 | 🌐 Go | 📅 2026-08-22 - Giving Kubernetes Superpowers to everyone.
...
* [kube-capacity](https://github.com/robscott/kube-capacity) ⭐ 2,663 | 🐛 51 | 🌐 Go | 📅 2025-11-21 - A simple CLI that provides an overview of the resource requests, limits, and utilization in a Kubernetes cluster.
...
* [test-infra](https://github.com/kubernetes/test-infra) ⭐ 4,015 | 🐛 124 | 🌐 Go | 📅 2026-08-22 - Test infrastructure for the Kubernetes project.
...
* [jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 211 | 🐛 169 | 🌐 Python | 📅 2026-08-22 - Open source hardware-in-the-loop testing framework with Kubernetes-native device management and CI/CD integration.
...
* [cost-model](https://github.com/kubecost/cost-model) ⭐ 6,688 | 🐛 298 | 🌐 Go | 📅 2026-08-21 - Cross-cloud cost allocation models for workloads running on Kubernetes.
* [opencost](https://github.com/opencost/opencost) ⭐ 6,688 | 🐛 298 | 🌐 Go | 📅 2026-08-21 - Kubernetes cost monitoring powered by open allocation models.
...
* [swagger](https://github.com/swagger-api/swagger-ui) ⭐ 28,979 | 🐛 1,138 | 🌐 JavaScript | 📅 2026-08-21 - Swagger UI is a collection of HTML, JavaScript, and CSS assets that dynamically generate beautiful documentation from a Swagger-compliant API.
...
* [redis](https://github.com/redis/redis) ⭐ 76,070 | 🐛 2,902 | 🌐 C | 📅 2026-08-20 - Redis is an in-memory database that persists on disk. The data model is key-value, but many different kind of values are supported: Strings, Lists, Sets, Sorted Sets, Hashes, HyperLogLogs, Bitmaps.
* [nocodb](https://github.com/nocodb/nocodb) ⭐ 64,643 | 🐛 707 | 🌐 TypeScript | 📅 2026-08-22 - The Open Source Airtable alternative.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 52,153 | 🐛 322 | 🌐 Go | 📅 2026-08-20 - Distributed reliable key-value store for the most critical data of a distributed system.
* [milvus](https://github.com/milvus-io/milvus) ⭐ 45,732 | 🐛 1,326 | 🌐 Go | 📅 2026-08-22 - Vector database for scalable similarity search and AI applications.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,460 | 🐛 6,832 | 🌐 Go | 📅 2026-08-22 - TiDB is a distributed NewSQL database compatible with MySQL protocol.
* [leveldb](https://github.com/google/leveldb) ⭐ 39,349 | 🐛 402 | 🌐 C++ | 📅 2026-03-11 - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
* [cockroachdb](https://github.com/cockroachdb/cockroach/) ⭐ 32,411 | 🐛 8,287 | 🌐 Go | 📅 2026-08-07 - CockroachDB - the open source, cloud-native SQL database.
...
* [timescaledb](https://github.com/timescale/timescaledb) ⭐ 23,399 | 🐛 394 | 🌐 C | 📅 2026-08-20 - An open-source time-series SQL database optimized for fast ingest and complex queries. Packaged as a PostgreSQL extension.
* [sharding-sphere](https://github.com/apache/shardingsphere) ⭐ 20,782 | 🐛 256 | 🌐 Java | 📅 2026-08-22 - Distributed database middleware.
* [tikv](https://github.com/tikv/tikv) ⭐ 16,808 | 🐛 1,804 | 🌐 Rust | 📅 2026-08-21 - Distributed transactional key-value database, originally created to complement TiDB.
* [arangodb](https://github.com/arangodb/arangodb) ⭐ 14,261 | 🐛 838 | 🌐 C++ | 📅 2026-08-21 - ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.
* [nebula](https://github.com/vesoft-inc/nebula) ⭐ 12,357 | 🐛 679 | 🌐 C++ | 📅 2026-05-18 - A distributed, fast open-source graph database featuring horizontal scalability and high availability.
* [oceanbase](https://github.com/oceanbase/oceanbase) ⭐ 10,253 | 🐛 584 | 🌐 C++ | 📅 2026-08-22 - A distributed, banking suitable, open-source related database featuring high scalability and high compatibility.
* [databend](https://github.com/datafuselabs/databend) ⭐ 9,423 | 🐛 564 | 🌐 Rust | 📅 2026-08-22 - An elastic and reliable Serverless Data Warehouse, offers Blazing Fast Query and combines Elasticity, Simplicity, Low cost of the Cloud, built to make the Data Cloud easy.
* [tinydb](https://github.com/msiemens/tinydb) ⭐ 7,555 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - TinyDB is a lightweight document oriented database optimized for your happiness.
* [spicedb](https://github.com/authzed/spicedb) ⭐ 6,979 | 🐛 149 | 🌐 Go | 📅 2026-08-21 - Inspired by Google's Zanzibar paper, SpiceDB is a database system for managing security-critical application permissions.
* [couchdb](https://github.com/apache/couchdb) ⭐ 6,939 | 🐛 371 | 🌐 Erlang | 📅 2026-08-21 - Apache CouchDB is one of a new breed of database management systems.
...
* [polardb-for-postgresql](https://github.com/alibaba/PolarDB-for-PostgreSQL) ⭐ 3,193 | 🐛 64 | 🌐 C | 📅 2026-08-22 - PolarDB for PostgreSQL (PolarDB for short) is an open source database system based on PostgreSQL.
...
* [kubeblocks](https://github.com/apecloud/kubeblocks) ⭐ 3,108 | 🐛 254 | 🌐 Go | 📅 2026-08-21 - KubeBlocks is an open source system software that runs and manages data infrastructure on K8s. It helps developers, SREs, and platform engineers deploy and maintain dedicated DBPaaS, and supports a variety of public clouds and on-premise environments.
...
* [harbor](https://github.com/goharbor/harbor) ⭐ 29,205 | 🐛 846 | 🌐 Go | 📅 2026-08-21 - An open source trusted cloud native registry project that stores, signs, and scans content.
* [vitess](https://github.com/vitessio/vitess) ⭐ 21,237 | 🐛 1,089 | 🌐 Go | 📅 2026-08-22 - Vitess is a database clustering system for horizontal scaling of MySQL.
* [ceph](https://github.com/ceph/ceph) ⭐ 16,955 | 🐛 1,262 | 🌐 C++ | 📅 2026-08-22 - Ceph is a distributed object, block, and file storage platform.
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,352 | 🐛 196 | 🌐 Go | 📅 2026-08-21 - A distributed POSIX file system built on top of Redis and S3.
* [rook](https://github.com/rook/rook) ⭐ 13,607 | 🐛 144 | 🌐 Go | 📅 2026-08-21 - File, Block, and Object Storage Services for your Cloud-Native Environment.
* [openebs](https://github.com/openebs/openebs) ⭐ 9,800 | 🐛 38 | 📅 2026-08-22 - OpenEBS is containerized block storage written in Go for cloud native and other environments w/ per container (or pod) QoS SLAs, tiering and replica policies across AZs and environments, and predictable and scalable performance.
* [fastdfs](https://github.com/happyfish100/fastdfs) ⭐ 9,248 | 🐛 466 | 🌐 C | 📅 2026-08-17 - FastDFS is an open source high performance distributed file system (DFS). It's major functions include: file storing, file syncing and file accessing, and design for high capacity and load balance.
* [longhorn](https://github.com/longhorn/longhorn) ⭐ 7,923 | 🐛 1,855 | 🌐 Shell | 📅 2026-08-21 - We put storage on cows and move them around from rancher.
...
* [glusterfs](https://github.com/gluster/glusterfs) ⭐ 5,219 | 🐛 280 | 🌐 C | 📅 2026-08-22 - Gluster is a software defined distributed storage that can scale to several petabytes. It provides interfaces for object, block and file storage.
...
* [zot](https://github.com/project-zot/zot) ⭐ 2,641 | 🐛 78 | 🌐 Go | 📅 2026-08-21 - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification).
* [oras](https://github.com/oras-project/oras) ⭐ 2,396 | 🐛 76 | 🌐 Go | 📅 2026-08-20 - OCI registry client, managing content like artifacts, images, packages.
...
* [kafka](https://github.com/apache/kafka) ⭐ 33,584 | 🐛 510 | 🌐 Java | 📅 2026-08-21 - A distributed streaming platform.
* [nsq](https://github.com/nsqio/nsq) ⭐ 25,772 | 🐛 77 | 🌐 Go | 📅 2026-08-11 - A realtime distributed messaging platform.
* [rocketmq](https://github.com/apache/rocketmq) ⭐ 22,561 | 🐛 563 | 🌐 Java | 📅 2026-08-20 - Apache RocketMQ is a distributed messaging and streaming platform with low latency, high performance and reliability, trillion-level capacity and flexible scalability.
* [gnatsd](https://github.com/nats-io/nats-server) ⭐ 20,559 | 🐛 544 | 🌐 Go | 📅 2026-08-22 - High-Performance server for NATS, the cloud native messaging system.
* [emqx](https://github.com/emqx/emqx) ⭐ 16,646 | 🐛 255 | 🌐 Erlang | 📅 2026-08-22 - EMQ X Broker - Scalable Distributed MQTT Message Broker for IoT in 5G Era.
* [pulsar](https://github.com/apache/pulsar) ⭐ 15,311 | 🐛 1,752 | 🌐 Java | 📅 2026-08-20 - A distributed messaging and streaming platform.
...
* [istio](https://github.com/istio/istio) ⭐ 38,351 | 🐛 514 | 🌐 Go | 📅 2026-08-22 - Connect, secure, control, and observe services.
...
* [linkerd2](https://github.com/linkerd/linkerd2) ⭐ 11,478 | 🐛 199 | 🌐 Go | 📅 2026-08-21 - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
...
* [kuma](https://github.com/kumahq/kuma) ⭐ 3,994 | 🐛 157 | 🌐 Go | 📅 2026-08-21 - Universal Control Plane for your Service Mesh.
...
* [coredns](https://github.com/coredns/coredns) ⭐ 14,266 | 🐛 296 | 🌐 Go | 📅 2026-08-20 - CoreDNS is a DNS server that chains middleware.
* [zookeeper](https://github.com/apache/zookeeper) ⭐ 12,794 | 🐛 240 | 🌐 Java | 📅 2026-08-17 - Apache ZooKeeper is an effort to develop and maintain an open-source server which enables highly reliable distributed coordination.
...
* [pingora](https://github.com/cloudflare/pingora) ⭐ 27,253 | 🐛 313 | 🌐 Rust | 📅 2026-08-07 - A library for building fast, reliable and evolvable network services.
* [cilium](https://github.com/cilium/cilium) ⭐ 24,993 | 🐛 1,108 | 🌐 Go | 📅 2026-08-22 - API-aware Networking and Security using eBPF and XDP.
...
* [ziti](https://github.com/openziti/ziti) ⭐ 4,355 | 🐛 283 | 🌐 Go | 📅 2026-08-22 - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network.
* [hubble](https://github.com/cilium/hubble) ⭐ 4,309 | 🐛 44 | 🌐 Makefile | 📅 2026-08-18 - Hubble - Network, Service & Security Observability for Kubernetes.
...
* [submariner](https://github.com/submariner-io/submariner) ⭐ 2,686 | 🐛 30 | 🌐 Go | 📅 2026-08-22 - Connect all your Kubernetes clusters, no matter where they are in the world.
* [kube-router](https://github.com/cloudnativelabs/kube-router) ⭐ 2,496 | 🐛 16 | 🌐 Go | 📅 2026-08-17 - Kube-router, a turnkey solution for Kubernetes networking.
* [kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,392 | 🐛 80 | 🌐 Go | 📅 2026-08-22 - Kube-OVN, a Kubernetes network fabric for enterprises that is rich in functions and easy in operations.
* [antrea](https://github.com/antrea-io/antrea) ⭐ 1,807 | 🐛 201 | 🌐 Go | 📅 2026-08-21 - Antrea is a Kubernetes networking based on Open vSwitch.
...
* [caddy](https://github.com/caddyserver/caddy) ⭐ 75,102 | 🐛 272 | 🌐 Go | 📅 2026-08-22 - Fast, cross-platform HTTP/2 web server with automatic HTTPS.
* [traefik](https://github.com/containous/traefik) ⭐ 64,535 | 🐛 914 | 🌐 Go | 📅 2026-08-21 - Træfik, a modern reverse proxy.
* [nginx](https://github.com/nginx/nginx) ⭐ 31,470 | 🐛 470 | 🌐 C | 📅 2026-08-21 - Nginx is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.
* [envoy](https://github.com/envoyproxy/envoy) ⭐ 28,812 | 🐛 1,886 | 🌐 C++ | 📅 2026-08-22 - C++ front/service proxy.
* [cloudflared](https://github.com/cloudflare/cloudflared) ⭐ 15,336 | 🐛 531 | 🌐 Go | 📅 2026-08-21 - Cloudflare Tunnel client (formerly Argo Tunnel).
* [reverse-proxy](https://github.com/microsoft/reverse-proxy) ⭐ 9,601 | 🐛 191 | 🌐 C# | 📅 2026-08-17 - A toolkit for developing high-performance HTTP reverse proxy applications.
* [metallb](https://github.com/metallb/metallb) ⭐ 8,329 | 🐛 102 | 🌐 Go | 📅 2026-08-17 - A network load-balancer implementation for Kubernetes using standard routing protocols.
...
* [katran](https://github.com/facebookincubator/katran) ⭐ 5,299 | 🐛 0 | 🌐 C | 📅 2026-08-21 - A high performance layer 4 load balancer.
* [nginx-kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,067 | 🐛 253 | 🌐 Go | 📅 2026-08-22 - NGINX and NGINX Plus Ingress Controllers for Kubernetes.
...
* [skipper](https://github.com/zalando/skipper) ⭐ 3,318 | 🐛 313 | 🌐 Go | 📅 2026-08-21 - An HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress.
...
* [brpc](https://github.com/apache/incubator-brpc) ⭐ 17,592 | 🐛 466 | 🌐 C++ | 📅 2026-08-22 - Most common RPC framework used throughout Baidu, with 600,000+ instances and 500+ kinds of services, called "baidu-rpc" inside Baidu.
* [thrift](https://github.com/apache/thrift) ⭐ 10,956 | 🐛 12 | 🌐 C++ | 📅 2026-08-21 - Apache thrift.
...
* [kitex](https://github.com/cloudwego/kitex) ⭐ 8,024 | 🐛 68 | 🌐 Go | 📅 2026-08-21 - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices.
...
* [moby](https://github.com/moby/moby) ⭐ 71,992 | 🐛 3,898 | 🌐 Go | 📅 2026-08-21 - Moby Project - a collaborative project for the container ecosystem to assemble container-based systems.
* [podman](https://github.com/containers/podman) ⭐ 32,665 | 🐛 1,131 | 🌐 Go | 📅 2026-08-21 - A tool for managing OCI containers and pods.
* [lima](https://github.com/AkihiroSuda/lima) ⭐ 21,731 | 🐛 536 | 🌐 Go | 📅 2026-08-21 - Linux virtual machines, on macOS (aka "Linux-on-Mac", "macOS subsystem for Linux", "containerd for Mac", unofficially).
* [containerd](https://github.com/containerd/containerd) ⭐ 21,145 | 🐛 445 | 🌐 Go | 📅 2026-08-22 - An open and reliable container runtime.
* [gvisor](https://github.com/google/gvisor) ⭐ 19,135 | 🐛 866 | 🌐 Go | 📅 2026-08-22 - Sandboxed Container Runtime.
...
* [agones](https://github.com/googleforgames/agones) ⭐ 6,982 | 🐛 60 | 🌐 Go | 📅 2026-08-19 - Dedicated Game Server Hosting and Scaling for Multiplayer Games on Kubernetes.
...
* [wazero](https://github.com/tetratelabs/wazero) ⭐ 6,337 | 🐛 40 | 🌐 Go | 📅 2026-08-19 - The zero dependency WebAssembly runtime for Go developers.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,072 | 🐛 603 | 🌐 C | 📅 2026-08-22 - WebAssembly Micro Runtime (WAMR).
...
* [crun](https://github.com/containers/crun) ⭐ 4,062 | 🐛 54 | 🌐 C | 📅 2026-08-19 - A fast and lightweight fully featured OCI runtime and C library for running containers.
...
* [firecracker-containerd](https://github.com/firecracker-microvm/firecracker-containerd) ⭐ 2,906 | 🐛 95 | 🌐 Go | 📅 2026-08-17 - firecracker-containerd enables containerd to manage containers as Firecracker microVMs.
* [wasmcloud](https://github.com/wasmCloud/wasmCloud) ⭐ 2,419 | 🐛 64 | 🌐 Rust | 📅 2026-08-22 - wasmCloud is a universal host runtime for actors built with WebAssembly and capability providers.
* [hyperd](https://github.com/hyperhq/hyperd) ⚠️ Archived - HyperContainer Daemon.
* [kuasar](https://github.com/kuasar-io/kuasar) ⭐ 1,442 | 🐛 29 | 🌐 Rust | 📅 2026-06-05 - An efficient container runtime that provides cloud-native, all-scenario multiple sandbox container solutions.
* [openchoreo](https://github.com/openchoreo/openchoreo) ⭐ 1,395 | 🐛 255 | 🌐 Go | 📅 2026-08-21 - OpenChoreo is a developer platform for Kubernetes.
* [runwasi](https://github.com/containerd/runwasi) ⭐ 1,329 | 🐛 66 | 🌐 Rust | 📅 2026-08-22 - Facilitates running Wasm/WASI workloads managed by containerd.
...
* [kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 124,868 | 🐛 3,003 | 🌐 Go | 📅 2026-08-21 - Production-Grade Container Scheduling and Management.
* [compose](https://github.com/docker/compose) ⭐ 38,041 | 🐛 94 | 🌐 Go | 📅 2026-08-21 - Define and run multi-container applications with Docker.
* [conductor](https://github.com/Netflix/conductor) ⚠️ Archived - Conductor is a microservices orchestration engine.
* [cluster-autoscaler](https://github.com/kubernetes/autoscaler) ⭐ 8,944 | 🐛 313 | 🌐 Go | 📅 2026-08-22 - Kubernetes Cluster Autoscaler for dynamic node scaling across cloud providers.
...
* [karmada](https://github.com/karmada-io/karmada) ⭐ 5,573 | 🐛 839 | 🌐 Go | 📅 2026-08-21 - Open, Multi-Cloud, Multi-Cluster Kubernetes Orchestration.
...
* [hami](https://github.com/Project-HAMi/HAMi) ⭐ 4,413 | 🐛 48 | 🌐 Go | 📅 2026-08-21 - Heterogeneous GPU Sharing on Kubernetes.
...
* [kueue](https://github.com/kubernetes-sigs/kueue) ⭐ 2,895 | 🐛 712 | 🌐 Go | 📅 2026-08-22 - Kubernetes-native Job Queueing.
* [kcp](https://github.com/kcp-dev/kcp) ⭐ 2,814 | 🐛 143 | 🌐 Go | 📅 2026-08-21 - Multi-tenant control plane for running many virtual Kubernetes clusters.
* [fleet](https://github.com/coreos/fleet) ⚠️ Archived - Fleet ties together systemd and etcd into a distributed init system.
* [koordinator](https://github.com/koordinator-sh/koordinator) ⭐ 1,740 | 🐛 309 | 🌐 Go | 📅 2026-08-22 - QoS based scheduling system for hybrid orchestration workloads on Kubernetes, bringing workloads the best layout and status.
...
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,204 | 🐛 112 | 🌐 Rust | 📅 2026-08-21 - Secure and fast microVMs for serverless computing.
...
* [dapr](https://github.com/dapr/dapr) ⭐ 26,025 | 🐛 431 | 🌐 Go | 📅 2026-08-21 - Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge.
* [thanos](https://github.com/thanos-io/thanos) ⭐ 14,181 | 🐛 878 | 🌐 Go | 📅 2026-08-22 - Highly available Prometheus setup with long term storage capabilities.
* [keda](https://github.com/kedacore/keda) ⭐ 10,456 | 🐛 235 | 🌐 Go | 📅 2026-08-21 - KEDA is a Kubernetes-based Event Driven Autoscaling component. It provides event driven scale for any container running in Kubernetes.
* [fission](https://github.com/fission/fission) ⭐ 8,910 | 🐛 51 | 🌐 Go | 📅 2026-08-22 - Fast Serverless Functions for Kubernetes.
...
* [serving](https://github.com/knative/serving) ⭐ 6,084 | 🐛 161 | 🌐 Go | 📅 2026-08-21 - Kubernetes-based, scale-to-zero, request-driven compute.
* [fn](https://github.com/fnproject/fn) ⭐ 5,944 | 🐛 159 | 🌐 Go | 📅 2026-06-08 - The container native, cloud agnostic serverless platform.
* [spec](https://github.com/cloudevents/spec) ⭐ 5,872 | 🐛 16 | 🌐 Python | 📅 2026-07-23 - CloudEvents Specification.
...
* [eventing](https://github.com/knative/eventing) ⭐ 1,552 | 🐛 113 | 🌐 Go | 📅 2026-08-21 - Open source specification and implementation of Knative event binding and delivery.
...
* [kubebuilder](https://github.com/kubernetes-sigs/kubebuilder) ⭐ 9,292 | 🐛 68 | 🌐 Go | 📅 2026-08-20 - Kubebuilder - SDK for building Kubernetes APIs using CRDs.
...
* [kubevirt](https://github.com/kubevirt/kubevirt) ⭐ 7,017 | 🐛 570 | 🌐 Go | 📅 2026-08-22 - Kubernetes Virtualization Operator with API and runtime in order to define and manage virtual machines.
* [strimzi-kafka-operator](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,914 | 🐛 158 | 🌐 Java | 📅 2026-08-22 - Apache Kafka running on Kubernetes.
...
* [spark-on-k8s-operator](https://github.com/GoogleCloudPlatform/spark-on-k8s-operator) ⭐ 3,148 | 🐛 115 | 🌐 Python | 📅 2026-08-21 - Kubernetes operator for managing the lifecycle of Apache Spark applications on Kubernetes.
* [keel](https://github.com/keel-hq/keel) ⭐ 2,720 | 🐛 210 | 🌐 Go | 📅 2026-08-21 - Kubernetes Operator to automate Helm, DaemonSet, StatefulSet & Deployment updates.
...
* [kaito](https://github.com/Azure/kaito) ⭐ 1,002 | 🐛 64 | 🌐 Go | 📅 2026-08-22 - Kubernetes AI Toolchain Operator.
...
* [kubevirtbmc](https://github.com/kubevirtbmc/kubevirtbmc) ⭐ 88 | 🐛 34 | 🌐 Go | 📅 2026-08-22 - A Kubernetes operator of virtual BMCs that provide Redfish and IPMI services for KubeVirt virtual machines.
...
* [k3s](https://github.com/k3s-io/k3s) ⭐ 33,784 | 🐛 70 | 🌐 Go | 📅 2026-08-21 - Lightweight Kubernetes.
* [kubeedge](https://github.com/kubeedge/kubeedge) ⭐ 7,554 | 🐛 1,279 | 🌐 Go | 📅 2026-08-18 - Kubernetes Native Edge Computing Framework (project under CNCF).
...
* [akri](https://github.com/project-akri/akri) ⭐ 1,258 | 🐛 89 | 🌐 Rust | 📅 2026-08-01 - A Kubernetes Resource Interface for the Edge.
...
* [grafana](https://github.com/grafana/grafana) ⭐ 76,345 | 🐛 3,342 | 🌐 TypeScript | 📅 2026-08-22 - The tool for beautiful monitoring and metric analytics & dashboards for Graphite, InfluxDB & Prometheus & More.
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,768 | 🐛 915 | 🌐 Go | 📅 2026-08-22 - The Prometheus monitoring system and time series database.
* [kibana](https://github.com/elastic/kibana) ⭐ 21,248 | 🐛 14,210 | 🌐 TypeScript | 📅 2026-08-22 - Kibana analytics and search dashboard for Elasticsearch.
...
* [victoriametrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,579 | 🐛 778 | 🌐 Go | 📅 2026-08-22 - VictoriaMetrics: fast, cost-effective monitoring solution and time series database.
...
* [opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) ⭐ 7,438 | 🐛 705 | 🌐 Go | 📅 2026-08-21 - Vendor-neutral telemetry pipelines for metrics, logs, and traces.
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,182 | 🐛 104 | 🌐 Go | 📅 2026-08-20 - Add-on agent to generate and expose cluster-level metrics.
...
* [cortex](https://github.com/cortexproject/cortex) ⭐ 5,851 | 🐛 359 | 🌐 Go | 📅 2026-08-21 - A multitenant, horizontally scalable Prometheus as a Service.
...
* [tetragon](https://github.com/cilium/tetragon) ⭐ 4,941 | 🐛 265 | 🌐 C | 📅 2026-08-21 - eBPF-based Security Observability and Runtime Enforcement.
* [deepflow](https://github.com/deepflowys/deepflow) ⭐ 4,239 | 🐛 267 | 🌐 Go | 📅 2026-08-21 - A highly automated observability platform.
* [metaflow](https://github.com/metaflowys/metaflow) ⭐ 4,239 | 🐛 267 | 🌐 Go | 📅 2026-08-21 - MetaFlow is an automated observability platform for cloud-native developers.
...
* [ebpftop](https://github.com/Netflix/bpftop) ⭐ 2,701 | 🐛 5 | 🌐 C | 📅 2026-08-01 - bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
* [perses](https://github.com/perses/perses) ⭐ 2,373 | 🐛 263 | 🌐 Go | 📅 2026-08-21 - The CNCF candidate for observability visualisation.
...
* [elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,849 | 🐛 5,893 | 🌐 Java | 📅 2026-08-22 - Open Source, Distributed, RESTful Search Engine.
* [loki](https://github.com/grafana/loki) ⭐ 28,774 | 🐛 1,726 | 🌐 Go | 📅 2026-08-22 - Like Prometheus, but for logs.
* [vector](https://github.com/vectordotdev/vector) ⭐ 22,430 | 🐛 2,526 | 🌐 Rust | 📅 2026-08-22 - High-performance observability data router for logs, metrics, and traces.
* [telegraf](https://github.com/influxdata/telegraf) ⭐ 17,764 | 🐛 395 | 🌐 Go | 📅 2026-08-21 - The plugin-driven server agent for collecting & reporting metrics.
* [fluentd](https://github.com/fluent/fluentd) ⭐ 13,578 | 🐛 138 | 🌐 Ruby | 📅 2026-08-21 - Fluentd: Unified Logging Layer (project under CNCF).
* [beats](https://github.com/elastic/beats) ⭐ 12,640 | 🐛 1,040 | 🌐 Go | 📅 2026-08-22 - Beats - Lightweight shippers for Elasticsearch & Logstash.
* [quickwit](https://github.com/quickwit-oss/quickwit) ⭐ 11,535 | 🐛 803 | 🌐 Rust | 📅 2026-08-21 - Open-source & cloud-native log management & analytics.
* [fluent-bit](https://github.com/fluent/fluent-bit) ⭐ 8,056 | 🐛 775 | 🌐 C | 📅 2026-08-21 - Fast and Lightweight Log/Data Forwarder for Linux, BSD and macOS.
...
* [sentry](https://github.com/getsentry/sentry) ⭐ 44,594 | 🐛 2,300 | 🌐 Python | 📅 2026-08-22 - Sentry is a cross-platform crash reporting and aggregation platform.
* [skywalking](https://github.com/apache/skywalking) ⭐ 24,925 | 🐛 23 | 🌐 Java | 📅 2026-08-20 - An APM system for tracing, monitoring, diagnosing distributed systems, especially based on microservices, cloud native and container.
* [jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,128 | 🐛 566 | 🌐 Go | 📅 2026-08-20 - Jaeger, a Distributed Tracing System.
* [zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,453 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - Zipkin is a distributed tracing system.
* [pinpoint](https://github.com/naver/pinpoint) ⭐ 13,862 | 🐛 532 | 🌐 Java | 📅 2026-08-21 - Pinpoint is an open source APM (Application Performance Management) tool for large-scale distributed systems written in Java.
* [opentelemetry](https://github.com/open-telemetry/opentelemetry-specification) ⭐ 4,318 | 🐛 520 | 🌐 Makefile | 📅 2026-08-19 - An observability framework for cloud-native software.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,551 | 🐛 252 | 🌐 Go | 📅 2026-08-21 - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets.
* [keycloak](https://github.com/keycloak/keycloak) ⭐ 36,335 | 🐛 3,115 | 🌐 Java | 📅 2026-08-22 - Open Source Identity and Access Management For Modern Applications and Services.
* [vault](https://github.com/hashicorp/vault) ⭐ 36,153 | 🐛 1,429 | 🌐 Go | 📅 2026-08-21 - A tool for managing secrets.
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,835 | 🐛 3,397 | 🌐 Go | 📅 2026-08-21 - Certificate authority and access plane for SSH, Kubernetes, web apps, databases and desktops.
* [supertokens-core](https://github.com/supertokens/supertokens-core) ⭐ 15,273 | 🐛 168 | 🌐 Java | 📅 2026-08-19 - Open source alternative to Auth0 / Firebase Auth / AWS Cognito.
* [cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,040 | 🐛 248 | 🌐 Go | 📅 2026-08-22 - Automatically provision and manage TLS certificates in Kubernetes.
* [kratos](https://github.com/ory/kratos) ⭐ 13,840 | 🐛 224 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication, MFA, FIDO2, profile management, identity schemas, social sign in, registration, account recovery, service-to-service and IoT auth. Can work as an OAuth2 / OpenID Connect Provider. Golang, headless, API-only - without templating or theming headaches.
...
* [opa](https://github.com/open-policy-agent/opa) ⭐ 12,134 | 🐛 338 | 🌐 Go | 📅 2026-08-21 - An open source project to policy-enable your service.
* [kubescape](https://github.com/armosec/kubescape) ⭐ 11,679 | 🐛 97 | 🌐 Go | 📅 2026-08-21 - Kubescape is the first tool for testing if Kubernetes is deployed securely as defined in Kubernetes Hardening Guidance by to NSA and CISA.
...
* [syft](https://github.com/anchore/syft) ⭐ 9,447 | 🐛 627 | 🌐 Go | 📅 2026-08-21 - CLI tool and library for generating a Software Bill of Materials from container images and filesystems.
* [falco](https://github.com/falcosecurity/falco) ⭐ 9,288 | 🐛 64 | 🌐 C++ | 📅 2026-08-03 - Behavioral Activity Monitoring With Container Support.
* [firezone](https://github.com/firezone/firezone) ⭐ 9,040 | 🐛 394 | 🌐 Elixir | 📅 2026-08-22 - VPN server and Linux firewall built on WireGuard®. Supports SSO, MFA, and user-scoped access rules.
* [checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,966 | 🐛 164 | 🌐 Python | 📅 2026-08-20 - A static analysis tool for infrastructure as code - to prevent misconfigs at build time.
...
* [kyverno](https://github.com/kyverno/kyverno/) ⭐ 8,059 | 🐛 617 | 🌐 Go | 📅 2026-08-21 - Kubernetes Native Policy Management.
* [external-secrets](https://github.com/external-secrets/external-secrets) ⭐ 6,803 | 🐛 267 | 🌐 Go | 📅 2026-08-19 - Sync secrets from external stores like AWS Secrets Manager or Vault into Kubernetes.
...
* [opal](https://github.com/permitio/opal) ⭐ 5,502 | 🐛 64 | 🌐 Python | 📅 2026-08-19 - An administration layer for Policy Engines, detecting changes to both policy and policy data in real time and pushing live updates to your agents.
* [pomerium](https://github.com/pomerium/pomerium/) ⭐ 4,969 | 🐛 149 | 🌐 Go | 📅 2026-08-21 - Pomerium is a zero-trust context and identity aware access gateway inspired by BeyondCorp.
* [coraza](https://github.com/corazawaf/coraza) ⭐ 3,749 | 🐛 119 | 🌐 Go | 📅 2026-08-22 - OWASP Coraza WAF is a golang modsecurity compatible web application firewall library.
...
* [cedar](https://github.com/cedar-policy/cedar) ⭐ 1,679 | 🐛 175 | 🌐 Rust | 📅 2026-08-21 - Core implementation of the Cedar language.
...
* [neuvector](https://github.com/neuvector/neuvector) ⭐ 1,329 | 🐛 304 | 🌐 Go | 📅 2026-08-22 - Kubernetes-native container security platform.
...
* [darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 857 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks, with a proof trail per finding.
...
* [trust-manager](https://github.com/cert-manager/trust-manager) ⭐ 394 | 🐛 44 | 🌐 Go | 📅 2026-08-22 - trust-manager is an operator for distributing trust bundles across a Kubernetes cluster.
...
* [go-microvm](https://github.com/stacklok/go-microvm) ⭐ 20 | 🐛 10 | 🌐 Go | 📅 2026-08-19 - Go framework for running OCI images as microVMs via libkrun with embedded runtime, rootfs management, and guest networking.
...
* [toxiproxy](https://github.com/shopify/toxiproxy) ⭐ 12,274 | 🐛 105 | 🌐 Go | 📅 2026-08-04 - A TCP proxy to simulate network and system conditions for chaos and resiliency testing.
* [chaos-mesh](https://github.com/chaos-mesh/chaos-mesh) ⭐ 7,852 | 🐛 551 | 🌐 Go | 📅 2026-08-18 - A Chaos Engineering Platform for Kubernetes.
* [chaosblade](https://github.com/chaosblade-io/chaosblade) ⭐ 6,496 | 🐛 365 | 🌐 Python | 📅 2026-08-17 - An easy to use and powerful chaos engineering experiment toolkit（阿里巴巴开源的一款简单易用、功能强大的混沌实验注入工具）.
...
* [ratelimit](https://github.com/envoyproxy/ratelimit) ⭐ 2,685 | 🐛 33 | 🌐 Go | 📅 2026-08-21 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications.
...
* [testkube](https://github.com/kubeshop/testkube) ⭐ 1,645 | 🐛 51 | 🌐 Go | 📅 2026-08-21 - Kubernetes-native framework for test definition and execution.
* [krkn](https://github.com/krkn-chaos/krkn) ⭐ 488 | 🐛 139 | 🌐 Python | 📅 2026-08-20 - Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project.
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,305 | 🐛 746 | 🌐 TypeScript | 📅 2026-08-21 - Simple management UI for Docker.
* [backstage](https://github.com/backstage/backstage) ⭐ 34,210 | 🐛 404 | 🌐 TypeScript | 📅 2026-08-22 - Backstage is an open platform for building developer portals.
* [rancher](https://github.com/rancher/rancher) ⭐ 25,867 | 🐛 3,351 | 🌐 Go | 📅 2026-08-22 - Complete container management platform.
...
* [openshift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 300 | 🌐 Go | 📅 2026-08-21 - Enterprise Kubernetes for Developers.
...
* [radar](https://github.com/skyhook-io/radar) ⭐ 3,044 | 🐛 57 | 🌐 Go | 📅 2026-08-20 - Modern Kubernetes visibility tool with multi-cluster topology, image filesystem viewer, Helm and GitOps management, and built-in MCP server.
...
* [kubestellar](https://github.com/kubestellar/console) ⭐ 127 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-22 - KubeStellar Console is an AI-powered multi-cluster Kubernetes dashboard with natural language operations, MCP support, and GitOps deployment management.
...
* [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,136 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
* [kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) ⭐ 49,525 | 🐛 51 | 📅 2025-04-10 - Bootstrap Kubernetes the hard way on Google Cloud Platform. No scripts.
...
* [aws-eks-best-practices](https://github.com/aws/aws-eks-best-practices/) ⭐ 2,158 | 🐛 91 | 🌐 Python | 📅 2026-08-21 - A best practices guide for day 2 operations, including operational excellence, security, reliability, performance efficiency, and cost optimization.
